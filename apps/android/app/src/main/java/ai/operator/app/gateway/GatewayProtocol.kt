...
enum class GatewayMethod(
  ...
  operatorApprovalList("operator.approval.list"),
  operatorSetupDetect("operator.setup.detect"),
  operatorSetupActivate("operator.setup.activate"),
  operatorSetupAuthStart("operator.setup.auth.start"),
  ...
  operatorSetupVerify("operator.setup.verify"),
...
enum class GatewayEvent(
  ...
  operatorApprovalRequested("operator.approval.requested"),
  operatorApprovalResolved("operator.approval.resolved"),
