...
enum class GatewayMethod(
  ...
  OpenclawChat("operator.chat"),
  OpenclawApprovalList("operator.approval.list"),
  OpenclawSetupDetect("operator.setup.detect"),
  OpenclawSetupActivate("operator.setup.activate"),
  OpenclawSetupAuthStart("operator.setup.auth.start"),
  ...
  OpenclawSetupVerify("operator.setup.verify"),
...
enum class GatewayEvent(
  ...
  OpenclawApprovalRequested("operator.approval.requested"),
  OpenclawApprovalResolved("operator.approval.resolved"),
