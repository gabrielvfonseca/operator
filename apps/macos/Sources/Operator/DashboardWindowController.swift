...
final class DashboardWindowController: NSWindowController, WKNavigationDelegate, WKUIDelegate, NSWindowDelegate {
    private static let linkMessageHandlerName = "operatorLink"
    private static let windowDragMessageHandlerName = "operatorWindowDrag"
    private static let updateMessageHandlerName = "operatorUpdate"
