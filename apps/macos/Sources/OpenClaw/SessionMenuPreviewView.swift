...
enum SessionMenuPreviewLoader {
    private static let logger = Logger(subsystem: "ai.operator", category: "SessionPreview")
    ...
    private static func requestPreview(
        keys: [String],
        maxItems: Int) async throws -> OperatorSessionsPreviewPayload
    {
    ...
    private static func snapshot(
        from entry: OperatorSessionPreviewEntry,
    ...
    private static func cache(payload: OperatorSessionsPreviewPayload, maxItems: Int) async {
    ...
    private static func previewItems(
        from payload: OperatorChatHistoryPayload,
        maxItems: Int) -> [SessionPreviewItem]
    {
        let boundedItems = self.normalizeMaxItems(maxItems)
        let raw: [OperatorKit.AnyCodable] = payload.messages ?? []
    ...
    private static func decodeMessages(_ raw: [OperatorKit.AnyCodable]) -> [OperatorChatMessage] {
    ...
    private static func previewText(for message: OperatorChatMessage) -> String? {
    ...
    private static func isToolCall(_ message: OperatorChatMessage) -> Bool {
    ...
    private static func toolNames(for message: OperatorChatMessage) -> [String] {
        var names: [String] = []
    ...
    private static func mediaSummary(for message: OperatorChatMessage) -> String? {
