...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.operator", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Operator windows, but below the system’s pop-up menus.
