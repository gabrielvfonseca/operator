...
public enum operatorTalkCommand: String, Codable, Sendable {
...
public struct operatorTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct operatorTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
