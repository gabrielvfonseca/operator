...
public struct WorkerAdmissionHandshake: Codable, Sendable {
    ...
    private enum CodingKeys: String, CodingKey {
        ...
        case operatorversion = "operatorVersion"
...
public struct SessionCatalogSession: Codable, Sendable {
    ...
    public let archived: Bool
    public let operatorsessionkey: String?
        ...
        canopenterminal: Bool? = nil)
    {
        ...
        self.archived = archived
        self.operatorsessionkey = operatorsessionkey
    ...
    private enum CodingKeys: String, CodingKey {
        ...
        case archived
        case operatorsessionkey = "operatorSessionKey"
