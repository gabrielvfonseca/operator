...
public typealias operatorPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias operatorPlatformImage = UIImage
#endif

public enum operatorChatCommandFilter: String, CaseIterable, Sendable {
    case all = "All"
    case commands = "Commands"
    case skills = "Skills"
}

public struct operatorChatCommandChoice: Identifiable, Hashable, Sendable {
...
public struct operatorChatUsageCost: Codable, Hashable, Sendable {
...
public struct operatorChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: operatorChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(operatorChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct operatorChatMessageContent: Codable, Hashable, Sendable {
...
public struct operatorChatMessage: Codable, Hashable, Identifiable, Sendable {
    private struct operatorMetadata: Codable {
        let idempotencyKey: String?
    }

    public var id: UUID = .init()
    public let role: String
    public let content: [operatorChatMessageContent]
    public let timestamp: Double?
    public let idempotencyKey: String?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: operatorChatUsage?
    ...
    public init(from decoder: Decoder) throws {
        ...
        let decodedoperator = try container.decodeIfPresent(operatorMetadata.self, forKey: .operator)
        let decodedIdempotencyKey = try decodedoperator?.idempotencyKey ??
        ...
        let decodedUsage = try container.decodeIfPresent(operatorChatUsage.self, forKey: .usage)
        ...
        let decodedContent: [operatorChatMessageContent] = if let decoded = try? container.decode(
            [operatorChatMessageContent].self,
            forKey: .content)
        {
            decoded
        ...
        let audioAttachments: [operatorChatMessageContent] = alreadyContainsAudio ? [] : mediaPaths
            .enumerated()
            .compactMap { index, mediaPath in
                ...
                return operatorChatMessageContent(
                    type: "file",
                    text: nil,
                    mimeType: mimeType,
...
public struct operatorChatInFlightRun: Codable, Sendable {
...
public struct operatorChatSessionInfo: Codable, Sendable {
...
public struct operatorChatHistoryPayload: Codable, Sendable {
    public let sessionKey: String
    public let sessionId: String?
    public let messages: [AnyCodable]?
    public let thinkingLevel: String?
    public let sessionInfo: operatorChatSessionInfo?
    public let inFlightRun: operatorChatInFlightRun?
    ...
    public init(
        ...
        sessionInfo: operatorChatSessionInfo? = nil,
        inFlightRun: operatorChatInFlightRun? = nil)
    {
...
public struct operatorSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct operatorSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [operatorSessionPreviewItem]
}

public struct operatorSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [operatorSessionPreviewEntry]

    public init(ts: Int, previews: [operatorSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct operatorChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct operatorChatCreateSessionResponse: Codable, Sendable {
    public let ok: Bool?
    public let key: String
    public let sessionId: String?
}

public struct operatorChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct operatorSessionMessageEventPayload: Codable, Sendable {
    public let sessionKey: String?
    public let agentId: String?
    public let message: operatorChatMessage?
...
public struct operatorAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct operatorChatPendingToolCall: Identifiable, Hashable, Sendable {
    public var id: String {
        self.toolCallId
    }
...
public struct operatorGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct operatorPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: operatorPlatformImage?
    public let durationSeconds: Double?
...
public struct operatorChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
