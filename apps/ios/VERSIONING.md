# Operator iOS Versioning

Operator iOS release uploads use an explicit CalVer release version. The
...
```text
refs/operator/mobile-releases/ios/<CFBundleShortVersionString>-<CFBundleVersion>
```

Example:

```text
refs/operator/mobile-releases/ios/2026.6.11-3
```
