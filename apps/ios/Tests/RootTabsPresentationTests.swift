...
struct RootTabsPresentationTests {
    ...
    @Test func `app launch defaults to chat tab`() {
        #expect(RootTabs.initialTab(arguments: ["Operator"]) == .chat)
        #expect(RootTabs.initialTab(arguments: ["Operator", "--operator-initial-tab"]) == .chat)
        #expect(RootTabs.initialTab(arguments: ["Operator", "--operator-initial-tab", "unknown"]) == .chat)
    }

    @Test func `app launch uses requested destination before chat fallback`() {
        #expect(RootTabs.initialTab(arguments: ["Operator", "--operator-initial-destination", "overview"]) == .control)
        #expect(RootTabs.initialTab(arguments: ["Operator", "--operator-initial-destination", "chat"]) == .chat)
        #expect(RootTabs.initialTab(arguments: ["Operator", "--operator-initial-destination", "agents"]) == .agent)
        #expect(RootTabs.initialTab(arguments: ["Operator", "--operator-initial-destination", "gateway"]) == .settings)
        #expect(
    ...
    @Test func `app launch respects explicit initial tab override`() {
        #expect(RootTabs.initialTab(arguments: ["Operator", "--operator-initial-tab", "control"]) == .control)
        #expect(RootTabs.initialTab(arguments: ["Operator", "--operator-initial-tab", "overview"]) == .control)
        #expect(RootTabs.initialTab(arguments: ["Operator", "--operator-initial-tab", "chat"]) == .chat)
        #expect(RootTabs.initialTab(arguments: ["Operator", "--operator-initial-tab", "voice"]) == .talk)
        #expect(RootTabs.initialTab(arguments: ["Operator", "--operator-initial-tab", "agents"]) == .agent)
        #expect(RootTabs.initialTab(arguments: ["Operator", "--operator-initial-tab", "settings"]) == .settings)
    }
    ...
    @Test func `chat sidebar destination can use native route title instead of agent branding`() {
        ...
        #expect(ChatProTab.defaultHeaderTitle(showsAgentBadge: true, agentDisplayName: "Operator") == "Operator")
        #expect(ChatProTab.defaultHeaderTitle(showsAgentBadge: false, agentDisplayName: "Operator") == "Chat")
    }
