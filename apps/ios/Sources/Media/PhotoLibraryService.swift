...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: OperatorPhotosLatestParams) async throws -> OperatorPhotosLatestPayload {
        ...
        var results: [OperatorPhotoPayload] = []
        ...
        return OperatorPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> OperatorPhotoPayload
    {
