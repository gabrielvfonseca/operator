        ...
        return NavigationLink {
            ...
            HStack(spacing: 12) {
                Image(systemName: isDirectory ? "folder" : "doc.text")
                    ...
                    .foregroundStyle(isDirectory ? OperatorBrand.accent : Color.secondary)
                    .frame(width: 24)
...
struct AgentWorkspaceFilePreview: View {
    ...
    private var content: some View {
        if let file {
            ...
            .padding(OperatorProMetric.pagePadding)
        }
    }
    ...
    private func share() {
        ...
        let directory = FileManager.default.temporaryDirectory
            .appendingPathComponent("OperatorWorkspaceFiles", isDirectory: true)
