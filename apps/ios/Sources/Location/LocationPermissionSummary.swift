...
struct LocationPermissionSummary: Equatable {
    var desiredMode: OperatorLocationMode
    var locationServicesEnabled: Bool
    var authorizationStatus: CLAuthorizationStatus
    var accuracyAuthorization: CLAccuracyAuthorization

    var effectiveMode: OperatorLocationMode {
    ...
    var detailText: String {
        ...
        {
        case (.off, false, _, _):
            "Location sharing is disabled in Operator. Location Services are off in iOS Settings."
        case (.off, true, .authorizedAlways, _):
            "Location sharing is disabled in Operator. iOS currently allows Always."
        case (.off, true, .authorizedWhenInUse, _):
            "Location sharing is disabled in Operator. iOS currently allows While Using."
        case (.off, _, _, _):
        ...
        @unknown default:
            "Operator cannot determine the current iOS location permission."
        }
    }
}
