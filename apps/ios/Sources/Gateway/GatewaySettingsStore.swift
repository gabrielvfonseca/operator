...
enum GatewaySettingsStore {
    private static let productionGatewayService = "ai.operatorfoundation.app.gateway"
    ...
    #endif
    private static let nodeService = "ai.operatorfoundation.app.node"
    private static let talkService = "ai.operatorfoundation.app.talk"
    ...
    private static let gatewayCustomHeadersService = "ai.operatorfoundation.app.gateway.custom-headers"
...
enum GatewayDiagnostics {
    ...
    private static let logger = Logger(subsystem: "ai.operatorfoundation.app", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.operatorfoundation.app.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("operator-gateway.log")
    }
