...
class GatewayUrlConfirmation extends OperatorLightDomContentsElement {
...
if (!customElements.get("operator-gateway-url-confirmation")) {
  customElements.define("operator-gateway-url-confirmation", GatewayUrlConfirmation);
}
