...
class ThemeModeToggle extends OperatorLightDomContentsElement {
...
if (!customElements.get("operator-theme-mode-toggle")) {
  customElements.define("operator-theme-mode-toggle", ThemeModeToggle);
}
