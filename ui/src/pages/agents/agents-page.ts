...
class AgentsPage extends OperatorLightDomElement implements AgentsState {
...
if (!customElements.get("operator-agents-page")) {
  customElements.define("operator-agents-page", AgentsPage);
}
