...
class AgentMemoryPanel extends OperatorLightDomElement {
...
if (!customElements.get("operator-agent-memory-panel")) {
  customElements.define("operator-agent-memory-panel", AgentMemoryPanel);
}
