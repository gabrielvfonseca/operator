...
describeControlUiE2e("GitHub link hover cards", () => {
  ...
  it("previews issue and pull request links while preserving navigation", async () => {
          ...
          content: [
            {
              type: "text",
              text: [
                "Review [#99816](https://github.com/operator/operator/pull/99816),",
                "then [#99815](https://github.com/operator/operator/issues/99815).",
                "A [missing item](https://github.com/operator/operator/issues/999999) stays usable.",
    ...
    expect(await missingLink.getAttribute("href")).toBe(
      "https://github.com/operator/operator/issues/999999",
    );
    await page.mouse.move(1, 1);
    ...
    expect(popup.url()).toBe("https://github.com/operator/operator/pull/99816");
  });
});
