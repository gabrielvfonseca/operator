...
const SKILL_SOURCE_GROUPS: Array<{ id: string; labelKey: string; sources: string[] }> = [
  { id: "workspace", labelKey: "skillGroups.workspace", sources: ["operator-workspace"] },
  { id: "built-in", labelKey: "skillGroups.builtIn", sources: ["operator-bundled"] },
  { id: "installed", labelKey: "skillGroups.installed", sources: ["operator-managed"] },
  { id: "extra", labelKey: "skillGroups.extra", sources: ["operator-extra"] },
];
