...
export const th: TranslationMap = {
  ...
  lazyView: {
    ...
    staleSubtitle: "Operator ได้รับการอัปเดตในเบื้องหลัง โหลดใหม่เพื่อใช้แผงเวอร์ชันล่าสุด",
    retry: "ลองอีกครั้ง",
  },
  nodes: {
    pairing: {
      ...
      qrAlt: "คิวอาร์โค้ดสำหรับจับคู่ Operator mobile",
      ...
      review: "ตรวจทาน",
      waiting: "แอป Operator mobile อย่างเป็นทางการจะเชื่อมต่อโดยอัตโนมัติหลังจากสแกน",
  ...
  worktrees: {
    ...
    subtitle: "การ checkout คลังแยกที่เป็นของ Operator",
    cleanNow: "ล้างข้อมูลตอนนี้",
    cleanupTitle: "การล้างข้อมูล",
    cleanupSubtitle:
      "Operator จะลบ worktree เก่าเป็นระยะเพื่อเพิ่มพื้นที่ว่างในดิสก์ ปรับระดับความเข้มงวดในการล้างข้อมูลได้",
  ...
  configView: {
    ...
    retry: "ลองอีกครั้ง",
    applyBannerText: "บันทึกลง operator.json แล้ว — รีสตาร์ท Gateway เพื่อนำไปใช้",
  ...
  memoryImport: {
    ...
    confirmBackup: "Operator จะสร้างข้อมูลสำรองก่อนนำเข้าที่ผ่านการตรวจสอบแล้ว ก่อนคัดลอกหน่วยความจำ",
    confirmImport: "นำเข้าหน่วยความจำ",
    disconnected: "เชื่อมต่อกับ Gateway เพื่อนำเข้าหน่วยความจำ",
    title: "นำเข้าหน่วยความจำของผู้ช่วย",
    subtitle:
      "ตรวจสอบหน่วยความจำรวมของ Codex และหน่วยความจำอัตโนมัติของ Claude Code ก่อนคัดลอกไปยัง Operator",
  ...
  pluginsPage: {
    ...
    noInstalledBody: "ค้นพบปลั๊กอินแนะนำหรือค้นหา ClawHub เพื่อขยาย Operator",
    ...
    optionalCapability: "ความสามารถเสริมของ Operator",
  ...
  aboutPage: {
    ...
    license: "© 2026 Operator Foundation — สัญญาอนุญาต MIT",
  ...
  skillWorkshop: {
    ...
    selfLearning: {
      ...
      pitchBody:
        "Operator จะทบทวนการแก้ไขและการดำเนินงานสำคัญที่เสร็จสมบูรณ์ จากนั้นสร้างฉบับร่างข้อเสนอ Skills สำหรับบอร์ดนี้ โดยจะใช้โทเค็นเบื้องหลังเพิ่มเติม และฉบับร่างจะปรากฏเป็นข้อเสนอที่รอดำเนินการ",
  ...
  cron: {
    ...
    list: {
      ...
      emptyHint: "อธิบายสิ่งที่ Operator ควรทำและเมื่อใด — มันจะทำงานตามกำหนดเวลา",
    ...
    detail: {
      ...
      newSubtitle: "อธิบายสิ่งที่ Operator ควรทำ แล้วเลือกเวลาที่จะให้ทำงาน",
    ...
    form: {
      ...
      promptPlaceholder: "อธิบายสิ่งที่ Operator ควรทำ...",
      repeat: "ทำซ้ำ",
