...
export const en: TranslationMap = {
  ...
  lazyView: {
    ...
    staleSubtitle: "Operator was updated in the background. Reload to get the latest panel.",
    retry: "Retry",
  },
  nodes: {
    pairing: {
      ...
      qrAlt: "Operator mobile pairing QR code",
      ...
      review: "Review",
      waiting: "Official Operator mobile apps connect automatically after scanning.",
      help: "Pairing help",
  ...
  worktrees: {
    ...
    subtitle: "Isolated repository checkouts owned by Operator.",
    cleanNow: "Clean up now",
    cleanupTitle: "Cleanup",
    cleanupSubtitle:
      "Operator periodically removes old worktrees to free disk space. Tune how aggressively cleanup runs.",
  ...
  configView: {
    ...
    retry: "Retry",
    applyBannerText: "Saved to operator.json — restart the gateway to apply.",
  ...
  memoryImport: {
    ...
    confirmBackup: "Operator creates a verified pre-import backup before copying memory.",
    confirmImport: "Import memory",
    disconnected: "Connect to the gateway to import memory.",
    title: "Import assistant memory",
    subtitle:
      "Review Codex consolidated memory and Claude Code auto-memory before copying it into Operator.",
  ...
  pluginsPage: {
    ...
    noInstalledBody: "Discover a featured plugin or search ClawHub to extend Operator.",
    ...
    optionalCapability: "Optional Operator capability.",
    enabled: "Enabled",
    disabled: "Disabled",
    available: "Available",
  ...
  aboutPage: {
    ...
    license: "© 2026 Operator Foundation — MIT License.",
  ...
  skillWorkshop: {
    ...
    selfLearning: {
      ...
      pitchBody:
        "Operator reviews corrections and substantial completed runs, then drafts skill proposals for this board. It spends extra background tokens and drafts arrive as pending proposals.",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste:
          "Paste the token from operator dashboard --no-open or enter the configured password.",
        stepGenerate:
          "If no token is configured, run operator doctor --generate-gateway-token on the gateway host.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "Run operator dashboard --no-open and open the fresh URL or paste its token.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Run operator devices list on the Gateway host.",
        stepApproveId: "Approve this request: operator devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Reopen the served dashboard with operator dashboard so the UI and Gateway come from the same install.",
        stepDevUi:
          "If using pnpm ui:dev, rebuild or restart the dev UI against the current checkout.",
        stepRestart:
          "Restart the Gateway after updating Operator so it serves the current protocol.",
      },
      network: {
        title: "Could not connect",
        summary:
          "The browser could not complete the Gateway connection. Check the target and transport before retrying credentials.",
        stepGateway: "Confirm the Gateway is running with operator status or operator gateway run.",
        stepUrl:
          "Check the WebSocket URL and use wss:// when the Gateway is behind HTTPS/Tailscale Serve.",
        stepDashboard:
          "Reopen the dashboard with operator dashboard --no-open to recopy the current URL and auth details.",
      },
    },
  },
  chat: {
  ...
  cron: {
    ...
    list: {
      ...
      emptyHint: "Describe what Operator should do and when — it runs on schedule.",
    ...
    detail: {
      ...
      newSubtitle: "Describe what Operator should do, then pick when it runs.",
    ...
    form: {
      ...
      promptPlaceholder: "Describe what Operator should do...",
      repeat: "Repeat",
