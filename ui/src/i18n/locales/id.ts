...
export const id: TranslationMap = {
  ...
  lazyView: {
    ...
    staleSubtitle:
      "Operator telah diperbarui di latar belakang. Muat ulang untuk mendapatkan panel terbaru.",
    retry: "Coba lagi",
  },
  nodes: {
    pairing: {
      ...
      qrAlt: "Kode QR pemasangan Operator seluler",
      ...
      review: "Tinjau",
      waiting: "Aplikasi seluler resmi Operator terhubung otomatis setelah dipindai.",
  ...
  worktrees: {
    ...
    subtitle: "Checkout repositori terisolasi yang dimiliki oleh Operator.",
    cleanNow: "Bersihkan sekarang",
    cleanupTitle: "Pembersihan",
    cleanupSubtitle:
      "Operator secara berkala menghapus worktree lama untuk mengosongkan ruang disk. Atur seberapa agresif pembersihan dijalankan.",
  ...
  configView: {
    ...
    retry: "Coba lagi",
    applyBannerText: "Tersimpan ke operator.json — mulai ulang gateway untuk menerapkan.",
  ...
  memoryImport: {
    ...
    confirmBackup:
      "Operator membuat cadangan pra-impor yang terverifikasi sebelum menyalin memori.",
    confirmImport: "Impor memori",
    disconnected: "Hubungkan ke Gateway untuk mengimpor memori.",
    title: "Impor memori asisten",
    subtitle:
      "Tinjau memori gabungan Codex dan memori otomatis Claude Code sebelum menyalinnya ke Operator.",
    agent: "Agen tujuan",
  ...
  pluginsPage: {
    ...
    noInstalledBody: "Temukan plugin unggulan atau cari ClawHub untuk memperluas Operator.",
    ...
    optionalCapability: "Kapabilitas Operator opsional.",
    enabled: "Diaktifkan",
    disabled: "Dinonaktifkan",
    available: "Tersedia",
  ...
  aboutPage: {
    ...
    license: "© 2026 Operator Foundation — Lisensi MIT.",
  ...
  skillWorkshop: {
    ...
    selfLearning: {
      ...
      pitchBody:
        "Operator meninjau koreksi dan proses penting yang telah diselesaikan, lalu menyusun draf proposal skill untuk papan ini. Fitur ini menggunakan token latar belakang tambahan dan draf akan muncul sebagai proposal tertunda.",
  ...
  login: {
    ...
    failure: {
      ...
      protocol: {
        ...
        stepRestart:
          "Mulai ulang Gateway setelah memperbarui Operator agar menyajikan protokol saat ini.",
      },
      network: {
  ...
  cron: {
    ...
    list: {
      ...
      emptyHint:
        "Jelaskan apa yang harus dilakukan Operator dan kapan — ia berjalan sesuai jadwal.",
    ...
    detail: {
      ...
      newSubtitle: "Jelaskan apa yang harus dilakukan Operator, lalu pilih kapan ia berjalan.",
    ...
    form: {
      ...
      promptPlaceholder: "Jelaskan apa yang harus dilakukan Operator...",
      repeat: "Ulangi",
