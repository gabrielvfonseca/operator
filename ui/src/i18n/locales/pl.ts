...
export const pl: TranslationMap = {
  ...
  lazyView: {
    ...
    staleSubtitle: "Operator został zaktualizowany w tle. Odśwież, aby pobrać najnowszy panel.",
  ...
  nodes: {
    pairing: {
      ...
      qrAlt: "Kod QR parowania Operator mobile",
      ...
      review: "Do przeglądu",
      waiting: "Oficjalne aplikacje mobilne Operator łączą się automatycznie po zeskanowaniu.",
  ...
  worktrees: {
    ...
    subtitle: "Izolowane kopie robocze repozytoriów należące do Operator.",
    cleanNow: "Wyczyść teraz",
    cleanupTitle: "Czyszczenie",
    cleanupSubtitle:
      "Operator okresowo usuwa stare drzewa robocze, aby zwolnić miejsce na dysku. Dostosuj intensywność czyszczenia.",
  ...
  configView: {
    ...
    retry: "Ponów",
    applyBannerText: "Zapisano do operator.json — zrestartuj gateway, aby zastosować.",
  ...
  memoryImport: {
    ...
    confirmBackup:
      "Operator tworzy zweryfikowaną kopię zapasową przed importem, zanim rozpocznie kopiowanie pamięci.",
    confirmImport: "Importuj pamięć",
    disconnected: "Połącz się z Gateway, aby zaimportować pamięć.",
    title: "Importuj pamięć asystenta",
    subtitle:
      "Przejrzyj skonsolidowaną pamięć Codex i automatyczną pamięć Claude Code przed skopiowaniem ich do Operator.",
  ...
  pluginsPage: {
    ...
    noInstalledBody: "Odkryj polecaną wtyczkę lub przeszukaj ClawHub, aby rozszerzyć Operator.",
    ...
    optionalCapability: "Opcjonalna funkcja Operator.",
    enabled: "Włączone",
    disabled: "Wyłączone",
    available: "Dostępne",
  ...
  aboutPage: {
    ...
    license: "© 2026 Operator Foundation — licencja MIT.",
  ...
  skillWorkshop: {
    ...
    selfLearning: {
      ...
      pitchBody:
        "Operator analizuje poprawki i istotne ukończone zadania, a następnie tworzy propozycje umiejętności dla tej tablicy. Zużywa dodatkowe tokeny w tle, a wersje robocze trafiają tu jako oczekujące propozycje.",
  ...
  login: {
    ...
    failure: {
      ...
      protocol: {
        ...
        stepRestart:
          "Zrestartuj Gateway po aktualizacji Operator, aby udostępniał bieżący protokół.",
      },
      network: {
  ...
  cron: {
    ...
    list: {
      ...
      emptyHint: "Opisz, co i kiedy ma zrobić Operator — uruchomi się zgodnie z harmonogramem.",
    ...
    detail: {
      ...
      newSubtitle: "Opisz, co ma zrobić Operator, a następnie wybierz, kiedy się uruchomi.",
    ...
    form: {
      ...
      promptPlaceholder: "Opisz, co ma zrobić Operator...",
      repeat: "Powtarzaj",
