...
export const vi: TranslationMap = {
  ...
  lazyView: {
    ...
    staleSubtitle:
      "Operator đã được cập nhật trong nền. Hãy tải lại để xem bảng điều khiển mới nhất.",
    retry: "Thử lại",
  },
  nodes: {
    pairing: {
      ...
      qrAlt: "Mã QR ghép nối Operator di động",
      ...
      review: "Đánh giá",
      waiting: "Các ứng dụng di động Operator chính thức sẽ tự động kết nối sau khi quét.",
  ...
  worktrees: {
    ...
    subtitle: "Các bản checkout kho lưu trữ được cô lập do Operator sở hữu.",
    cleanNow: "Dọn dẹp ngay",
    cleanupTitle: "Dọn dẹp",
    cleanupSubtitle:
      "Operator định kỳ xóa các worktree cũ để giải phóng dung lượng ổ đĩa. Điều chỉnh mức độ dọn dẹp.",
  ...
  configView: {
    ...
    retry: "Thử lại",
    applyBannerText: "Đã lưu vào operator.json — khởi động lại gateway để áp dụng.",
  ...
  subtitles: {
    ...
    config: "Chỉnh sửa operator.json.",
  ...
  memoryImport: {
    ...
    confirmBackup: "Operator tạo bản sao lưu đã xác minh trước khi nhập rồi mới sao chép bộ nhớ.",
    confirmImport: "Nhập bộ nhớ",
    disconnected: "Kết nối với Gateway để nhập bộ nhớ.",
    title: "Nhập bộ nhớ của trợ lý",
    subtitle:
      "Xem lại bộ nhớ hợp nhất của Codex và bộ nhớ tự động của Claude Code trước khi sao chép vào Operator.",
    agent: "Tác nhân đích",
  ...
  pluginsPage: {
    ...
    noInstalledBody: "Khám phá một plugin nổi bật hoặc tìm kiếm trên ClawHub để mở rộng Operator.",
    ...
    optionalCapability: "Khả năng Operator tùy chọn.",
    enabled: "Đã bật",
    disabled: "Đã tắt",
    available: "Có sẵn",
  ...
  aboutPage: {
    ...
    license: "© 2026 Operator Foundation — Giấy phép MIT.",
  ...
  skillWorkshop: {
    ...
    selfLearning: {
      ...
      pitchBody:
        "Operator xem xét các chỉnh sửa và những lượt chạy quan trọng đã hoàn thành, sau đó soạn thảo các đề xuất kỹ năng cho bảng này. Tính năng này sử dụng thêm token nền và các bản nháp sẽ xuất hiện dưới dạng đề xuất đang chờ xử lý.",
  ...
  login: {
    ...
    failure: {
      ...
      protocol: {
        ...
        stepRestart:
          "Khởi động lại Gateway sau khi cập nhật Operator để nó phục vụ giao thức hiện tại.",
      },
      network: {
  ...
  cron: {
    ...
    list: {
      ...
      emptyHint: "Mô tả những gì Operator nên làm và khi nào — nó sẽ chạy theo lịch.",
    ...
    detail: {
      ...
      newSubtitle: "Mô tả những gì Operator nên làm, sau đó chọn thời điểm chạy.",
    ...
    form: {
      ...
      promptPlaceholder: "Mô tả những gì Operator nên làm...",
      repeat: "Lặp lại",
