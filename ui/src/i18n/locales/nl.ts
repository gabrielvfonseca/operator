...
export const nl: TranslationMap = {
  ...
  lazyView: {
    ...
    staleSubtitle:
      "Operator is op de achtergrond bijgewerkt. Laad opnieuw om het nieuwste paneel te zien.",
  ...
  nodes: {
    pairing: {
      ...
      qrAlt: "QR-code voor koppeling met Operator mobiel",
      ...
      review: "Beoordeling",
      waiting: "Officiële mobiele Operator-apps verbinden automatisch na het scannen.",
  ...
  worktrees: {
    ...
    subtitle: "Geïsoleerde repository-checkouts beheerd door Operator.",
    cleanNow: "Nu opschonen",
    cleanupTitle: "Opschonen",
    cleanupSubtitle:
      "Operator verwijdert periodiek oude worktrees om schijfruimte vrij te maken. Stel in hoe agressief de opschoning wordt uitgevoerd.",
  ...
  configView: {
    ...
    retry: "Opnieuw proberen",
    applyBannerText: "Opgeslagen in operator.json — herstart de gateway om toe te passen.",
  ...
  memoryImport: {
    ...
    confirmBackup:
      "Operator maakt een geverifieerde back-up vóór de import voordat het geheugen wordt gekopieerd.",
    ...
    subtitle:
      "Controleer het geconsolideerde geheugen van Codex en het automatische geheugen van Claude Code voordat u het naar Operator kopieert.",
    agent: "Doelagent",
  ...
  pluginsPage: {
    ...
    noInstalledBody: "Ontdek een uitgelichte plugin of zoek in ClawHub om Operator uit te breiden.",
    ...
    optionalCapability: "Optionele Operator-mogelijkheid.",
    enabled: "Ingeschakeld",
    disabled: "Uitgeschakeld",
    available: "Beschikbaar",
  ...
  aboutPage: {
    ...
    license: "© 2026 Operator Foundation — MIT-licentie.",
  ...
  skillWorkshop: {
    ...
    selfLearning: {
      ...
      pitchBody:
        "Operator beoordeelt correcties en omvangrijke voltooide runs en stelt vervolgens skillvoorstellen op voor dit bord. Het verbruikt extra tokens op de achtergrond en concepten verschijnen als openstaande voorstellen.",
  ...
  login: {
    ...
    failure: {
      ...
      protocol: {
        ...
        stepRestart:
          "Herstart de Gateway na het bijwerken van Operator zodat het huidige protocol wordt geserveerd.",
      },
      network: {
  ...
  cron: {
    ...
    list: {
      ...
      emptyHint: "Beschrijf wat Operator moet doen en wanneer — het draait volgens schema.",
    ...
    detail: {
      ...
      newSubtitle: "Beschrijf wat Operator moet doen en kies wanneer het wordt uitgevoerd.",
    ...
    form: {
      ...
      promptPlaceholder: "Beschrijf wat Operator moet doen...",
      repeat: "Herhalen",
