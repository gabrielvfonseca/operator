...
export const pt_BR: TranslationMap = {
  ...
  lazyView: {
    ...
    staleSubtitle:
      "O Operator foi atualizado em segundo plano. Recarregue para obter o painel mais recente.",
  ...
  nodes: {
    pairing: {
      ...
      qrAlt: "Código QR de pareamento do Operator mobile",
      ...
      review: "Revisão",
      waiting: "Os apps móveis oficiais do Operator se conectam automaticamente após a leitura.",
  ...
  worktrees: {
    ...
    subtitle: "Checkouts isolados de repositórios pertencentes ao Operator.",
    cleanNow: "Limpar agora",
    cleanupTitle: "Limpeza",
    cleanupSubtitle:
      "O Operator remove periodicamente worktrees antigos para liberar espaço em disco. Ajuste o nível de agressividade da limpeza.",
  ...
  configView: {
    ...
    retry: "Tentar novamente",
    applyBannerText: "Salvo em operator.json — reinicie o gateway para aplicar.",
  ...
  memoryImport: {
    ...
    confirmBackup:
      "O Operator cria um backup verificado antes da importação e antes de copiar a memória.",
    ...
    subtitle:
      "Revise a memória consolidada do Codex e a memória automática do Claude Code antes de copiá-las para o Operator.",
  ...
  pluginsPage: {
    ...
    noInstalledBody:
      "Descubra um plugin em destaque ou pesquise no ClawHub para expandir o Operator.",
    ...
    optionalCapability: "Recurso opcional do Operator.",
    enabled: "Ativado",
    disabled: "Desativado",
    available: "Disponível",
  ...
  aboutPage: {
    ...
    license: "© 2026 Operator Foundation — Licença MIT.",
  ...
  skillWorkshop: {
    ...
    selfLearning: {
      ...
      pitchBody:
        "O Operator revisa correções e execuções substanciais concluídas e, em seguida, cria rascunhos de propostas de skills para este quadro. Ele consome tokens adicionais em segundo plano, e os rascunhos chegam como propostas pendentes.",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste: "Cole o token de operator dashboard --no-open ou informe a senha configurada.",
        stepGenerate:
          "Se nenhum token estiver configurado, execute operator doctor --generate-gateway-token no host do Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard: "Execute operator dashboard --no-open e abra o novo URL ou cole seu token.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Execute operator devices list no host do Gateway.",
        stepApproveId: "Aprove esta solicitação: operator devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Reabra o dashboard servido com operator dashboard para que UI e Gateway venham da mesma instalação.",
        stepDevUi:
          "Se estiver usando pnpm ui:dev, reconstrua ou reinicie a UI de desenvolvimento com o checkout atual.",
        stepRestart:
          "Reinicie o Gateway depois de atualizar o Operator para que ele sirva o protocolo atual.",
      },
      network: {
        ...
        stepGateway:
          "Confirme que o Gateway está em execução com operator status ou operator gateway run.",
        stepUrl:
          "Verifique o URL de WebSocket e use wss:// quando o Gateway estiver atrás de HTTPS/Tailscale Serve.",
        stepDashboard:
          "Reabra o dashboard com operator dashboard --no-open para copiar novamente o URL atual e os detalhes de auth.",
      },
    },
  },
  chat: {
  ...
  cron: {
    ...
    list: {
      ...
      emptyHint:
        "Descreva o que o Operator deve fazer e quando — ele executa conforme a programação.",
    ...
    detail: {
      ...
      newSubtitle: "Descreva o que o Operator deve fazer e escolha quando será executado.",
    ...
    form: {
      ...
      promptPlaceholder: "Descreva o que o Operator deve fazer...",
      repeat: "Repetir",
