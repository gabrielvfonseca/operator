...
function installControlUiMockGateway(input: {
  ...
  (window as unknown as WindowWithGateway)["__OPERATOR_CONTROL_UI_BASE_PATH__"] = scenario.basePath;
  ...
  (window as unknown as WindowWithGateway).operatorControlUiE2eGateway = exposed;
