...
import {
  ...
  OperatorLitElement,
} from "./operator-element.ts";

const LIGHT_ELEMENT_NAME = "test-operator-light-dom-element";
const LIGHT_CONTENTS_ELEMENT_NAME = "test-operator-light-dom-contents-element";
const SHADOW_ELEMENT_NAME = "test-operator-shadow-dom-element";
...
describe("Operator Lit elements", () => {
  beforeEach(async () => {
