...
describeControlUiE2e("GitHub link hover cards", () => {
  ...
  it("previews issue and pull request links while preserving navigation", async () => {
          ...
          content: [
            {
              type: "text",
              text: [
                "Review [#99816](https://github.com/gabrielvfonseca/operator/pull/99816),",
                "then [#99815](https://github.com/gabrielvfonseca/operator/issues/99815).",
                "A [missing item](https://github.com/gabrielvfonseca/operator/issues/999999) stays usable.",
                "The [repository](https://github.com/operator/operator) has no item preview.",
              ].join(" "),
            },
          ],
          role: "assistant",
    ...
    await expectText(card, "operator/operator #99816");
    ...
    expect(popup.url()).toBe("https://github.com/gabrielvfonseca/operator/pull/99816");
  });
});
