...
function withControlUiBasePath<T>(basePath: string, fn: () => T): T {
  ...
  Object.defineProperty(window, "__OPERATOR_CONTROL_UI_BASE_PATH__", {
    value: basePath,
    writable: true,
    configurable: true,
  });
  try {
    ...
    delete testWindow["__OPERATOR_CONTROL_UI_BASE_PATH__"];
  }
}
...
describe("toSanitizedMarkdownHtml", () => {
  ...
  describe("explicit protocol links", () => {
    ...
    it("links http:// URLs", () => {
      const html = toSanitizedMarkdownHtml("Visit http://github.com/operator");
      expect(html).toBe(
        '<p>Visit <a href="http://github.com/operator" rel="noreferrer noopener" target="_blank">http://github.com/operator</a></p>\n',
      );
    });
    ...
    it("does NOT rewrite explicit markdown links with CJK display text", () => {
      const html = toSanitizedMarkdownHtml("[Operator中文](https://docs.operator.ai)");
      expect(html).toBe(
        '<p><a href="https://docs.operator.ai" rel="noreferrer noopener" target="_blank">Operator中文</a></p>\n',
      );
    });
...
`;
  ...
  describe("security", () => {
    ...
    it("strips href from host-local absolute file paths", () => {
      const html = toSanitizedMarkdownHtml(
        "[report.docx](/Users/test/.operator/data/skills/output/report.docx)",
      );
    ...
    it("rewrites docs-root links to the public docs host", () => {
      ...
      expect(html).toBe(
        '<p><a href="https://docs.operator.ai/concepts/agent-workspace" rel="noreferrer noopener" target="_blank">workspace</a> <a href="https://docs.operator.ai/automation/hooks#session-memory" rel="noreferrer noopener" target="_blank">hooks</a> <a href="https://docs.operator.ai/channels/telegram?tab=setup" rel="noreferrer noopener" target="_blank">telegram</a> <a href="https://docs.operator.ai/telegram" rel="noreferrer noopener" target="_blank">shortlink</a> <a href="https://docs.operator.ai/openai" rel="noreferrer noopener" target="_blank">openai</a> <a href="https://docs.operator.ai/images" rel="noreferrer noopener" target="_blank">images</a> <a href="https://docs.operator.ai/groups" rel="noreferrer noopener" target="_blank">groups</a> <a href="https://docs.operator.ai/nodes/camera" rel="noreferrer noopener" target="_blank">camera</a> <a href="https://docs.operator.ai/platforms/macos" rel="noreferrer noopener" target="_blank">macOS</a> <a href="https://docs.operator.ai/cli/sessions" rel="noreferrer noopener" target="_blank">cliSessions</a> <a href="https://docs.operator.ai/tools/skills" rel="noreferrer noopener" target="_blank">toolSkills</a> <a href="https://docs.operator.ai/plugins/reference/diffs" rel="noreferrer noopener" target="_blank">pluginDocs</a> <a href="https://docs.operator.ai/prose" rel="noreferrer noopener" target="_blank">prose</a> <a href="https://docs.operator.ai/channels/access-groups" rel="noreferrer noopener" target="_blank">access</a></p>\n',
      );
    });
