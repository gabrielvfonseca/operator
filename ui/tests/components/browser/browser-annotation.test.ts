...
import { buildAnnotationPrompt } from "../../../src/components/browser/browser-annotation.ts";
import {
  inspectBrowserElementAt,
  type BrowserInspectedNode,
} from "../../../src/components/browser/browser-client.ts";
...
describe("buildAnnotationPrompt", () => {
  it("describes the page, marked regions, and inspected element", () => {
    const prompt = buildAnnotationPrompt({
      url: "https://github.com/gabrielvfonseca/operator/pull/103853",
    ...
    expect(prompt).toContain("https://github.com/gabrielvfonseca/operator/pull/103853");
