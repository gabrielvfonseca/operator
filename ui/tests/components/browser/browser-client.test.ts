...
import { fetchBrowserScreenshotDataUrl } from "../../../src/components/browser/browser-client.ts";
...
describe("fetchBrowserScreenshotDataUrl", () => {
  ...
  it("aborts a stalled screenshot fetch after the request deadline", async () => {
    ...
    expect(url).toBe("/operator/__operator__/assistant-media?source=%2Ftmp%2Fbrowser+shot.png");
