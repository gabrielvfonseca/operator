...
import type { ThemeModeChangeDetail } from "../../src/components/theme-mode-toggle.ts";
...
describe("theme mode toggle", () => {
  it("defaults to system and cycles one button through every mode", async () => {
    const toggle = document.createElement("operator-theme-mode-toggle") as ThemeModeToggleElement;
