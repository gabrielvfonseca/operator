...
} from "../../../src/pages/skill-workshop/history-scan.ts";
import { createSkillWorkshopState } from "../../../src/pages/skill-workshop/proposals.ts";
import type { SkillWorkshopHistoryScanResult } from "../../../src/pages/skill-workshop/state.ts";
...
function result(overrides: Partial<SkillWorkshopHistoryScanResult> = {}) {
  return {
    schema: "operator.skill-workshop.history-scan.v1" as const,
    hasScanned: false,
    reviewedSessions: 0,
    ideasFound: 0,
    hasMore: false,
