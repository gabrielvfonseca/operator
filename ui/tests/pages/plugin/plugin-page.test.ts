...
import {
  getLogbookState,
  stopLogbookPolling,
} from "../../../src/pages/plugin/logbook-controller.ts";
import { renderLogbook } from "../../../src/pages/plugin/logbook-view.ts";
import { PluginPage } from "../../../src/pages/plugin/plugin-page.ts";
...
const deferredPluginPageTag = "operator-deferred-plugin-page-test";
