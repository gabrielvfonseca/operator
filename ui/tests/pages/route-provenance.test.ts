...
import type { ModelProvidersRouteData } from "../../src/pages/model-providers/model-providers-page.ts";
import { page as modelProvidersPage } from "../../src/pages/model-providers/route.ts";
import type { NodesRouteData } from "../../src/pages/nodes/nodes-page.ts";
import { page as nodesPage } from "../../src/pages/nodes/route.ts";
import type { PluginsRouteData } from "../../src/pages/plugins/plugins-page.ts";
import { page as pluginsPage } from "../../src/pages/plugins/route.ts";
import { page as sessionsPage } from "../../src/pages/sessions/route.ts";
import type { SessionsRouteData } from "../../src/pages/sessions/sessions-page.ts";
import { page as skillsPage } from "../../src/pages/skills/route.ts";
import type { SkillsRouteData } from "../../src/pages/skills/skills-page.ts";
import { page as usagePage } from "../../src/pages/usage/route.ts";
