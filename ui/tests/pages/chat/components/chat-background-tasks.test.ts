...
import { renderBackgroundTasksStatusRow } from "../../../../src/pages/chat/components/chat-background-tasks-status.ts";
import {
...
} from "../../../../src/pages/chat/components/chat-background-tasks.ts";
...
describe("background tasks rail rendering", () => {
  ...
  it("shows live tool activity for running tasks and duration for finished tasks", () => {
    ...
    expect(running?.querySelector("operator-elapsed-time")).not.toBeNull();
    ...
    expect(finished?.querySelector("operator-elapsed-time")).toBeNull();
  });
...
describe("running-tasks status row", () => {
  ...
  it("renders count, ticking elapsed time, and opens the collapsed rail", () => {
    ...
    expect(row?.querySelector("operator-elapsed-time")).not.toBeNull();
