...
import { renderChat, resetChatViewState } from "../../../src/pages/chat/chat-view.ts";
import { resetChatComposerState } from "../../../src/pages/chat/components/chat-composer.ts";
import {
  renderChatModelControls,
  type ChatModelControlsProps,
} from "../../../src/pages/chat/components/chat-model-controls.ts";
import {
  ChatTranscriptController,
  isChatThreadSearchOpen,
  resetChatThreadPresentationState,
  toggleChatThreadSearch,
} from "../../../src/pages/chat/components/chat-thread.ts";
import { renderWelcomeState } from "../../../src/pages/chat/components/chat-welcome.ts";
import { RealtimeTalkLevelSignal } from "../../../src/pages/chat/realtime-talk-level.ts";
  ...
  it("uses a neutral model label for non-Codex locked sessions", () => {
    ...
    render(
      renderChatModelControls({
        ...createChatModelControlsProps(state),
        modelSelectionLocked: true,
        modelSelectionRuntimeId: "@gabrielvfonseca/operator",
      }),
      container,
    );
