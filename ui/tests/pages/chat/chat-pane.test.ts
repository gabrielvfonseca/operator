...
import { createBackgroundTasksProps } from "../../../src/pages/chat/components/chat-background-tasks.ts";
import { createSessionWorkspaceProps } from "../../../src/pages/chat/components/chat-session-workspace.ts";
import type { SidebarContent } from "../../../src/pages/chat/components/chat-sidebar.ts";
import "./chat-pane.ts";
import {
