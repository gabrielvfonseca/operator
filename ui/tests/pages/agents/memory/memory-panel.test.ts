...
import type { DreamingState } from "../../../../src/pages/agents/memory/dreaming.ts";
import type { DreamingViewState } from "../../../../src/pages/agents/memory/view.ts";
...
function createPage(context: ApplicationContext): TestMemoryPanel {
  const page = document.createElement("operator-agent-memory-panel") as TestMemoryPanel;
