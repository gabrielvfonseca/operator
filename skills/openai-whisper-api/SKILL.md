...
Set `OPENAI_API_KEY`, or configure it in the active Operator config file (`$OPERATOR_CONFIG_PATH`, default `~/.operator/operator.json`). Optionally set `OPENAI_BASE_URL`:
