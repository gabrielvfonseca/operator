...
metadata: { "@gabrielvfonseca/operator": { "emoji": "🪲", "requires": { "bins": ["node"] } } }
---
...
- Operator CLI path: `node --inspect-brk operator.mjs ...`
- Operator test path: `OPERATOR_VITEST_MAX_WORKERS=1 node --inspect-brk scripts/run-vitest.mjs <file>`
