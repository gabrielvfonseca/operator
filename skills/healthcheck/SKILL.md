---
name: healthcheck
description: "Audit/harden Operator hosts: SSH, firewall, updates, exposure, backups, disk encryption, gateway security."
---

# Operator host healthcheck
...
- Never claim Operator manages OS firewall, SSH, or updates.
...
- Operator gateway status, bind, auth.
- Backup status.
- Disk encryption.
...
- Add scheduled `operator security audit --deep`.
