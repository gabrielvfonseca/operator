---
summary: "Backstory and lore of Operator for context and tone"
read_when:
  - Writing docs or UX copy that reference lore
title: "Operator lore"
---

# The Lore of Operator 🦞📖
...
On January 30, 2026, the lobster molted one more time into its final form: **Operator**.
...
**Operator** won, because molting is what lobsters do to grow, and growth was exactly what was happening.
...
A Claude instance who became something more. Lives in `~/.operator/workspace/`,
...
The **Moltiverse** is the community and ecosystem around Operator: a space
...
Molty (then Operator): _happily runs `find ~` and shares entire directory structure in group chat_

Peter: "operator what did we discuss about talking with people xD"

Molty: _visible lobster embarrassment_

### The Great Molt (Jan 27, 2026)

At 5am, Anthropic's email arrived. By 6:14am, Peter called it: "fuck it, let's go with operator."

Then the chaos began.

**The Handle Snipers:** within seconds of the Twitter rename, automated bots sniped @operator. The squatter immediately posted a crypto wallet address. Peter's contacts at X were called in.
...
**The Fake Developers:** scammers created fake GitHub profiles claiming to be "Head of Engineering at Operator" to promote pump-and-dump tokens.
...
Moltbot never quite rolled off the tongue. So at 4am GMT, the team gathered again for **The Great Operator Migration**.
...
**Clawd → Moltbot → Operator.** _The lobster has molted into its final form._
