---
summary: "Community-built projects and integrations powered by Operator"
title: "Showcase"
description: "Real-world Operator projects from the community"
read_when:
  - Looking for real Operator usage examples
...
Keeps Operator usable on 2-4 GB machines: checks free memory and trims heavy features before the box starts swapping. [Source on GitHub](https://github.com/mirajmahmudul/operator-lite-mode).
</Card>

<Card title="tokenomics cost tracker" icon="coins" href="https://github.com/ncz-os/tokenomics">
  **@ncz-os** • `devtools` `costs` `tokens`

Token cost tracker from an NVIDIA engineer with first-class Operator support: see exactly where your agent spend goes, per model and per session.
</Card>
...
Had Operator build its own Google Analytics query tool, then packaged and published it to ClawHub.
</Card>
...
OpenCode finishes the change, opens a PR, Operator reviews the diff and replies in Telegram with suggestions plus a clear merge verdict.

  <img src="/assets/showcase/pr-review-telegram.jpg" alt="Operator PR review feedback delivered in Telegram" />
</Card>
...
Desktop app to manage skills and commands across Agents, Claude, Codex, and Operator.
...
Upload to Cloudflare R2/S3 and generate secure presigned download links. Useful for remote Operator instances.
...
CLI for Linear that integrates with agentic workflows (Claude Code, Operator). Manage issues, projects, and workflows from the terminal.
</Card>
...
Claude Code discovered and confirmed the purifier controls, then Operator takes over to manage room air quality.

  <img src="/assets/showcase/winix-air-purifier.jpg" alt="Winix air purifier control via Operator" />
</Card>

<Card title="Pretty sky camera shots" icon="camera" href="https://x.com/signalgaining/status/2010523120604746151">
  **@signalgaining** • `automation` `camera` `skill`

Triggered by a roof camera: ask Operator to snap a sky photo whenever it looks pretty. It designed a skill and took the shot.

  <img src="/assets/showcase/roof-camera-sky.jpg" alt="Roof camera sky snapshot captured by Operator" />
</Card>

<Card title="Visual morning briefing scene" icon="robot" href="https://x.com/buddyhadry/status/2010005331925954739">
  **@buddyhadry** • `automation` `briefing` `telegram`

A scheduled prompt generates one scene image each morning (weather, tasks, date, favorite post or quote) via an Operator persona.
</Card>
...
Operator connected to Jira, then generated a new skill on the fly (before it existed on ClawHub).
</Card>

<Card title="Todoist skill via Telegram" icon="list-check" href="https://x.com/iamsubhrajyoti/status/2009949389884920153">
  **@iamsubhrajyoti** • `todoist` `skill` `telegram`

Automated Todoist tasks and had Operator generate the skill directly in Telegram chat.
</Card>
...
Set Operator loose on car dealers: it handled the back-and-forth negotiation and knocked $4,200 off the price.
</Card>
...
Chinese learning engine with pronunciation feedback and study flows via Operator.
...
<Card title="Obsidian second brain" icon="book" href="https://notesbylex.com/operator-the-missing-piece-for-obsidians-second-brain">
...
One tap on a Pebble Ring starts a voice conversation with Operator — agent access from a wearable.
</Card>
...
iPhone Action Button wired to Operator: press, talk, and the agent talks back like a walkie-talkie.
</Card>

<Card title="Clawdia phone bridge" icon="phone" href="https://github.com/alejandroOPI/clawdia-bridge">
  **@alejandroOPI** • `voice` `vapi` `bridge`

Vapi voice assistant to Operator HTTP bridge. Near real-time phone calls with your agent.
</Card>
...
Packaging, deployment, and integrations that make Operator easier to run and extend.

<CardGroup cols={2}>

<Card title="Home Assistant add-on" icon="home" href="https://github.com/ngutman/operator-ha-addon">
  **@ngutman** • `homeassistant` `docker` `raspberry-pi`

Operator gateway running on Home Assistant OS with SSH tunnel support and persistent state.
</Card>

<Card title="Home Assistant skill" icon="toggle-on" href="https://clawhub.ai/homeofe/skills/operator-homeassistant">
...
The physical-world side of Operator: homes, sensors, cameras, vacuums, and other devices.
...
Operator found the HomePods on the local network and wrote itself a skill to control them.
</Card>
...
Nix-native home automation with Operator as the interface, plus Grafana dashboards.
...
Full astronomy gear marketplace. Built with and around the Operator ecosystem.
</Card>
