...
- [Doctor](/gateway/doctor) - `operator doctor`: health checks, config migrations, repair steps
...
- [Environment variables](/help/environment) - where Operator loads env vars and precedence
...
- [Operator lore](/start/lore) - the story
