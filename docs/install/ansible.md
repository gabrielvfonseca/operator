---
summary: "Automated, hardened Operator installation with Ansible, Tailscale VPN, and firewall isolation"
read_when:
...
Deploy Operator to production servers with **[operator-ansible](https://github.com/gabrielvfonseca/operator-ansible)**, an automated installer with a security-first architecture.

<Info>
The [operator-ansible](https://github.com/gabrielvfonseca/operator-ansible) repo is the source of truth for Ansible deployment. This page is a quick overview.
</Info>
...
4. Node.js and pnpm (Operator requires Node 22.22.3+, 24.15+, or 25.9+; Node 24 is recommended)
5. Operator, installed host-based, not containerized
...
<Steps>
  ...
  <Step title="Run the onboarding wizard">
    The post-install script guides you through configuring Operator.
  </Step>
...
<Steps>
  ...
  <Step title="Clone the repository">
    ```bash
    git clone https://github.com/gabrielvfonseca/operator-ansible.git
    cd operator-ansible
    ```
  </Step>
  ...
  <Step title="Run the playbook">
    ...
    # Then run: /tmp/operator-setup.sh
    ```
...
The Ansible installer sets up Operator for manual updates; see [Updating](/install/updating) for the standard flow.
...
For detailed security architecture and troubleshooting, see the operator-ansible repo:

- [Security Architecture](https://github.com/gabrielvfonseca/operator-ansible/blob/main/docs/security.md)
- [Technical Details](https://github.com/gabrielvfonseca/operator-ansible/blob/main/docs/architecture.md)
- [Troubleshooting Guide](https://github.com/gabrielvfonseca/operator-ansible/blob/main/docs/troubleshooting.md)

## Related

- [operator-ansible](https://github.com/gabrielvfonseca/operator-ansible): full deployment guide
