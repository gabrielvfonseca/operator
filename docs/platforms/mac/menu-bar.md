...
- Source: `WorkActivityStore` (`apps/macos/Sources/Operator/WorkActivityStore.swift`).
...
- Settings > Debug > "Icon override" picker:
  ...
  - `Idle`
- Stored under `UserDefaults` key `operator.iconOverride`; mapped to `IconState.overridden`.
