---
summary: "Contributor guide for adding a new shared capability to the Operator plugin system"
read_when:
...
<Info>
  This is a **contributor guide** for Operator core developers. If you are
...
Use this when Operator needs a new shared domain such as embeddings, image
