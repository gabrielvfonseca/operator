---
summary: "Operator ACP runtime backend with plugin-owned session and transport management."
read_when:
...
Operator ACP runtime backend with plugin-owned session and transport management.
