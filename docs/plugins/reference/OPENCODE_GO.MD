---
summary: "Adds OpenCode Go model provider support to Operator."
read_when:
...
Adds OpenCode Go model provider support to Operator.

## Distribution

- Package: `@gabrielvfonseca/opencode-go-provider`
