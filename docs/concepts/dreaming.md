...
<Tabs>
  <Tab title="Promotion preview / apply">
    ...
    operator memory promote --apply
    operator memory promote --limit 5
  ...
  <Tab title="Explain promotion">
    ...
    ```bash
    operator memory promote-explain "router vlan"
    operator memory promote-explain "router vlan" --json
    ```
  ...
  <Tab title="REM harness preview">
    ...
    ```bash
    operator memory rem-harness
    operator memory rem-harness --json
    ```
