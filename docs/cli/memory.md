---
summary: "CLI reference for `operator memory` (status/index/search/promote/promote-explain/rem-harness/rem-backfill)"
read_when:
...
```bash
operator memory status [--agent <id>] [--deep] [--index] [--fix] [--json] [--verbose]
```
...
```bash
operator memory index [--agent <id>] [--force] [--verbose]
```
...
```bash
operator memory search [query] [--query <text>] [--agent <id>] [--max-results <n>] [--min-score <n>] [--json]
```
...
```bash
operator memory promote [--agent <id>] [--limit <n>] [--min-score <n>] \
...
```bash
operator memory promote-explain <selector> [--agent <id>] [--include-promoted] [--json]
```
...
```bash
operator memory rem-harness [--agent <id>] [--path <file-or-dir>] [--grounded] [--include-promoted] [--json]
```
...
```bash
operator memory rem-backfill --path <file-or-dir> [--agent <id>] [--stage-short-term] [--json]
operator memory rem-backfill --rollback [--rollback-short-term] [--json]
```
