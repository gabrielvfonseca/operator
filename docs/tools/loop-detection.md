...
Operator has two cooperating guardrails against repetitive tool-call patterns,
...
When a loop is detected, Operator logs a loop event and either warns or blocks
