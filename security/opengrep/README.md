...
`precise.yml` is Operator's shipped precise OpenGrep rulepack. Each rule is tied
...
Some Operator paths are excluded by `.gitignore` for build reasons even though
