...
import { createChannelMcpRuntime } from "../../src/mcp/channel-server-runtime.js";
import { extractAttachmentsFromMessage } from "../../src/mcp/channel-shared.js";
  ...
  describe("gateway-backed flows", () => {
    describe("gateway integration", () => {
      ...
      test("lists conversations and reads messages", async () => {
        ...
        const bridge = new OperatorChannelBridge({} as never, {
