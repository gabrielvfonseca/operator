...
import { normalizeHealthCheck } from "../../src/flows/health-check-adapter.js";
import type { RunnableHealthCheck, SplitHealthCheckInput } from "../../src/flows/health-check-runner-types.js";
import type { HealthCheck, HealthRepairContext } from "../../src/flows/health-checks.js";

function ctx(cfg: OperatorConfig): HealthRepairContext {
  return {
    mode: "fix",
    runtime: {
      log() {},
          ...
          return [
            {
              ...
              ocPath: "oc://operator.json/gateway.mode",
            },
          ];
        },
        async repair() {
