...
import { slugifySessionKey } from "../../src/agents/sandbox/shared.js";
import { CONFIG_DIR } from "../../src/utils.js";
import {
  createSandboxMediaContexts,
  createSandboxMediaStageConfig,
  withSandboxMediaTempHome,
} from "../../src/auto-reply/stage-sandbox-media.test-harness.js";
...
import { stageSandboxMedia } from "../../src/auto-reply/reply/stage-sandbox-media.js";
...
function createRemoteStageParams(home: string): {
  ...
  return {
    ...
    workspaceDir: join(home, "@gabrielvfonseca/operator"),
    sessionKey,
    remoteCacheDir: join(home, ".operator", "media", "remote-cache", slugifySessionKey(sessionKey)),
  };
}
...
describe("stageSandboxMedia scp remote paths", () => {
  it("rejects remote attachment filenames with shell metacharacters before spawning scp", async () => {
    await withSandboxMediaTempHome("operator-triggers-", async (home) => {
