...
import { testing } from "../../../src/auto-reply/reply/reply-run-registry.test-support.js";
import { admitReplyTurn, runWithReplyOperationLifecycleAdmission } from "../../../src/auto-reply/reply/reply-turn-admission.js";
...
function createSessionStore(entries: Record<string, object>): string {
  const root = tempDirs.make("operator-reply-admission-");
