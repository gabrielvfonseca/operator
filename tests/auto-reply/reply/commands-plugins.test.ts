...
import { buildPluginsCommandParams, type ConfigSnapshotMock } from "../../../src/auto-reply/reply/commands.test-harness.js";
...
vi.mock("../../plugins/toggle-config.js", () => ({
  setPluginEnabledInConfig: vi.fn((config: OperatorConfig, id: string, enabled: boolean) => ({
    ...config,
    plugins: {
      ...config.plugins,
      entries: {
