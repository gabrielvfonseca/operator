...
import { resolveReplyDeliveryAccountId, resolveReplyToMode } from "../../../src/auto-reply/reply/reply-threading.js";
...
describe("resolveReplyToMode", () => {
  ...
  it("uses registered channel threading adapters for runtime reply-mode resolution", () => {
    ...
    expect(resolveReplyToMode({} as OperatorConfig, "whatsapp", "work", "group")).toBe("first");
    expect(resolveReplyToMode({} as OperatorConfig, "whatsapp", "default", "group")).toBe("all");
  });
