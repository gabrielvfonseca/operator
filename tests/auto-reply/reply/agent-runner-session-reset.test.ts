...
import { resetReplyRunSession } from "../../../src/auto-reply/reply/agent-runner-session-reset.js";
import { setAgentRunnerSessionResetTestDeps } from "../../../src/auto-reply/reply/agent-runner-session-reset.test-support.js";
...
describe("resetReplyRunSession", () => {
  ...
  beforeEach(async () => {
    rootDir = await fs.mkdtemp(path.join(os.tmpdir(), "operator-reset-run-"));
