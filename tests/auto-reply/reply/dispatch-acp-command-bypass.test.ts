...
import { shouldBypassAcpDispatchForCommand } from "../../../src/auto-reply/reply/dispatch-acp-command-bypass.js";
...
describe("shouldBypassAcpDispatchForCommand", () => {
  ...
  it("returns false for plain-text ACP turns", () => {
    ...
    expect(shouldBypassAcpDispatchForCommand(ctx, {} as OperatorConfig)).toBe(false);
  });
  ...
  it("returns true for ACP slash commands", () => {
    ...
    expect(shouldBypassAcpDispatchForCommand(ctx, {} as OperatorConfig)).toBe(true);
  });
