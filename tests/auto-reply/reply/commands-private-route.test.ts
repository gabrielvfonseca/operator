...
} from "../../../src/auto-reply/reply/commands-private-route.js";
...
function createOwnerDerivedApprovalChannelPlugin(params: {
  ...
  const resolveOwnerTargets = (cfg: OperatorConfig) =>
...
function buildCommandParams(cfg: OperatorConfig): HandleCommandsParams {
  return {
    cfg,
    ctx: {
      Provider: "discord",
