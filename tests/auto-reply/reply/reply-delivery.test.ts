...
import { createBlockReplyContentKey } from "../../../src/auto-reply/reply/block-reply-pipeline.js";
import {
  createBlockReplyDeliveryHandler,
  normalizeReplyPayloadDirectives,
} from "../../../src/auto-reply/reply/reply-delivery.js";
import type { TypingSignaler } from "../../../src/auto-reply/reply/typing-mode.js";
...
describe("createBlockReplyDeliveryHandler", () => {
  ...
  it("passes structured media block replies through media path normalization", async () => {
    ...
    const absPath = path.join("/tmp/home", "@gabrielvfonseca/operator", "image.png");
  ...
  it("suppresses generated media-failure warning text for silent structured block replies", async () => {
    ...
    const absPath = path.join("/tmp/home", "@gabrielvfonseca/operator", "survived.png");
