...
import { runMemoryFlushIfNeeded, runPreflightCompactionIfNeeded } from "../../../src/auto-reply/reply/agent-runner-memory.js";
import { setAgentRunnerMemoryTestDeps } from "../../../src/auto-reply/reply/agent-runner-memory.test-support.js";
import { createTestFollowupRun, writeTestSessionStore } from "../../../src/auto-reply/reply/agent-runner.test-fixtures.js";
import type { ReplyOperation } from "../../../src/auto-reply/reply/reply-run-registry.js";
...
describe("runMemoryFlushIfNeeded", () => {
  ...
  it("skips Operator preflight compaction for explicit Codex runtime overrides", async () => {
    registerMemoryFlushPlanResolverForTest(() => ({
      softThresholdTokens: 4_000,
      forceFlushTranscriptBytes: 1_000_000_000,
      reserveTokensFloor: 0,
  ...
  it("keeps the OpenAI API context window for persisted Operator runtime overrides", async () => {
    registerMemoryFlushPlanResolverForTest(() => ({
      softThresholdTokens: 4_000,
      forceFlushTranscriptBytes: 1_000_000_000,
      reserveTokensFloor: 0,
