...
import { createTestFollowupRun } from "../../../src/auto-reply/reply/agent-runner.test-fixtures.js";
import type { QueueSettings } from "../../../src/auto-reply/reply/queue.js";
...
describe("runReplyAgent runtime config", () => {
  ...
  it("rotates, rebinds, and optionally notifies when memory flush is exhausted", async () => {
    await withTempDir({ prefix: "operator-direct-runtime-" }, async (tempDir) => {
