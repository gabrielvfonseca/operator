...
import type { SkillCommandSpec } from "../../../src/skills/types.js";
...
import { markCommandSessionMetadataChanged } from "../../../src/auto-reply/reply/command-session-metadata.js";
import { clearInlineDirectives } from "../../../src/auto-reply/reply/get-reply-directives-utils.js";
import { handleInlineActions } from "../../../src/auto-reply/reply/get-reply-inline-actions.js";
import { stripInlineStatus } from "../../../src/auto-reply/reply/reply-inline.js";
import { buildTestCtx } from "../../../src/auto-reply/reply/test-ctx.js";
import type { TypingController } from "../../../src/auto-reply/reply/typing.js";

const {
  buildStatusReplyMock,
  createOperatorToolsMock,
  getChannelPluginMock,
  handleCommandsMock,
  listSkillCommandsForWorkspaceMock,
} = vi.hoisted(() => ({
  buildStatusReplyMock: vi.fn(),
  createOperatorToolsMock: vi.fn(),
...
function mockToolDispatchedSkillCommand() {
  ...
  createOperatorToolsMock.mockReturnValue([
    {
      name: "send_status",
      execute: toolExecute,
    },
...
describe("handleInlineActions", () => {
  beforeEach(() => {
    ...
    createOperatorToolsMock.mockReset();
  ...
  it("passes requesterAgentIdOverride into inline tool runtimes", async () => {
    ...
    expect(result).toEqual({ kind: "reply", reply: { text: "✅ Done." } });
    expect(
      mockObjectArg(createOperatorToolsMock, "createOperatorTools").requesterAgentIdOverride,
    ).toBe("named-worker");
  ...
  it("passes sender identity into inline tool runtimes", async () => {
    ...
    expect(result).toEqual({ kind: "reply", reply: { text: "✅ Done." } });
    const toolsArgs = mockObjectArg(createOperatorToolsMock, "createOperatorTools");
  ...
  it("passes sandboxed runtime state into inline tool construction", async () => {
    ...
    expect(createOperatorToolsMock).toHaveBeenCalledWith(
