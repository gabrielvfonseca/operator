...
import { parseAudioTag } from "../../../src/media/audio-tags.js";
...
import { createBlockReplyCoalescer } from "../../../src/auto-reply/reply/block-reply-coalescer.js";
import { matchesMentionWithExplicit } from "../../../src/auto-reply/reply/mentions.js";
import { normalizeReplyPayload } from "../../../src/auto-reply/reply/normalize-reply.js";
import { createReplyReferencePlanner, isSingleUseReplyToMode } from "../../../src/auto-reply/reply/reply-reference.js";
import {
  extractShortModelName,
  resolveResponsePrefixTemplate,
} from "../../../src/auto-reply/reply/response-prefix-template.js";
import {
  createStreamingDirectiveAccumulator,
  splitTrailingDirective,
} from "../../../src/auto-reply/reply/streaming-directives.js";
  ...
  it("resolves known variables, aliases, and case-insensitive tokens", () => {
    const cases = [
      ...
      },
      {
        ...
        expected: "[Operator] anthropic/claude-opus-4-6 (think:high)",
      },
    ] as const;
