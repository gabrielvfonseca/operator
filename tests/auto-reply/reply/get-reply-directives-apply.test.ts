...
import { applyInlineDirectiveOverrides } from "../../../src/auto-reply/reply/get-reply-directives-apply.js";
import { createFastTestModelSelectionState } from "../../../src/auto-reply/reply/model-selection.js";
...
describe("applyInlineDirectiveOverrides", () => {
  it.each([
    ...
    async ({ rejectedRef, reason, expected }) => {
      const directives = parseInlineDirectives("hello /model openai/gpt-5.4 --runtime operator");
      const typing = {
        onReplyStart: async () => {},
      ...
      const result = await applyInlineDirectiveOverrides({
        ctx: buildTestCtx({
          Body: "hello /model openai/gpt-5.4 --runtime operator",
        ...
        command: {
          ...
          rawBodyNormalized: "hello /model openai/gpt-5.4 --runtime operator",
          commandBodyNormalized: "hello /model openai/gpt-5.4 --runtime operator",
        },
        directives,
