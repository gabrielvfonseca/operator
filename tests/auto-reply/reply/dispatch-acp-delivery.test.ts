...
import { createAcpDispatchDeliveryCoordinator } from "../../../src/auto-reply/reply/dispatch-acp-delivery.js";
...
import { createAcpTestConfig } from "../../../src/auto-reply/reply/test-fixtures/acp-runtime.js";
...
function createVisibleChatAcpCoordinator(cfg: OperatorConfig) {
  return createAcpDispatchDeliveryCoordinator({
    cfg,
    ctx: buildTestCtx({
      Provider: "visiblechat",
...
describe("createAcpDispatchDeliveryCoordinator", () => {
  ...
  it("routes ACP replies when cfg.channels is missing", async () => {
    await expectVisibleChatBlockRoutesToAccount({} as OperatorConfig, "default");
  });
