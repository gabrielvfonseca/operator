...
import { DEFAULT_LEARN_REQUEST } from "../../../src/skills/workshop/learn-prompt.js";
import { INTERNAL_MESSAGE_CHANNEL } from "../../../src/utils/message-channel.js";
import { handleLearnCommand } from "../../../src/auto-reply/reply/commands-learn.js";
import type { HandleCommandsParams } from "../../../src/auto-reply/reply/commands-types.js";

const DEFAULT_TEST_MODELS: NonNullable<OperatorConfig["models"]> = {
  providers: {
    openai: {
