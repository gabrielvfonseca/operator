...
import { runPreflightCompactionIfNeeded } from "../../../src/auto-reply/reply/agent-runner-memory.js";
...
describe("runPreflightCompactionIfNeeded stale totalTokens gating", () => {
  ...
  beforeEach(async () => {
    rootDir = await fs.mkdtemp(path.join(os.tmpdir(), "operator-preflight-stale-"));
