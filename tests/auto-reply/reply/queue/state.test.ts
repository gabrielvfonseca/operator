...
import { enqueueFollowupRun } from "../../../../src/auto-reply/reply/queue/enqueue.js";
import { clearFollowupQueue, getFollowupQueue, refreshQueuedFollowupSession } from "../../../../src/auto-reply/reply/queue/state.js";
...
describe("refreshQueuedFollowupSession", () => {
  ...
  it("uses the highest supported non-max level when retargeting queued work", () => {
    ...
    refreshQueuedFollowupSession({
      ...
      nextProvider: "custom",
      nextModel: "reasoner",
      nextThinking: { level: "ultra", agentRuntime: "@gabrielvfonseca/operator" },
    });
