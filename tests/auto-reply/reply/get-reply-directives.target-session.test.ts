...
import { SessionWorkStartInvalidatedError } from "../../../src/config/sessions/lifecycle.js";
import {
...
import { resolveReplyDirectives } from "../../../src/auto-reply/reply/get-reply-directives.js";
...
vi.mock("../../agents/thinking-runtime.js", () => ({
  resolveEffectiveAgentRuntime: ({
    ...
    (provider === "openai" ? "codex" : "@gabrielvfonseca/operator"),
}));
