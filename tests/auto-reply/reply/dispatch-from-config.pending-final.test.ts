...
} from "../../../src/auto-reply/reply/dispatch-from-config.pending-final.js";
import { retireTerminalRestartRecoverySourceClaim } from "../../../src/auto-reply/reply/restart-recovery-claim.js";
...
describe("pending final delivery restart proof", () => {
  ...
  beforeEach(async () => {
    tmpDir = await fs.mkdtemp(path.join(os.tmpdir(), "operator-pending-final-"));
