...
} from "../../src/tts/provider-registry-core.js";
...
describe("speech provider registry", () => {
  const getProviderCalls: Array<{ providerId: string; cfg?: OperatorConfig }> = [];
  const listProvidersCalls: Array<{ cfg?: OperatorConfig }> = [];
