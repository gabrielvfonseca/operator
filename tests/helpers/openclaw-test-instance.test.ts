// Operator test instance tests cover spawned test instance lifecycle.
import fs from "node:fs/promises";
import path from "node:path";
import { describe, expect, it, vi } from "vitest";
import { createOperatorTestInstance, testing } from "./operator-test-instance.js";
...
describe("operator test instance", () => {
  ...
  it("signals test instance process groups on POSIX", () => {
    ...
    testing.signalOperatorTestProcess(child, "SIGKILL", killProcess);
