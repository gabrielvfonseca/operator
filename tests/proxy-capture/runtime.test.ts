...
} from "../../src/proxy-capture/runtime.js";
...
const settings: DebugProxySettings = {
  enabled: true,
  required: false,
  dbPath: "/tmp/operator-proxy-runtime-test.sqlite",
  blobDir: "/tmp/operator-proxy-runtime-test-blobs",
  certDir: "/tmp/operator-proxy-runtime-test-certs",
