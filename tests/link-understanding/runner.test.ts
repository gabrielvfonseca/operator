...
import type { LinkModelConfig } from "../../src/config/types.tools.js";
import { fetchWithSsrFGuard } from "../../src/infra/net/fetch-guard.js";
import { runCommandWithTimeout } from "../../src/process/exec.js";
import { runLinkUnderstanding } from "../../src/link-understanding/runner.js";
...
describe("runLinkUnderstanding", () => {
  ...
  it("fetches links through the SSRF guard before passing content to CLI stdin", async () => {
    ...
    expect(runCommandWithTimeout).toHaveBeenCalledWith(["summarize", "--source"], {
      env: {
        OPERATOR_LINK_FINAL_URL: "https://example.com/final",
        OPERATOR_LINK_URL: "https://example.com/page",
      },
      input: "page body",
      timeoutMs: 30000,
    });
