...
import type { GatewayServiceCommandConfig } from "../../../src/daemon/service-types.js";
import { runNodeDaemonInstall, runNodeDaemonStatus } from "../../../src/cli/node-cli/daemon.js";
...
vi.mock("../../daemon/runtime-hints.js", () => ({
  ...
  buildPlatformServiceStartHints: () => ["operator node install", "operator node start"],
}));
