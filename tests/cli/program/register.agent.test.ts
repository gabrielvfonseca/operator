...
import { registerAgentTurnCommand } from "../../../src/cli/program/register.agent-turn.js";
import { registerAgentsCommands } from "../../../src/cli/program/register.agent.js";
...
describe("agent command registration", () => {
  ...
  it("forwards set-identity options", async () => {
    await runCli([
      ...
      ":lobster:",
      "--avatar",
      "https://example.com/operator.png",
      "--json",
    ]);
