...
import { getCoreCliCommandNames, registerCoreCliByName } from "../../../src/cli/program/command-registry-core.js";
import { createProgramContext } from "../../../src/cli/program/context.js";
import { getCoreCliCommandDescriptors } from "../../../src/cli/program/core-command-descriptors.js";
import { registerSubCliByName } from "../../../src/cli/program/register.subclis.js";
import { getSubCliEntries } from "../../../src/cli/program/subcli-descriptors.js";
...
describe("root command descriptions", () => {
  ...
  it("keeps catalog placeholders and registered commands in sync", async () => {
    ...
    const argv = ["node", "@gabrielvfonseca/operator", "completion"];
