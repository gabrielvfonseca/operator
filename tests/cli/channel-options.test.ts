...
import { formatCliChannelOptions, resolveCliChannelOptions } from "../../src/cli/channel-options.js";
import { testing } from "../../src/cli/channel-options.test-support.js";
import { testing as startupMetadataTesting } from "../../src/cli/startup-metadata.test-support.js";
...
describe("resolveCliChannelOptions", () => {
  ...
  afterEach(() => {
    testing.resetPrecomputedChannelOptionsForTests();
    delete process.env.OPERATOR_PLUGIN_CATALOG_PATHS;
  });
  ...
  it("ignores external catalog env during CLI bootstrap", () => {
    process.env.OPERATOR_PLUGIN_CATALOG_PATHS = "/tmp/plugins-catalog.json";
