...
import { formatCliBannerLine } from "../../src/cli/banner.js";
...
describe("formatCliBannerLine", () => {
  it("hides tagline text when cli.banner.taglineMode is off", () => {
    ...
    expect(line).toBe("🦞 Operator 2026.3.7 (abc1234)");
  });
  ...
  it("uses default tagline when cli.banner.taglineMode is default", () => {
    ...
    expect(line).toBe("🦞 Operator 2026.3.7 (abc1234) — All your chats, one Operator.");
  });
