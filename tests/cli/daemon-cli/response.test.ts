...
import { createDaemonActionContext } from "../../../src/cli/daemon-cli/response.js";
  ...
  it("classifies common daemon hint kinds", () => {
    ...
    expect(writeJson).toHaveBeenCalledWith(
      expect.objectContaining({
        ...
        hints,
        hintItems: [
          { kind: "install", text: "operator gateway install" },
          {
            kind: "container-restart",
            text: "Restart the container or the service that manages it for operator-demo-container.",
          },
          {
          ...
          },
          {
            ...
            text: "If you're in a container, run the gateway in the foreground instead of `operator gateway`.",
          },
          {
            kind: "wsl-systemd",
