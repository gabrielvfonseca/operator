...
import { appendSessionCostLine } from "../../src/status/status-runtime-lines.js";
import { buildStatusText } from "../../src/status/status-text.js";
...
describe("Codex usage after runtime fallback", () => {
  ...
  it("shows Codex rate-limit usage for a Codex-bound session on Operator Default", async () => {
