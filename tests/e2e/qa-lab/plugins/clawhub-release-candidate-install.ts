...
const DEFAULT_TARBALL_ENV = "OPERATOR_QA_RELEASE_CANDIDATE_TARBALL";
const CHECKOUT_BUILD_RESULT_PREFIX = "__OPERATOR_QA_RELEASE_CANDIDATE_TARBALL__";
...
function parseOptions(
  ...
  let artifactBase = "";
  let buildFromCheckout = env.OPERATOR_QA_RELEASE_CANDIDATE_BUILD === "1";
