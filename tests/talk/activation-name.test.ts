...
describe("realtime voice activation names", () => {
  ...
  it("prefers longer activation names first", () => {
    expect(
      sortRealtimeVoiceActivationNames(["claw", "claw bot", "@gabrielvfonseca/operator"]),
    ).toEqual(["claw bot", "@gabrielvfonseca/operator", "claw"]);
