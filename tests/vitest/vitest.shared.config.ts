...
function hasWorkerOverride(env: Record<string, string | undefined>): boolean {
  return Boolean((env.OPERATOR_VITEST_MAX_WORKERS ?? env.OPERATOR_TEST_WORKERS)?.trim());
}

function sourcePackageAlias(packageId: string, subpath?: string) {
  return {
    find: `@gabrielvfonseca/${packageId}${subpath ? `/${subpath}` : ""}`,
...
export const sharedVitestConfig = {
  ...
  resolve: {
    alias: [
      ...
      {
        find: "@gabrielvfonseca/model-catalog-core/model-catalog-refs",
        replacement: path.join(
          repoRoot,
          "packages",
          "model-catalog-core",
      ...
      {
        find: "@gabrielvfonseca/model-catalog-core/model-catalog-normalize",
        replacement: path.join(
          repoRoot,
          "packages",
          "model-catalog-core",
      ...
      {
        find: "@gabrielvfonseca/model-catalog-core/model-catalog-types",
        replacement: path.join(
          repoRoot,
          "packages",
          "model-catalog-core",
      ...
      {
        find: "@gabrielvfonseca/model-catalog-core/provider-id",
        replacement: path.join(repoRoot, "packages", "model-catalog-core", "src", "provider-id.ts"),
      },
      {
        find: "@gabrielvfonseca/model-catalog-core/provider-model-id-normalization",
        replacement: path.join(
          repoRoot,
          "packages",
          "model-catalog-core",
      ...
      {
        find: "@gabrielvfonseca/model-catalog-core/provider-model-id-normalize",
        replacement: path.join(
          repoRoot,
          "packages",
          "model-catalog-core",
      ...
      ...pluginSdkSubpaths.map((subpath) => ({
        find: `@gabrielvfonseca/plugin-sdk/${subpath}`,
  ...
  test: {
    ...
    include: [
      ...
      "packages/**/*.test.ts",
      "test/**/*.test.ts",
      "ui/tests/pages/chat/tool-stream.node.test.ts",
    ],
