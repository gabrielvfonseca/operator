...
import { isJavaScriptModulePath } from "../../../src/plugins/native-module-require.js";
import { resolveExistingPluginModulePath } from "../../../src/channels/plugins/module-loader.js";
...
function createTempDir(): string {
  const tempDir = fs.mkdtempSync(path.join(os.tmpdir(), "operator-channel-module-loader-"));
