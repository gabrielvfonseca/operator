...
import { runSessionRegistryMaintenanceForStore } from "../../../src/config/sessions/session-registry-maintenance.js";
import { resolveSqliteTargetFromSessionStorePath } from "../../../src/config/sessions/session-sqlite-target.js";
import type { SessionEntry } from "../../../src/config/sessions/types.js";

const DAY_MS = 24 * 60 * 60 * 1000;
const fixtureSuite = createFixtureSuite("operator-session-registry-maintenance-");
