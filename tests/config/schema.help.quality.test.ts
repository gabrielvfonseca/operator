...
import { MEDIA_AUDIO_FIELD_HELP } from "../../src/config/media-audio-field-metadata.js";
import { FIELD_HELP } from "../../src/config/schema.help.js";
import { FIELD_LABELS } from "../../src/config/schema.labels.js";
...
const ENUM_EXPECTATIONS: Record<string, string[]> = {
  ...
  "browser.profiles.*.driver": ['"@gabrielvfonseca/operator"', '"clawd"', '"existing-session"'],
