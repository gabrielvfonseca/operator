...
import { applyModelDefaults as applyModelDefaultsWithPolicy } from "../../src/config/defaults.js";
import type { ModelProviderConfig, OperatorConfig } from "../../src/config/types.js";
      ...
      plugins: [
        {
          ...
          source: "test",
          manifestPath: "/tmp/custom-provider-plugin/operator.plugin.json",
