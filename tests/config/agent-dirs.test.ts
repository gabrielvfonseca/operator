...
import { findDuplicateAgentDirs } from "../../src/config/agent-dirs.js";
...
describe("resolveEffectiveAgentDir via findDuplicateAgentDirs", () => {
  it("uses OPERATOR_HOME for default agent dir resolution", () => {
  ...
  it("resolves agent dir under OPERATOR_HOME state dir", () => {
