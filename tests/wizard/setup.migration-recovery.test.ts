...
import { createMigrationItem, summarizeMigrationItems } from "../../src/plugin-sdk/migration.js";
...
} from "../../src/wizard/setup.migration-recovery.js";
import {
...
async function makeTempRoot(): Promise<string> {
  return tempRoots.make("operator-setup-recovery-");
}
