...
import { createSetupTranslator, t } from "../../../src/wizard/i18n/index.js";
import { en } from "../../../src/wizard/i18n/locales/en.js";
import { zh_CN } from "../../../src/wizard/i18n/locales/zh-CN.js";
import { zh_TW } from "../../../src/wizard/i18n/locales/zh-TW.js";
import type { WizardTranslationTree } from "../../../src/wizard/i18n/types.js";
...
describe("wizard i18n", () => {
  it.each([
    ...
    vi.stubEnv("OPERATOR_LOCALE", locale);
    expect(t("wizard.gateway.port")).toBe(expected);
  });

  it("uses OPERATOR_LOCALE before process locale variables", () => {
    vi.stubEnv("OPERATOR_LOCALE", "zh-TW");
