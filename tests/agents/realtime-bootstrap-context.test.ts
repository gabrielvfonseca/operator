...
import { resolveRealtimeBootstrapContextInstructions } from "../../src/agents/realtime-bootstrap-context.js";
...
function makeConfig(workspaceDir: string): OperatorConfig {
...
describe("resolveRealtimeBootstrapContextInstructions", () => {
  it("formats the default profile bootstrap files without exposing local paths", async () => {
    ...
    expect(instructions).toContain("Operator realtime voice profile context");
