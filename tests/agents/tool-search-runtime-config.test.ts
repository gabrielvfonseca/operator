...
import { resolveAgentRuntimeToolConfig } from "../../src/agents/tool-runtime-config.js";
import { resolveAgentToolSearchRuntimeConfig } from "../../src/agents/tool-search-runtime-config.js";
...
describe("resolveAgentToolSearchRuntimeConfig", () => {
  ...
  it("uses the input config when no runtime snapshot exists", () => {
    const config = { tools: { toolSearch: false } } as OperatorConfig;
