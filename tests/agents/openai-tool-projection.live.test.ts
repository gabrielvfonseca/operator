...
import { createCodexNativeWebSearchWrapper } from "../../src/llm/providers/stream-wrappers/openai.js";
...
describeLive("OpenAI tool projection live", () => {
  const modelId = process.env.OPERATOR_LIVE_OPENAI_TOOL_MODEL || "gpt-5.6-luna";
