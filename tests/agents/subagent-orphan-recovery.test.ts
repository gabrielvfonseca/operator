...
import * as sessions from "../../src/config/sessions.js";
...
import * as sessionUtils from "../../src/gateway/session-transcript-readers.js";
import {
  getActiveGatewayRootWorkCount,
  resetGatewayWorkAdmission,
  tryBeginGatewaySuspendAdmission,
} from "../../src/process/gateway-work-admission.js";
import { resolveInternalSessionEffectsTarget } from "../../src/agents/internal-session-effects.js";
import * as announceDelivery from "../../src/agents/subagent-announce-delivery.js";
import {
...
} from "../../src/agents/subagent-orphan-recovery.js";
import * as subagentRegistrySteerRuntime from "../../src/agents/subagent-registry-steer-runtime.js";
...
describe("subagent-orphan-recovery", () => {
  ...
  it("adds config change hint when assistant messages reference config modifications", async () => {
    ...
    vi.mocked(sessionUtils.readSessionMessagesAsync).mockResolvedValue([
      ...
      { role: "assistant", content: "I've modified operator.json to add the new setting." },
    ]);
