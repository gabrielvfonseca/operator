...
import { resolveConfiguredSubagentSpawnModelSelection } from "../../src/agents/model-selection.js";
import {
  resolveConfiguredSubagentRunTimeoutSeconds,
  resolveSubagentModelAndThinkingPlan,
  splitModelRef,
} from "../../src/agents/subagent-spawn-plan.js";
...
function createConfig(overrides?: Record<string, unknown>): OperatorConfig {
  return {
