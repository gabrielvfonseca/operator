...
import * as execApprovals from "../../src/infra/exec-approvals.js";
import { buildEmbeddedSandboxInfo } from "../../src/agents/embedded-agent-runner/sandbox-info.js";
import {
  resolveEmbeddedFullAccessState,
  resolveEmbeddedSandboxInfoExecPolicy,
} from "../../src/agents/embedded-agent-runner/sandbox-info.js";
import type { SandboxContext } from "../../src/agents/sandbox.js";
...
function createSandboxContext(overrides?: Partial<SandboxContext>): SandboxContext {
  ...
  const base = {
    ...
    workspaceDir: "/tmp/operator-sandbox",
    agentWorkspaceDir: "/tmp/operator-workspace",
    workspaceAccess: "none",
    runtimeId: "operator-sbx-test",
    runtimeLabel: "operator-sbx-test",
    containerName: "operator-sbx-test",
    ...
    browser: {
      ...
      containerName: "operator-sbx-browser-test",
    },
