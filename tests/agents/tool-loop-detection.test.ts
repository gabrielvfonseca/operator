...
import type { ToolLoopDetectionConfig } from "../../src/config/types.tools.js";
import type { SessionState } from "../../src/logging/diagnostic-session-state.js";
...
describe("tool-loop-detection", () => {
  ...
  describe("detectToolCallLoop", () => {
    ...
    it("keeps changing empty-output exec failures below the global no-progress breaker", () => {
      const state = createState();
      const params = { command: "operator flaky-helper" };
