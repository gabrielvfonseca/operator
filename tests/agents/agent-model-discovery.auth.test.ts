...
import { resolveAgentCredentialMapFromStore } from "../../src/agents/agent-auth-credentials.js";
import { addEnvBackedAgentCredentials } from "../../src/agents/agent-auth-discovery-core.js";
import { discoverAuthStorage } from "../../src/agents/agent-model-discovery.js";
...
async function createAgentDir(): Promise<string> {
  return await fs.mkdtemp(path.join(os.tmpdir(), "operator-agent-auth-storage-"));
}
