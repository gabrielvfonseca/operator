...
import { streamAnthropic } from "@gabrielvfonseca/ai/internal/anthropic";
import type { Model } from "@gabrielvfonseca/operator/plugin-sdk/llm";
import { describe, expect, it } from "vitest";
import { createAnthropicMessagesTransportStreamFn } from "../../src/agents/anthropic-transport-stream.js";
import { isLiveTestEnabled } from "../../src/agents/live-test-helpers.js";
import { shouldSkipLiveProviderDrift } from "../../src/agents/live-test-provider-drift.js";
import { isLiveBillingDrift } from "../../src/agents/live-test-provider-drift.test-support.js";
...
describeProviderLive("anthropic transport stream provider live", () => {
  it("keeps a healthy forced tool when a sibling descriptor is unreadable", async () => {
    const modelId = process.env.OPERATOR_LIVE_ANTHROPIC_TOOL_MODEL || "claude-haiku-4-5-20251001";
    const model: AnthropicMessagesModel = {
      id: modelId,
      name: modelId,
      api: "anthropic-messages",
