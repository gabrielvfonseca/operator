...
} from "../../src/plugin-sdk/agent-harness.js";
import { listAgentToolResultMiddlewares } from "../../src/plugins/agent-tool-result-middleware.js";
import { listCodexAppServerExtensionFactories } from "../../src/plugins/codex-app-server-extension-factory.js";
...
import {
  ...
  writeTempPlugin,
} from "../../src/agents/test-helpers/temp-plugin-extension-fixtures.js";
...
describe("agent tool result middleware", () => {
  it("includes plugin-registered middleware and restores it from cache", async () => {
    ...
    process.env.OPERATOR_BUNDLED_PLUGINS_DIR = tmp;
