...
import type { GatewayActiveWorkInspectors } from "../../src/infra/gateway-active-work.js";
...
describe("runExecProcess POSIX command wrapper", () => {
  ...
  it("wraps command with PATH export if OPERATOR_PREPEND_PATH is present", async () => {
