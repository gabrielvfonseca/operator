...
import * as configSessions from "../../src/config/sessions.js";
import * as sessionAccessor from "../../src/config/sessions/session-accessor.js";
...
import * as hookRunnerGlobal from "../../src/plugins/hook-runner-global.js";
import type { HookRunner } from "../../src/plugins/hooks.js";
...
import * as embeddedRuns from "../../src/agents/embedded-agent-runner/runs.js";
import { testing as subagentAnnounceDeliveryTesting } from "../../src/agents/subagent-announce-delivery.test-support.js";
import { runSubagentAnnounceDispatch } from "../../src/agents/subagent-announce-dispatch.js";
import { testing as subagentAnnounceOutputTesting } from "../../src/agents/subagent-announce-output.test-support.js";
...
let configOverride: OperatorConfig = {
  session: {
    mainKey: "main",
    scope: "per-sender",
  },
...
function setConfigOverride(next: OperatorConfig): void {
  configOverride = next;
...
describe("subagent announce formatting", () => {
  ...
  beforeAll(async () => {
    ...
    // See: https://github.com/operator/operator/issues/31298
  ...
  afterAll(() => {
    ...
    process.env.OPERATOR_TEST_FAST = previousFastTestEnv;
  });
  ...
  beforeEach(() => {
    vi.useRealTimers();
    // OPERATOR_TEST_FAST is set in beforeAll before module import
  ...
  it("sends instructional message to main agent with status and findings", async () => {
    ...
    expect(msg).toContain("Operator runtime context (internal):");
