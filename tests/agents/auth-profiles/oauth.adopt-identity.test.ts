...
import { getOAuthProviderRuntimeMocks } from "../../../src/agents/auth-profiles/oauth-common-mocks.test-support.js";
...
import { resetOAuthRefreshQueuesForTest } from "../../../src/agents/auth-profiles/oauth.test-support.js";
import {
...
describe("OAuth credential adoption is identity-gated", () => {
  ...
  beforeAll(async () => {
    tempRoot = await createOAuthTestTempRoot("operator-oauth-adopt-identity-");
  });
