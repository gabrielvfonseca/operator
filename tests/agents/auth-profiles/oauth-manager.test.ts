...
import { createOAuthManager, OAuthManagerRefreshError } from "../../../src/agents/auth-profiles/oauth-manager.js";
import {
  isSafeToAdoptBootstrapOAuthIdentity,
  isSafeToAdoptMainStoreOAuthIdentity,
} from "../../../src/agents/auth-profiles/oauth-shared.js";
import {
...
async function withOAuthTempRoot(
  ...
  await withEnvAsync({ OPERATOR_STATE_DIR: tempRoot }, async () => await run(tempRoot));
}
...
async function withOAuthAgentDirs(
  ...
  await withOAuthTempRoot(prefix, async (tempRoot) => {
    ...
    await withEnvAsync({ OPERATOR_AGENT_DIR: mainAgentDir }, async () => {
