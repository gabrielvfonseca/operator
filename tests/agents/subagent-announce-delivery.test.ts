...
import { OutboundDeliveryError } from "../../src/infra/outbound/deliver-types.js";
import {
...
} from "../../src/agents/subagent-announce-delivery.runtime.js";
import {
  testing,
  deliverSubagentAnnouncement,
  resolveSubagentCompletionOrigin,
} from "../../src/agents/subagent-announce-delivery.test-support.js";
...
const longChildCompletionOutput = [
  ...
  "PR: https://github.com/operator/operator/pull/12345",
...
describe("deliverSubagentAnnouncement active requester steering", () => {
  ...
  it("waits through compaction and re-steers the active requester (86566)", async () => {
    const previousTestFast = process.env.OPERATOR_TEST_FAST;
    ...
    try {
      ...
      if (previousTestFast === undefined) {
        ...
        process.env.OPERATOR_TEST_FAST = previousTestFast;
      }
    }
  });
