...
import { applyDeferredFollowupToolDescriptions } from "../../src/agents/agent-tools.deferred-followup.js";
...
describe("createOperatorCodingTools deferred follow-up guidance", () => {
