// Verifies the read-only Operator gateway tool schema and config reads.
import { beforeEach, describe, expect, it, vi } from "vitest";
import { GatewayClientRequestError } from "../../src/gateway/client.js";
import { createGatewayTool } from "../../src/agents/tools/gateway-tool.js";
...
describe("gateway tool", () => {
  ...
  it("exposes only config read actions", () => {
    ...
    expect(tool.description).toBe(
      "Read gateway config + schema. Writes/restart: use operator tool.",
    );
  });
