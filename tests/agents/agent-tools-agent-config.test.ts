...
import type { SandboxDockerConfig } from "../../src/agents/sandbox/types.docker.js";
import { createRestrictedAgentSandboxConfig } from "../../src/agents/test-helpers/sandbox-agent-config-fixtures.js";
...
*** End Patch`;
  ...
  function createMainSessionTools(cfg: OperatorConfig) {
  ...
  function createMainAgentConfig(params: {
    tools: NonNullable<OperatorConfig["tools"]>;
    agentTools?: NonNullable<NonNullable<OperatorConfig["agents"]>["list"]>[number]["tools"];
  }): OperatorConfig {
    return {
      tools: params.tools,
      agents: {
