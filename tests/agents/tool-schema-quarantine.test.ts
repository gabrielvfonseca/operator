...
} from "../../src/agents/tool-schema-quarantine-health.js";
import { logRuntimeToolSchemaQuarantine } from "../../src/agents/tool-schema-quarantine.js";
...
describe("runtime tool schema quarantine logging", () => {
  ...
  it("clears this process's persisted quarantine after the tool schema recovers", async () => {
    await withStateDirEnv("operator-tool-schema-quarantine-recovery-", async () => {
      recordPersistedRuntimeToolSchemaQuarantine({
