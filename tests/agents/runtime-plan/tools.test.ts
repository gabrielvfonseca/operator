...
import type { RuntimeToolSchemaDiagnostic } from "../../../src/agents/tool-schema-projection.js";
import {
  getToolTerminalPresentation,
  setToolTerminalPresentation,
} from "../../../src/agents/tool-terminal-presentation.js";
import type { AnyAgentTool } from "../../../src/agents/tools/common.js";
import { logAgentRuntimeToolDiagnostics, normalizeAgentRuntimeTools } from "../../../src/agents/runtime-plan/tools.js";
  ...
  it("uses RuntimePlan-owned tool normalization when a plan is available", () => {
    ...
    expect(
      normalizeAgentRuntimeTools({
        ...
        workspaceDir: "/tmp/operator-runtime-plan-tools",
        model,
      }),
    ).toBe(normalized);
