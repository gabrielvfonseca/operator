...
import type { Theme } from "../../../../src/agents/modes/interactive/theme/theme.js";
import { createEditTool, createEditToolDefinition, type EditOperations } from "../../../../src/agents/sessions/tools/edit.js";
import type { EditToolDetails } from "../../../../src/agents/sessions/tools/tool-contracts.js";
...
describe("edit tool", () => {
  ...
  async function createTempFile(content: string) {
    tmpDir = await fs.mkdtemp(path.join(os.tmpdir(), "operator-edit-tool-"));
