...
import { spawnCommand } from "../../../../src/process/exec.js";
import { ensureTool } from "../../../../src/agents/utils/tools-manager.js";
import { createFindToolDefinition } from "../../../../src/agents/sessions/tools/find.js";
...
it.each([
  ...
  const tempDir = tempDirs.make("operator-find-fd-");
