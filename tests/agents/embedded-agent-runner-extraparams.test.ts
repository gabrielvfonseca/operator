...
import { testing as extraParamsTesting } from "../../src/agents/embedded-agent-runner/extra-params.test-support.js";
...
import { isAnthropicFamilyCacheTtlEligible } from "../../src/llm/providers/stream-wrappers/anthropic-family-cache-semantics.js";
import { createAnthropicToolPayloadCompatibilityWrapper } from "../../src/llm/providers/stream-wrappers/anthropic-family-tool-payload-compat.js";
import { createGoogleThinkingPayloadWrapper } from "../../src/llm/providers/stream-wrappers/google.js";
import { createMinimaxFastModeWrapper } from "../../src/llm/providers/stream-wrappers/minimax.js";
import {
...
} from "../../src/llm/providers/stream-wrappers/openai.js";
import {
  applyExtraParamsToAgent,
  resolveAgentTransportOverride,
  resolveExplicitSettingsTransport,
  resolvePreparedExtraParams,
} from "../../src/agents/embedded-agent-runner/extra-params.js";
import { log } from "../../src/agents/embedded-agent-runner/logger.js";
...
describe("applyExtraParamsToAgent", () => {
  ...
  it("passes agentDir and workspaceDir to provider stream wrappers", () => {
    ...
    expect(capturedContext?.agentDir).toBe("/tmp/operator-agent");
    expect(capturedContext?.workspaceDir).toBe("/tmp/operator-workspace");
