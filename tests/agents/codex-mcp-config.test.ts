// Covers conversion from Operator bundle-MCP config into Codex app-server
// thread config patches.
import { afterEach, beforeEach, describe, expect, it, vi } from "vitest";
import { buildCodexMcpServersConfig, loadCodexBundleMcpThreadConfig } from "../../src/agents/codex-mcp-config.js";
...
describe("buildCodexMcpServersConfig", () => {
  it("normalizes Operator MCP servers into Codex app-server mcp_servers shape", () => {
