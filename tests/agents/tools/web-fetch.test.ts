...
import { getToolTerminalPresentation } from "../../../src/agents/tool-terminal-presentation.js";
import { createWebFetchTool } from "../../../src/agents/tools/web-fetch.js";
import { sanitizeWebFetchUrl } from "../../../src/agents/tools/web-fetch.test-support.js";

describe("sanitizeWebFetchUrl", () => {
  it("removes whitespace between scheme and authority (reported bug)", () => {
    expect(sanitizeWebFetchUrl("https:// docs.operator.ai")).toBe("https://docs.operator.ai");
  });
