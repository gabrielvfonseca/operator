...
import type { TranscriptStopRequest } from "../../../src/transcripts/provider-types.js";
import { TranscriptsStore } from "../../../src/transcripts/store.js";
import { createTranscriptsAutoStartService, createTranscriptsTool } from "../../../src/agents/tools/transcripts-tool.js";
...
async function makeStateDir(): Promise<string> {
  return await fs.mkdtemp(path.join(os.tmpdir(), "operator-transcripts-"));
}
