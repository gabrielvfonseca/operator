...
} from "../../../src/agents/tools/model-config.helpers.js";
import { hasDirectProviderApiKeyAuthForTool } from "../../../src/agents/tools/model-config.helpers.test-support.js";
...
const openAiRefCfg: OperatorConfig = {
  models: {
    providers: {
      openai: {
...
describe("hasProviderAuthForTool", () => {
  it("threads cfg/workspaceDir into config-aware env-key resolution", () => {
    ...
    const cfg = { models: { providers: {} } } as OperatorConfig;
