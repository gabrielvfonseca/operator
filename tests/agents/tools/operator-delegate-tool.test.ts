...
import { callInProcessGatewayTool } from "../../../src/agents/tools/in-process-gateway.js";
import { createOperatorDelegateToolsForRun } from "../../../src/agents/tools/operator-delegate-tool.js";
...
describe("operator delegation tool", () => {
