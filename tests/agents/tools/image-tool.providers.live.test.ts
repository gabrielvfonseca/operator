...
} from "../../../src/plugin-sdk/test-env.js";
import { isLiveTestEnabled } from "../../../src/agents/live-test-helpers.js";
import { isLiveAuthDrift } from "../../../src/agents/live-test-provider-drift.test-support.js";
import { createImageTool } from "../../../src/agents/tools/image-tool.js";
import { testing } from "../../../src/agents/tools/image-tool.test-support.js";
...
async function withLiveWorkspace<T>(
  ...
  const root = await fs.mkdtemp(path.join(os.tmpdir(), "operator-image-tool-live-"));
  try {
