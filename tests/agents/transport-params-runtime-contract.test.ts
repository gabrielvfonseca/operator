...
import { createOpenAIThinkingLevelWrapper } from "../../src/llm/providers/stream-wrappers/openai.js";
import {
...
import { supportsGptParallelToolCallsPayload } from "../../src/agents/provider-api-families.js";
...
describe("transport params runtime contract (embedded Operator/OpenAI path)", () => {
