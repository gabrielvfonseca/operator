...
import { resolveSessionModelIdentityRef, resolveSessionModelRef } from "../../src/agents/session-model-ref.js";
...
describe("resolveSessionModelIdentityRef", () => {
  const resolveLegacyIdentityRef = (cfg: OperatorConfig, modelProvider?: string) =>
  ...
  test("infers provider from configured provider catalogs when allowlist is absent", () => {
    ...
    } as unknown as OperatorConfig["models"];
