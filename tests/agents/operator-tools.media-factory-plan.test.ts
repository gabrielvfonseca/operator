...
import type { InstalledPluginIndexRecord } from "../../src/plugins/installed-plugin-index.js";
...
import { resolveOptionalMediaToolFactoryPlan } from "../../src/agents/operator-tools.media-factory-plan.js";
import { DEFAULT_PLUGIN_TOOLS_ALLOWLIST_ENTRY } from "../../src/agents/tool-policy.js";
import { loadCapabilityMetadataSnapshot } from "../../src/agents/tools/manifest-capability-availability.js";
import * as pdfModelConfigModule from "../../src/agents/tools/pdf-tool.model-config.js";

type CreateOperatorToolsOptions = Parameters<
  typeof import("./operator-tools.js").createOperatorTools
>[0];
let createOperatorToolsForTestModule: typeof import("./operator-tools.js").createOperatorTools;
