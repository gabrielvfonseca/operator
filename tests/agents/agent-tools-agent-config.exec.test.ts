...
function requireExecTool(tools: ReturnType<typeof createOperatorCodingTools>) {
...
describe("Agent-specific exec tool defaults", () => {
  ...
  it("should apply agent-specific exec host defaults over global defaults", async () => {
    ...
    const mainTools = createOperatorCodingTools({
      config: cfg,
      sessionKey: "agent:main:main",
    ...
    const helperTools = createOperatorCodingTools({
      config: cfg,
