...
import { wrapStreamFnSanitizeMalformedToolCalls } from "../../src/agents/embedded-agent-runner/run/attempt.tool-call-normalization.js";
import { extractAssistantText } from "../../src/agents/embedded-agent-utils.js";
import { completeSimpleWithLiveTimeout, logLiveCache } from "../../src/agents/live-cache-test-support.js";
import { isLiveTestEnabled } from "../../src/agents/live-test-helpers.js";
import { buildAssistantMessage, buildUsageWithNoCost } from "../../src/agents/stream-message-shared.js";
...
function buildLiveAnthropicModel(): {
  ...
  const modelId =
    (process.env.OPERATOR_LIVE_ANTHROPIC_CACHE_MODEL || "claude-sonnet-4-6")
      .split(/[/:]/)
