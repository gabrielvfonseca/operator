...
} from "../../src/agents/model-catalog-browse.js";
import type { ModelCatalogSnapshot } from "../../src/agents/model-catalog.types.js";
...
function config(params: { providerWildcard?: boolean } = {}): OperatorConfig {
  return {
