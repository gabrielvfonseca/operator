...
import type { ModelProviderConfig } from "../../../src/config/config.js";
import { discoverModels } from "../../../src/agents/agent-model-discovery.js";
...
} from "../../../src/agents/embedded-agent-runner/model.forward-compat.test-support.js";
import { resolveModel } from "../../../src/agents/embedded-agent-runner/model.js";
import {
...
describe("resolveModel forward-compat errors and overrides", () => {
  ...
  it("includes auth hint for unknown ollama models (#17328)", () => {
    ...
    expect(result.error).toContain("docs.operator.ai/providers/ollama");
  });
