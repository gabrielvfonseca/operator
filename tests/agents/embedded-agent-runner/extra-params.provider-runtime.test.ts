...
import { runExtraParamsCase, testing as extraParamsTesting } from "../../../src/agents/embedded-agent-runner/extra-params.test-support.js";
...
describe("extra-params: provider runtime handoff", () => {
  ...
  it("keeps unsupported upstream transport values out of Operator runtime hooks", () => {
    // Upstream transports can name modes Operator does not own; unresolved values
