...
import { normalizeEmbeddedAgentRuntime } from "../../../src/agents/agent-runtime-id.js";
import * as embeddedAgentRunner from "../../../src/agents/embedded-agent-runner.js";
import * as embeddedAgent from "../../../src/agents/embedded-agent.js";
...
describe("embedded runner compatibility aliases", () => {
  ...
  it("normalizes shipped runtime aliases", () => {
    ...
    expect(normalizeEmbeddedAgentRuntime("pi")).toBe("@gabrielvfonseca/operator");
