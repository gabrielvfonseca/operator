...
import { findClientToolNameConflicts } from "../../../src/agents/agent-tool-definition-adapter.js";
...
import type { ClientToolDefinition } from "../../../src/agents/embedded-agent-runner/run/params.js";
import {
...
} from "../../../src/agents/embedded-agent-runner/tool-name-allowlist.js";
...
describe("tool name allowlists", () => {
  ...
  it("pins the reserved Operator built-in tool namespace used by client conflict checks", () => {
