...
import { isSecretValueRegisteredForRedaction } from "../../../../src/logging/secret-redaction-registry.js";
import {
  looksLikeSecretSentinel,
  mintSecretSentinel,
  resolveSecretSentinel,
} from "../../../../src/secrets/sentinel.js";
import type { AuthProfileStore } from "../../../../src/agents/auth-profiles.js";
import { FailoverError } from "../../../../src/agents/failover-error.js";
import type { RuntimeAuthState } from "../../../../src/agents/embedded-agent-runner/run/helpers.js";
...
} from "../../../../src/agents/embedded-agent-runner/run/auth-controller.js";
...
describe("createEmbeddedRunAuthController", () => {
  ...
  it("registers exchanged credentials when sentinels are disabled", async () => {
    vi.stubEnv("OPERATOR_SECRET_SENTINELS", "off");
    const harness = createMutableAuthControllerHarness();
    const setRuntimeApiKey = vi.fn<(provider: string, apiKey: string) => void>();
