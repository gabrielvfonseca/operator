...
vi.mock("@gabrielvfonseca/media-core/constants", () => ({ MAX_IMAGE_BYTES: 1_234 }));
...
import { prepareEmbeddedAttemptPromptExecution } from "../../../../src/agents/embedded-agent-runner/run/attempt-prompt-execution-prepare.js";
