...
import { buildToolSearchRunPlan } from "../../../../src/agents/embedded-agent-runner/run/attempt.tool-search-run-plan.js";
...
describe("buildToolSearchRunPlan", () => {
  ...
  it("keeps client names out of Operator capability guidance", () => {
    const plan = buildToolSearchRunPlan({
  ...
  it("keeps MCP names out of Operator capability guidance", () => {
