...
import { createDiagnosticTraceContext } from "../../../../src/infra/diagnostic-trace-context.js";
import {
...
import { createHookRunnerWithRegistry } from "../../../../src/plugins/hooks.test-fixtures.js";
...
async function collectProviderTimelineEvents(run: () => Promise<void>) {
  const root = tempDirs.make("operator-provider-timeline-");
