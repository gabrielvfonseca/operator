...
import { resolveActiveErrorContext } from "../../../../src/agents/embedded-agent-runner/run/helpers.js";
...
describe("resolveActiveErrorContext", () => {
  ...
  it("ignores the embedded Operator harness provider when the model provider is known", () => {
    // The Operator harness id is a transport wrapper, not the provider users
