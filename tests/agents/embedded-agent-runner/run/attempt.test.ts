...
import { addSession } from "../../../../src/agents/bash-process-registry.js";
...
import { wrapPluginSystemContextSection } from "../../../../src/agents/hook-system-context-boundary.js";
...
import { buildContextEnginePromptCacheInfo } from "../../../../src/agents/embedded-agent-runner/run/attempt.context-engine-helpers.js";
import {
...
} from "../../../../src/agents/embedded-agent-runner/run/attempt.prompt-helpers.js";
import { composeSystemPromptWithHookContext } from "../../../../src/agents/embedded-agent-runner/run/attempt.thread-helpers.js";
import { wrapStreamFnRepairMalformedToolCallArguments } from "../../../../src/agents/embedded-agent-runner/run/attempt.tool-call-argument-repair.js";
import {
  wrapStreamFnSanitizeMalformedToolCalls,
  wrapStreamFnTrimToolCallNames,
} from "../../../../src/agents/embedded-agent-runner/run/attempt.tool-call-normalization.js";
import { buildEmbeddedAttemptToolRunContext } from "../../../../src/agents/embedded-agent-runner/run/attempt.tool-run-context.js";
  ...
  it("includes resolved auth profile fields for context-engine afterTurn compaction", () => {
    ...
    const legacy = buildAfterTurnRuntimeContext({
      attempt: {
        ...
        agentAccountId: "acct-1",
        authProfileId: "openai:p1",
        config: { plugins: { slots: { contextEngine: "lossless-claw" } } } as OperatorConfig,
        skillsSnapshot: undefined,
        provider: "openai",
        modelId: "gpt-5.4",
        thinkLevel: "off",
