...
import { SessionManager } from "../../../../src/agents/sessions/index.js";
import {
  handleEmbeddedAttemptMidTurnPrecheck,
  prepareEmbeddedAttemptPromptPreflight,
} from "../../../../src/agents/embedded-agent-runner/run/attempt-prompt-preflight.js";
import {
...
const attempt = {
  ...
  modelId: "test-model",
  sessionFile: "/tmp/operator-attempt-preflight-test.jsonl",
  sessionId: "session-1",
