...
import { resolveAttemptTranscriptPolicy } from "../../../../src/agents/embedded-agent-runner/run/attempt.transcript-policy.js";
...
describe("resolveAttemptTranscriptPolicy", () => {
  ...
  it("uses RuntimePlan transcript policy when available", () => {
    ...
    const runtimePlanModelContext = {
      workspaceDir: "/tmp/operator-transcript-policy",
