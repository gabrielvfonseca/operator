...
import { buildTimestampPrefix } from "../../../../src/gateway/server-methods/agent-timestamp.js";
import type { AgentMessage } from "../../../../src/agents/runtime/index.js";
import type { guardSessionManager } from "../../../../src/agents/session-tool-result-guard-wrapper.js";
import type { AgentSession } from "../../../../src/agents/sessions/index.js";
import { prepareEmbeddedAttemptSessionBoundary } from "../../../../src/agents/embedded-agent-runner/run/attempt-session-boundary.js";
    ...
    const converted = await activeSession.agent.convertToLlm([
      {
        ...
        timestamp: 1,
        __operator: { senderName: "Must not leak" },
      } as AgentMessage,
    ]);
      ...
      getUserTranscriptContexts: () => [
        ...
        },
        {
          ...
          transcriptMessage: {
            ...
            timestamp: 2,
            __operator: { senderId: "bob-id", senderName: "Bob" },
          } as AgentMessage,
        },
      ],
      isRawModelRun: false,
