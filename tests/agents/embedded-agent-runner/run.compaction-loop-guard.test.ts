...
import type { PostCompactionLoopPersistedError as PostCompactionLoopPersistedErrorType } from "../../../src/agents/embedded-agent-runner/post-compaction-loop-guard.js";
import {
  makeAttemptResult,
