...
import { addTestHook, createMockPluginRegistry } from "../../src/plugins/hooks.test-fixtures.js";
...
import { toClientToolDefinitions, toToolDefinitions } from "../../src/agents/agent-tool-definition-adapter.js";
...
import { markCodeModeControlTool } from "../../src/agents/code-mode-control-tools.js";
import { CODE_MODE_EXEC_TOOL_NAME, createCodeModeTools } from "../../src/agents/code-mode.js";
import { splitSdkTools } from "../../src/agents/embedded-agent-runner/tool-split.js";
import type { ExtensionContext } from "../../src/agents/sessions/index.js";
import { setToolTerminalPresentation } from "../../src/agents/tool-terminal-presentation.js";
...
describe("before_tool_call hook integration for client tools", () => {
  ...
  it("lets trusted policies read session extensions for client tools when config is provided", async () => {
    resetGlobalHookRunner();
    const stateDir = await fs.mkdtemp(path.join(os.tmpdir(), "operator-client-tool-policy-"));
