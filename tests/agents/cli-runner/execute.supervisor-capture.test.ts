...
import { findCliMaxTurnsError } from "../../../src/agents/failover-error.js";
import { getCliMessagingDeliveryEvidence } from "../../../src/agents/cli-runner/delivery-evidence.js";
import { executePreparedCliRun } from "../../../src/agents/cli-runner/execute.js";
import { createManagedRun, supervisorSpawnMock } from "../../../src/agents/cli-runner/execute.test-support.js";
  ...
  it("surfaces Claude max-turn results with run and session recovery context", async () => {
    ...
    await expect(
      ...
      message:
        ...
        "Operator run: run-max-turns. Operator session: session-1. " +
