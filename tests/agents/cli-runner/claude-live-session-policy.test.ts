...
import { resolveClaudeLiveMode } from "../../../src/agents/cli-runner/claude-live-session-policy.js";
...
describe("resolveClaudeLiveMode", () => {
  ...
  it("keeps restrictive Operator policies on Claude default permissions", () => {
