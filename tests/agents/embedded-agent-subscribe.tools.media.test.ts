...
import { isToolResultMediaTrusted } from "../../src/agents/embedded-agent-subscribe.tools.test-support.js";
...
describe("extractToolResultMediaArtifact", () => {
  ...
  it("falls back to details.path when image content exists", () => {
    ...
    // Embedded read tool doesn't include structured media but Operator
