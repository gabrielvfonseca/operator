...
import { createRunningTaskRun } from "../../src/tasks/detached-task-runtime.js";
...
import { recoverOrphanedSubagentSessions as recoverOrphanedSubagentSessionsWithRuntime } from "../../src/agents/subagent-orphan-recovery.js";
import {
...
describe("subagent orphan recovery — faithful restart path", () => {
  ...
  beforeEach(async () => {
    ...
    tempStateDir = await fs.mkdtemp(path.join(os.tmpdir(), "operator-orphan-integ-"));
