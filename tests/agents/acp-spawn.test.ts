...
import type { AcpInitializeSessionInput } from "../../src/acp/control-plane/manager.types.js";
...
async function createCrossAgentWorkspaceFixture(options?: {
  ...
  const workspaceRoot = await fs.mkdtemp(path.join(os.tmpdir(), "operator-acp-spawn-"));
