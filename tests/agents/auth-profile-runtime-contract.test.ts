...
import type * as ManifestRegistryModule from "../../src/plugins/manifest-registry.js";
import { runAgentAttempt as runAgentAttemptImpl } from "../../src/agents/command/attempt-execution.js";
...
describe("Auth profile runtime contract - embedded Operator and CLI adapter", () => {
  ...
  beforeEach(async () => {
    tmpDir = await fs.mkdtemp(path.join(os.tmpdir(), "operator-auth-contract-"));
