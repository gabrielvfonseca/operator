...
import type { AgentSandboxConfig } from "../../../src/config/types.agents-shared.js";
import type { OperatorConfig } from "../../../src/config/types.operator.js";
import { resolveSandboxWorkspaceAuthority } from "../../../src/agents/sandbox/workspace-authority.js";

const SAFE_WORKBOARD_TOOLS = ["exec", "process", "read", "write", "edit", "apply_patch"];

function configWithSandbox(sandbox: AgentSandboxConfig): OperatorConfig {
  return {
    agents: {
...
describe("resolveSandboxWorkspaceAuthority", () => {
  ...
  it("applies inherited session denies to required lifecycle tools", async () => {
    ...
    const storePath = createSessionStorePath("operator-workspace-authority");
