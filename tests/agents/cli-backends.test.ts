...
import type { CliBackendConfig } from "../../src/config/types.js";
...
describe("resolveCliBackendConfig claude-cli defaults", () => {
  it("derives bypassPermissions from Operator's default YOLO exec policy", () => {
    ...
    expect(resolved?.config.args).toContain("mcp__operator__*");
    ...
    expect(resolved?.config.resumeArgs).toContain("mcp__operator__*");
