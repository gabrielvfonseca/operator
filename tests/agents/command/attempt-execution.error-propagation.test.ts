...
import { ACP_TURN_TIMEOUT_DETAIL_CODE } from "../../../src/acp/control-plane/manager.turn-timeout.js";
import { AcpRuntimeError, formatAcpErrorChain } from "../../../src/acp/runtime/errors.js";
import {
...
describe("emitAcpLifecycleError preserves AcpRuntimeError detail (regression: operator-4a8)", () => {
