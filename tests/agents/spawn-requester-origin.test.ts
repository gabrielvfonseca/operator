...
import type { AgentBindingMatch } from "../../src/config/types.agents.js";
import type { OperatorConfig } from "../../src/config/types.operator.js";
import { resolveRequesterOriginForChild } from "../../src/agents/spawn-requester-origin.js";
...
describe("resolveRequesterOriginForChild", () => {
  ...
  it.each([
    ...
    expect(
      resolveAccount({
        cfg: { bindings: [...scenario.bindings] } as OperatorConfig,
