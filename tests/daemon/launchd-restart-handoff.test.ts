...
import { scheduleDetachedLaunchdRestartHandoff } from "../../src/daemon/launchd-restart-handoff.js";
...
describe("scheduleDetachedLaunchdRestartHandoff", () => {
  it("waits for the caller pid before kickstarting launchd", () => {
    ...
    expect(args[2]).toBe("operator-launchd-restart-handoff");
  ...
  it("sanitizes restart helper environment overrides before spawning", () => {
    ...
    expect(options.env.OPERATOR_PROFILE).toBe("default");
