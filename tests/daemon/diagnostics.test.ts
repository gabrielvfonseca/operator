...
import { readGatewayLogTailLines, readLastGatewayErrorLine } from "../../src/daemon/diagnostics.js";
import { resolveGatewayLogPaths, resolveGatewaySupervisorLogPaths } from "../../src/daemon/restart-logs.js";
...
describe("readLastGatewayErrorLine", () => {
  it("ignores stale launchd stderr when stderr is suppressed", async () => {
    ...
    const env = { HOME: homeDir, OPERATOR_STATE_DIR: stateDir };
