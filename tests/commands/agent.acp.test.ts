...
import * as acpManagerModule from "../../src/acp/control-plane/manager.js";
import { AcpRuntimeError } from "../../src/acp/runtime/errors.js";
import * as embeddedModule from "../../src/agents/embedded-agent.js";
import * as configIoModule from "../../src/config/io.js";
...
function mockConfigWithAcpOverrides(
  home: string,
  storePath: string,
  acpOverrides: Partial<NonNullable<OperatorConfig["acp"]>>,
) {
  const cfg = createAcpEnabledConfig(home, storePath);
  cfg.acp = {
    ...cfg.acp,
...
describe("agentCommand ACP runtime routing", () => {
  ...
  it("blocks ACP turns when disabled by policy", async () => {
    ...
    ] satisfies Array<Partial<NonNullable<OperatorConfig["acp"]>>>) {
