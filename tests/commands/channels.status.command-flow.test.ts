...
import { GatewaySecretRefUnavailableError } from "../../src/gateway/credentials.js";
import { DEFAULT_ACCOUNT_ID } from "../../src/routing/session-key.js";
import { channelsStatusCommand } from "../../src/commands/channels/status.js";
import { createCapturingTestRuntime } from "../../src/commands/test-runtime-config-helpers.js";
    ...
    mocks.callGateway.mockRejectedValue(
      new Error(
        [
          ...
          "Source: env OPERATOR_GATEWAY_URL",
        ].join("\n"),
      ),
    );
    mocks.requireValidConfigSnapshot.mockResolvedValue({ secretResolved: false, channels: {} });
