...
import { configMocks } from "../../src/commands/channels.mock-harness.js";
import {
...
describe("channelsRemoveCommand", () => {
  ...
  it("asks users to add an external channel plugin before removing its account", async () => {
    ...
    expect(runtime.error).toHaveBeenCalledWith(
      'Channel plugin "external-chat" is not installed. Run operator channels add --channel external-chat first.',
    );
