...
import type { GatewayBindMode } from "../../src/config/types.gateway.js";
...
function mockAliasOwnership(host: string, loopbackPid = 4242) {
  mocks.inspectPortUsage.mockResolvedValue({
    ...
    status: "busy",
    listeners: [
      { pid: 4242, commandLine: "operator-gateway", address: `${host}:18789` },
      { pid: loopbackPid, commandLine: "operator-gateway", address: "127.0.0.1:18789" },
    ],
    hints: [],
  });
}
