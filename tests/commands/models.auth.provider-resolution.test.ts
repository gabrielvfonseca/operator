...
import { resolveRequestedLoginProviderOrThrow } from "../../src/commands/models/auth.js";
...
describe("resolveRequestedLoginProviderOrThrow", () => {
  ...
  it("throws when requested provider is not loaded", () => {
    ...
    expect(() =>
      ...
      'Unknown provider "google-antigravity". Loaded providers: google-gemini-cli, minimax-portal. Verify plugins via `operator plugins list --json`.',
    );
  });
});
