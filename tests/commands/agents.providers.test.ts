...
import type { OfficialExternalPluginRepairHint } from "../../src/plugins/official-external-plugin-repair-hints.js";
import {
  buildProviderStatusIndex,
  buildProviderSummaryMetadataIndex,
  listProvidersForAgent,
  summarizeBindings,
} from "../../src/commands/agents.providers.js";
...
describe("buildProviderStatusIndex", () => {
  ...
  it("uses repair hints instead of unknown for bound missing external channels", () => {
    ...
    expect(lines).toEqual([
      "Feishu default: missing plugin - Install the official external plugin with: openclaw plugins install @gabrielvfonseca/feishu, or run: openclaw doctor --fix.",
    ]);
  });
