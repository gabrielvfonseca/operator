...
} from "../../../../src/commands/doctor/shared/context-engine-host-compat.js";
...
function configWithEngine(engineId: string, cfg: OperatorConfig = {}): OperatorConfig {
  return {
    ...cfg,
    plugins: {
      ...cfg.plugins,
...
describe("doctor context-engine host compatibility", () => {
  ...
  it("evaluates native Codex and Operator agent-run hosts", async () => {
