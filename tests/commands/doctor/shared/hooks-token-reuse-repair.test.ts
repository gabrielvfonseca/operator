...
import { repairHooksTokenReuseGatewayAuth } from "../../../../src/commands/doctor/shared/hooks-token-reuse-repair.js";

const ROTATED_HOOKS_TOKEN = "rotated-hooks-token-1234567890";

function repair(cfg: OperatorConfig, env: NodeJS.ProcessEnv = {}) {
