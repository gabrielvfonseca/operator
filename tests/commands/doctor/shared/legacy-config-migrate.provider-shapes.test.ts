...
import { LEGACY_CONFIG_MIGRATIONS_RUNTIME_TTS } from "../../../../src/commands/doctor/shared/legacy-config-migrations.runtime.tts.js";
import { normalizeLegacyTalkConfig } from "../../../../src/commands/doctor/shared/legacy-talk-config-normalizer.js";
...
function migrateLegacyConfig(raw: unknown): {
  ...
  return { config: next as OperatorConfig | null, changes };
}
