...
} from "../../../../src/commands/doctor/shared/stale-subagent-allowlist.js";
...
describe("stale subagent allowlist doctor repair", () => {
  ...
  it("formats preview warnings with the doctor fix command", () => {
    ...
    expect(warnings).toStrictEqual([
      ...
      '- Run "operator doctor --fix" to remove stale subagent target ids, or add a configured agent or ACP target for each intended target.',
    ]);
  });
});
