...
import { collectPluginToolAllowlistWarnings } from "../../../../src/commands/doctor/shared/plugin-tool-allowlist-warnings.js";
  ...
  plugins: [
    {
      ...
      cliBackends: [],
      hooks: [],
      manifestPath: "/virtual/firecrawl/operator.plugin.json",
      origin: "bundled",
      providers: [],
    ...
    },
    {
      ...
      cliBackends: [],
      hooks: [],
      manifestPath: "/virtual/lobster/operator.plugin.json",
      origin: "bundled",
      providers: [],
