...
import { collectCodexNativeAssetInfoNotes } from "../../../../src/commands/doctor/shared/codex-native-assets.js";
import { scanCodexNativeAssets } from "../../../../src/commands/doctor/shared/codex-native-assets.test-support.js";
...
function codexConfig(): OperatorConfig {
  return {
    plugins: {
      entries: {
        codex: { enabled: true },
