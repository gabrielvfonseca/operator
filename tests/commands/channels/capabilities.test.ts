...
import { getChannelPlugin, listChannelPlugins } from "../../../src/channels/plugins/index.js";
import type { ChannelPlugin } from "../../../src/channels/plugins/types.public.js";
import { DEFAULT_ACCOUNT_ID } from "../../../src/routing/session-key.js";
import { channelsCapabilitiesCommand } from "../../../src/commands/channels/capabilities.js";
...
describe("channelsCapabilitiesCommand", () => {
  ...
  it("prints Slack bot + user scopes when user token is configured", async () => {
    const plugin = buildPlugin({
      ...
      probe: { ok: true, bot: { name: "@gabrielvfonseca/operator" }, team: { name: "team" } },
    });
    plugin.status = {
      ...plugin.status,
