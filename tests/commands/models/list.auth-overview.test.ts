...
import { resolveProviderAuthOverview } from "../../../src/commands/models/list.auth-overview.js";
...
describe("resolveProviderAuthOverview", () => {
  ...
  it("reports the selected agent auth store when profiles are effective", () => {
    persistedStores.set("/tmp/operator-agent-custom", {
      profiles: {
    ...
    const overview = resolveProviderAuthOverview({
      ...
      modelsPath: "/tmp/operator-agent-custom/models.json",
