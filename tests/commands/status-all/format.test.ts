...
} from "../../../src/commands/status-all/format.js";
  ...
  it("builds overview rows with shared ordering", () => {
    expect(
      buildStatusOverviewRows({
        ...
        middleRows: [{ Item: "Security", Value: "Run: operator security audit --deep" }],
      ...
      { Item: "Security", Value: "Run: operator security audit --deep" },
