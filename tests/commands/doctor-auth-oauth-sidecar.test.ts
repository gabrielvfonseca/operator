...
import { maybeRepairLegacyOAuthSidecarProfiles } from "../../src/commands/doctor-auth-oauth-sidecar.js";
import { testing } from "../../src/commands/doctor-auth-oauth-sidecar.test-support.js";
...
describe("maybeRepairLegacyOAuthSidecarProfiles", () => {
  ...
  it("scans OPERATOR_AGENT_DIR before treating sidecars as unreferenced", async () => {
    const state = await makeTestState();
