...
import { refreshPluginRegistry } from "../../src/plugins/plugin-registry.js";
import {
  createColdPluginConfig,
  createColdPluginFixture,
  createColdPluginHermeticEnv,
  isColdPluginRuntimeLoaded,
} from "../../src/plugins/test-helpers/cold-plugin-fixtures.js";
import { cleanupTrackedTempDirs, makeTrackedTempDir } from "../../src/plugins/test-helpers/fs-fixtures.js";
import { buildAuthChoiceGroups, formatAuthChoiceChoicesForCli } from "../../src/commands/auth-choice-options.js";
import { listManifestInstalledChannelIds } from "../../src/commands/channel-setup/discovery.js";
import { resolveProviderCatalogPluginIdsForFilter } from "../../src/commands/models/list.provider-catalog.js";

const tempDirs: string[] = [];

function makeTempDir() {
  return makeTrackedTempDir("operator-command-cold-imports", tempDirs);
}
