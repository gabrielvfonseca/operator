...
import type { resolvePluginProviders as resolvePluginProvidersFn } from "../../src/plugins/providers.runtime.js";
...
import { resolvePreferredProviderForAuthChoice } from "../../src/plugins/provider-auth-choice-preference.js";
...
describe("resolvePreferredProviderForAuthChoice", () => {
  ...
  it("passes explicit env through legacy auth normalization", async () => {
    const env = { OPERATOR_AUTH_CHOICE_TEST: "1" } as NodeJS.ProcessEnv;
    resolveManifestDeprecatedProviderAuthChoice.mockReturnValue({
      choiceId: "anthropic-cli",
      choiceLabel: "Anthropic Claude CLI",
    });
