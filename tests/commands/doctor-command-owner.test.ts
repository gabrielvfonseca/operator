...
} from "../../src/commands/doctor-command-owner.js";
  ...
  it("explains missing command owners in plain language", () => {
    ...
    expect(note).toHaveBeenCalledWith(
      [
        ...
        "Fix: set commands.ownerAllowFrom to your channel user id, for example operator config set commands.ownerAllowFrom '[\"telegram:123456789\"]'",
