...
import type { ChannelStatusIssue } from "../../src/channels/plugins/types.core.js";
import type { ChannelPlugin } from "../../src/channels/plugins/types.public.js";
import { createScopedChannelConfigAdapter } from "../../src/plugin-sdk/channel-config-helpers.js";
import { setActivePluginRegistry } from "../../src/plugins/runtime.js";
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "../../src/routing/session-key.js";
import { createChannelTestPluginBase, createTestRegistry } from "../../src/test-utils/channel-plugins.js";
import { configMocks, offsetMocks, secretMocks } from "../../src/commands/channels.mock-harness.js";
import { channelsAddCommand } from "../../src/commands/channels/add.js";
import { channelsRemoveCommand } from "../../src/commands/channels/remove.js";
import { formatGatewayChannelsStatusLines } from "../../src/commands/channels/status.js";
  ...
  it.each([
    {
      ...
      patterns: [
        ...
        /Run: (?:operator|operator)( --profile isolated)? doctor/,
      ],
    },
    {
      ...
      telegram: [
        {
          ...
          enabled: true,
          configured: true,
          probe: { ok: true, bot: { username: "operator_bot" } },
        },
      ],
    });
    expect(joined).toMatch(/bot:@operator_bot/);
  });
