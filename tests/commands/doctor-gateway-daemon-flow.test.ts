...
import type { ExtraGatewayService } from "../../src/daemon/inspect.js";
import * as launchd from "../../src/daemon/launchd.js";
...
} from "../../src/commands/doctor-service-repair-policy.js";
...
describe("maybeRepairGatewayDaemon", () => {
  ...
  it("skips gateway service install when a system Operator gateway service exists", async () => {
    setPlatform("linux");
    service.isLoaded.mockResolvedValue(false);
    findSystemGatewayServices.mockResolvedValue([
      {
