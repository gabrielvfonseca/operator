...
import type { GatewayTlsRuntime } from "../../src/infra/tls/gateway.js";
import type { RuntimeEnv } from "../../src/runtime.js";
import { withEnvAsync } from "../../src/test-utils/env.js";
import { gatewayStatusCommand } from "../../src/commands/gateway-status.js";
import { createSecretRefGatewayConfig } from "../../src/commands/gateway-status/test-support.js";
...
describe("gateway-status command", () => {
  ...
  it("includes diagnostic next steps when no gateway is reachable or discoverable", async () => {
    ...
    expect(warning?.message).toContain("operator gateway status --deep --require-rpc");
