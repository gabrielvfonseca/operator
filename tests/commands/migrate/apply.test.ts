...
import type { MigrationPlan, MigrationProviderPlugin } from "../../../src/plugins/types.js";
import { createNonExitingRuntime } from "../../../src/runtime.js";
import { createSuiteTempRootTracker } from "../../../src/test-helpers/temp-dir.js";
import { runMigrationApply } from "../../../src/commands/migrate/apply.js";

let stateDir = "";
const suiteTempDirs = createSuiteTempRootTracker({ prefix: "operator-migrate-apply-" });
