...
import { applyMigrationItemSelection } from "../../../src/commands/migrate/item-selection.js";
import {
...
} from "../../../src/commands/migrate/selection.js";
...
function skillItem(params: {
  ...
  return {
    ...
    target: `/tmp/operator/workspace/skills/${params.name}`,
