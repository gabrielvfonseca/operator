...
import { createTaskRecord as createTaskRecordOrNull } from "../../src/tasks/task-registry.js";
...
import { tasksAuditJsonCommand, tasksListJsonCommand } from "../../src/commands/tasks-json.js";
...
async function withTaskJsonStateDir(run: () => Promise<void>): Promise<void> {
  await withOperatorTestState(
    { layout: "state-only", prefix: "operator-tasks-json-command-" },
    async () => {
      resetTaskRegistryDeliveryRuntimeForTests();
