...
import { getBundledChannelSetupPlugin } from "../../src/channels/plugins/bundled.js";
...
import { configMocks, lifecycleMocks } from "../../src/commands/channels.mock-harness.js";
import {
  createExternalChatCatalogEntry,
  createExternalChatSetupPlugin,
} from "../../src/commands/channels.plugin-install.test-helpers.js";
...
const channelWizardMocks = vi.hoisted(() => {
  ...
  return {
    prompter,
    setupChannels: vi.fn(async (...args: unknown[]) => args[0] as OperatorConfig),
  };
});
