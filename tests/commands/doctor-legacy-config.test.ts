...
import { normalizeLegacyBrowserConfig } from "../../src/commands/doctor/shared/legacy-config-core-normalizers.js";

function asLegacyConfig(value: unknown): OperatorConfig {
