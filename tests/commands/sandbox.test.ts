...
import type { SandboxBrowserInfo, SandboxContainerInfo } from "../../src/agents/sandbox.js";
...
import { sandboxListCommand, sandboxRecreateCommand } from "../../src/commands/sandbox.js";
...
function createContainer(overrides: Partial<SandboxContainerInfo> = {}): SandboxContainerInfo {
  const containerName = overrides.containerName ?? "operator-sandbox-test";
  return {
    containerName,
    backendId: "docker",
    runtimeLabel: containerName,
    sessionKey: "test-session",
    image: "operator/sandbox:latest",
...
function createBrowser(overrides: Partial<SandboxBrowserInfo> = {}): SandboxBrowserInfo {
  return {
    containerName: "operator-browser-test",
    sessionKey: "test-session",
    image: "operator/browser:latest",
    imageMatch: true,
    running: true,
    createdAtMs: NOW - 3600000,
    lastUsedAtMs: NOW - 600000,
