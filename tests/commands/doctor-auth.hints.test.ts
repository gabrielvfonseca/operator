...
} from "../../src/commands/doctor-auth.js";
import { legacyCodexProviderOverrideToHealthFinding } from "../../src/commands/doctor-auth.test-support.js";
...
function doctorFixtureConfig(config: unknown): OperatorConfig {
