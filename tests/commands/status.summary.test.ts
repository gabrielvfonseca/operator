...
import type { TaskAuditFinding } from "../../src/tasks/task-registry.audit.js";
import type { TaskRecord, TaskRegistrySummary } from "../../src/tasks/task-registry.types.js";
...
vi.mock("./status.summary.runtime.js", () => ({
  statusSummaryRuntime: {
    ...
    resolveSessionRuntimeLabel: vi.fn(() => "Operator Default"),
