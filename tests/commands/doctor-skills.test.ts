...
import { createEmptyInstallChecks } from "../../src/cli/requirements-test-fixtures.js";
import type { OperatorConfig } from "../../src/config/types.operator.js";
import type { SkillStatusEntry, SkillStatusReport } from "../../src/skills/discovery/status.js";
import type { DoctorPrompter } from "../../src/commands/doctor-prompter.js";
import {
  collectUnavailableAgentSkills,
  disableUnavailableSkillsInConfig,
} from "../../src/commands/doctor-skills-core.js";
import { maybeRepairSkillReadiness } from "../../src/commands/doctor-skills.js";
...
describe("doctor skills", () => {
  ...
  it("formats unavailable skill names compactly and alphabetically", async () => {
    ...
    expect(typeof body === "string" ? body.split("\n") : []).toEqual([
      ...
      "- calendar, places",
      "Disable unused skills: operator doctor --fix",
      "Inspect details: operator skills check --agent <id> or operator skills info <name> --agent <id>",
    ]);
  });
