...
import { listManifestInstalledChannelIds, resolveChannelSetupEntries } from "../../../src/commands/channel-setup/discovery.js";
...
describe("listManifestInstalledChannelIds", () => {
  ...
  it("uses the auto-enabled config snapshot for manifest discovery", () => {
    ...
    const installedIds = listManifestInstalledChannelIds({
      ...
      env: { OPERATOR_HOME: "/tmp/home" } as NodeJS.ProcessEnv,
    });
