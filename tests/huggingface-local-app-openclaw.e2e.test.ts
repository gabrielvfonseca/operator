...
// Hugging Face local-app CLI contract tests cover Operator's snippet-facing commands.
...
describe("Hugging Face Operator local-app CLI contract", () => {
...
async function handleFakeOpenAiRequest(
  ...
  writeSse(res, {
    id: "chatcmpl-hf-operator-contract",
