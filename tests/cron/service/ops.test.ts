...
import { formatTaskStatusDetail } from "../../../src/tasks/task-status.js";
import { withEnvAsync } from "../../../src/test-utils/env.js";
import * as cronSchedule from "../../../src/cron/schedule.js";
import { setupCronServiceSuite, writeCronStoreSnapshot } from "../../../src/cron/service.test-harness.js";
import * as cronStoreModule from "../../../src/cron/store.js";
import { loadCronJobsStoreWithConfigJobs, loadCronStore } from "../../../src/cron/store.js";
import type { CronJob } from "../../../src/cron/types.js";
import { add, list, remove, run, start, stop, update } from "../../../src/cron/service/ops.js";
import { createCronServiceState, type CronEvent } from "../../../src/cron/service/state.js";
import { tryCreateCronTaskRun, tryFinishCronTaskRun } from "../../../src/cron/service/task-runs.js";
import { runMissedJobs } from "../../../src/cron/service/timer.js";
...
async function withStateDirForStorePath<T>(
  ...
  try {
    return await withEnvAsync({ OPERATOR_STATE_DIR: stateRoot }, runWithStateDir);
  } finally {
    resetTaskRegistryForTests();
  }
}
