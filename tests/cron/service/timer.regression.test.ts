...
import { HEARTBEAT_SKIP_LANES_BUSY, type HeartbeatRunResult } from "../../../src/infra/heartbeat-wake.js";
import { enqueueCommandInLane } from "../../../src/process/command-queue.js";
import { CommandLane } from "../../../src/process/lanes.js";
import { cancelTaskById, listTaskRecords } from "../../../src/tasks/task-registry.js";
import {
...
import {
  ...
  isCronJobActive,
  markCronJobActive,
} from "../../../src/cron/active-jobs.js";
import * as schedule from "../../../src/cron/schedule.js";
...
import { resetActiveCronTaskRunsForTests } from "../../../src/cron/service/active-run-cancellation.test-support.js";
import { computeJobNextRunAtMs } from "../../../src/cron/service/jobs.js";
import { run as runManualCronJob } from "../../../src/cron/service/ops.js";
import { createCronServiceState, type CronEvent } from "../../../src/cron/service/state.js";
import { applyJobResult, executeJobCoreWithTimeout, runMissedJobs } from "../../../src/cron/service/timer.js";
import { executeJobCore, onTimer } from "../../../src/cron/service/timer.test-support.js";
...
describe("cron service timer regressions", () => {
  ...
  it("respects abort signals while retrying one-shot main-session wake-now heartbeat runs", async () => {
    ...
    const state = createCronServiceState({
      cronEnabled: true,
      storePath: "/tmp/operator-cron-abort-test/jobs.json",
      log: noopLogger,
      nowMs: () => Date.now(),
      enqueueSystemEvent,
      requestHeartbeat,
