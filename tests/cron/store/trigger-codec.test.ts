...
} from "../../../src/cron/store/row-codec.js";
import type { CronJobRow } from "../../../src/cron/store/schema.js";
import { bindTriggerColumns, triggerFromRow } from "../../../src/cron/store/trigger-codec.js";
...
describe("cron trigger SQLite codec", () => {
  ...
  it("round-trips trigger state through updateCronRuntimeRows", async () => {
    ...
    const handle = openOperatorStateDatabase({ path: path.join(fixtureRoot, "state.sqlite") });
    try {
