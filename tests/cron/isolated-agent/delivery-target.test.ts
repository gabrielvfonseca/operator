...
} from "../../../src/infra/outbound/targets.test-helpers.js";
import { buildChannelOutboundSessionRoute } from "../../../src/plugin-sdk/core.js";
...
import { resolveMessageChannelSelection } from "../../../src/infra/outbound/channel-selection.runtime.js";
import { maybeResolveIdLikeTarget } from "../../../src/infra/outbound/target-id-resolution.js";
import { resolveOutboundTarget } from "../../../src/infra/outbound/targets.runtime.js";
import { resolveDeliveryTarget } from "../../../src/cron/isolated-agent/delivery-target.js";
      ...
      },
      {
        ...
        plugin: {
          ...
          config: {
            listAccountIds: () => [],
            resolveAccount: () => ({}),
            resolveAllowFrom: ({ cfg }: { cfg: OperatorConfig }) =>
...
function makeCfg(overrides?: Partial<OperatorConfig>): OperatorConfig {
  return {
    bindings: [],
    channels: {},
    ...overrides,
...
function makeForumBoundCfg(accountId = "account-b"): OperatorConfig {
  return makeCfg({
    bindings: [
      {
        agentId: AGENT_ID,
...
async function resolveLastTarget(cfg: OperatorConfig) {
