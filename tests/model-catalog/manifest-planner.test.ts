...
import { planManifestModelCatalogRows, planManifestModelCatalogSuppressions } from "../../src/model-catalog/index.js";
...
describe("manifest model catalog planner", () => {
  ...
  // Regression for https://github.com/operator/operator/issues/73876.
