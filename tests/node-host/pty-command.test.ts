...
import type { OperatorPluginNodeHostCommandIo } from "../../src/plugins/types.js";
import { decodeNodePtyResumeParams, runNodePtyCommand } from "../../src/node-host/pty-command.js";
...
describe("node PTY command", () => {
  ...
  it("relays output, data, resize, abort, and exit", async () => {
    ...
    const io: OperatorPluginNodeHostCommandIo = {
      signal: abort.signal,
      emitChunk,
      onInput: (callback) => {
        onInput = callback;
