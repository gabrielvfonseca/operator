...
import { collectGatewayConfigFindings } from "../../src/security/audit-gateway-config.js";
...
describe("security audit gateway config findings", () => {
  ...
  it("warns when OPERATOR_GATEWAY_TOKEN shadows a different configured token source", () => {
    const cfg: OperatorConfig = {
