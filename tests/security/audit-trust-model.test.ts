...
} from "../../src/security/audit-extra.sync.js";

function audit(cfg: OperatorConfig) {
    ...
    const cases = [
      ...
      },
      {
        ...
        assert: (findings: ReturnType<typeof audit>) => {
          ...
          expect(finding.detail).toContain("https://docs.operator.ai/gateway/multi-tenant-hosting");
