...
} from "../../src/test-utils/process-tree.js";
import { runInstallPolicy, validateInstallPolicyStatic } from "../../src/security/install-policy.js";
...
function configWithPolicy(scriptPath: string, env: Record<string, string>): OperatorConfig {
  return {
    security: {
      installPolicy: {
        enabled: true,
