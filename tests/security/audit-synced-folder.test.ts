...
import { collectSyncedFolderFindings } from "../../src/security/audit-extra.sync.js";
...
describe("security audit synced folder findings", () => {
  it("warns when state/config look like a synced folder", () => {
    const findings = collectSyncedFolderFindings({
      stateDir: "/Users/test/Dropbox/.operator",
      configPath: "/Users/test/Dropbox/.operator/operator.json",
    });
