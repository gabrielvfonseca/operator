  ...
  it("parses child run IDs and repair flags", () => {
    expect(
      parseReleaseVerifyBetaArgs([
        ...
        "v2026.5.10-beta.3",
        "--plugins",
        "@gabrielvfonseca/plugin-a,@gabrielvfonseca/plugin-b",
      ...
      pluginSelection: ["@gabrielvfonseca/plugin-a", "@gabrielvfonseca/plugin-b"],
      clawHubBootstrapPlugins: ["@gabrielvfonseca/plugin-b"],
...
describe("validateClawHubBootstrapEvidence", () => {
  ...
  const run = {
    ...
    status: "completed",
    conclusion: "success",
    html_url: "https://github.com/gabrielvfonseca/operator/actions/runs/34",
  ...
  const evidence = {
    ...
    requestedPlugins: ["@gabrielvfonseca/meta"],
    verificationMode: "postpublish",
    packages: [
      {
        packageName: "@gabrielvfonseca/meta",
  ...
  function validate(
    ...
    return validateClawHubBootstrapEvidence({
      ...
      expectedPackages: overrides.expectedPackages ?? ["@gabrielvfonseca/meta"],
  ...
  it("rejects legacy release-ref runs and mismatched target/package evidence", () => {
    ...
    expect(() => validate({ expectedPackages: ["@gabrielvfonseca/other"] })).toThrow(
