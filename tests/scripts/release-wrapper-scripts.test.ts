...
const UNKNOWN_PACKAGE = "@gabrielvfonseca/not-a-real-release-wrapper-test-package";
...
function createOldReleaseTarget() {
  ...
  writeFileSync(
    ...
    `${JSON.stringify({ name: "@gabrielvfonseca/operator", version: "2026.7.1-beta.3" }, null, 2)}\n`,
  );
  writeFileSync(
