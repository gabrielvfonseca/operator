...
import { createLocalShellRunner } from "../../src/tui/tui-local-shell.js";
...
describe("createLocalShellRunner", () => {
  ...
  it("sets OPERATOR_SHELL when running local shell commands", async () => {
    ...
    expect(spawnOptions.env?.OPERATOR_SHELL).toBe("tui-local");
