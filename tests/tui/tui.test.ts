...
import { MAX_TIMER_TIMEOUT_MS } from "../../src/infra/parse-finite-number.js";
import { MALFORMED_STREAMING_FRAGMENT_ERROR_MESSAGE } from "../../src/shared/assistant-error-format.js";
import { withEnv } from "../../src/test-utils/env.js";
import { getSlashCommands, parseCommand } from "../../src/tui/commands.js";
import {
...
describe("resolveLocalAuthCliInvocation", () => {
  ...
  it("uses the packaged wrapper when dist is available", () => {
    expect(
      ...
      command: "/usr/bin/node",
      args: ["/repo/operator.mjs", "models", "auth", "login"],
    });
  });
});
