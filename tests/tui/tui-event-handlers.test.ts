...
import { createEventHandlers } from "../../src/tui/tui-event-handlers.js";
import { getPendingSubmitAcceptedRunId, type TuiPendingSubmit } from "../../src/tui/tui-submit-state.js";
import type {
  AgentEvent,
  BtwEvent,
  ChatEvent,
