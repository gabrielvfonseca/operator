...
import { resetCronActiveJobs } from "../../src/cron/active-jobs.js";
import {
  emitAgentEvent,
...
import type { ParsedAgentSessionKey } from "../../src/routing/session-key.js";
import { withTempDir } from "../../src/test-helpers/temp-dir.js";
import { withEnvAsync } from "../../src/test-utils/env.js";
import { SUBAGENT_KILL_TASK_ERROR } from "../../src/tasks/detached-task-runtime-contract.js";
import { ensureTaskRuntimeStateReady } from "../../src/tasks/runtime-internal.js";
import {
  createTaskFlowForTask as createTaskFlowForTaskOrNull,
  createManagedTaskFlow as createManagedTaskFlowOrNull,
  getTaskFlowById,
  requestFlowCancel,
} from "../../src/tasks/task-flow-registry.js";
...
import {
  ...
  sweepTaskRegistry,
} from "../../src/tasks/task-registry.maintenance.js";
import { configureTaskRegistryRuntime } from "../../src/tasks/task-registry.store.js";
import { summarizeTaskRecords } from "../../src/tasks/task-registry.summary.js";
...
function createAcpSessionStoreEntry(params: {
  ...
  return {
    cfg: {} as never,
    storePath: "/tmp/operator-test-sessions.json",
...
async function withTaskRegistryTempDir<T>(
  ...
  return await withTempDir({ prefix: "operator-task-registry-" }, async (root) => {
