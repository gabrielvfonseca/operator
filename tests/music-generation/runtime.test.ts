...
import type { GenerateMusicParams } from "../../src/music-generation/runtime-types.js";
import { generateMusic, listRuntimeMusicGenerationProviders } from "../../src/music-generation/runtime.js";
...
describe("music-generation runtime", () => {
  ...
  it("lists runtime music-generation providers through the provider registry", () => {
    ...
    expect(
      listRuntimeMusicGenerationProviders({ config: {} as OperatorConfig }, runtimeDeps),
