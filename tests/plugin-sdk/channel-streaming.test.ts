...
} from "../../src/plugin-sdk/channel-streaming.js";
    ...
    const line = buildChannelProgressDraftLine(
      {
        ...
        args: {
          command:
            "node scripts/check-something-with-a-very-long-path /tmp/operator/some/really/deep/path/that/keeps/going/and/going/index.ts --flag value",
        },
      },
      { detailMode: "raw" },
    );
