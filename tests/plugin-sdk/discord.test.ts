...
import type { MessageReceipt } from "../../src/plugin-sdk/channel-outbound.js";
/**
...
describe("discord plugin-sdk facade", () => {
  it("exports the @gabrielvfonseca/discord 2026.3.13 import surface", async () => {
  ...
  it("types Discord component edit options and normalized result", () => {
    ...
    expectTypeOf<DiscordComponentSendOpts["cfg"]>().toEqualTypeOf<OperatorConfig>();
