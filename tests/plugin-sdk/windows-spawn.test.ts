...
import { materializeWindowsSpawnProgram, resolveWindowsSpawnProgram } from "../../src/plugin-sdk/windows-spawn.js";
...
describe("resolveWindowsSpawnProgram", () => {
  it("rejects node command strings that include inline entrypoint arguments on Windows", () => {
    expect(() =>
      resolveWindowsSpawnProgram({
        command: "node C:\\Users\\me\\.operator\\npm\\node_modules\\@openai\\codex\\bin\\codex.js",
        platform: "win32",
        env: {},
        execPath: "C:\\node\\node.exe",
      }),
  ...
  it("fails closed by default for unresolved windows wrappers", async () => {
    const dir = await createTempDir("operator-windows-spawn-test-");
