...
import { withRealpathSymlinkRebindRace } from "../../src/test-utils/symlink-rebind-race.js";
...
const fixtureRootTracker = createSuiteTempRootTracker({ prefix: "operator-archive-" });
