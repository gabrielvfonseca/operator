...
import { computeNextHeartbeatPhaseDueMs, resolveHeartbeatPhaseMs } from "../../src/infra/heartbeat-schedule.js";
import {
...
describe("startHeartbeatRunner", () => {
  ...
  it("preserves immediate delivery for repeated bare wake reasons", async () => {
    // 'wake' is the immediate-path reason from `operator system event --mode now`
