...
import { inspectWindowsGatewayFirewall } from "../../src/infra/windows-gateway-firewall-diagnostics.js";
import { getWindowsPowerShellExePath, getWindowsSystem32ExePath } from "../../src/infra/windows-install-roots.js";
...
function ruleRow(params?: {
  ...
  return {
    DisplayName: params?.displayName ?? "Operator Gateway",
