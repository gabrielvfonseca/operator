...
import { resolveAgentMainSessionKey, resolveMainSessionKey } from "../../src/config/sessions.js";
...
type AgentDefaultsConfig = NonNullable<NonNullable<OperatorConfig["agents"]>["defaults"]>;
