...
import { explainShellCommand } from "../../../src/infra/command-explainer/extract.js";
import { parseBashForCommandExplanation } from "../../../src/infra/command-explainer/tree-sitter-runtime.js";
...
describe("command explainer tree-sitter runtime", () => {
  ...
  it("detects eval, source, aliases, and carrier shell wrappers", async () => {
    const evalCommand = await explainShellCommand('eval "$OPERATOR_CMD"');
