...
} from "../../src/auto-reply/heartbeat-tool-response.js";
import {
  markReplyPayloadForSourceSuppressionDelivery,
  setReplyPayloadMetadata,
} from "../../src/auto-reply/reply-payload.js";
import {
  GENERIC_EXTERNAL_RUN_FAILURE_TEXT,
  HEARTBEAT_EXTERNAL_RUN_FAILURE_TEXT,
} from "../../src/auto-reply/reply/agent-runner-failure-copy.js";
import type { OperatorConfig } from "../../src/config/config.js";
import { patchSessionEntry } from "../../src/config/sessions/session-accessor.js";
import { getLastHeartbeatEvent, resetHeartbeatEventsForTest } from "../../src/infra/heartbeat-events.js";
import { runHeartbeatOnce, testing, type HeartbeatDeps } from "../../src/infra/heartbeat-runner.js";
import { installHeartbeatRunnerTestRuntime } from "../../src/infra/heartbeat-runner.test-harness.js";
import {
...
describe("runHeartbeatOnce heartbeat response tool", () => {
  ...
  function expectTelegramSend(
    sendTelegram: ReturnType<typeof vi.fn>,
    params: { text: string; cfg: OperatorConfig; silent?: boolean },
  ) {
...
`,
  ...
  it.each([
    {
      name: "uses the isolated Codex runtime instead of the base Operator runtime",
    ...
    {
      name: "uses the isolated Operator runtime instead of the base Codex runtime",
      config: {
