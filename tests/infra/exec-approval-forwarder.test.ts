...
function makeTargetsCfg(targets: Array<{ channel: string; to: string }>): OperatorConfig {
  return {
    approvals: {
      exec: {
        enabled: true,
...
function makeSessionCfg(options: { discordExecApprovalsEnabled?: boolean } = {}): OperatorConfig {
  return {
