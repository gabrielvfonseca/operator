...
import type { SessionBindingRecord } from "../../../src/infra/outbound/session-binding.types.js";
...
describe("generic current-conversation bindings", () => {
  ...
  beforeEach(async () => {
    ...
    testStateDir = await fs.mkdtemp(path.join(os.tmpdir(), "operator-current-bindings-"));
