...
import { ensureOutboundSessionEntry, resolveOutboundSessionRoute } from "../../../src/infra/outbound/outbound-session.js";
import { setMinimalOutboundSessionPluginRegistryForTests } from "../../../src/infra/outbound/outbound-session.test-helpers.js";
...
describe("resolveOutboundSessionRoute", () => {
  ...
  const perChannelPeerCfg = { session: { dmScope: "per-channel-peer" } } as OperatorConfig;
  ...
  const perChannelPeerSessionCfg = { session: { dmScope: "per-channel-peer" } } as OperatorConfig;
