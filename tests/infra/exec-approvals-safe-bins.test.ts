...
import { resolveSafeBinProfiles } from "../../src/infra/exec-safe-bin-policy.js";
import { getTrustedSafeBinDirs } from "../../src/infra/exec-safe-bin-trust.js";
...
describe("exec approvals safe bins", () => {
  ...
  it("allows caller-defined custom safe-bin profiles", () => {
    ...
    const allow = isSafeBinUsage({
      ...
      resolution: {
        rawExecutable: "echo",
        resolvedPath: "/opt/operator-test/bin/echo",
        executableName: "echo",
      },
      safeBins: normalizeSafeBins(["echo"]),
      safeBinProfiles,
      trustedSafeBinDirs: new Set(["/opt/operator-test/bin"]),
    });
