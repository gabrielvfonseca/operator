...
import { POSIX_OPERATOR_TMP_DIR, resolvePreferredOperatorTmpDir } from "../../src/infra/tmp-openclaw-dir.js";
...
describe("resolvePreferredOperatorTmpDir", () => {
  ...
  it("repairs existing /tmp/openclaw permissions when they are too broad", () => {
    ...
    expect(warn).toHaveBeenCalledWith(
      `[openclaw] tightened permissions on temp dir: ${POSIX_OPERATOR_TMP_DIR}`,
    );
    expect(tmpdir).not.toHaveBeenCalled();
  });
