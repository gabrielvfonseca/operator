...
import { resolveReplyOperationRunState } from "../../src/auto-reply/reply/reply-operation-run-state.js";
...
import { markCronJobActive, resetCronActiveJobs } from "../../src/cron/active-jobs.js";
import { getActivePluginRegistry, setActivePluginRegistry } from "../../src/plugins/runtime.js";
import type { CommandLaneSnapshot } from "../../src/process/command-queue.js";
...
import { type HeartbeatDeps, runHeartbeatOnce } from "../../src/infra/heartbeat-runner.js";
import { seedMainSessionStore, withTempHeartbeatSandbox } from "../../src/infra/heartbeat-runner.test-utils.js";
import {
  HEARTBEAT_SKIP_CRON_IN_PROGRESS,
  HEARTBEAT_SKIP_LANES_BUSY,
  HEARTBEAT_SKIP_REQUESTS_IN_FLIGHT,
} from "../../src/infra/heartbeat-wake.js";
import { resetSystemEventsForTest, enqueueSystemEvent } from "../../src/infra/system-events.js";
...
function createHeartbeatTelegramConfig(): OperatorConfig {
  return {
    agents: {
      defaults: {
        heartbeat: { every: "30m" },
...
async function seedHeartbeatTelegramSession(storePath: string, cfg: OperatorConfig) {
