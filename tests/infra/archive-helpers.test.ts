...
} from "../../src/infra/archive.js";
import { pathExists, withTimeout } from "../../src/infra/fs-safe.js";
import { JsonFileReadError, readJsonFileStrict } from "../../src/infra/json-files.js";

const tempDirs = createTrackedTempDirs();
const createTempDir = () => tempDirs.make("operator-archive-helper-test-");
