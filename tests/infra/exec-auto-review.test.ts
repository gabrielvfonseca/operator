...
import { defaultExecAutoReviewer, type ExecAutoReviewInput } from "../../src/infra/exec-auto-review.js";
...
describe("default exec auto reviewer", () => {
  ...
  it.each([
    ["cat ~/.operator/credentials/model.json", ["cat", "~/.operator/credentials/model.json"]],
