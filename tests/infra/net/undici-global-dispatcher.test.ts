...
const mockedModuleIds = [
  "@operator/proxyline/dispatcher-brand",
  "node:net",
  "./proxy-env.js",
  "./undici-runtime.js",
  "../wsl.js",
...
vi.mock("@operator/proxyline/dispatcher-brand", () => ({
  isProxylineDispatcher,
}));
...
} from "../../../src/infra/net/proxy-env.js";
import {
...
describe("forceResetGlobalDispatcher", () => {
  ...
  it("restores a direct Agent when clearing a proxy dispatcher installed by Operator", () => {
    vi.mocked(hasEnvHttpProxyAgentConfigured).mockReturnValue(true);
    ensureGlobalUndiciEnvProxyDispatcher();
    expect(getCurrentDispatcher()).toBeInstanceOf(EnvHttpProxyAgent);
