...
import { createActiveHoursPredicate, isWithinActiveHours } from "../../src/infra/heartbeat-active-hours.js";

function cfgWithUserTimezone(userTimezone = "UTC"): OperatorConfig {
  return {
    agents: {
      defaults: {
        userTimezone,
