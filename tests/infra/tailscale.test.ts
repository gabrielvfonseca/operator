...
import * as tailscale from "../../src/infra/tailscale.js";
...
describe("tailscale helpers", () => {
  ...
  beforeEach(() => {
    envSnapshot = captureEnv(["OPERATOR_TEST_TAILSCALE_BINARY", "NODE_ENV", "VITEST"]);
    process.env.OPERATOR_TEST_TAILSCALE_BINARY = "tailscale";
