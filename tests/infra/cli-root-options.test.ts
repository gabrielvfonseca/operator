...
import { consumeRootOptionToken, isValueToken } from "../../src/infra/cli-root-options.js";
...
describe("consumeRootOptionToken", () => {
  it.each([
    ...
    { args: ["--container=operator-demo"], index: 0, expected: 1 },
    { args: ["--profile", "work"], index: 0, expected: 2 },
    { args: ["--container", "operator-demo"], index: 0, expected: 2 },
