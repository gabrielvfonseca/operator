...
} from "../../../src/skills/workshop/history-scan-candidate-rules.js";
import { selectSkillHistoryScanCandidates } from "../../../src/skills/workshop/history-scan-candidates.js";
import {
  reconcileSkillHistoryScanProgress,
  resolveSkillHistoryScanHasMore,
} from "../../../src/skills/workshop/history-scan-progress.js";
import { buildSkillHistoryScanPrompt } from "../../../src/skills/workshop/history-scan-prompt.js";
import {
  resolveSkillHistoryScanReviewOutcome,
  resolveSkillHistoryScanRunFailure,
} from "../../../src/skills/workshop/history-scan-review-outcome.js";
import { getSkillHistoryScanStatus, type SkillHistoryScanResult } from "../../../src/skills/workshop/history-scan-state.js";
import {
  formatSkillHistoryScanTranscript,
  isSkillHistoryScanLocalTranscriptSizeEligible,
  prepareSkillHistoryScanReviewMessages,
} from "../../../src/skills/workshop/history-scan-transcript-content.js";
import {
  collectSkillHistoryScanBatch,
  resolveSkillHistoryScanTranscriptBudget,
} from "../../../src/skills/workshop/history-scan-transcript.js";
import { runSkillHistoryScan } from "../../../src/skills/workshop/history-scan.js";
...
describe("Skill Workshop history scan", () => {
  ...
  it("removes shared-session heartbeat work before bounding the review window", () => {
    ...
    const messages = [
      ...interactive,
      { role: "user", content: "[Operator heartbeat poll]" },
      ...Array.from({ length: 100 }, (_, index) => ({
  ...
  it("rejects an opposite-direction scan while one is active", async () => {
    ...
    try {
      ...
      const params = {
        ...
        env: { ...process.env, OPERATOR_STATE_DIR: path.join(tempDir, "state") },
        workspaceDir,
      };
