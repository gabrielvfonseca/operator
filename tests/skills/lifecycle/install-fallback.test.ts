...
import { hasBinaryMock, runCommandWithTimeoutMock } from "../../../src/skills/test-support/install-test-mocks.js";
...
const suiteTempDirs = createSuiteTempRootTracker({ prefix: "operator-fallback-test-" });
