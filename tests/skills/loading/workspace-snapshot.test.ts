...
import { withPathResolutionEnv } from "../../../src/test-utils/env.js";
...
import { writeSkill, writeWorkspaceSkills } from "../../../src/skills/test-support/e2e-test-helpers.js";
import {
  restoreMockSkillsHomeEnv,
  setMockSkillsHomeEnv,
  type SkillsHomeEnvSnapshot,
} from "../../../src/skills/test-support/home-env.test-support.js";
import { buildWorkspaceSkillSnapshot, buildWorkspaceSkillsPrompt } from "../../../src/skills/loading/workspace.js";

vi.mock("./plugin-skills.js", () => ({
  resolvePluginSkillDirs: () => [],
}));

const fixtureSuite = createFixtureSuite("operator-skills-snapshot-suite-");
...
beforeAll(async () => {
  ...
  tempHome = await createTempHomeEnv("operator-skills-snapshot-home-");
