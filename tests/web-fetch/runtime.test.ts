...
import type { PluginWebFetchProviderEntry } from "../../src/plugins/types.js";
...
function getFirecrawlApiKey(config?: OperatorConfig): unknown {
...
function createFirecrawlPluginConfig(apiKey: unknown): OperatorConfig {
  return {
    plugins: {
      entries: {
        firecrawl: {
...
describe("web fetch runtime", () => {
  ...
  it("invalidates provider discovery when the same config object changes", () => {
    ...
    } as OperatorConfig & { tools: { web: { fetch: { provider: string } } } };
