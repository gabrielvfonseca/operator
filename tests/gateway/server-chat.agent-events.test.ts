...
import { formatChannelProgressDraftLine } from "../../src/channels/streaming.js";
import {
...
} from "../../src/gateway/server-chat.js";
import { loadGatewaySessionRow } from "../../src/gateway/server-chat.load-gateway-session-row.runtime.js";
...
describe("agent event handler", () => {
  ...
  it("strips internal runtime context from assistant chat events", () => {
    ...
    expect(payload.message?.content?.[0]?.text).not.toContain("BEGIN_OPERATOR_INTERNAL_CONTEXT");
