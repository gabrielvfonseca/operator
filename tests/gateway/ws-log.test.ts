...
import { formatForLog, summarizeAgentEventForWsLog } from "../../src/gateway/ws-log.js";
...
describe("gateway ws log helpers", () => {
  ...
  test("formatForLog walks cause chain so the underlying error is not hidden (operator-4a8)", () => {
