...
import { startGatewayTailscaleExposure } from "../../src/gateway/server-tailscale.js";
...
describe("startGatewayTailscaleExposure preserveFunnel", () => {
  ...
  it("passes serviceName through to Tailscale Serve setup and cleanup", async () => {
    ...
    expect(mocks.enableTailscaleServe).toHaveBeenCalledWith(18789, undefined, "svc:operator");
    ...
    expect(mocks.disableTailscaleServe).toHaveBeenCalledWith(undefined, "svc:operator");
  });
