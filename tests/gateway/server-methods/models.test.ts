...
import { expectGatewayErrorResponse } from "../../../src/gateway/server-methods/gateway-response.test-helpers.js";
...
function requestModelsList(params: {
  ...
  const request = expectDefined(
    ...
    context: {
      getRuntimeConfig: () => params.runtimeConfig ?? ({} as OperatorConfig),
            ...
            profiles: {
              "vllm:env": {
                ...
                keyRef: {
                  source: "env",
                  provider: "default",
                  id: "OPERATOR_TEST_PROFILE_API_KEY",
                },
              },
            },
          });
