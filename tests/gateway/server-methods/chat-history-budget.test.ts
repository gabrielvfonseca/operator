...
import { enforceChatHistoryFinalBudget } from "../../../src/gateway/server-methods/chat-history-budget.js";
...
describe("enforceChatHistoryFinalBudget", () => {
  ...
  it("falls back to a small placeholder when even the last message is too large", () => {
    const last = {
      ...
      __operator: { id: "abc", seq: 7, turnBoundary: true },
    };
