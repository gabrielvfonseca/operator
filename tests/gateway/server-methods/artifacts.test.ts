...
import { expectRecordFields } from "../../../src/gateway/test-helpers.assertions.js";
import { artifactsHandlers } from "../../../src/gateway/server-methods/artifacts.js";
    ...
    mockedMessages([
      {
        ...
        __operator: { seq: 2, messageTaskId: "task-1" },
      },
      {
        role: "assistant",
        content: [{ type: "image", data: "b3RoZXI=", alt: "other-task.png" }],
        __operator: { seq: 3, messageTaskId: "task-2" },
      },
      {
        role: "assistant",
