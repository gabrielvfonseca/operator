...
import type { createOpenAIModelRoutesResolver } from "../../../src/agents/openai-model-routes.js";
...
import { buildModelsListResult } from "../../../src/gateway/server-methods/models-list-result.js";
...
async function listModels(params: {
  ...
  const context = {
    getRuntimeConfig: () => params.cfg ?? ({} as OperatorConfig),
        ...
        models: [
          {
            ...
            name: "GPT-5.4 Nano",
            provider: "openai",
            agentRuntime: IMPLICIT_OPERATOR_RUNTIME,
            contextWindow: 1_000_000,
            reasoning: true,
            available: true,
          },
