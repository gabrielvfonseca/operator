...
import type { SessionCatalogProvider } from "../../../src/plugins/session-catalog.js";
import { createTerminalLaunchPolicy } from "../../../src/gateway/terminal/launch.js";
import { terminalHandlers, TERMINAL_OPEN_DEADLINE_MS } from "../../../src/gateway/server-methods/terminal.js";
...
function makeOpts(
  ...
  terminalPolicyConfig?: OperatorConfig,
  nodeRegistry: {
  ...
  const runtimeConfig = { gateway: { terminal: terminalConfig } } as OperatorConfig;
