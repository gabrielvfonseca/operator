...
} from "../../../src/gateway/worker-environments/admission.js";
import { hashWorkerCredential, type WorkerCredentialRecord } from "../../../src/gateway/worker-environments/credential.js";
import type { WorkerEnvironmentRecord, WorkerEnvironmentStore } from "../../../src/gateway/worker-environments/store.js";
...
describe("worker admission", () => {
  ...
  it.each([
    ...
    ["version-mismatch", () => admission({ handshake: { ...RECEIPT, operatorVersion: "other" } })],
