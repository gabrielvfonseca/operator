...
import type { GatewayReloadPlan } from "../../src/gateway/config-reload.js";
import { createGatewayAuxHandlers } from "../../src/gateway/server-aux-handlers.js";
...
describe("gateway aux handlers", () => {
  ...
  it("rolls back stopped channels when a later restart fails", async () => {
    const authAgentDir = "/tmp/operator-secrets-reload-concurrent-oauth";
