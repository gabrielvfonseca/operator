...
import { getActiveNodeContext, setActiveNodeContext } from "../../src/infra/active-node-context.js";
import { onDiagnosticEvent, resetDiagnosticEventsForTest } from "../../src/infra/diagnostic-events.js";
import { createEmptyPluginRegistry } from "../../src/plugins/registry-empty.js";
import { listConnectedNodePluginTools } from "../../src/gateway/node-plugin-tool-snapshot.js";
...
function makeClient(
  ...
  return {
    ...
    connect: {
      ...
      maxProtocol: 1,
      client: {
        id: opts.clientId ?? "operator-macos",
