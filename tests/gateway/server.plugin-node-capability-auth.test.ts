...
import { PLUGIN_NODE_CAPABILITY_PATH_PREFIX } from "../../src/gateway/plugin-node-capability.js";
import { MAX_PREAUTH_PAYLOAD_BYTES } from "../../src/gateway/server-constants.js";
import { attachGatewayUpgradeHandler, createGatewayHttpServer } from "../../src/gateway/server-http.js";
...
const A2UI_PATH = "/__operator__/a2ui";
const CANVAS_HOST_PATH = "/__operator__/canvas";
const CANVAS_WS_PATH = "/__operator__/ws";
