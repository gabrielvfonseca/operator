...
import { openAuthenticatedGatewayWs, waitForGatewayWsClose } from "../../src/gateway/shared-auth.test-helpers.js";
import {
  getFreePort,
...
const SECRET_REF_TOKEN_ID = "OPERATOR_SHARED_TOKEN_HOT_RELOAD_SECRET_REF";
