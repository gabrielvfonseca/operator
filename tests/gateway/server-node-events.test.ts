...
import type { loadSessionEntry as loadSessionEntryType } from "../../src/gateway/session-utils.js";
...
const buildSessionLookup = (
  ...
  cfg: { session: { mainKey: "agent:main:main" } } as OperatorConfig,
...
const runtimeMocks = vi.hoisted(() => ({
  ...
  resolveSessionModelRef: vi.fn(
    (_cfg: OperatorConfig, entry?: { model?: string; modelProvider?: string }) => ({
...
import type { NodeEventContext } from "../../src/gateway/server-node-events-types.js";
import { handleNodeEvent } from "../../src/gateway/server-node-events.js";
