...
} from "../../src/gateway/device-auth.js";
  ...
  it.each([
    {
      ...
      expected:
        "v2|dev-1|operator-macos|ui|operator|operator.admin,operator.read|1700000000000||nonce-abc",
    },
    {
      ...
      expected:
        "v3|dev-1|operator-macos|ui|operator|operator.admin,operator.read|1700000000000|tok-123|nonce-abc|ios|iphone",
    },
    {
      ...
      expected: "v3|dev-2|operator-ios|ui|operator|operator.read|1700000000001||nonce-def||",
    },
  ])("$name", ({ build, expected }) => {
