...
describe("gateway startup import boundaries", () => {
  it("keeps heavy cron and doctor legacy paths out of the server.impl import graph", () => {
    ...
    expect(serverImpl).not.toContain('from "../../src/gateway/server-cron.js"');
    expect(serverImpl).toContain('from "../../src/gateway/server-cron-lazy.js"');
    expect(serverImpl).not.toContain('from "../../src/gateway/server-methods.js"');
    expect(serverImpl).not.toContain('from "../../src/gateway/config-reload.js"');
    ...
    expect(serverImpl).not.toContain('from "../../src/plugins/hook-runner-global.js"');
    expect(serverImpl).not.toContain('from "../../src/tasks/task-registry.js"');
    expect(serverImpl).not.toContain('from "../../src/tasks/task-registry.maintenance.js"');
    expect(serverImpl).toContain('import("../tasks/task-registry.maintenance.js")');
    expect(serverImpl).not.toContain('from "../../src/secrets/runtime.js"');
    ...
    expect(serverImpl).not.toContain('from "../../src/plugins/worker-provider-registry.js"');
