...
import { pruneSupersededSilentPairingsAfterApproval } from "../../src/gateway/device-pairing-prune.js";

const suiteRootTracker = createSuiteTempRootTracker({ prefix: "operator-gateway-pairing-prune-" });
