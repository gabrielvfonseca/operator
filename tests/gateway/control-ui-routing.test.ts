...
} from "../../src/gateway/control-ui-routing.js";
...
describe("isControlUiPluginManagerRequest", () => {
  it.each([
    ...
    {
      basePath: "/operator",
      pathname: "/operator/settings/plugins",
      method: "GET",
      expected: true,
    },
...
describe("isControlUiApprovalDocumentPath", () => {
  it.each([
    ...
    { basePath: "/operator", pathname: "/operator/approve/exec%3Aa%2Fb" },
  ...
  it.each([
    ...
    { basePath: "/operator", pathname: "/approve/id" },
    ...
    it.each([
      {
        ...
        search: "?foo=1",
        method: "GET",
        expected: { kind: "redirect" as const, location: "/operator/?foo=1" },
      },
      {
