...
import type { AuthorizedGatewayHttpRequest } from "../../../src/gateway/http-utils.js";
import { authorizeOperatorScopesForMethod, CLI_DEFAULT_OPERATOR_SCOPES } from "../../../src/gateway/method-scopes.js";
import { isApprovalRecordVisibleToClient } from "../../../src/gateway/server-methods/approval-shared.js";
