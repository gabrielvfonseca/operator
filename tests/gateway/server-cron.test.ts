...
import { SsrFBlockedError } from "../../src/infra/net/ssrf.js";
import {
...
import { buildGatewayCronService, fireOnExitJob } from "../../src/gateway/server-cron.js";

function createCronConfig(name: string): OperatorConfig {
...
describe("buildGatewayCronService", () => {
  ...
  it("stops on-exit watcher children when the direct cron service stops", async () => {
    vi.stubEnv("OPERATOR_SKIP_CRON", "0");
