...
import { createNodeReapprovalCoordinator } from "../../src/gateway/node-reapproval-coordinator.js";

const tempDirs = createSuiteTempRootTracker({ prefix: "operator-node-reapproval-" });
