...
import { INVALID_EXEC_SECRET_REF_IDS } from "../../src/test-utils/secret-ref-test-vectors.js";
...
describe("secret ref resolver", () => {
  ...
  beforeAll(async () => {
    fixtureRoot = await fs.mkdtemp(path.join(os.tmpdir(), "operator-secrets-resolve-"));
