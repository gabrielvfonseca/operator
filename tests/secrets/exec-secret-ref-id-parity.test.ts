...
import { validateConfigObjectRaw } from "../../src/config/validation.js";
...
} from "../../src/test-utils/talk-test-provider.js";
import { isSecretsApplyPlan } from "../../src/secrets/plan.js";
import { isValidExecSecretRefId, isValidFileSecretRefId } from "../../src/secrets/ref-contract.js";
import { compileTargetRegistryEntry, materializePathTokens } from "../../src/secrets/target-registry-pattern.js";
...
import { listSecretTargetRegistryEntries } from "../../src/secrets/target-registry.js";
