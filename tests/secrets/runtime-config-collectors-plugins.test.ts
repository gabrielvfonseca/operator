...
import type { PluginOrigin } from "../../src/plugins/types.js";
import { collectPluginConfigAssignments } from "../../src/secrets/runtime-config-collectors-plugins.js";
import {
...
function makeContext(sourceConfig: OperatorConfig): ResolverContext {
...
function collectAcpxConfigAssignments(config: OperatorConfig): ResolverContext {
...
function expectInactiveAcpxConfig(config: OperatorConfig): void {
