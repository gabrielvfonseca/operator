...
import { resolveFirstBoundAccountId } from "../../src/routing/bound-account-read.js";

function cfgWithBindings(bindings: AgentRouteBinding[]): OperatorConfig {
  return { bindings } as unknown as OperatorConfig;
}
