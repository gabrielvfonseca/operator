...
} from "../../src/commitments/extraction.js";
import { validateCommitmentCandidates } from "../../src/commitments/extraction.test-support.js";
import { readCommitmentsForTest } from "../../src/commitments/store.test-utils.js";
import type { CommitmentCandidate, CommitmentExtractionItem } from "../../src/commitments/types.js";
...
describe("commitment extraction", () => {
  ...
  it("rejects disabled, low-confidence, and non-future candidates", () => {
    const cfg: OperatorConfig = { commitments: { enabled: true } };
