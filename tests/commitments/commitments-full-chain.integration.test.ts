...
import { runHeartbeatOnce } from "../../src/infra/heartbeat-runner.js";
...
import { enqueueCommitmentExtraction } from "../../src/commitments/runtime.js";
import {
  configureCommitmentExtractionRuntime,
  drainCommitmentExtractionQueue,
  resetCommitmentExtractionRuntimeForTests,
} from "../../src/commitments/runtime.test-support.js";
import { readCommitmentsForTest } from "../../src/commitments/store.test-utils.js";
import type { CommitmentExtractionBatchResult, CommitmentExtractionItem } from "../../src/commitments/types.js";
...
describe("commitments full-chain integration", () => {
  ...
  it("flows from hidden extraction to stored commitment to scoped heartbeat delivery", async () => {
    ...
    await withTempHeartbeatSandbox(async ({ tmpDir, storePath, replySpy }) => {
      await withEnvAsync({ OPERATOR_STATE_DIR: tmpDir }, async () => {
