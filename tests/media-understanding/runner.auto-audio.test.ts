...
import type { MediaUnderstandingConfig } from "../../src/config/types.tools.js";
import { withEnvAsync } from "../../src/test-utils/env.js";
import { runCapability } from "../../src/media-understanding/runner.js";
import { clearMediaUnderstandingBinaryCacheForTests } from "../../src/media-understanding/runner.test-support.js";
import { withAudioFixture } from "../../src/media-understanding/runner.test-utils.js";
import type { AudioTranscriptionRequest, MediaUnderstandingProvider } from "../../src/media-understanding/types.js";
...
function createOpenAiAudioCfg(extra?: Partial<OperatorConfig>): OperatorConfig {
  return {
    models: {
      providers: {
        openai: {
