...
import type { PluginOrigin } from "../../src/plugins/plugin-origin.types.js";
import { createEmptyPluginRegistry } from "../../src/plugins/registry.js";
import type { OperatorPluginService, OperatorPluginServiceContext } from "../../src/plugins/types.js";
...
function expectServiceLogger(ctx: OperatorPluginServiceContext) {
...
function expectServiceContexts(
  contexts: OperatorPluginServiceContext[],
  config: Parameters<typeof startPluginServices>[0]["config"],
) {
...
describe("startPluginServices", () => {
  ...
  it("starts services and stops them in reverse order", async () => {
    const starts: string[] = [];
    const stops: string[] = [];
    const contexts: OperatorPluginServiceContext[] = [];
  ...
  it("rejects unsafe event names, scopes, and payloads", async () => {
    let context: OperatorPluginServiceContext | undefined;
    const broadcastPluginEvent = vi.fn();
    await startPluginServices({
      registry: createRegistry([
        {
  ...
  it("grants internal diagnostics only to trusted diagnostics exporter services", async () => {
    ...
    const prometheusContexts: OperatorPluginServiceContext[] = [];
    ...
    const officialDiagnosticsOtelContexts: OperatorPluginServiceContext[] = [];
    ...
    const officialInstallContexts: OperatorPluginServiceContext[] = [];
    ...
    const untrustedContexts: OperatorPluginServiceContext[] = [];
    ...
    const spoofedContexts: OperatorPluginServiceContext[] = [];
