...
import { addStaticTestHooks, addTestHook, TEST_PLUGIN_AGENT_CTX } from "../../src/plugins/hooks.test-fixtures.js";
import { createEmptyPluginRegistry, type PluginRegistry } from "../../src/plugins/registry.js";
import type { PluginHookBeforeAgentStartResult, PluginHookRegistration } from "../../src/plugins/types.js";
...
describe("before_agent_start hook merger", () => {
  ...
  it("passes runId through the agent context to hook handlers", async () => {
    ...
    addTestHook({
      ...
      pluginId: "ctx-spy",
      hookName: "before_agent_start",
      handler: ((_eventValue: unknown, ctx: typeof stubCtx) => {
        capturedCtx = ctx;
        return {};
