...
type LoadOperatorProviderIndex =
  typeof import("../model-catalog/index.js").loadOperatorProviderIndex;
...
const loadOperatorProviderIndex = vi.hoisted(() =>
  vi.fn<LoadOperatorProviderIndex>(() => ({ version: 1, providers: {} })),
);
...
} from "../../src/plugins/provider-install-catalog.js";
...
function vllmPluginWithPackageInstall(): InstalledPluginIndexRecord {
  return {
    pluginId: "vllm",
    origin: "global",
    manifestPath: "/Users/test/.operator/plugins/vllm/operator.plugin.json",
    manifestHash: "hash",
    rootDir: "/Users/test/.operator/plugins/vllm",
    enabled: true,
    startup: {
      sidecar: false,
      memory: false,
    ...
    compat: [],
    packageName: "@gabrielvfonseca/vllm",
    packageInstall: {
      npm: {
        spec: "@gabrielvfonseca/vllm-fork@1.0.0",
        packageName: "@gabrielvfonseca/vllm-fork",
        selector: "1.0.0",
...
describe("provider install catalog", () => {
  beforeEach(() => {
    vi.clearAllMocks();
    loadOperatorProviderIndex.mockReturnValue({ version: 1, providers: {} });
      ...
      plugins: [
        {
          pluginId: "openai",
          origin: "bundled",
          manifestPath: "/repo/extensions/openai/operator.plugin.json",
          manifestHash: "hash",
          ...
          compat: [],
          packageName: "@gabrielvfonseca/openai",
          packageInstall: {
            defaultChoice: "npm",
            npm: {
              spec: "@gabrielvfonseca/openai@1.2.3",
              packageName: "@gabrielvfonseca/openai",
              selector: "1.2.3",
              selectorKind: "exact-version",
              exactVersion: true,
    ...
    expect(resolveProviderInstallCatalogEntries()).toEqual([
      {
        ...
        origin: "bundled",
        install: {
          npmSpec: "@gabrielvfonseca/openai@1.2.3",
  ...
  it("prefers durable install records over package-authored install intent", () => {
    loadPluginRegistrySnapshot.mockReturnValue(
      registrySnapshot({
        installRecords: {
          vllm: {
            source: "npm",
            spec: "@gabrielvfonseca/vllm",
            resolvedSpec: "@gabrielvfonseca/vllm@2.0.0",
    ...
    expect(resolveProviderInstallCatalogEntry("vllm")).toEqual({
      ...
      origin: "global",
      install: {
        npmSpec: "@gabrielvfonseca/vllm@2.0.0",
      ...
      installSource: {
        defaultChoice: "npm",
        npm: {
          spec: "@gabrielvfonseca/vllm@2.0.0",
          packageName: "@gabrielvfonseca/vllm",
          selector: "2.0.0",
          selectorKind: "exact-version",
          exactVersion: true,
      ...
      plugins: [
        {
          ...
          origin: "global",
          manifestPath: "/Users/test/.operator/plugins/demo-provider/operator.plugin.json",
          manifestHash: "hash",
          rootDir: "/Users/test/.operator/plugins/demo-provider",
          enabled: true,
          startup: {
            sidecar: false,
            memory: false,
      ...
      plugins: [
        {
          pluginId: "demo-provider",
          origin: "workspace",
          manifestPath: "/repo/extensions/demo-provider/operator.plugin.json",
          manifestHash: "hash",
  ...
  it("surfaces provider-index install metadata when the provider plugin is not installed", () => {
    loadOperatorProviderIndex.mockReturnValue({
      version: 1,
      providers: {
        moonshot: {
          id: "moonshot",
    ...
    expect(resolveProviderInstallCatalogEntry("moonshot-api-key")).toEqual({
      ...
      installSource: {
        defaultChoice: "npm",
        npm: {
          spec: "@gabrielvfonseca/plugin-moonshot@1.2.3",
          packageName: "@gabrielvfonseca/plugin-moonshot",
          selector: "1.2.3",
          selectorKind: "exact-version",
          exactVersion: true,
          expectedIntegrity: "sha512-moonshot",
  ...
  it("surfaces provider-index ClawHub install metadata as the preferred source", () => {
    ...
    expect(resolveProviderInstallCatalogEntry("moonshot-api-key")).toEqual({
      ...
      installSource: {
        ...
        npm: {
          spec: "@gabrielvfonseca/plugin-moonshot@2026.5.2",
          packageName: "@gabrielvfonseca/plugin-moonshot",
          selector: "2026.5.2",
          selectorKind: "exact-version",
          exactVersion: true,
      ...
      plugins: [
        {
          pluginId: "moonshot",
          origin: "bundled",
          manifestPath: "/repo/extensions/moonshot/operator.plugin.json",
          manifestHash: "hash",
  ...
  it("keeps missing provider-index entries visible when only some provider plugins are installed", () => {
    ...
    loadOperatorProviderIndex.mockReturnValue({
      ...
      providers: {
        groq: {
          ...
          plugin: {
            id: "groq",
            package: "@gabrielvfonseca/plugin-groq",
            install: {
              npmSpec: "@gabrielvfonseca/plugin-groq@1.0.0",
              defaultChoice: "npm",
            },
          },
          authChoices: [
    ...
    expect(resolveProviderInstallCatalogEntry("vllm-server")).toEqual({
      ...
      installSource: {
        ...
        npm: {
          spec: "@gabrielvfonseca/plugin-vllm@2026.5.2",
          packageName: "@gabrielvfonseca/plugin-vllm",
          selector: "2026.5.2",
          selectorKind: "exact-version",
          exactVersion: true,
