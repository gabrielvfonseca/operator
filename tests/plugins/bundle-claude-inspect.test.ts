...
import { inspectBundleLspRuntimeSupport } from "../../src/plugins/bundle-lsp.js";
import { loadBundleManifest } from "../../src/plugins/bundle-manifest.js";
...
describe("Claude bundle plugin inspect integration", () => {
  ...
  beforeAll(() => {
    rootDir = makeTrackedTempDir("operator-claude-bundle", tempDirs);
