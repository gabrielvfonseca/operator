...
import { buildPluginRegistrySnapshotReport, buildPluginSnapshotReport } from "../../src/plugins/status.js";
import {
...
function makeTempDir() {
  return makeTrackedTempDir("operator-plugin-status", tempDirs);
}
...
describe("buildPluginRegistrySnapshotReport", () => {
  ...
  it("reconstructs list metadata from indexed manifests without importing plugin runtime", () => {
    const fixture = createColdPluginFixture({
      ...
      packageName: "@example/operator-indexed-demo",
  ...
  it("replays persisted list metadata without importing plugin runtime", async () => {
    const fixture = createColdPluginFixture({
      ...
      packageName: "@example/operator-persisted-demo",
