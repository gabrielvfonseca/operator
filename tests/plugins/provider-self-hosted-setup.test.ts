...
} from "../../src/plugins/provider-self-hosted-setup.js";
import type { ProviderAuthMethodNonInteractiveContext } from "../../src/plugins/types.js";
...
function createContext(params: {
  ...
  return {
    ...
    agentDir: "/tmp/operator-self-hosted-test-agent",
