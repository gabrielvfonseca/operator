...
import { getGlobalHookRunner, resetGlobalHookRunner } from "../../src/plugins/hook-runner-global.js";
...
describe("global hook runner live view (#91918)", () => {
  ...
  it("keeps local-extension tool-call hooks dispatchable across scoped default-mode activations", async () => {
    ...
    const bootRegistry = loadOperatorPlugins({
    ...
    const memoryRegistry = loadOperatorPlugins({
      workspaceDir: gate.dir,
      config,
