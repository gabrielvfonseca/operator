...
import { setGatewayNodesRuntime, setGatewaySubagentRuntime } from "../../../src/plugins/runtime/gateway-bindings.js";
...
describe("plugin runtime command execution", () => {
  ...
  it("modelAuth wrappers preserve workspace scope while stripping credential steering", async () => {
    ...
    const cfg = { plugins: { allow: ["workspace-cloud"] } } as OperatorConfig;
