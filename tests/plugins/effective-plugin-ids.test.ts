...
import { resolveEffectivePluginIds } from "../../src/plugins/effective-plugin-ids.js";

function resolve(config: OperatorConfig): string[] {
...
describe("resolveEffectivePluginIds", () => {
  ...
  ] satisfies Array<{ name: string; plugins: NonNullable<OperatorConfig["plugins"]> }>)(
