...
import { resolvePluginNpmProjectsDir } from "../../src/plugins/install-paths.js";
import {
  listManagedPluginNpmProjectRootsSync,
  listManagedPluginNpmRoots,
} from "../../src/plugins/npm-project-roots.js";

const tempDirs = useAutoCleanupTempDirTracker(afterEach);

function makeNpmRoot(): string {
  const tempDir = tempDirs.make("operator-npm-project-roots-");
