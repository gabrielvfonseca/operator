...
import { bundledPluginFile, getBundledPluginRoots } from "../../../src/plugins/contracts/test-helpers/bundled-plugin-roots.js";
...
const RUNTIME_API_EXPORT_GUARDS: Record<string, readonly string[]> = {
  [bundledPluginFile({
    ...
    'export type { OperatorPluginServiceContext } from "./api.js";',
  ],
  ...
  [bundledPluginFile({ rootDir: ROOT_DIR, pluginId: "imessage", relativePath: "runtime-api.ts" })]:
    [
      'export { DEFAULT_ACCOUNT_ID, getChatChannelMeta, type ChannelPlugin } from "@gabrielvfonseca/operator/plugin-sdk/core";',
      ...
      'export { buildComputedAccountStatusSnapshot, collectStatusIssuesFromLastError } from "@gabrielvfonseca/operator/plugin-sdk/status-helpers";',
      'export { formatTrimmedAllowFromEntries } from "@gabrielvfonseca/operator/plugin-sdk/channel-config-helpers";',
      ...
      'export type IMessageAccountConfig = Omit< NonNullable<NonNullable<RuntimeApiOperatorConfig["channels"]>["imessage"]>, "accounts" | "defaultAccount" >;',
    ],
  [bundledPluginFile({
    rootDir: ROOT_DIR,
    pluginId: "googlechat",
    ...
    'export { createActionGate, jsonResult, readNumberParam, readReactionParams, readStringParam } from "@gabrielvfonseca/operator/plugin-sdk/channel-actions";',
    'export { buildChannelConfigSchema, GoogleChatConfigSchema } from "./config-api.js";',
    'export type { ChannelMessageActionAdapter, ChannelMessageActionName, ChannelStatusIssue } from "@gabrielvfonseca/operator/plugin-sdk/channel-contract";',
    'export { missingTargetError } from "@gabrielvfonseca/operator/plugin-sdk/channel-feedback";',
    'export { createAccountStatusSink, runPassiveAccountLifecycle } from "@gabrielvfonseca/operator/plugin-sdk/channel-outbound";',
    ...
    'export { GROUP_POLICY_BLOCKED_LABEL, resolveAllowlistProviderRuntimeGroupPolicy, resolveDefaultGroupPolicy, warnMissingProviderGroupPolicyFallbackOnce } from "@gabrielvfonseca/operator/plugin-sdk/runtime-group-policy";',
    ...
    'export type { GoogleChatAccountConfig, GoogleChatConfig } from "@gabrielvfonseca/operator/plugin-sdk/config-contracts";',
    ...
    'export { registerWebhookTargetWithPluginRoute, resolveWebhookTargetWithAuthOrReject, withResolvedWebhookRequestPipeline } from "@gabrielvfonseca/operator/plugin-sdk/webhook-targets";',
    'export { createWebhookInFlightLimiter, readJsonWebhookBodyOrReject, type WebhookInFlightLimiter } from "@gabrielvfonseca/operator/plugin-sdk/webhook-request-guards";',
  ...
  [bundledPluginFile({ rootDir: ROOT_DIR, pluginId: "msteams", relativePath: "runtime-api.ts" })]: [
    ...
    'export { mergeAllowlist, resolveAllowlistMatchSimple, summarizeMapping } from "@gabrielvfonseca/operator/plugin-sdk/allow-from";',
    'export type { BaseProbeResult, ChannelDirectoryEntry, ChannelGroupContext, ChannelMessageActionName, ChannelOutboundAdapter } from "@gabrielvfonseca/operator/plugin-sdk/channel-contract";',
    ...
    'export { createChannelMessageReplyPipeline } from "@gabrielvfonseca/operator/plugin-sdk/channel-outbound";',
    'export { PAIRING_APPROVED_MESSAGE, buildProbeChannelStatusSummary, createDefaultChannelRuntimeState } from "@gabrielvfonseca/operator/plugin-sdk/channel-status";',
    'export { buildChannelKeyCandidates, normalizeChannelSlug, resolveChannelEntryMatchWithFallback, resolveNestedAllowlistDecision } from "@gabrielvfonseca/operator/plugin-sdk/channel-targets";',
    'export type { GroupPolicy, GroupToolPolicyConfig, MSTeamsChannelConfig, MSTeamsCloudName, MSTeamsConfig, MSTeamsReplyStyle, MSTeamsTeamConfig, MarkdownTableMode, OperatorConfig } from "@gabrielvfonseca/operator/plugin-sdk/config-contracts";',
    'export { isDangerousNameMatchingEnabled } from "@gabrielvfonseca/operator/plugin-sdk/dangerous-name-runtime";',
    ...
    'export { detectMime, extensionForMime, extractOriginalFilename, getFileExtension, resolveChannelMediaMaxBytes } from "@gabrielvfonseca/operator/plugin-sdk/media-runtime";',
  ...
  [bundledPluginFile({ rootDir: ROOT_DIR, pluginId: "matrix", relativePath: "runtime-api.ts" })]: [
    ...
    'export { assertHttpUrlTargetsPrivateNetwork, closeDispatcher, createPinnedDispatcher, resolvePinnedHostnameWithPolicy, ssrfPolicyFromDangerouslyAllowPrivateNetwork, type LookupFn, type SsrFPolicy } from "@gabrielvfonseca/operator/plugin-sdk/ssrf-runtime";',
    ...
    'export type { ChannelDirectoryEntry, ChannelMessageActionContext } from "@gabrielvfonseca/operator/plugin-sdk/channel-contract";',
    'export type { OperatorConfig } from "@gabrielvfonseca/operator/plugin-sdk/config-contracts";',
    'export { formatZonedTimestamp } from "@gabrielvfonseca/operator/plugin-sdk/time-runtime";',
    'export type { PluginRuntime, RuntimeLogger } from "@gabrielvfonseca/operator/plugin-sdk/plugin-runtime";',
    'export type { RuntimeEnv } from "@gabrielvfonseca/operator/plugin-sdk/runtime-env";',
  ...
  [bundledPluginFile({
    ...
    'export { createChannelPairingController } from "@gabrielvfonseca/operator/plugin-sdk/channel-pairing";',
    'export type { BlockStreamingCoalesceConfig, DmConfig, DmPolicy, GroupPolicy, GroupToolPolicyConfig, OperatorConfig } from "@gabrielvfonseca/operator/plugin-sdk/config-contracts";',
    'export { GROUP_POLICY_BLOCKED_LABEL, resolveAllowlistProviderRuntimeGroupPolicy, resolveDefaultGroupPolicy, warnMissingProviderGroupPolicyFallbackOnce } from "@gabrielvfonseca/operator/plugin-sdk/runtime-group-policy";',
    'export { createChannelMessageReplyPipeline } from "@gabrielvfonseca/operator/plugin-sdk/channel-outbound";',
  ...
  [bundledPluginFile({ rootDir: ROOT_DIR, pluginId: "telegram", relativePath: "runtime-api.ts" })]:
    [
      ...
      'export type { OperatorPluginService, OperatorPluginServiceContext, PluginLogger } from "@gabrielvfonseca/operator/plugin-sdk/plugin-entry";',
      'export type { PluginRuntime } from "@gabrielvfonseca/operator/plugin-sdk/runtime-store";',
      'export type { AcpRuntime, AcpRuntimeCapabilities, AcpRuntimeDoctorReport, AcpRuntimeEnsureInput, AcpRuntimeEvent, AcpRuntimeHandle, AcpRuntimeStatus, AcpRuntimeTurnInput, AcpRuntimeErrorCode, AcpSessionUpdateTag } from "@gabrielvfonseca/operator/plugin-sdk/acp-runtime";',
      'export { AcpRuntimeError } from "@gabrielvfonseca/operator/plugin-sdk/acp-runtime";',
      'export { emptyPluginConfigSchema, formatPairingApproveHint, getChatChannelMeta } from "@gabrielvfonseca/operator/plugin-sdk/channel-plugin-common";',
      ...
      'export { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "@gabrielvfonseca/operator/plugin-sdk/account-id";',
      'export { PAIRING_APPROVED_MESSAGE, buildTokenChannelStatusSummary, projectCredentialSnapshotFields, resolveConfiguredFromCredentialStatuses } from "@gabrielvfonseca/operator/plugin-sdk/channel-status";',
      'export { jsonResult, readNumberParam, readReactionParams, readStringArrayParam, readStringOrNumberParam, readStringParam, resolvePollMaxSelections } from "@gabrielvfonseca/operator/plugin-sdk/channel-actions";',
      ...
      'export type { ChannelPlugin } from "@gabrielvfonseca/operator/plugin-sdk/channel-core";',
      'export type { OperatorConfig } from "@gabrielvfonseca/operator/plugin-sdk/config-contracts";',
      'export type TelegramAccountConfig = NonNullable< NonNullable<RuntimeOperatorConfig["channels"]>["telegram"] >;',
  ...
  [bundledPluginFile({ rootDir: ROOT_DIR, pluginId: "twitch", relativePath: "runtime-api.ts" })]: [
    'export type { ChannelAccountSnapshot, ChannelCapabilities, ChannelGatewayContext, ChannelLogSink, ChannelMessageActionAdapter, ChannelMessageActionContext, ChannelMeta, ChannelOutboundAdapter, ChannelOutboundContext, ChannelResolveKind, ChannelResolveResult, ChannelStatusAdapter } from "@gabrielvfonseca/operator/plugin-sdk/channel-contract";',
    'export type { ChannelPlugin } from "@gabrielvfonseca/operator/plugin-sdk/channel-core";',
  ...
  [bundledPluginFile({
    ...
    'export { isRequestBodyLimitError, readRequestBodyWithLimit, requestBodyErrorToText } from "@gabrielvfonseca/operator/plugin-sdk/webhook-request-guards";',
    'export { fetchWithSsrFGuard, isBlockedHostnameOrIp } from "@gabrielvfonseca/operator/plugin-sdk/ssrf-runtime";',
    'export type { SessionEntry } from "@gabrielvfonseca/operator/plugin-sdk/session-store-runtime";',
    'export { TtsAutoSchema, TtsConfigSchema, TtsModeSchema, TtsProviderSchema } from "@gabrielvfonseca/operator/plugin-sdk/tts-runtime";',
