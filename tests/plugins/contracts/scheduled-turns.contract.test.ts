...
import type { CronServiceContract } from "../../../src/cron/service-contract.js";
import type { CronJob, CronJobCreate } from "../../../src/cron/types.js";
import type {
  GatewayRequestHandler,
  GatewayRequestHandlerOptions,
} from "../../../src/gateway/server-methods/types.js";
import { withEnv } from "../../../src/test-utils/env.js";
import { cleanupReplacedPluginHostRegistry } from "../../../src/plugins/host-hook-cleanup.js";
import {
...
} from "../../../src/plugins/host-hook-scheduled-turns.js";
import { loadOperatorPlugins } from "../../../src/plugins/loader.js";
import { clearPluginLoaderCache, makeTempDir, writePlugin } from "../../../src/plugins/loader.test-fixtures.js";
...
function createMockCronService(): CronServiceContract {
  return {
    ...
    status: vi.fn(async () => ({
      enabled: true,
      storePath: "/tmp/operator-test-cron.json",
      storage: "sqlite" as const,
      sqlitePath: "/tmp/openclaw-test-state/state/operator.sqlite",
      jobs: 0,
      nextWakeAtMs: null,
    })),
    list: vi.fn(async () => []),
...
describe("plugin scheduled turns", () => {
  ...
  it("builds payloads accepted by the real cron.add protocol validator", async () => {
    const { validateCronAddParams } = await import(
