...
import { enableExplicitlySelectedPluginInConfig, enablePluginInConfig } from "../../src/plugins/enable.js";
...
describe("enablePluginInConfig", () => {
  ...
  it("can enable a built-in channel plugin entry without mutating channel config", () => {
    const result = enablePluginInConfig({} as OperatorConfig, "twitch", {
