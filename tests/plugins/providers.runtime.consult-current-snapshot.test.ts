...
import { resolveExternalAuthProfilesWithPlugins } from "../../src/plugins/provider-runtime.js";
import { isPluginProvidersLoadInFlight, resolvePluginProviders } from "../../src/plugins/providers.runtime.js";
...
function registerCurrentSnapshot(config: OperatorConfig, workspaceDir = WORKSPACE) {
