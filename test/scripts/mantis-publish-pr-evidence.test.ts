...
describe("scripts/mantis/publish-pr-evidence", () => {
  it("renders a manifest-driven PR comment with inline screenshots and video links", () => {
    ...
    const body = renderEvidenceComment({
      artifactUrl: "https://github.com/operator/operator/actions/runs/1/artifacts/2",
      manifest,
      ...
      runUrl: "https://github.com/operator/operator/actions/runs/1",
  ...
  it("renders a successful no-visual-proof manifest without media tables", () => {
    ...
    const body = renderEvidenceComment({
      ...
      runUrl: "https://github.com/operator/operator/actions/runs/1",
      treeUrl:
        "https://github.com/operator/operator/tree/qa-artifacts/mantis/telegram-desktop/pr-1/run-1",
    });
