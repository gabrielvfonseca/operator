...
function pr(params: {
  ...
  return {
    ...
    url: `https://github.com/operator/operator/pull/${params.number}`,
  };
}
    ...
    expect(plan).toStrictEqual([
      {
        action: "close",
        candidate,
        comment: `Thanks for the fix. This is now covered by the landed #70532 / commit https://github.com/operator/operator/commit/6415e35.
