...
describe("scripts/operator-release-clawhub-runtime-state.ts", () => {
  it("emits verifier args and proof lines for awaited ClawHub runs", () => {
    ...
    expect(JSON.parse(result.stdout)).toEqual({
      ...
      proofLines: {
        normal: "- plugin ClawHub publish: https://github.com/operator/operator/actions/runs/123",
        bootstrap:
          "- plugin ClawHub bootstrap: https://github.com/operator/operator/actions/runs/456",
      },
    });
