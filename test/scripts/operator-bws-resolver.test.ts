...
const resolverPath = path.resolve("scripts/secrets/operator-bws-resolver.mjs");

function makeTempDir(): string {
  const dir = mkdtempSync(path.join(tmpdir(), "operator-bws-resolver-"));
  tempDirs.push(dir);
  return dir;
}
...
describe("operator-bws-resolver", () => {
