...
const validCloseoutParams = {
  ...
  mainAppcast:
    "https://github.com/operator/operator/releases/download/v2026.6.8/Operator-2026.6.8.zip\n",
  release,
...
describe("stable release closeout", () => {
  ...
  it("requires the canonical macOS zip, dmg, and dSYM assets", () => {
    const result = verifyStableMainCloseout({
      ...
      mainAppcast:
        "https://github.com/operator/operator/releases/download/v2026.6.8/operator-2026.6.8-dependency-evidence.zip\n",
      nowMs: Date.parse("2026-06-17T00:00:00Z"),
    });
  ...
  it("uses exact correction versions for correction-release state and assets", () => {
    ...
    const result = verifyStableMainCloseout({
      ...
      mainAppcast:
        "https://github.com/operator/operator/releases/download/v2026.6.8-2/Operator-2026.6.8-2.zip\n",
      nowMs: Date.parse("2026-06-17T00:00:00Z"),
    });
  ...
  it("allows a fallback correction tag for an existing base stable package", () => {
    const result = verifyStableMainCloseout({
      ...
      mainAppcast:
        "https://github.com/operator/operator/releases/download/v2026.6.8-2/Operator-2026.6.8.zip\n",
      nowMs: Date.parse("2026-06-17T00:00:00Z"),
    });
