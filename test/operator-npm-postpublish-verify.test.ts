  ...
  it("requires a trusted GitHub release identity for the exact SLSA provenance attestation", async () => {
    ...
    expect(verificationPolicy).toEqual({
      ...
      certificateIdentityURI:
        "https://github.com/operator/operator/.github/workflows/operator-npm-release.yml@refs/heads/release/2026.3.23",
    });
    ...
    expect(verificationPolicy).toEqual({
      certificateIssuer: "https://token.actions.githubusercontent.com",
      certificateIdentityURI: `https://github.com/operator/operator/.github/workflows/operator-npm-release.yml@${protectedWorkflowRef}`,
    });
