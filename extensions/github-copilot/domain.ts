...
import { normalizeGithubCopilotDomain } from "@gabrielvfonseca/operator/plugin-sdk/provider-auth";
...
function readConfiguredGithubCopilotDomain(config?: OperatorConfig): string | undefined {
...
export function withGithubCopilotDomainConfig(cfg: OperatorConfig, domain: string): OperatorConfig {
  const models: NonNullable<OperatorConfig["models"]> = cfg.models ?? {};
