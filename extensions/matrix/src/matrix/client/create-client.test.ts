...
describe("createMatrixClient", () => {
  const storagePaths = {
    rootDir: "/tmp/operator-matrix-create-client-test",
    storagePath: "/tmp/operator-matrix-create-client-test/storage.json",
    recoveryKeyPath: "/tmp/operator-matrix-create-client-test/recovery.key",
    idbSnapshotPath: "/tmp/operator-matrix-create-client-test/idb.snapshot",
    accountKey: "default",
  ...
  it("persists storage metadata by default", async () => {
    ...
    expect(MatrixClientMock).toHaveBeenCalledWith("https://matrix.example.org", "tok", {
      ...
      cryptoDatabasePrefix: "operator-matrix-default-token-hash",
