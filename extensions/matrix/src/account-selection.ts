...
import { hasConfiguredSecretInput } from "@gabrielvfonseca/operator/plugin-sdk/secret-input-runtime";
...
export function resolveMatrixChannelConfig(cfg: OperatorConfig): Record<string, unknown> | null {
