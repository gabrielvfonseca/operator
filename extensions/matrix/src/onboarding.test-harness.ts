...
import type { OutputRuntimeEnv } from "@gabrielvfonseca/operator/plugin-sdk/runtime";
import type { ChannelSetupWizardAdapter } from "@gabrielvfonseca/operator/plugin-sdk/setup";
...
export function createMatrixUpdateKeepCredentialsPrompter(params?: {
  ...
  return createMatrixWizardPrompter({
    ...
    text: {
      ...
      "Matrix device name (optional)": params?.deviceName ?? "Operator Gateway",
    },
    confirm: {
