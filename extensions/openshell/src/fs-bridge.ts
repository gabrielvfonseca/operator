...
import { root as fsRoot } from "@gabrielvfonseca/operator/plugin-sdk/file-access-runtime";
import type {
  SandboxFsBridge,
  SandboxFsStat,
  SandboxResolvedPath,
} from "@gabrielvfonseca/operator/plugin-sdk/sandbox";
import { createWritableRenameTargetResolver } from "@gabrielvfonseca/operator/plugin-sdk/sandbox";
import { FsSafeError, isPathInside } from "@gabrielvfonseca/operator/plugin-sdk/security-runtime";
...
const MATERIALIZED_SKILLS_CONTAINER_PARTS = [".operator", "sandbox-skills", "skills"] as const;
