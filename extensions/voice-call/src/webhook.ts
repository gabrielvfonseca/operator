...
import { resolveConfiguredCapabilityProvider } from "@gabrielvfonseca/operator/plugin-sdk/provider-selection-runtime";
import type { TalkEvent } from "@gabrielvfonseca/operator/plugin-sdk/realtime-voice";
import {
...
export class VoiceCallWebhookServer {
  ...
  private fullConfig: OperatorConfig | null;
  ...
  private async initializeMediaStreaming(): Promise<void> {
    ...
    const pluginConfig =
      this.fullConfig ?? (this.coreConfig as unknown as OperatorConfig | undefined);
    ...
    const resolution = resolveConfiguredCapabilityProvider({
      ...
      cfg: pluginConfig,
      cfgForResolve: pluginConfig ?? ({} as OperatorConfig),
    ...
    const streamConfig: MediaStreamConfig = {
      ...
      providerConfig,
      cfg: this.fullConfig ?? (this.coreConfig as OperatorConfig | null) ?? undefined,
