...
function mergeZaloAccountConfig(cfg: OperatorConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: OperatorConfig): ResolvedZaloAccount[] {
