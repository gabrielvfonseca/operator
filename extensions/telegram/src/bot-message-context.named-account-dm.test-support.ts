...
let clearRuntimeConfigSnapshot: typeof import("operator/plugin-sdk/runtime-config-snapshot").clearRuntimeConfigSnapshot;
let setRuntimeConfigSnapshot: typeof import("operator/plugin-sdk/runtime-config-snapshot").setRuntimeConfigSnapshot;
