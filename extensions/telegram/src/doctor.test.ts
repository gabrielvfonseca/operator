...
const DOCTOR_FIX_COMMAND = "operator doctor --fix";

async function collectPreviewWarnings(cfg: OperatorConfig, env?: NodeJS.ProcessEnv) {
...
async function repairConfig(cfg: OperatorConfig) {
