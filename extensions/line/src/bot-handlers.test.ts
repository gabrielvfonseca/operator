...
vi.mock("operator/plugin-sdk/channel-inbound", () => ({
  buildMentionRegexes: () => [],
...
vi.mock("operator/plugin-sdk/command-auth-native", () => ({
...
vi.mock("operator/plugin-sdk/runtime-group-policy", () => ({
...
describe("handleLineWebhookEvents", () => {
  ...
  afterAll(() => {
    vi.doUnmock("operator/plugin-sdk/channel-inbound");
    vi.doUnmock("operator/plugin-sdk/channel-pairing");
    vi.doUnmock("operator/plugin-sdk/command-auth-native");
    vi.doUnmock("operator/plugin-sdk/runtime-group-policy");
    vi.doUnmock("operator/plugin-sdk/runtime-env");
    vi.doUnmock("operator/plugin-sdk/reply-history");
    vi.doUnmock("operator/plugin-sdk/routing");
