...
vi.mock("operator/plugin-sdk/plugin-config-runtime", () => ({
...
vi.mock("operator/plugin-sdk/channel-activity-runtime", () => ({
...
describe("LINE send helpers", () => {
  ...
  afterAll(() => {
    ...
    vi.doUnmock("operator/plugin-sdk/channel-activity-runtime");
