...
6. Rebuild Operator and restart the gateway before doing live ACP validation.
...
- Do not rely on a globally installed `acpx` binary for Operator ACP validation.
