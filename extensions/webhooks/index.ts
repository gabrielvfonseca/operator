// Webhooks plugin entrypoint registers its Operator integration.
...
function registerWebhookRoutes(api: OperatorPluginApi): void {
...
export default definePluginEntry({
  ...
  name: "Webhooks",
  description:
    "Authenticated inbound webhooks that bind external automation to Operator TaskFlows.",
