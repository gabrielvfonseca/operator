...
import { getImageMetadata } from "@gabrielvfonseca/operator/plugin-sdk/media-runtime";
import { createSolidPngBuffer } from "@gabrielvfonseca/operator/plugin-sdk/test-fixtures";
