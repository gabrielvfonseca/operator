...
export function applyOpencodeZenProviderConfig(cfg: OperatorConfig): OperatorConfig {
  return {
    ...cfg,
    agents: {
      ...cfg.agents,
...
export function applyOpencodeZenConfig(cfg: OperatorConfig): OperatorConfig {
