...
import type { OperatorConfig as RuntimeOperatorConfig } from "openclaw/plugin-sdk/config-contracts";
export type { RuntimeOperatorConfig as OperatorConfig };
export type { OperatorPluginApi, PluginRuntime } from "openclaw/plugin-sdk/core";
