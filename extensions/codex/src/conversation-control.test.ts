...
import { clearRuntimeAuthProfileStoreSnapshots } from "@gabrielvfonseca/operator/plugin-sdk/agent-runtime";
...
describe("codex conversation controls", () => {
  beforeEach(async () => {
    resetCodexTestBindingStore();
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "operator-codex-control-"));
