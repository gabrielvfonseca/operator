/**
 * Resolves Codex filesystem sandbox policy payloads into Operator path/glob
...
function readFsSandboxCwd(execServer: OperatorExecServer, sandbox: JsonObject): string {
