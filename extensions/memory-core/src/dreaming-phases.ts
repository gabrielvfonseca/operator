...
import { truncateUtf16Safe } from "operator/plugin-sdk/memory-core-host-engine-foundation";
import {
  buildSessionEntry,
...
import { appendRegularFile } from "operator/plugin-sdk/security-runtime";
import { normalizeStringEntries, uniqueStrings } from "operator/plugin-sdk/string-coerce-runtime";
...
type Logger = Pick<OperatorPluginApi["logger"], "info" | "warn" | "error">;
...
const MANAGED_DAILY_DREAMING_BLOCKS = [
  {
    heading: "## Light Sleep",
    startMarker: "<!-- operator:dreaming:light:start -->",
    endMarker: "<!-- operator:dreaming:light:end -->",
  },
  {
    heading: "## REM Sleep",
    startMarker: "<!-- operator:dreaming:rem:start -->",
    endMarker: "<!-- operator:dreaming:rem:end -->",
  },
] as const;
