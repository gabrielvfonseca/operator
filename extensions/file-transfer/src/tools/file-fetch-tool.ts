...
import type { AnyAgentTool } from "@gabrielvfonseca/operator/plugin-sdk/agent-harness-runtime";
...
import { wrapExternalContent } from "@gabrielvfonseca/operator/plugin-sdk/security-runtime";
