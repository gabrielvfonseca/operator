...
import type { ChannelOutboundPayloadHint } from "@gabrielvfonseca/operator/plugin-sdk/channel-contract";
...
function resolveDiscordOwnerApprovers(cfg: OperatorConfig): string[] {
