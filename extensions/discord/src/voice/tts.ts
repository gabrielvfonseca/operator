...
import type { OperatorConfig, TtsConfig } from "openclaw/plugin-sdk/config-contracts";
...
function resolveVoiceTtsConfig(params: { cfg: OperatorConfig; override?: TtsConfig }): {
  cfg: OperatorConfig;
