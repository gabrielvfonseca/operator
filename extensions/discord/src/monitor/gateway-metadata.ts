...
import { captureHttpExchange } from "@gabrielvfonseca/operator/plugin-sdk/proxy-capture";
...
const DISCORD_GATEWAY_INFO_TIMEOUT_ENV = "OPERATOR_DISCORD_GATEWAY_INFO_TIMEOUT_MS";
