...
import type { CommandArgs } from "@gabrielvfonseca/operator/plugin-sdk/command-auth-native";
import { finalizeInboundContext } from "@gabrielvfonseca/operator/plugin-sdk/reply-dispatch-runtime";
