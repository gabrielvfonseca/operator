...
import type { DiscordActionConfig } from "@gabrielvfonseca/operator/plugin-sdk/config-contracts";
...
function discordAllowlistCfg(guilds: Record<string, unknown>): OperatorConfig {
  return {
    channels: {
      discord: {
        token: "token",
...
function handleMessagingAction(
  ...
  cfg: OperatorConfig = DISCORD_TEST_CFG,
  options?: {
    mediaAccess?: {
