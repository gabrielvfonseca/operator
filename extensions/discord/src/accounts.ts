...
import type { DiscordAccountConfig, DiscordActionConfig, OperatorConfig } from "./runtime-api.js";
...
export function listEnabledDiscordAccounts(cfg: OperatorConfig): ResolvedDiscordAccount[] {
