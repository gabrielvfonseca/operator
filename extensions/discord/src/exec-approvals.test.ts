...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<OperatorConfig["channels"]>["discord"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<OperatorConfig["channels"]>["discord"]>>,
): OperatorConfig {
  return {
    channels: {
      discord: {
