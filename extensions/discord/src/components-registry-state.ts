import { resolveGlobalMap } from "@gabrielvfonseca/operator/plugin-sdk/global-singleton";
...
export const discordComponentRegistryState = {
  componentEntries: resolveGlobalMap<string, DiscordComponentEntry>(
    Symbol.for("operator.discord.componentEntries"),
  ),
  modalEntries: resolveGlobalMap<string, DiscordModalEntry>(
    Symbol.for("operator.discord.modalEntries"),
  ),
