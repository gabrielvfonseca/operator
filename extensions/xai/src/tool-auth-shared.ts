...
function readLegacyGrokFallbackAuth(cfg?: OperatorConfig): XaiFallbackAuth | undefined {
...
function readLegacyGrokApiKeyResult(cfg?: OperatorConfig): ConfiguredRuntimeApiKeyResolution {
  const search = cfg?.tools?.web?.search;
  if (!search || typeof search !== "object") {
    return { status: "missing" };
  }
...
export function resolveFallbackXaiAuth(cfg?: OperatorConfig): XaiFallbackAuth | undefined {
