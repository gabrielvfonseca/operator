...
function resolveLegacyXSearchConfig(config?: OperatorConfig): JsonRecord | undefined {
...
function resolvePluginXSearchConfig(config?: OperatorConfig): JsonRecord | undefined {
...
function resolveLegacyGrokWebSearchConfig(config?: OperatorConfig): JsonRecord | undefined {
  const web = config?.tools?.web as Record<string, unknown> | undefined;
...
function resolvePluginWebSearchConfig(config?: OperatorConfig): JsonRecord | undefined {
  const pluginConfig = config?.plugins?.entries?.xai?.config;
...
export function resolveEffectiveXSearchConfig(config?: OperatorConfig): JsonRecord | undefined {
