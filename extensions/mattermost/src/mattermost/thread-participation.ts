...
import { createPersistentDedupeCache } from "@gabrielvfonseca/operator/plugin-sdk/dedupe-runtime";
 ...
 */
const MATTERMOST_THREAD_PARTICIPATION_KEY = Symbol.for("operator.mattermostThreadParticipation");
