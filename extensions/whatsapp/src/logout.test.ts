...
describe("web logout", () => {
  ...
  it("does not delete through symlinked auth dirs inside the Operator auth root", async () => {
  ...
  it("does not delete through intermediate symlinks inside the Operator auth root", async () => {
