...
import { normalizeOptionalAccountId } from "@gabrielvfonseca/operator/plugin-sdk/account-core";
...
function resolveQuoteLookupAccountId(cfg?: OperatorConfig, accountId?: string | null): string {
