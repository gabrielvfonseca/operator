...
import { clamp } from "@gabrielvfonseca/operator/plugin-sdk/text-utility-runtime";
...
export function resolveHeartbeatSeconds(cfg: OperatorConfig, overrideSeconds?: number): number {
