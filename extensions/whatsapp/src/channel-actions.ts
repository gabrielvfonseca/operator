...
function areWhatsAppAgentReactionsEnabled(params: { cfg: OperatorConfig; accountId?: string }) {
...
function hasAnyWhatsAppAccountWithAgentReactionsEnabled(cfg: OperatorConfig) {
