import type { NormalizedLocation } from "@gabrielvfonseca/operator/plugin-sdk/channel-inbound";
import type { PollInput } from "@gabrielvfonseca/operator/plugin-sdk/poll-runtime";
