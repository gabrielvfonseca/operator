...
import { buildOpenAICompletionsParams } from "@gabrielvfonseca/operator/plugin-sdk/provider-transport-runtime";
...
function readManifest(): StepFunManifest {
  return JSON.parse(readFileSync(resolve(import.meta.dirname, "operator.plugin.json"), "utf-8"));
}
