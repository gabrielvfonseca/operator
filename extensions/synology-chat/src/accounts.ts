...
import { resolveDangerousNameMatchingEnabled } from "@gabrielvfonseca/operator/plugin-sdk/dangerous-name-runtime";
...
/** Extract the channel config from the full Operator config object. */
function getChannelConfig(cfg: OperatorConfig): SynologyChatChannelConfig | undefined {
 ...
 */
export function listAccountIds(cfg: OperatorConfig): string[] {
...
export function resolveAccount(
  ...
  const envBotName = process.env.OPERATOR_BOT_NAME ?? "Operator";
