/**
 * Synology Chat Channel Plugin for Operator.
 *
...
import type { ChannelOutboundAdapter } from "@gabrielvfonseca/operator/plugin-sdk/channel-contract";
import {
  createChatChannelPlugin,
  type ChannelPlugin,
} from "@gabrielvfonseca/operator/plugin-sdk/channel-core";
import { waitUntilAbort } from "@gabrielvfonseca/operator/plugin-sdk/channel-outbound";
import {
...
const resolveSynologyChatDmPolicy = createScopedDmSecurityResolver<ResolvedSynologyChatAccount>({
  ...
  approveHint: "operator pairing approve synology-chat <code>",
...
> & {
  pairing: {
    ...
    notifyApproval: (params: { cfg: OperatorConfig; id: string }) => Promise<void>;
  };
  security: {
    resolveDmPolicy: (params: { cfg: OperatorConfig; account: ResolvedSynologyChatAccount }) => {
  ...
  return createChatChannelPlugin({
    base: {
      ...
      meta: {
        ...
        blurb: "Connect your Synology NAS Chat to Operator",
        order: 90,
      },
      capabilities: {
    ...
    pairing: {
      text: {
        ...
        message: "Operator: your access has been approved.",
