...
export const WIKI_RELATED_START_MARKER = "<!-- operator:wiki:related:start -->";
export const WIKI_RELATED_END_MARKER = "<!-- operator:wiki:related:end -->";
export const WIKI_RAW_SOURCE_MARKER = "<!-- operator:wiki:raw-source -->";
...
const HUMAN_START_MARKER = "<!-- operator:human:start -->";
const HUMAN_END_MARKER = "<!-- operator:human:end -->";
