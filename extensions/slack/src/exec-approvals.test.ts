...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<OperatorConfig["channels"]>["slack"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<OperatorConfig["channels"]>["slack"]>>,
): OperatorConfig {
  return {
    channels: {
      slack: {
