...
import { generateSecureToken } from "@gabrielvfonseca/operator/plugin-sdk/secure-random-runtime";
...
export const SLACK_EXTERNAL_ARG_MENU_PREFIX = "operator_cmdarg_ext:";
