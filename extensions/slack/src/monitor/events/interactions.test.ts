...
describe("registerSlackInteractionEvents", () => {
        ...
        message: {
          ...
          blocks: [
            ...
            },
            {
              ...
              elements: [{ type: "button", action_id: "operator:verify" }],
            },
          ],
        },
      },
  ...
  it("registers a matcher that accepts plugin action ids beyond the Operator prefix", () => {
    const { ctx, getActionMatcher } = createContext();
    registerSlackInteractionEvents({ ctx: ctx as never });

    const matcher = getActionMatcher();
    expect(matcher.test("operator:verify")).toBe(true);
  ...
  it("treats Slack reply buttons as plain interaction events instead of plugin dispatch", async () => {
          ...
          blocks: [
            {
              ...
              elements: [{ type: "button", action_id: "operator:reply_button" }],
            },
          ],
        },
      },
    ...
    const eventText = mockCallArg(enqueueSystemEventMock, 0, "enqueueSystemEvent");
    expect(eventText).toContain('"actionId":"operator:reply_button"');
    expectRecordFields(
      requireRecord(
      ...
      {
        contextKey: "slack:interaction:C1:100.200:operator:reply_button",
        deliveryContext: {
          accountId: "default",
          channel: "slack",
          threadId: "100.100",
  ...
  it("resolves typed exec approvals from Slack-private action data", async () => {
    ...
    await handler({
          ...
          blocks: [
            {
              ...
              elements: [
                { type: "button", action_id: "operator:approval_button:1:1" },
                { type: "button", action_id: "operator:reply_button" },
              ],
            },
          ],
        },
      ...
      action: {
        ...
        block_id: "exec_actions",
        value:
          'operator:approval:v1:{"approvalId":"plugin:looks-plugin","approvalKind":"exec","decision":"allow-once"}',
        text: { type: "plain_text", text: "Allow once" },
      },
    });
  ...
  it("cleans stale typed buttons and shows the canonical first-answer winner", async () => {
    ...
    await getHandler()({
        ...
        message: {
          ...
          blocks: [
            ...
            { type: "section", text: { type: "mrkdwn", text: "Command preview" } },
            {
              ...
              elements: [
                { type: "button", action_id: "operator:approval_button:1:1" },
                { type: "button", action_id: "operator:approval_button:1:2" },
              ],
            },
          ],
        },
      ...
      action: {
        ...
        block_id: "exec_actions",
        value:
          'operator:approval:v1:{"approvalId":"req-123","approvalKind":"exec","decision":"allow-once"}',
        text: { type: "plain_text", text: "Allow once" },
      },
    });
  ...
  it("fails closed for malformed Slack approval envelopes", async () => {
    ...
    await getHandler()({
      ...
      action: {
        ...
        action_id: "operator:approval_button:1:1",
        block_id: "exec_actions",
        value: 'operator:approval:v1:{"approvalId":"req-123","decision":"allow-once"}',
        text: { type: "plain_text", text: "Allow once" },
      },
    });
  ...
  it("uses the typed plugin kind for unprefixed approval ids", async () => {
    ...
    await handler({
          ...
          blocks: [
            {
              ...
              elements: [{ type: "button", action_id: "operator:approval_button:1:1" }],
            },
          ],
        },
      },
      action: {
        ...
        block_id: "plugin_actions",
        value:
          'operator:approval:v1:{"approvalId":"req-123","approvalKind":"plugin","decision":"allow-always"}',
  ...
  it.each([
    { name: "current", actionId: "operator:reply_link:1:1", value: undefined },
    {
      name: "legacy",
      actionId: "operator:reply_button:1:1",
  ...
  it("drops modal lifecycle payloads when mismatch guard triggers", async () => {
    ...
    await viewHandler({
      ...
      body: {
        ...
        view: {
          id: "V123",
          callback_id: "operator:deploy_form",
          ...
          blocks: [
            {
              ...
              elements: [{ type: "multi_static_select", action_id: "operator:multi" }],
            },
          ],
        },
      },
          ...
          blocks: [
            {
              type: "actions",
              block_id: "date_block",
              elements: [{ type: "datepicker", action_id: "operator:date" }],
            },
            {
              type: "actions",
              block_id: "time_block",
              elements: [{ type: "timepicker", action_id: "operator:time" }],
            },
            {
              type: "actions",
              block_id: "datetime_block",
              elements: [{ type: "datetimepicker", action_id: "operator:datetime" }],
            },
          ],
        },
      },
      ...
      blocks: [
        {
          ...
          elements: [
            {
              type: "mrkdwn",
              text: ":white_check_mark: *operator:datetime* selected by <@U333>",
            },
          ],
        },
      ],
  ...
  it("captures modal submissions and enqueues view submission event", async () => {
    ...
    expectRecordFields(payload as unknown as Record<string, unknown>, {
      ...
      actionId: "view:operator:deploy_form",
      callbackId: "operator:deploy_form",
      viewId: "V123",
      userId: "U777",
  ...
  it("dispatches plugin-owned modal submissions with full view state before compacting events", async () => {
    ...
    await viewHandler({
      ...
      body: {
        ...
        view: {
          id: "V777",
          callback_id: "operator:contract_confirm_hearing",
          private_metadata: JSON.stringify({
            channelId: "D777",
            channelType: "im",
            userId: "U777",
    ...
    expectRecordFields(requireRecord(dispatchCall, "dispatch call"), {
      ...
      dedupeId: "view_submission:operator:contract_confirm_hearing:V777:U777",
    });
    ...
    expectRecordFields(interaction, {
      ...
      namespace: "dean.contract",
      payload: "confirm_hearing",
      callbackId: "operator:contract_confirm_hearing",
      viewId: "V777",
  ...
  it("dispatches callback-id-only plugin modal submissions without agent routing metadata", async () => {
    ...
    await viewHandler({
      ...
      body: {
        ...
        view: {
          id: "V778",
          callback_id: "operator:dean.contract:confirm_hearing",
          state: {
            values: {
              contract: {
    ...
    expectRecordFields(requireRecord(dispatchCall, "dispatch call"), {
      channel: "slack",
      data: "dean.contract:confirm_hearing",
      dedupeId: "view_submission:operator:dean.contract:confirm_hearing:V778:U777",
    });
    ...
    expectRecordFields(requireRecord(registrationCtx.interaction, "registration interaction"), {
      ...
      namespace: "dean.contract",
      payload: "confirm_hearing",
      callbackId: "operator:dean.contract:confirm_hearing",
      viewId: "V778",
    });
    expect(enqueueSystemEventMock).not.toHaveBeenCalled();
  });
  ...
  it("keeps no-channel modal events open when allowFrom is unset", async () => {
    ...
    await viewHandler({
      ...
      body: {
        ...
        view: {
          id: "V444",
          callback_id: "operator:routing_form",
  ...
  it("captures modal input labels and picker values across block types", async () => {
            ...
            values: {
              ...
              email_block: {
                email_input: {
                  ...
                  value: "team@operator.ai",
                },
              },
              url_block: {
                url_input: {
                  type: "url_text_input",
                  value: "https://docs.operator.ai",
                },
              },
              richtext_block: {
                richtext_input: {
    ...
    expectRecordFields(inputByActionId(inputs, "email_input"), {
      inputKind: "email",
      inputEmail: "team@operator.ai",
    });
    expectRecordFields(inputByActionId(inputs, "url_input"), {
      inputKind: "url",
      inputUrl: "https://docs.operator.ai/",
    });
  ...
  it("truncates rich text preview to keep payload summaries compact", async () => {
    ...
    await viewHandler({
      ...
      body: {
        ...
        view: {
          id: "V555",
          callback_id: "operator:long_richtext",
