...
function enableSlackAccount(cfg: OperatorConfig, accountId: string): OperatorConfig {
...
function hasSlackInteractiveRepliesConfig(cfg: OperatorConfig, accountId: string): boolean {
...
function createSlackTokenCredential(params: {
  ...
  return {
    ...
    applyUseEnv: ({ cfg, accountId }: { cfg: OperatorConfig; accountId: string }) =>
