...
} from "@gabrielvfonseca/operator/plugin-sdk/provider-transport-runtime";
import {
...
type GoogleTransportApi = CanonicalGoogleTransportApi | "operator-google-generative-ai-transport";
...
function normalizeGoogleTransportRouteApi(
  ...
  switch (api) {
    ...
    case "operator-google-generative-ai-transport":
