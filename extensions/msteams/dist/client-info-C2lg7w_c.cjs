...
//#endregion
Object.defineProperty(exports, "GATEWAY_CLIENT_CAPS", {
	enumerable: true,
	get: function() {
		return GATEWAY_CLIENT_CAPS;
	}
});
Object.defineProperty(exports, "GATEWAY_CLIENT_IDS", {
	enumerable: true,
	get: function() {
		return GATEWAY_CLIENT_IDS;
	}
});
Object.defineProperty(exports, "GATEWAY_CLIENT_MODES", {
	enumerable: true,
	get: function() {
		return GATEWAY_CLIENT_MODES;
	}
});
Object.defineProperty(exports, "GATEWAY_CLIENT_NAMES", {
	enumerable: true,
	get: function() {
		return GATEWAY_CLIENT_NAMES;
	}
});
Object.defineProperty(exports, "hasGatewayClientCap", {
	enumerable: true,
	get: function() {
		return hasGatewayClientCap;
	}
});
Object.defineProperty(exports, "normalizeGatewayClientId", {
	enumerable: true,
	get: function() {
		return normalizeGatewayClientId;
	}
});
Object.defineProperty(exports, "normalizeGatewayClientMode", {
	enumerable: true,
	get: function() {
		return normalizeGatewayClientMode;
	}
});
Object.defineProperty(exports, "normalizeGatewayClientName", {
	enumerable: true,
	get: function() {
		return normalizeGatewayClientName;
	}
});
