...
function normalizeAccountId(value) {
	return require_account_id.normalizeOptionalAccountId(value);
}
//#endregion
...
function normalizeDeliveryContext(context) {
	if (!context) return;
	const route = require_channel_route.normalizeChannelRouteTarget({
		channel: typeof context.channel === "string" ? require_message_channel_core.normalizeMessageChannel(context.channel) ?? context.channel.trim() : void 0,
		to: context.to,
	...
	const normalized = {
		...
		to: require_channel_route.channelRouteTarget(route),
		accountId: normalizeAccountId(route.accountId)
	};
	const threadId = require_channel_route.channelRouteThreadId(route);
...
function deliveryContextFromChannelRoute(route) {
	...
	return normalizeDeliveryContext({
		...
		to: require_channel_route.channelRouteTarget(normalized),
		accountId: normalized?.accountId,
		threadId: require_channel_route.channelRouteThreadId(normalized)
	});
}
...
function channelRouteFromDeliveryContext(context) {
	return require_channel_route.normalizeChannelRouteTarget(normalizeDeliveryContext(context));
}
...
function isInternalRouteContext(context) {
	...
	return Boolean(channel && (channel === "webchat" || require_message_channel_core.isInternalNonDeliveryChannel(channel)));
}
function hasExternalDeliveryTarget(context) {
	const channel = require_message_channel_core.normalizeMessageChannel(context?.channel);
	return Boolean(channel && !require_message_channel_core.isInternalNonDeliveryChannel(channel) && require_message_channel_core.isDeliverableMessageChannel(channel) && context?.to);
}
...
function deliveryContextKey(context) {
	return require_channel_route.channelRouteCompactKey(normalizeDeliveryContext(context));
}
//#endregion
Object.defineProperty(exports, "deliveryContextFromChannelRoute", {
	enumerable: true,
	get: function() {
		return deliveryContextFromChannelRoute;
	}
});
Object.defineProperty(exports, "deliveryContextFromSession", {
	enumerable: true,
	get: function() {
		return deliveryContextFromSession;
	}
});
Object.defineProperty(exports, "deliveryContextKey", {
	enumerable: true,
	get: function() {
		return deliveryContextKey;
	}
});
Object.defineProperty(exports, "mergeDeliveryContext", {
	enumerable: true,
	get: function() {
		return mergeDeliveryContext;
	}
});
Object.defineProperty(exports, "normalizeAccountId", {
	enumerable: true,
	get: function() {
		return normalizeAccountId;
	}
});
Object.defineProperty(exports, "normalizeDeliveryChannelRoute", {
	enumerable: true,
	get: function() {
		return normalizeDeliveryChannelRoute;
	}
});
Object.defineProperty(exports, "normalizeDeliveryContext", {
	enumerable: true,
	get: function() {
		return normalizeDeliveryContext;
	}
});
Object.defineProperty(exports, "normalizeSessionDeliveryFields", {
	enumerable: true,
	get: function() {
		return normalizeSessionDeliveryFields;
	}
