...
const log = require_subsystem.createSubsystemLogger("gateway/health-monitor");
...
function startChannelHealthMonitor(deps) {
	...
	const checkIntervalMs = (0, require_number_coercion.number_coercion_exports.resolveTimerTimeoutMs)(deps.checkIntervalMs, DEFAULT_CHECK_INTERVAL_MS);
		...
		try {
			...
			for (const [channelId, accounts] of Object.entries(snapshot.channelAccounts)) {
				...
				for (const [accountId, status] of Object.entries(accounts)) {
					...
					const health = require_channel_health_policy.evaluateChannelHealth(status, {
						channelId,
						now,
					...
					const reason = require_channel_health_policy.resolveChannelRestartReason(status, health);
...
var server_runtime_startup_services_exports = /* @__PURE__ */ require_rolldown_runtime.__exportAll({
	startGatewayChannelHealthMonitor: () => startGatewayChannelHealthMonitor,
	startGatewayRuntimeServices: () => startGatewayRuntimeServices
});
...
function startGatewayChannelHealthMonitor(params) {
	...
	return startChannelHealthMonitor({
		...
		...staleEventThresholdMinutes != null && { timing: { staleEventThresholdMs: staleEventThresholdMinutes * 6e4 } },
...
//#endregion
Object.defineProperty(exports, "createNoopHeartbeatRunner", {
	enumerable: true,
	get: function() {
		return createNoopHeartbeatRunner;
	}
});
Object.defineProperty(exports, "server_runtime_startup_services_exports", {
	enumerable: true,
	get: function() {
		return server_runtime_startup_services_exports;
	}
});
Object.defineProperty(exports, "startGatewayChannelHealthMonitor", {
	enumerable: true,
	get: function() {
		return startGatewayChannelHealthMonitor;
	}
});
Object.defineProperty(exports, "startGatewayRuntimeServices", {
	enumerable: true,
	get: function() {
		return startGatewayRuntimeServices;
	}
});
