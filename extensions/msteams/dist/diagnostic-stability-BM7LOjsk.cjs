...
function getDiagnosticStabilityState() {
	...
	globalStore["__operatorDiagnosticStabilityState"] ??= createState();
	return globalStore["__operatorDiagnosticStabilityState"];
}
...
function startDiagnosticStabilityRecorder() {
	...
	state.unsubscribe = require_diagnostic_events.onDiagnosticEvent((event) => {
...
//#endregion
Object.defineProperty(exports, "MAX_DIAGNOSTIC_STABILITY_LIMIT", {
	enumerable: true,
	get: function() {
		return MAX_DIAGNOSTIC_STABILITY_LIMIT;
	}
});
Object.defineProperty(exports, "getDiagnosticStabilitySnapshot", {
	enumerable: true,
	get: function() {
		return getDiagnosticStabilitySnapshot;
	}
});
Object.defineProperty(exports, "normalizeDiagnosticStabilityQuery", {
	enumerable: true,
	get: function() {
		return normalizeDiagnosticStabilityQuery;
	}
});
Object.defineProperty(exports, "startDiagnosticStabilityRecorder", {
	enumerable: true,
	get: function() {
		return startDiagnosticStabilityRecorder;
	}
});
Object.defineProperty(exports, "stopDiagnosticStabilityRecorder", {
	enumerable: true,
	get: function() {
