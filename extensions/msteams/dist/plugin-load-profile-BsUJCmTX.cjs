...
*
* The same `OPERATOR_PLUGIN_LOAD_PROFILE=1` env flag activates all probes.
*
...
function shouldProfilePluginLoader() {
	return process.env.OPERATOR_PLUGIN_LOAD_PROFILE === "1";
}
/**
...
//#endregion
Object.defineProperty(exports, "createProfiler", {
	enumerable: true,
	get: function() {
		return createProfiler;
	}
});
Object.defineProperty(exports, "formatPluginLoadProfileLine", {
	enumerable: true,
	get: function() {
		return formatPluginLoadProfileLine;
	}
});
Object.defineProperty(exports, "shouldProfilePluginLoader", {
	enumerable: true,
	get: function() {
		return shouldProfilePluginLoader;
	}
});
Object.defineProperty(exports, "withProfile", {
	enumerable: true,
	get: function() {
		return withProfile;
	}
