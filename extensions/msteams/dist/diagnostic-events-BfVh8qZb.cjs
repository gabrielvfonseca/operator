...
const DIAGNOSTIC_TRACE_SCOPE_STATE_KEY = Symbol.for("operator.diagnosticTraceScope.state.v1");
...
function isDiagnosticTraceScopeState(value) {
	...
	return candidate.marker === DIAGNOSTIC_TRACE_SCOPE_STATE_KEY && candidate.storage instanceof node_async_hooks.AsyncLocalStorage;
}
...
function parseDiagnosticTraceparent(traceparent) {
	...
	if (!TRACEPARENT_VERSION_RE.test((0, _gabrielvfonseca_normalization_core.expectDefined)(version, "diagnostic trace context version")) || version === "ff" || version === TRACEPARENT_VERSION && parts.length !== 4) return;
...
function emitTrustedSecurityEvent(event) {
	emitDiagnosticEventWithTrust({
		type: "security.event",
		...event,
		eventId: event.eventId ?? (0, node_crypto.randomUUID)()
...
//#endregion
Object.defineProperty(exports, "areDiagnosticsEnabledForProcess", {
	enumerable: true,
	get: function() {
		return areDiagnosticsEnabledForProcess;
	}
});
Object.defineProperty(exports, "createChildDiagnosticTraceContext", {
	enumerable: true,
	get: function() {
		return createChildDiagnosticTraceContext;
	}
});
Object.defineProperty(exports, "createDiagnosticTraceContext", {
	enumerable: true,
	get: function() {
		return createDiagnosticTraceContext;
	}
});
Object.defineProperty(exports, "createDiagnosticTraceContextFromActiveScope", {
	enumerable: true,
	get: function() {
		return createDiagnosticTraceContextFromActiveScope;
	}
});
Object.defineProperty(exports, "emitDiagnosticEvent", {
	enumerable: true,
	get: function() {
		return emitDiagnosticEvent;
	}
});
Object.defineProperty(exports, "emitDiagnosticEventWithTrustedTraceContext", {
	enumerable: true,
	get: function() {
		return emitDiagnosticEventWithTrustedTraceContext;
	}
});
Object.defineProperty(exports, "emitFailoverEvent", {
	enumerable: true,
	get: function() {
		return emitFailoverEvent;
	}
});
Object.defineProperty(exports, "emitInternalDiagnosticEvent", {
	enumerable: true,
	get: function() {
		return emitInternalDiagnosticEvent;
	}
});
Object.defineProperty(exports, "emitTrustedDiagnosticEvent", {
	enumerable: true,
	get: function() {
		return emitTrustedDiagnosticEvent;
	}
});
Object.defineProperty(exports, "emitTrustedDiagnosticEventWithPrivateData", {
	enumerable: true,
	get: function() {
		return emitTrustedDiagnosticEventWithPrivateData;
	}
});
Object.defineProperty(exports, "emitTrustedSecurityEvent", {
	enumerable: true,
	get: function() {
		return emitTrustedSecurityEvent;
	}
});
Object.defineProperty(exports, "emitTrustedSkillUsedDiagnosticEvent", {
	enumerable: true,
	get: function() {
		return emitTrustedSkillUsedDiagnosticEvent;
	}
});
Object.defineProperty(exports, "formatDiagnosticTraceparent", {
	enumerable: true,
	get: function() {
		return formatDiagnosticTraceparent;
	}
});
Object.defineProperty(exports, "freezeDiagnosticTraceContext", {
	enumerable: true,
	get: function() {
		return freezeDiagnosticTraceContext;
	}
});
Object.defineProperty(exports, "getActiveDiagnosticTraceContext", {
	enumerable: true,
	get: function() {
		return getActiveDiagnosticTraceContext;
	}
});
Object.defineProperty(exports, "getInternalDiagnosticEventSequence", {
	enumerable: true,
	get: function() {
		return getInternalDiagnosticEventSequence;
	}
});
Object.defineProperty(exports, "isDiagnosticsEnabled", {
	enumerable: true,
	get: function() {
		return isDiagnosticsEnabled;
	}
});
Object.defineProperty(exports, "isValidDiagnosticSpanId", {
	enumerable: true,
	get: function() {
		return isValidDiagnosticSpanId;
	}
});
Object.defineProperty(exports, "isValidDiagnosticTraceFlags", {
	enumerable: true,
	get: function() {
		return isValidDiagnosticTraceFlags;
	}
});
Object.defineProperty(exports, "isValidDiagnosticTraceId", {
	enumerable: true,
	get: function() {
		return isValidDiagnosticTraceId;
	}
});
Object.defineProperty(exports, "onDiagnosticEvent", {
	enumerable: true,
	get: function() {
		return onDiagnosticEvent;
	}
});
Object.defineProperty(exports, "onInternalDiagnosticEvent", {
	enumerable: true,
	get: function() {
		return onInternalDiagnosticEvent;
	}
});
Object.defineProperty(exports, "onTrustedInternalDiagnosticEvent", {
	enumerable: true,
	get: function() {
		return onTrustedInternalDiagnosticEvent;
	}
});
Object.defineProperty(exports, "onTrustedToolExecutionEvent", {
	enumerable: true,
	get: function() {
		return onTrustedToolExecutionEvent;
	}
});
Object.defineProperty(exports, "runWithDiagnosticTraceContext", {
	enumerable: true,
	get: function() {
		return runWithDiagnosticTraceContext;
	}
});
Object.defineProperty(exports, "setDiagnosticsEnabledForProcess", {
	enumerable: true,
	get: function() {
		return setDiagnosticsEnabledForProcess;
	}
});
