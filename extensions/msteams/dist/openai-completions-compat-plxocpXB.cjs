...
if (process.env.VITEST || false) globalThis[Symbol.for("operator.openAICompletionsCompatTestApi")] = { resolveOpenAICompletionsCompatDefaults };
//#endregion
Object.defineProperty(exports, "detectOpenAICompletionsCompat", {
	enumerable: true,
	get: function() {
