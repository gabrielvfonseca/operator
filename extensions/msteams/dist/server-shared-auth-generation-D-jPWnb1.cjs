...
function enforceSharedGatewaySessionGenerationForConfigWrite(params) {
	const reloadMode = require_config_reload_settings.resolveGatewayReloadSettings(params.nextConfig).mode;
...
//#endregion
Object.defineProperty(exports, "captureSharedGatewaySessionGenerationOwnership", {
	enumerable: true,
	get: function() {
		return captureSharedGatewaySessionGenerationOwnership;
	}
});
Object.defineProperty(exports, "claimSharedGatewaySessionGenerationIfOwned", {
	enumerable: true,
	get: function() {
		return claimSharedGatewaySessionGenerationIfOwned;
	}
});
Object.defineProperty(exports, "disconnectAllSharedGatewayAuthClients", {
	enumerable: true,
	get: function() {
		return disconnectAllSharedGatewayAuthClients;
	}
});
Object.defineProperty(exports, "disconnectStaleSharedGatewayAuthClients", {
	enumerable: true,
	get: function() {
		return disconnectStaleSharedGatewayAuthClients;
	}
});
Object.defineProperty(exports, "enforceSharedGatewaySessionGenerationForConfigWrite", {
	enumerable: true,
	get: function() {
		return enforceSharedGatewaySessionGenerationForConfigWrite;
	}
});
Object.defineProperty(exports, "finalizeOwnedSharedGatewaySessionGeneration", {
	enumerable: true,
	get: function() {
		return finalizeOwnedSharedGatewaySessionGeneration;
	}
});
Object.defineProperty(exports, "getRequiredSharedGatewaySessionGeneration", {
	enumerable: true,
	get: function() {
		return getRequiredSharedGatewaySessionGeneration;
	}
});
Object.defineProperty(exports, "isSharedGatewaySessionGenerationOwnershipCurrent", {
	enumerable: true,
	get: function() {
		return isSharedGatewaySessionGenerationOwnershipCurrent;
	}
});
Object.defineProperty(exports, "replaceOwnedSharedGatewaySessionGenerationState", {
	enumerable: true,
	get: function() {
		return replaceOwnedSharedGatewaySessionGenerationState;
	}
});
Object.defineProperty(exports, "restoreOwnedCurrentSharedGatewaySessionGeneration", {
	enumerable: true,
	get: function() {
		return restoreOwnedCurrentSharedGatewaySessionGeneration;
	}
});
Object.defineProperty(exports, "setRequiredSharedGatewaySessionGenerationIfOwned", {
	enumerable: true,
	get: function() {
		return setRequiredSharedGatewaySessionGenerationIfOwned;
	}
});
