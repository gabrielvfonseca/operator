...
function registerDiagnosticRunActivityListener() {
	...
	unregisterDiagnosticRunActivityListener = require_diagnostic_events.onInternalDiagnosticEvent((event) => {
		switch (event.type) {
...
if (process.env.VITEST || false) globalThis[Symbol.for("operator.diagnosticRunActivityTestApi")] = {
	markDiagnosticModelStartedForTest,
	markDiagnosticRunProgressForTest,
	markDiagnosticToolStartedForTest
};
//#endregion
Object.defineProperty(exports, "BLOCKED_TOOL_CALL_ABORT_FLOOR_MS", {
	enumerable: true,
	get: function() {
		return BLOCKED_TOOL_CALL_ABORT_FLOOR_MS;
	}
});
Object.defineProperty(exports, "RUN_STALE_TAKEOVER_MS", {
	enumerable: true,
	get: function() {
		return RUN_STALE_TAKEOVER_MS;
	}
});
Object.defineProperty(exports, "clearDiagnosticEmbeddedRunActivityForSession", {
	enumerable: true,
	get: function() {
		return clearDiagnosticEmbeddedRunActivityForSession;
	}
});
Object.defineProperty(exports, "getDiagnosticEmbeddedRunActivitySequence", {
	enumerable: true,
	get: function() {
		return getDiagnosticEmbeddedRunActivitySequence;
	}
});
Object.defineProperty(exports, "getDiagnosticSessionActivitySnapshot", {
	enumerable: true,
	get: function() {
		return getDiagnosticSessionActivitySnapshot;
	}
});
Object.defineProperty(exports, "markDiagnosticEmbeddedRunEnded", {
	enumerable: true,
	get: function() {
		return markDiagnosticEmbeddedRunEnded;
	}
});
Object.defineProperty(exports, "markDiagnosticEmbeddedRunStarted", {
	enumerable: true,
	get: function() {
		return markDiagnosticEmbeddedRunStarted;
	}
});
Object.defineProperty(exports, "markDiagnosticRunProgress", {
	enumerable: true,
	get: function() {
		return markDiagnosticRunProgress;
	}
});
Object.defineProperty(exports, "resolveRunStaleThresholdMs", {
	enumerable: true,
	get: function() {
		return resolveRunStaleThresholdMs;
	}
});
