...
function normalizeRateLimitClientIp(ip) {
	...
	return require_net.resolveClientIp({ remoteAddr: ip }) ?? "unknown";
}
...
function resolvePruneIntervalMs(value) {
	...
	return (0, require_number_coercion.number_coercion_exports.resolveTimerTimeoutMs)(value, PRUNE_INTERVAL_MS);
}
function createAuthRateLimiter(config) {
	const maxAttempts = config?.maxAttempts ?? DEFAULT_MAX_ATTEMPTS;
	const windowMs = (0, require_number_coercion.number_coercion_exports.resolveTimerTimeoutMs)(config?.windowMs, DEFAULT_WINDOW_MS, 0);
	const lockoutMs = (0, require_number_coercion.number_coercion_exports.resolveTimerTimeoutMs)(config?.lockoutMs, DEFAULT_LOCKOUT_MS, 0);
	const exemptLoopback = config?.exemptLoopback ?? true;
	const pruneIntervalMs = resolvePruneIntervalMs(config?.pruneIntervalMs);
	const maxEntries = (0, require_number_coercion.number_coercion_exports.resolveIntegerOption)(config?.maxEntries, DEFAULT_MAX_ENTRIES, { min: 1 });
	...
	function isExempt(ip) {
		return exemptLoopback && require_net.isLoopbackAddress(ip);
	}
...
//#endregion
Object.defineProperty(exports, "AUTH_RATE_LIMIT_SCOPE_BOOTSTRAP_TOKEN", {
	enumerable: true,
	get: function() {
		return AUTH_RATE_LIMIT_SCOPE_BOOTSTRAP_TOKEN;
	}
});
Object.defineProperty(exports, "AUTH_RATE_LIMIT_SCOPE_DEFAULT", {
	enumerable: true,
	get: function() {
		return AUTH_RATE_LIMIT_SCOPE_DEFAULT;
	}
});
Object.defineProperty(exports, "AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN", {
	enumerable: true,
	get: function() {
		return AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN;
	}
});
Object.defineProperty(exports, "AUTH_RATE_LIMIT_SCOPE_HOOK_AUTH", {
	enumerable: true,
	get: function() {
		return AUTH_RATE_LIMIT_SCOPE_HOOK_AUTH;
	}
});
Object.defineProperty(exports, "AUTH_RATE_LIMIT_SCOPE_NODE_PAIRING", {
	enumerable: true,
	get: function() {
		return AUTH_RATE_LIMIT_SCOPE_NODE_PAIRING;
	}
});
Object.defineProperty(exports, "AUTH_RATE_LIMIT_SCOPE_NODE_REAPPROVAL", {
	enumerable: true,
	get: function() {
		return AUTH_RATE_LIMIT_SCOPE_NODE_REAPPROVAL;
	}
});
Object.defineProperty(exports, "AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET", {
	enumerable: true,
	get: function() {
		return AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET;
	}
});
Object.defineProperty(exports, "AUTH_RATE_LIMIT_SCOPE_WATCH_CHALLENGE", {
	enumerable: true,
	get: function() {
		return AUTH_RATE_LIMIT_SCOPE_WATCH_CHALLENGE;
	}
});
Object.defineProperty(exports, "buildRateLimitIdentityKey", {
	enumerable: true,
	get: function() {
		return buildRateLimitIdentityKey;
	}
});
Object.defineProperty(exports, "createAuthRateLimiter", {
	enumerable: true,
	get: function() {
		return createAuthRateLimiter;
	}
});
Object.defineProperty(exports, "normalizeRateLimitClientIp", {
	enumerable: true,
	get: function() {
