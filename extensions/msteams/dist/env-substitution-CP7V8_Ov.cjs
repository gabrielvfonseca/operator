...
function substituteAny(value, env, path, opts) {
	...
	if (require_plain_object.isPlainObject(value)) {
		const result = {};
...
//#endregion
Object.defineProperty(exports, "containsEnvVarReference", {
	enumerable: true,
	get: function() {
		return containsEnvVarReference;
	}
});
Object.defineProperty(exports, "resolveConfigEnvVars", {
	enumerable: true,
	get: function() {
		return resolveConfigEnvVars;
	}
});
