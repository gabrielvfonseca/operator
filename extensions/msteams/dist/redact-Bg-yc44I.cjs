...
function normalizeRuntimeBasename(execPath) {
	...
	return (0, _gabrielvfonseca_normalization_core_string_coerce.normalizeLowercaseStringOrEmpty)(lastSlash === -1 ? trimmed : trimmed.slice(lastSlash + 1));
}
...
function sanitizeCommandDescriptorDescription(description) {
	return require_ansi.sanitizeForLog(description).trim();
}
...
const CORE_CLI_COMMAND_DESCRIPTORS = defineCommandDescriptorCatalog([
	...
	{
		name: "crestodian",
		description: "Deprecated: use operator setup",
		hasSubcommands: false,
		hidden: true
	},
	{
...
node_path.default.join("dist", "plugin-sdk", "qa-lab.js");
...
const subCliCommandCatalog = defineCommandDescriptorCatalog([
	...
	{
		name: "docs",
		description: "Search the live Operator docs",
		hasSubcommands: false
	},
	{
		name: "qa",
	...
	{
		name: "proxy",
		description: "Run the Operator debug proxy and inspect captured traffic",
		hasSubcommands: true
	},
	{
		name: "hooks",
	...
	{
		name: "plugins",
		description: "Manage Operator plugins and extensions",
		hasSubcommands: true,
		parentDefaultHelp: true
	},
	{
	...
	{
		name: "update",
		description: "Update Operator and inspect update channel status",
		hasSubcommands: true
	},
	{
		name: "completion",
...
function readLoggingConfig() {
	...
	try {
		...
		const parsed = json5.default.parse(node_fs.default.readFileSync(configPath, "utf8"));
		const logging = (0, _gabrielvfonseca_normalization_core_record_coerce.isRecord)(parsed) ? parsed.logging : void 0;
		const resolved = (0, _gabrielvfonseca_normalization_core_record_coerce.isRecord)(logging) ? logging : void 0;
		cachedLoggingConfig = {
			path: configPath,
			logging: resolved
		};
...
function analyzeTokensForNestedRepetition(tokens) {
	...
	const emitToken = (token) => {
		const frame = (0, _gabrielvfonseca_normalization_core.expectDefined)(frames[frames.length - 1], "frames entry at frames.length 1");
...
if (process.env.VITEST || false) globalThis[Symbol.for("operator.secretRedactionRegistryTestApi")] = { resetSecretRedactionRegistryForTest };
//#endregion
//#region src/logging/redact.ts
var redact_exports = /* @__PURE__ */ require_rolldown_runtime.__exportAll({
	computeSensitiveRedactionBitmap: () => computeSensitiveRedactionBitmap,
	getDefaultRedactPatterns: () => getDefaultRedactPatterns,
	isSensitiveFieldKey: () => isSensitiveFieldKey,
	redactSecrets: () => redactSecrets,
	redactSensitiveFieldValue: () => redactSensitiveFieldValue,
	redactSensitiveFieldValueWithConfig: () => redactSensitiveFieldValueWithConfig,
	redactSensitiveLines: () => redactSensitiveLines,
	redactSensitiveText: () => redactSensitiveText,
	redactToolDetail: () => redactToolDetail,
	redactToolPayloadText: () => redactToolPayloadText,
	redactToolPayloadTextWithConfig: () => redactToolPayloadTextWithConfig,
	resolveRedactOptions: () => resolveRedactOptions
});
...
function parsePattern(raw) {
	...
	if (raw instanceof RegExp) if (raw.flags.includes("g")) pattern = raw;
		...
		if (match) {
			const flags = (0, _gabrielvfonseca_normalization_core.expectDefined)(match[2], "redact regex capture 2").includes("g") ? match[2] : `${match[2]}g`;
			pattern = compileConfigRegex((0, _gabrielvfonseca_normalization_core.expectDefined)(match[1], "redact regex capture 1"), flags)?.regex ?? null;
...
function maskToken(token) {
	...
	return `${(0, _gabrielvfonseca_normalization_core_utf16_slice.sliceUtf16Safe)(token, 0, DEFAULT_REDACT_KEEP_START)}…${(0, _gabrielvfonseca_normalization_core_utf16_slice.sliceUtf16Safe)(token, -4)}`;
}
...
//#endregion
Object.defineProperty(exports, "compileConfigRegexes", {
	enumerable: true,
	get: function() {
		return compileConfigRegexes;
	}
});
Object.defineProperty(exports, "compileSafeRegex", {
	enumerable: true,
	get: function() {
		return compileSafeRegex;
	}
});
Object.defineProperty(exports, "computeSensitiveRedactionBitmap", {
	enumerable: true,
	get: function() {
		return computeSensitiveRedactionBitmap;
	}
});
Object.defineProperty(exports, "consumeRootOptionToken", {
	enumerable: true,
	get: function() {
		return consumeRootOptionToken;
	}
});
Object.defineProperty(exports, "getDefaultRedactPatterns", {
	enumerable: true,
	get: function() {
		return getDefaultRedactPatterns;
	}
});
Object.defineProperty(exports, "hasRegisteredSecretValuesForRedaction", {
	enumerable: true,
	get: function() {
		return hasRegisteredSecretValuesForRedaction;
	}
});
Object.defineProperty(exports, "isBunRuntime", {
	enumerable: true,
	get: function() {
		return isBunRuntime;
	}
...
Object.defineProperty(exports, "isSecretValueRegisteredForRedaction", {
	enumerable: true,
	get: function() {
		return isSecretValueRegisteredForRedaction;
	}
});
Object.defineProperty(exports, "isSensitiveFieldKey", {
	enumerable: true,
	get: function() {
		return isSensitiveFieldKey;
	}
});
Object.defineProperty(exports, "normalizeCommandDescriptorName", {
	enumerable: true,
	get: function() {
		return normalizeCommandDescriptorName;
	}
});
Object.defineProperty(exports, "readLoggingConfig", {
	enumerable: true,
	get: function() {
		return readLoggingConfig;
	}
});
Object.defineProperty(exports, "redactRegisteredSecretValues", {
	enumerable: true,
	get: function() {
		return redactRegisteredSecretValues;
	}
});
Object.defineProperty(exports, "redactSecrets", {
	enumerable: true,
	get: function() {
		return redactSecrets;
	}
});
Object.defineProperty(exports, "redactSensitiveFieldValue", {
	enumerable: true,
	get: function() {
		return redactSensitiveFieldValue;
	}
});
Object.defineProperty(exports, "redactSensitiveFieldValueWithConfig", {
	enumerable: true,
	get: function() {
		return redactSensitiveFieldValueWithConfig;
	}
});
Object.defineProperty(exports, "redactSensitiveLines", {
	enumerable: true,
	get: function() {
		return redactSensitiveLines;
	}
});
Object.defineProperty(exports, "redactSensitiveText", {
	enumerable: true,
	get: function() {
		return redactSensitiveText;
	}
});
Object.defineProperty(exports, "redactToolDetail", {
	enumerable: true,
	get: function() {
		return redactToolDetail;
	}
});
Object.defineProperty(exports, "redactToolPayloadText", {
	enumerable: true,
	get: function() {
		return redactToolPayloadText;
	}
});
Object.defineProperty(exports, "redactToolPayloadTextWithConfig", {
	enumerable: true,
	get: function() {
		return redactToolPayloadTextWithConfig;
	}
});
Object.defineProperty(exports, "redact_exports", {
	enumerable: true,
	get: function() {
		return redact_exports;
	}
});
Object.defineProperty(exports, "registerSecretValueForRedaction", {
	enumerable: true,
	get: function() {
		return registerSecretValueForRedaction;
	}
});
Object.defineProperty(exports, "resolveRedactOptions", {
	enumerable: true,
	get: function() {
		return resolveRedactOptions;
	}
});
Object.defineProperty(exports, "sanitizeCommandDescriptorDescription", {
	enumerable: true,
	get: function() {
		return sanitizeCommandDescriptorDescription;
	}
});
Object.defineProperty(exports, "shouldSkipMutatingLoggingConfigRead", {
	enumerable: true,
	get: function() {
		return shouldSkipMutatingLoggingConfigRead;
	}
});
Object.defineProperty(exports, "testRegexWithBoundedInput", {
	enumerable: true,
	get: function() {
		return testRegexWithBoundedInput;
	}
});
