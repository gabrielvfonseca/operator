...
//#endregion
Object.defineProperty(exports, "isRecoverableTerminalSessionStatus", {
	enumerable: true,
	get: function() {
		return isRecoverableTerminalSessionStatus;
	}
});
Object.defineProperty(exports, "recoverTerminalSessionEntryForVisibleTurn", {
	enumerable: true,
	get: function() {
		return recoverTerminalSessionEntryForVisibleTurn;
	}
});
