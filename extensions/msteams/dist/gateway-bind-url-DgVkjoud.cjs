...
function resolveGatewayBindUrl(params) {
	...
	if (bind === "custom") {
		const host = (0, _gabrielvfonseca_normalization_core_string_coerce.normalizeOptionalString)(params.customBindHost);
		if (host) return {
...
//#endregion
Object.defineProperty(exports, "resolveGatewayBindUrl", {
	enumerable: true,
	get: function() {
		return resolveGatewayBindUrl;
	}
});
