...
function resolveHeartbeatPrompt(raw) {
	return ((0, _gabrielvfonseca_normalization_core_string_coerce.normalizeOptionalString)(raw) ?? "") || HEARTBEAT_PROMPT;
}
function appendHeartbeatResponseToolInstructions(prompt) {
	const trimmed = (0, _gabrielvfonseca_normalization_core_string_coerce.normalizeOptionalString)(prompt) ?? "";
...
function stripTokenAtEdges(raw) {
	...
	const token = require_tokens.HEARTBEAT_TOKEN;
	const tokenAtEndWithOptionalTrailingPunctuation = new RegExp(`${require_regexp.escapeRegExp(token)}[^\\w]{0,4}$`);
...
function isTaskDue(lastRunMs, interval, nowMs) {
	...
	try {
		const intervalMs = require_parse_duration.parseDurationMs(interval, { defaultUnit: "m" });
...
Object.defineProperty(exports, "HEARTBEAT_RESPONSE_TOOL_INSTRUCTIONS", {
	enumerable: true,
	get: function() {
		return HEARTBEAT_RESPONSE_TOOL_INSTRUCTIONS;
	}
});
Object.defineProperty(exports, "HEARTBEAT_RESPONSE_TOOL_PROMPT", {
	enumerable: true,
	get: function() {
		return HEARTBEAT_RESPONSE_TOOL_PROMPT;
	}
});
Object.defineProperty(exports, "HEARTBEAT_TRANSCRIPT_PROMPT", {
	enumerable: true,
	get: function() {
		return HEARTBEAT_TRANSCRIPT_PROMPT;
	}
});
Object.defineProperty(exports, "isHeartbeatContentEffectivelyEmpty", {
	enumerable: true,
	get: function() {
		return isHeartbeatContentEffectivelyEmpty;
	}
});
Object.defineProperty(exports, "isTaskDue", {
	enumerable: true,
	get: function() {
		return isTaskDue;
	}
});
Object.defineProperty(exports, "parseHeartbeatTasks", {
	enumerable: true,
	get: function() {
		return parseHeartbeatTasks;
	}
});
Object.defineProperty(exports, "resolveHeartbeatPrompt", {
	enumerable: true,
	get: function() {
		return resolveHeartbeatPrompt;
	}
});
Object.defineProperty(exports, "resolveHeartbeatPromptForResponseTool", {
	enumerable: true,
	get: function() {
		return resolveHeartbeatPromptForResponseTool;
	}
});
Object.defineProperty(exports, "stripHeartbeatToken", {
	enumerable: true,
	get: function() {
		return stripHeartbeatToken;
	}
});
