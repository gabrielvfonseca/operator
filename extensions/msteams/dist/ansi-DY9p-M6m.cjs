...
const ansiOscAtIndexRegex = new RegExp(`${ANSI_OSC_INTRODUCER_PATTERN}[^\\x07\\x1b\\x9c]*${ANSI_STRING_TERMINATOR_PATTERN}`, "y");
...
var ansi_exports = /* @__PURE__ */ require_rolldown_runtime.__exportAll({
	sanitizeForLog: () => sanitizeForLog,
	splitGraphemes: () => splitGraphemes,
	stripAnsi: () => stripAnsi,
	stripAnsiForStreamChunk: () => stripAnsiForStreamChunk,
	stripAnsiSequences: () => stripAnsiSequences,
	truncateToVisibleWidth: () => truncateToVisibleWidth,
	visibleWidth: () => visibleWidth
});
const ANSI_COMPAT_SEQUENCE_AT_INDEX_REGEX = new RegExp(`${`${ANSI_OSC_INTRODUCER_PATTERN}[\\s\\S]*?${ANSI_STRING_TERMINATOR_PATTERN}`}|[\\u001B\\u009B][[\\]()#;?]*(?:\\d{1,4}(?:[;:]\\d{0,4})*)?[\\dA-PR-TZcf-nq-uy=><~]`);
...
function stripAnsiInternal(input, options) {
	...
	while (index < input.length) {
		...
		if (!csi) {
			const compatibilityMatch = options.compatibilityGrammar ? ANSI_COMPAT_SEQUENCE_AT_INDEX_REGEX.exec(input.slice(index)) : null;
...
//#endregion
Object.defineProperty(exports, "ansi_exports", {
	enumerable: true,
	get: function() {
		return ansi_exports;
	}
...
Object.defineProperty(exports, "splitAnsiSegments", {
	enumerable: true,
	get: function() {
		return splitAnsiSegments;
	}
});
Object.defineProperty(exports, "splitGraphemes", {
	enumerable: true,
	get: function() {
...
Object.defineProperty(exports, "stripAnsiForStreamChunk", {
	enumerable: true,
	get: function() {
		return stripAnsiForStreamChunk;
	}
});
Object.defineProperty(exports, "stripAnsiSequences", {
	enumerable: true,
	get: function() {
		return stripAnsiSequences;
	}
});
Object.defineProperty(exports, "truncateToVisibleWidth", {
	enumerable: true,
	get: function() {
		return truncateToVisibleWidth;
	}
});
Object.defineProperty(exports, "visibleWidth", {
	enumerable: true,
	get: function() {
		return visibleWidth;
	}
