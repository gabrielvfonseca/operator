...
function runTaskkill(args) {
	try {
		(0, node_child_process.spawn)("taskkill", args, {
			stdio: "ignore",
			detached: true,
			windowsHide: true
		}).once("error", () => {});
...
var kill_tree_exports = /* @__PURE__ */ require_rolldown_runtime.__exportAll({ killProcessTree: () => killProcessTree });
//#endregion
...
Object.defineProperty(exports, "kill_tree_exports", {
	enumerable: true,
	get: function() {
		return kill_tree_exports;
	}
});
Object.defineProperty(exports, "signalProcessTree", {
	enumerable: true,
	get: function() {
