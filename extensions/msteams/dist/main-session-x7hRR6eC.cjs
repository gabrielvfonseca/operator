...
function buildMainSessionKey(agentId, mainKey) {
	return `agent:${(0, _gabrielvfonseca_normalization_core_agent_id.normalizeAgentId)(agentId)}:${require_session_key.normalizeMainKey(mainKey)}`;
}
...
function resolveSessionRoutingContract(cfg) {
	...
	return [
		...
		require_session_key.normalizeMainKey(cfg?.session?.mainKey),
		(0, _gabrielvfonseca_normalization_core_agent_id.normalizeAgentId)(defaultAgentId)
	].join("|");
}
...
//#endregion
Object.defineProperty(exports, "SESSION_ROUTING_CHANGED_ERROR_REASON", {
	enumerable: true,
	get: function() {
		return SESSION_ROUTING_CHANGED_ERROR_REASON;
	}
});
Object.defineProperty(exports, "canonicalizeMainSessionAlias", {
	enumerable: true,
	get: function() {
		return canonicalizeMainSessionAlias;
	}
});
Object.defineProperty(exports, "resolveAgentMainSessionKey", {
	enumerable: true,
	get: function() {
		return resolveAgentMainSessionKey;
	}
});
Object.defineProperty(exports, "resolveExplicitAgentSessionKey", {
	enumerable: true,
	get: function() {
		return resolveExplicitAgentSessionKey;
	}
});
Object.defineProperty(exports, "resolveMainSessionKey", {
	enumerable: true,
	get: function() {
		return resolveMainSessionKey;
	}
});
Object.defineProperty(exports, "resolveSessionRoutingContract", {
	enumerable: true,
	get: function() {
		return resolveSessionRoutingContract;
	}
});
