...
var policy_exports = /* @__PURE__ */ require_rolldown_runtime.__exportAll({
	isAcpEnabledByPolicy: () => isAcpEnabledByPolicy,
	resolveAcpAgentPolicyError: () => resolveAcpAgentPolicyError,
	resolveAcpDispatchPolicyError: () => resolveAcpDispatchPolicyError,
	resolveAcpDispatchPolicyMessage: () => resolveAcpDispatchPolicyMessage,
	resolveAcpExplicitTurnPolicyError: () => resolveAcpExplicitTurnPolicyError
});
...
function resolveAcpDispatchPolicyError(cfg) {
	...
	return new _gabrielvfonseca_acp_core_runtime_errors.AcpRuntimeError("ACP_DISPATCH_DISABLED", message);
}
...
function resolveAcpExplicitTurnPolicyError(cfg) {
	...
	return new _gabrielvfonseca_acp_core_runtime_errors.AcpRuntimeError("ACP_DISPATCH_DISABLED", ACP_DISABLED_MESSAGE);
}
/** Returns whether an agent id passes the optional ACP allowed-agent list. */
function isAcpAgentAllowedByPolicy(cfg, agentId) {
	const allowed = (cfg.acp?.allowedAgents ?? []).map((entry) => (0, _gabrielvfonseca_normalization_core_agent_id.normalizeAgentId)(entry)).filter(Boolean);
	if (allowed.length === 0) return true;
	return allowed.includes((0, _gabrielvfonseca_normalization_core_agent_id.normalizeAgentId)(agentId));
}
...
function resolveAcpAgentPolicyError(cfg, agentId) {
	...
	return new _gabrielvfonseca_acp_core_runtime_errors.AcpRuntimeError("ACP_SESSION_INIT_FAILED", `ACP agent "${(0, _gabrielvfonseca_normalization_core_agent_id.normalizeAgentId)(agentId)}" is not allowed by policy.`);
}
//#endregion
Object.defineProperty(exports, "isAcpEnabledByPolicy", {
	enumerable: true,
	get: function() {
		return isAcpEnabledByPolicy;
	}
});
...
Object.defineProperty(exports, "resolveAcpAgentPolicyError", {
	enumerable: true,
	get: function() {
		return resolveAcpAgentPolicyError;
	}
});
Object.defineProperty(exports, "resolveAcpDispatchPolicyError", {
	enumerable: true,
	get: function() {
		return resolveAcpDispatchPolicyError;
	}
});
Object.defineProperty(exports, "resolveAcpDispatchPolicyMessage", {
	enumerable: true,
	get: function() {
		return resolveAcpDispatchPolicyMessage;
	}
});
