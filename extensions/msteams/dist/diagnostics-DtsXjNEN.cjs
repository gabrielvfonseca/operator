...
async function readLastGatewayErrorLine(env, options) {
	...
	const { stdoutPath, stderrPath } = platform === "darwin" ? require_restart_logs.resolveGatewaySupervisorLogPaths(env, { platform }) : require_restart_logs.resolveGatewayLogPaths(env);
...
//#endregion
Object.defineProperty(exports, "readGatewayLogTailLines", {
	enumerable: true,
	get: function() {
		return readGatewayLogTailLines;
	}
});
Object.defineProperty(exports, "readLastGatewayErrorLine", {
	enumerable: true,
	get: function() {
		return readLastGatewayErrorLine;
	}
});
