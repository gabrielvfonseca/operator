...
function buildDockerExecArgs(params) {
	...
	if (hasCustomPath) args.push("-e", `OPERATOR_PREPEND_PATH=${params.env.PATH}`);
	const pathExport = hasCustomPath ? "export PATH=\"${OPERATOR_PREPEND_PATH}:$PATH\"; unset OPERATOR_PREPEND_PATH; " : "";
...
function readEnvInt(key, legacyKey) {
	return (0, _gabrielvfonseca_normalization_core_number_coercion.parseStrictInteger)(process.env[key] || (legacyKey ? process.env[legacyKey] : void 0));
}
...
function chunkString(input, limit = CHUNK_LIMIT) {
	...
	while (i < input.length) {
		...
		const chunk = (0, _gabrielvfonseca_normalization_core_utf16_slice.sliceUtf16Safe)(input, i, i + Math.max(chunkLimit, firstCodePointWidth));
		chunks.push(chunk);
		i += chunk.length;
	}
	return chunks;
...
function truncateMiddle(str, max) {
	...
	return `${(0, _gabrielvfonseca_normalization_core_utf16_slice.sliceUtf16Safe)(str, 0, half)}...${(0, _gabrielvfonseca_normalization_core_utf16_slice.sliceUtf16Safe)(str, -half)}`;
}
...
//#endregion
Object.defineProperty(exports, "buildDockerExecArgs", {
	enumerable: true,
	get: function() {
		return buildDockerExecArgs;
	}
});
Object.defineProperty(exports, "buildSandboxEnv", {
	enumerable: true,
	get: function() {
...
Object.defineProperty(exports, "clampWithDefault", {
	enumerable: true,
	get: function() {
		return clampWithDefault;
	}
});
Object.defineProperty(exports, "coerceEnv", {
	enumerable: true,
	get: function() {
		return coerceEnv;
	}
});
Object.defineProperty(exports, "deriveSessionName", {
	enumerable: true,
	get: function() {
...
Object.defineProperty(exports, "readEnvInt", {
	enumerable: true,
	get: function() {
		return readEnvInt;
	}
});
Object.defineProperty(exports, "sliceLogLines", {
	enumerable: true,
	get: function() {
		return sliceLogLines;
	}
});
Object.defineProperty(exports, "truncateMiddle", {
	enumerable: true,
	get: function() {
