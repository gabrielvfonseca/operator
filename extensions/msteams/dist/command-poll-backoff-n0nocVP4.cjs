...
//#endregion
Object.defineProperty(exports, "pruneStaleCommandPolls", {
	enumerable: true,
	get: function() {
		return pruneStaleCommandPolls;
	}
});
Object.defineProperty(exports, "recordCommandPoll", {
	enumerable: true,
	get: function() {
		return recordCommandPoll;
	}
});
Object.defineProperty(exports, "resetCommandPollCount", {
	enumerable: true,
	get: function() {
		return resetCommandPollCount;
	}
});
