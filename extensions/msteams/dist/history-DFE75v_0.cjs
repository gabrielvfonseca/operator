...
function buildHistoryContext(params) {
	...
	return [
		...
		historyText,
		"",
		require_mentions.CURRENT_MESSAGE_MARKER,
		currentMessage
	].join(lineBreak);
}
...
//#endregion
Object.defineProperty(exports, "buildHistoryContextFromEntries", {
	enumerable: true,
	get: function() {
		return buildHistoryContextFromEntries;
	}
});
Object.defineProperty(exports, "buildInboundHistoryFromMap", {
	enumerable: true,
	get: function() {
		return buildInboundHistoryFromMap;
	}
});
Object.defineProperty(exports, "buildPendingHistoryContextFromMap", {
	enumerable: true,
	get: function() {
		return buildPendingHistoryContextFromMap;
	}
});
Object.defineProperty(exports, "clearHistoryEntriesIfEnabled", {
	enumerable: true,
	get: function() {
		return clearHistoryEntriesIfEnabled;
	}
});
Object.defineProperty(exports, "recordPendingHistoryEntryIfEnabled", {
	enumerable: true,
	get: function() {
		return recordPendingHistoryEntryIfEnabled;
	}
});
Object.defineProperty(exports, "recordPendingHistoryEntryWithMedia", {
	enumerable: true,
	get: function() {
		return recordPendingHistoryEntryWithMedia;
	}
});
