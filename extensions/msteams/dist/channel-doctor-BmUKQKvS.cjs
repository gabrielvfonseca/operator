...
var channel_doctor_exports = /* @__PURE__ */ require_rolldown_runtime.__exportAll({
	collectChannelDoctorCompatibilityMutations: () => collectChannelDoctorCompatibilityMutations,
	collectChannelDoctorEmptyAllowlistExtraWarnings: () => collectChannelDoctorEmptyAllowlistExtraWarnings,
	collectChannelDoctorMutableAllowlistWarnings: () => collectChannelDoctorMutableAllowlistWarnings,
	collectChannelDoctorPreviewWarnings: () => collectChannelDoctorPreviewWarnings,
	collectChannelDoctorRepairMutations: () => collectChannelDoctorRepairMutations,
	collectChannelDoctorStaleConfigMutations: () => collectChannelDoctorStaleConfigMutations,
	createChannelDoctorEmptyAllowlistPolicyHooks: () => createChannelDoctorEmptyAllowlistPolicyHooks,
	runChannelDoctorConfigSequences: () => runChannelDoctorConfigSequences,
	shouldSkipChannelDoctorDefaultEmptyGroupAllowlistWarning: () => shouldSkipChannelDoctorDefaultEmptyGroupAllowlistWarning
});
...
function safeGetLoadedChannelPlugin(id) {
	try {
		return require_registry.getLoadedChannelPlugin(id);
	} catch {
		return;
	}
}
function safeGetBundledChannelSetupPlugin(id) {
	try {
		return require_bundled.getBundledChannelSetupPlugin(id);
	} catch {
		return;
	}
}
function safeGetBundledChannelPlugin(id) {
	try {
		return require_bundled.getBundledChannelPlugin(id);
	} catch {
		return;
	}
}
function safeListReadOnlyChannelPlugins(context) {
	try {
		return require_read_only.resolveReadOnlyChannelPluginsForConfig(context.cfg, {
...
async function collectChannelDoctorPreviewWarnings(params) {
	...
	for (const entry of listChannelDoctorEntries(collectConfiguredChannelIds(params.cfg), {
		...
		try {
			...
			if (!require_types_secrets.isUnresolvedSecretInputError(error)) throw error;
...
//#endregion
Object.defineProperty(exports, "channel_doctor_exports", {
	enumerable: true,
	get: function() {
		return channel_doctor_exports;
	}
});
Object.defineProperty(exports, "collectChannelDoctorRepairMutations", {
	enumerable: true,
	get: function() {
		return collectChannelDoctorRepairMutations;
	}
});
Object.defineProperty(exports, "createChannelDoctorEmptyAllowlistPolicyHooks", {
	enumerable: true,
	get: function() {
		return createChannelDoctorEmptyAllowlistPolicyHooks;
	}
});
Object.defineProperty(exports, "shouldSkipChannelDoctorDefaultEmptyGroupAllowlistWarning", {
	enumerable: true,
	get: function() {
		return shouldSkipChannelDoctorDefaultEmptyGroupAllowlistWarning;
	}
});
