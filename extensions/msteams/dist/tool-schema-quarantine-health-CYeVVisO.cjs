...
const quarantineStore = require_registry.createRuntimeHealthStore({
...
function recordPersistedRuntimeToolSchemaQuarantine(quarantine) {
	const record = {
		...
		...require_registry.createRuntimeHealthRecordEnvelope(quarantine.failedAt),
...
//#endregion
Object.defineProperty(exports, "clearRecoveredPersistedRuntimeToolSchemaQuarantines", {
	enumerable: true,
	get: function() {
		return clearRecoveredPersistedRuntimeToolSchemaQuarantines;
	}
});
Object.defineProperty(exports, "listPersistedRuntimeToolSchemaQuarantines", {
	enumerable: true,
	get: function() {
		return listPersistedRuntimeToolSchemaQuarantines;
	}
});
Object.defineProperty(exports, "recordPersistedRuntimeToolSchemaQuarantine", {
	enumerable: true,
	get: function() {
		return recordPersistedRuntimeToolSchemaQuarantine;
	}
});
