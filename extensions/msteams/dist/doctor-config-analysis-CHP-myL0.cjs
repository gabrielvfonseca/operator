...
function stripUnknownConfigKeys(config) {
	...
	const parsed = require_zod_schema.OperatorSchema.safeParse(config);
...
function noteOpencodeProviderOverrides(cfg) {
	...
	const lines = overrides.flatMap((id) => {
		...
		const api = (0, _gabrielvfonseca_normalization_core_record_coerce.isRecord)(providerEntry) && typeof providerEntry.api === "string" ? providerEntry.api : void 0;
...
function isImplicitFallbackClobber(model) {
	const primary = (0, _gabrielvfonseca_normalization_core_string_coerce.resolvePrimaryStringValue)(model);
...
function collectImplicitFallbackClobberWarnings(cfg) {
	...
	for (const [index, agent] of agents.entries()) {
		...
		const primary = (0, _gabrielvfonseca_normalization_core_string_coerce.resolvePrimaryStringValue)(agent.model);
...
function noteIncludeConfinementWarning(snapshot) {
	...
	require_note.note([
		`- $include paths must stay under: ${node_path.default.dirname(snapshot.path ?? require_paths.CONFIG_PATH)}`,
...
//#endregion
Object.defineProperty(exports, "formatConfigPath", {
	enumerable: true,
	get: function() {
		return formatConfigPath;
	}
});
Object.defineProperty(exports, "noteImplicitFallbackClobberWarnings", {
	enumerable: true,
	get: function() {
		return noteImplicitFallbackClobberWarnings;
	}
});
Object.defineProperty(exports, "noteIncludeConfinementWarning", {
	enumerable: true,
	get: function() {
		return noteIncludeConfinementWarning;
	}
});
Object.defineProperty(exports, "noteOpencodeProviderOverrides", {
	enumerable: true,
	get: function() {
		return noteOpencodeProviderOverrides;
	}
});
Object.defineProperty(exports, "resolveConfigPathTarget", {
	enumerable: true,
	get: function() {
		return resolveConfigPathTarget;
	}
});
Object.defineProperty(exports, "stripUnknownConfigKeys", {
	enumerable: true,
	get: function() {
		return stripUnknownConfigKeys;
	}
});
