...
//#endregion
Object.defineProperty(exports, "assertSafeCronSessionTargetId", {
	enumerable: true,
	get: function() {
		return assertSafeCronSessionTargetId;
	}
});
Object.defineProperty(exports, "isDetachedCronSessionTarget", {
	enumerable: true,
	get: function() {
		return isDetachedCronSessionTarget;
	}
});
Object.defineProperty(exports, "isInvalidCronSessionTargetIdError", {
	enumerable: true,
	get: function() {
		return isInvalidCronSessionTargetIdError;
	}
});
Object.defineProperty(exports, "resolveCronCurrentSessionTarget", {
	enumerable: true,
	get: function() {
		return resolveCronCurrentSessionTarget;
	}
});
Object.defineProperty(exports, "resolveCronDeliverySessionKey", {
	enumerable: true,
	get: function() {
		return resolveCronDeliverySessionKey;
	}
});
Object.defineProperty(exports, "resolveCronNotificationSessionKey", {
	enumerable: true,
	get: function() {
		return resolveCronNotificationSessionKey;
	}
});
Object.defineProperty(exports, "resolveCronSessionTargetSessionKey", {
	enumerable: true,
	get: function() {
		return resolveCronSessionTargetSessionKey;
	}
});
