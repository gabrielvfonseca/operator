...
function isReplaySafeThinkingAssistantMessage(message, allowedToolNames) {
	...
	for (const block of content) {
		...
		if (!hasToolCallInput(typedBlock) || !toolCallId || seenToolCallIds.has(toolCallId) || !require_tool_call_shared.isAllowedToolCallName(typedBlock.name, allowedToolNames) || toolCallNeedsReplayMutation(typedBlock)) return false;
...
function shortHash(text, length = 8) {
	return require_crypto_digest.sha256HexPrefix(text, length);
}
...
//#endregion
Object.defineProperty(exports, "extractToolCallsFromAssistant", {
	enumerable: true,
	get: function() {
		return extractToolCallsFromAssistant;
	}
});
Object.defineProperty(exports, "extractToolResultId", {
	enumerable: true,
	get: function() {
		return extractToolResultId;
	}
});
Object.defineProperty(exports, "extractToolResultIds", {
	enumerable: true,
	get: function() {
		return extractToolResultIds;
	}
});
Object.defineProperty(exports, "isThinkingLikeBlock", {
	enumerable: true,
	get: function() {
		return isThinkingLikeBlock;
	}
});
Object.defineProperty(exports, "sanitizeToolCallIdsForCloudCodeAssist", {
	enumerable: true,
	get: function() {
		return sanitizeToolCallIdsForCloudCodeAssist;
	}
});
