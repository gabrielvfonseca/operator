...
//#endregion
Object.defineProperty(exports, "formatUnsafeGatewayTailscaleNoAuthMessage", {
	enumerable: true,
	get: function() {
		return formatUnsafeGatewayTailscaleNoAuthMessage;
	}
});
Object.defineProperty(exports, "isUnsafeGatewayTailscaleNoAuth", {
	enumerable: true,
	get: function() {
		return isUnsafeGatewayTailscaleNoAuth;
	}
});
