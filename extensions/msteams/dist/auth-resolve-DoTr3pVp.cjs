...
function resolveGatewayAuth(params) {
	...
	const tokenRef = require_types_secrets.resolveSecretInputRef({ value: authConfig.token }).ref;
	const passwordRef = require_types_secrets.resolveSecretInputRef({ value: authConfig.password }).ref;
	const resolvedCredentials = require_credentials.resolveGatewayCredentialsFromValues({
...
//#endregion
Object.defineProperty(exports, "resolveEffectiveSharedGatewayAuth", {
	enumerable: true,
	get: function() {
		return resolveEffectiveSharedGatewayAuth;
	}
});
Object.defineProperty(exports, "resolveGatewayAuth", {
	enumerable: true,
	get: function() {
