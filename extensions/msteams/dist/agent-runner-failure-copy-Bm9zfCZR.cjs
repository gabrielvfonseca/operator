...
//#endregion
Object.defineProperty(exports, "GENERIC_EXTERNAL_RUN_FAILURE_TEXT", {
	enumerable: true,
	get: function() {
		return GENERIC_EXTERNAL_RUN_FAILURE_TEXT;
	}
});
Object.defineProperty(exports, "HEARTBEAT_EXTERNAL_RUN_FAILURE_TEXT", {
	enumerable: true,
	get: function() {
		return HEARTBEAT_EXTERNAL_RUN_FAILURE_TEXT;
	}
});
Object.defineProperty(exports, "replaceGenericExternalRunFailureText", {
	enumerable: true,
	get: function() {
		return replaceGenericExternalRunFailureText;
	}
});
