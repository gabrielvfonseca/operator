...
/** Normalizes legacy prompt surface names to current Operator surface names. */
function normalizeAgentPromptSurfaceKind(surface) {
	return surface === "pi_main" ? "operator_main" : surface;
}
/** True when a prompt surface targets the main Operator prompt. */
function isOperatorMainPromptSurface(surface) {
	return normalizeAgentPromptSurfaceKind(surface) === "operator_main";
}
//#endregion
//#region src/plugins/command-registry-state.ts
const PLUGIN_COMMAND_STATE_KEY = Symbol.for("operator.pluginCommandsState");
const getState = () => require_global_singleton.resolveGlobalSingleton(PLUGIN_COMMAND_STATE_KEY, () => ({
...
function restorePluginCommands(commands) {
	...
	for (const command of commands) {
		const name = (0, _gabrielvfonseca_normalization_core_string_coerce.normalizeOptionalLowercaseString)(command.name);
		if (!name) continue;
...
/** Returns true when a command name is owned by built-in Operator command handling. */
...
function validatePluginCommandDefinition(command, opts) {
	...
	if (command.ownership === "reserved") {
		...
		if (!isReservedCommandName(command.name)) return `Reserved command ownership requires a reserved command name: ${(0, _gabrielvfonseca_normalization_core_string_coerce.normalizeOptionalLowercaseString)(command.name) ?? ""}`;
	}
	...
	if (command.requiredScopes !== void 0) {
		...
		const unknownScope = command.requiredScopes.find((scope) => !require_operator_scopes.isOperatorScope(scope));
	...
	if (command.nativeNames !== void 0 && !(0, _gabrielvfonseca_normalization_core_record_coerce.isRecord)(command.nativeNames)) return "Command nativeNames must be an object";
	...
	if (command.nativeProgressMessages !== void 0 && !(0, _gabrielvfonseca_normalization_core_record_coerce.isRecord)(command.nativeProgressMessages)) return "Command nativeProgressMessages must be an object";
	...
	if (command.descriptionLocalizations !== void 0 && !(0, _gabrielvfonseca_normalization_core_record_coerce.isRecord)(command.descriptionLocalizations)) return "Command descriptionLocalizations must be an object";
...
function validateAgentPromptGuidance(index, guidance) {
	...
	if (!(0, _gabrielvfonseca_normalization_core_record_coerce.isRecord)(guidance)) return `${label} must be a string or object`;
...
function pluginCommandSupportsChannel(command, channel) {
	...
	return command.channels.some((entry) => (0, _gabrielvfonseca_normalization_core_string_coerce.normalizeLowercaseStringOrEmpty)(entry) === normalizedChannel);
}
function registerPluginCommand(pluginId, command, opts) {
	...
	const normalizedName = (0, _gabrielvfonseca_normalization_core_string_coerce.normalizeLowercaseStringOrEmpty)(name);
	const description = command.description.trim();
	const normalizedCommand = {
		...command,
		name,
		description,
		...command.channels ? { channels: command.channels.map((channel) => (0, _gabrielvfonseca_normalization_core_string_coerce.normalizeLowercaseStringOrEmpty)(channel)) } : {},
	...
	require_globals.logVerbose(`Registered plugin command: ${key} (plugin: ${pluginId})`);
	return { ok: true };
}
//#endregion
Object.defineProperty(exports, "canExposeSenderIsOwner", {
	enumerable: true,
	get: function() {
		return canExposeSenderIsOwner;
	}
});
Object.defineProperty(exports, "clearPluginCommands", {
	enumerable: true,
	get: function() {
		return clearPluginCommands;
	}
});
Object.defineProperty(exports, "clearPluginCommandsForPlugin", {
	enumerable: true,
	get: function() {
		return clearPluginCommandsForPlugin;
	}
});
Object.defineProperty(exports, "isOperatorMainPromptSurface", {
	enumerable: true,
	get: function() {
		return isOperatorMainPromptSurface;
	}
});
Object.defineProperty(exports, "isReservedCommandName", {
	enumerable: true,
	get: function() {
		return isReservedCommandName;
	}
});
Object.defineProperty(exports, "isTrustedReservedCommandOwner", {
	enumerable: true,
	get: function() {
		return isTrustedReservedCommandOwner;
	}
});
Object.defineProperty(exports, "listPluginInvocationKeys", {
	enumerable: true,
	get: function() {
		return listPluginInvocationKeys;
	}
});
Object.defineProperty(exports, "listRegisteredPluginAgentPromptGuidance", {
	enumerable: true,
	get: function() {
		return listRegisteredPluginAgentPromptGuidance;
	}
});
Object.defineProperty(exports, "listRegisteredPluginCommands", {
	enumerable: true,
	get: function() {
		return listRegisteredPluginCommands;
	}
});
Object.defineProperty(exports, "pluginCommandSupportsChannel", {
	enumerable: true,
	get: function() {
		return pluginCommandSupportsChannel;
	}
});
Object.defineProperty(exports, "pluginCommands", {
	enumerable: true,
	get: function() {
		return pluginCommands;
	}
});
Object.defineProperty(exports, "registerPluginCommand", {
	enumerable: true,
	get: function() {
		return registerPluginCommand;
	}
});
Object.defineProperty(exports, "restorePluginCommands", {
	enumerable: true,
	get: function() {
		return restorePluginCommands;
	}
});
Object.defineProperty(exports, "setPluginCommandRegistryLocked", {
	enumerable: true,
	get: function() {
		return setPluginCommandRegistryLocked;
	}
});
Object.defineProperty(exports, "validatePluginCommandDefinition", {
	enumerable: true,
	get: function() {
		return validatePluginCommandDefinition;
	}
});
