...
function tokenize(text, opts) {
	...
	const tokens = [];
	const segments = (0, _gabrielvfonseca_normalization_core_string_coerce.normalizeLowercaseStringOrEmpty)(text).split(/[\s\p{P}]+/u).filter(Boolean);
...
//#endregion
Object.defineProperty(exports, "extractKeywords", {
	enumerable: true,
	get: function() {
		return extractKeywords;
	}
});
Object.defineProperty(exports, "isQueryStopWordToken", {
	enumerable: true,
	get: function() {
		return isQueryStopWordToken;
	}
});
