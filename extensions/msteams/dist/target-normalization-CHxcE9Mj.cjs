...
function resolveChannelPluginForTargetRead(channelId) {
	return require_registry_loaded.getLoadedChannelPluginForRead(channelId) ?? require_registry.getChannelPlugin(channelId);
}
...
function resolveTargetNormalizer(channelId, preparedPlugin) {
	...
	const version = require_runtime.getActivePluginChannelRegistryVersion();
...
function normalizeTargetForProvider(provider, raw, plugin) {
	if (!raw) return;
	const fallback = (0, _gabrielvfonseca_normalization_core_string_coerce.normalizeOptionalString)(raw);
	if (!fallback) return;
	const providerId = (0, _gabrielvfonseca_normalization_core_string_coerce.normalizeOptionalLowercaseString)(provider);
	return (0, _gabrielvfonseca_normalization_core_string_coerce.normalizeOptionalString)((providerId ? resolveTargetNormalizer(providerId, plugin) : void 0)?.(raw) ?? fallback);
}
/**
...
//#endregion
Object.defineProperty(exports, "buildTargetResolverSignature", {
	enumerable: true,
	get: function() {
		return buildTargetResolverSignature;
	}
});
Object.defineProperty(exports, "looksLikeTargetId", {
	enumerable: true,
	get: function() {
		return looksLikeTargetId;
	}
});
Object.defineProperty(exports, "maybeResolvePluginMessagingTarget", {
	enumerable: true,
	get: function() {
		return maybeResolvePluginMessagingTarget;
	}
});
Object.defineProperty(exports, "normalizeChannelTargetInput", {
	enumerable: true,
	get: function() {
		return normalizeChannelTargetInput;
	}
});
Object.defineProperty(exports, "normalizeTargetForProvider", {
	enumerable: true,
	get: function() {
		return normalizeTargetForProvider;
	}
});
Object.defineProperty(exports, "resolveNormalizedTargetInput", {
	enumerable: true,
	get: function() {
		return resolveNormalizedTargetInput;
	}
});
Object.defineProperty(exports, "resolveReservedTargetLiteral", {
	enumerable: true,
	get: function() {
		return resolveReservedTargetLiteral;
	}
});
