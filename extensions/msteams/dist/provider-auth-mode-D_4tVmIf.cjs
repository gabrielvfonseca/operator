...
async function resolveSecretInputModeForEnvSelection(params) {
	...
	return await params.prompter.select({
		...
		options: [{
			...
			hint: params.copy?.plaintextHint ?? "Stores the key directly in Operator config"
		}, {
			value: "ref",
...
//#endregion
Object.defineProperty(exports, "resolveSecretInputModeForEnvSelection", {
	enumerable: true,
	get: function() {
		return resolveSecretInputModeForEnvSelection;
	}
});
