...
async function getOrLoadBootstrapFiles(params) {
	...
	const files = await require_workspace.loadWorkspaceBootstrapFiles(params.workspaceDir);
...
//#endregion
Object.defineProperty(exports, "clearBootstrapSnapshot", {
	enumerable: true,
	get: function() {
		return clearBootstrapSnapshot;
	}
});
Object.defineProperty(exports, "clearBootstrapSnapshotOnSessionRollover", {
	enumerable: true,
	get: function() {
		return clearBootstrapSnapshotOnSessionRollover;
	}
});
Object.defineProperty(exports, "getOrLoadBootstrapFiles", {
	enumerable: true,
	get: function() {
		return getOrLoadBootstrapFiles;
	}
});
