...
const MALFORMED_STREAMING_FRAGMENT_ERROR_MESSAGE = "Operator transport error: malformed_streaming_fragment";
...
function parseApiErrorInfo(raw) {
	...
	if (httpPrefixMatch) {
		...
		candidate = (0, _gabrielvfonseca_normalization_core.expectDefined)(httpPrefixMatch[2], "http prefix match capture group 2").trim();
	}
...
function formatRawAssistantErrorForUi(raw) {
	...
	if (trimmed === "Operator transport error: malformed_streaming_fragment") return MALFORMED_STREAMING_FRAGMENT_USER_MESSAGE;
	...
	if (httpMatch) {
		const rest = (0, _gabrielvfonseca_normalization_core.expectDefined)(httpMatch[2], "http match capture group 2").trim();
	...
	return trimmed.length > 600 ? `${(0, _gabrielvfonseca_normalization_core_utf16_slice.truncateUtf16Safe)(trimmed, 600)}…` : trimmed;
}
//#endregion
Object.defineProperty(exports, "MALFORMED_STREAMING_FRAGMENT_ERROR_MESSAGE", {
	enumerable: true,
	get: function() {
		return MALFORMED_STREAMING_FRAGMENT_ERROR_MESSAGE;
	}
});
Object.defineProperty(exports, "extractLeadingHttpStatus", {
	enumerable: true,
	get: function() {
		return extractLeadingHttpStatus;
	}
});
Object.defineProperty(exports, "extractProviderWrappedHttpStatus", {
	enumerable: true,
	get: function() {
		return extractProviderWrappedHttpStatus;
	}
});
...
Object.defineProperty(exports, "isCloudflareOrHtmlErrorPage", {
	enumerable: true,
	get: function() {
		return isCloudflareOrHtmlErrorPage;
	}
});
Object.defineProperty(exports, "isGenericProviderInternalError", {
	enumerable: true,
	get: function() {
		return isGenericProviderInternalError;
	}
});
Object.defineProperty(exports, "parseApiErrorInfo", {
	enumerable: true,
	get: function() {
		return parseApiErrorInfo;
	}
});
Object.defineProperty(exports, "parseApiErrorPayload", {
	enumerable: true,
	get: function() {
		return parseApiErrorPayload;
	}
});
