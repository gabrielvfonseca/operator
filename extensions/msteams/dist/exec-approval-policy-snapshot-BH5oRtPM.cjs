...
//#endregion
Object.defineProperty(exports, "canonicalizeExecApprovalPolicyRules", {
	enumerable: true,
	get: function() {
		return canonicalizeExecApprovalPolicyRules;
	}
});
Object.defineProperty(exports, "normalizeExecApprovalPolicySnapshot", {
	enumerable: true,
	get: function() {
		return normalizeExecApprovalPolicySnapshot;
	}
});
