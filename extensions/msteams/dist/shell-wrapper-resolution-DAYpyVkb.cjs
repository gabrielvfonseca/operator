...
function basenameLower(token) {
	const win = node_path.default.win32.basename(token);
	const posix = node_path.default.posix.basename(token);
	return (0, _gabrielvfonseca_normalization_core_string_coerce.normalizeLowercaseStringOrEmpty)(win.length < posix.length ? win : posix);
}
...
function scanWrapperInvocation(argv, params) {
	...
	while (idx < argv.length) {
		...
		const directive = params.onToken(token, (0, _gabrielvfonseca_normalization_core_string_coerce.normalizeLowercaseStringOrEmpty)(token));
...
function isPowerShellInlineRestCommandFlag(token) {
	return POWERSHELL_INLINE_REST_COMMAND_FLAGS.has((0, _gabrielvfonseca_normalization_core_string_coerce.normalizeLowercaseStringOrEmpty)(token));
}
...
function isPowerShellInlineFileCommandFlag(token) {
	return POWERSHELL_INLINE_FILE_FLAGS.has((0, _gabrielvfonseca_normalization_core_string_coerce.normalizeLowercaseStringOrEmpty)(token));
}
...
function extractCmdInlineCommand(argv) {
	const idx = argv.findIndex((item) => {
		const token = (0, _gabrielvfonseca_normalization_core_string_coerce.normalizeLowercaseStringOrEmpty)(item);
...
//#endregion
Object.defineProperty(exports, "COMMAND_CARRIER_EXECUTABLES", {
	enumerable: true,
	get: function() {
		return COMMAND_CARRIER_EXECUTABLES;
	}
});
Object.defineProperty(exports, "POSIX_INLINE_COMMAND_FLAGS", {
	enumerable: true,
	get: function() {
		return POSIX_INLINE_COMMAND_FLAGS;
	}
});
Object.defineProperty(exports, "POSIX_SHELL_WRAPPERS", {
	enumerable: true,
	get: function() {
		return POSIX_SHELL_WRAPPERS;
	}
});
Object.defineProperty(exports, "POWERSHELL_WRAPPERS", {
	enumerable: true,
	get: function() {
		return POWERSHELL_WRAPPERS;
	}
});
Object.defineProperty(exports, "SOURCE_EXECUTABLES", {
	enumerable: true,
	get: function() {
		return SOURCE_EXECUTABLES;
	}
});
Object.defineProperty(exports, "extractBindableShellWrapperInlineCommand", {
	enumerable: true,
	get: function() {
		return extractBindableShellWrapperInlineCommand;
	}
});
Object.defineProperty(exports, "extractShellWrapperCommand", {
	enumerable: true,
	get: function() {
		return extractShellWrapperCommand;
	}
});
Object.defineProperty(exports, "extractShellWrapperInlineCommand", {
	enumerable: true,
	get: function() {
		return extractShellWrapperInlineCommand;
	}
});
Object.defineProperty(exports, "hasEnvManipulationBeforeShellWrapper", {
	enumerable: true,
	get: function() {
		return hasEnvManipulationBeforeShellWrapper;
	}
});
Object.defineProperty(exports, "hasPosixInteractiveStartupBeforeInlineCommand", {
	enumerable: true,
	get: function() {
		return hasPosixInteractiveStartupBeforeInlineCommand;
	}
});
Object.defineProperty(exports, "hasPosixLoginStartupBeforeInlineCommand", {
	enumerable: true,
	get: function() {
		return hasPosixLoginStartupBeforeInlineCommand;
	}
});
Object.defineProperty(exports, "hasTopLevelShellControlOperator", {
	enumerable: true,
	get: function() {
		return hasTopLevelShellControlOperator;
	}
});
Object.defineProperty(exports, "isDirectShellPositionalCarrierCommand", {
	enumerable: true,
	get: function() {
		return isDirectShellPositionalCarrierCommand;
	}
});
Object.defineProperty(exports, "isDispatchWrapperExecutable", {
	enumerable: true,
	get: function() {
		return isDispatchWrapperExecutable;
	}
});
Object.defineProperty(exports, "isEnvAssignmentToken", {
	enumerable: true,
	get: function() {
		return isEnvAssignmentToken;
	}
});
Object.defineProperty(exports, "isPowerShellInlineFileCommandFlag", {
	enumerable: true,
	get: function() {
		return isPowerShellInlineFileCommandFlag;
	}
});
Object.defineProperty(exports, "isPowerShellInlineRestCommandFlag", {
	enumerable: true,
	get: function() {
		return isPowerShellInlineRestCommandFlag;
	}
});
Object.defineProperty(exports, "isShellWrapperExecutable", {
	enumerable: true,
	get: function() {
		return isShellWrapperExecutable;
	}
});
Object.defineProperty(exports, "isShellWrapperInvocation", {
	enumerable: true,
	get: function() {
		return isShellWrapperInvocation;
	}
});
Object.defineProperty(exports, "normalizeExecutableToken", {
	enumerable: true,
	get: function() {
		return normalizeExecutableToken;
	}
});
Object.defineProperty(exports, "parseEnvInvocationPrelude", {
	enumerable: true,
	get: function() {
		return parseEnvInvocationPrelude;
	}
});
Object.defineProperty(exports, "parseInlineOptionToken", {
	enumerable: true,
	get: function() {
		return parseInlineOptionToken;
	}
});
Object.defineProperty(exports, "resolveCarrierCommandArgv", {
	enumerable: true,
	get: function() {
		return resolveCarrierCommandArgv;
	}
});
Object.defineProperty(exports, "resolveDispatchWrapperTrustPlan", {
	enumerable: true,
	get: function() {
		return resolveDispatchWrapperTrustPlan;
	}
});
Object.defineProperty(exports, "resolveInlineCommandMatch", {
	enumerable: true,
	get: function() {
		return resolveInlineCommandMatch;
	}
});
Object.defineProperty(exports, "resolvePowerShellInlineCommandMatch", {
	enumerable: true,
	get: function() {
		return resolvePowerShellInlineCommandMatch;
	}
});
Object.defineProperty(exports, "resolveShellWrapperTransportArgv", {
	enumerable: true,
	get: function() {
		return resolveShellWrapperTransportArgv;
	}
});
Object.defineProperty(exports, "splitShellArgs", {
	enumerable: true,
	get: function() {
		return splitShellArgs;
	}
});
Object.defineProperty(exports, "unwrapDispatchWrappersForResolution", {
	enumerable: true,
	get: function() {
		return unwrapDispatchWrappersForResolution;
	}
});
Object.defineProperty(exports, "unwrapKnownDispatchWrapperInvocation", {
	enumerable: true,
	get: function() {
		return unwrapKnownDispatchWrapperInvocation;
	}
});
Object.defineProperty(exports, "unwrapKnownShellMultiplexerInvocation", {
	enumerable: true,
	get: function() {
		return unwrapKnownShellMultiplexerInvocation;
	}
});
