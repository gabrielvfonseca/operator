...
function resolveGatewayPortWithDefault(port, fallback = require_paths.DEFAULT_GATEWAY_PORT) {
...
//#endregion
Object.defineProperty(exports, "buildDefaultControlUiAllowedOrigins", {
	enumerable: true,
	get: function() {
		return buildDefaultControlUiAllowedOrigins;
	}
});
Object.defineProperty(exports, "ensureControlUiAllowedOriginsForNonLoopbackBind", {
	enumerable: true,
	get: function() {
		return ensureControlUiAllowedOriginsForNonLoopbackBind;
	}
});
Object.defineProperty(exports, "hasConfiguredControlUiAllowedOrigins", {
	enumerable: true,
	get: function() {
		return hasConfiguredControlUiAllowedOrigins;
	}
});
Object.defineProperty(exports, "isGatewayNonLoopbackBindMode", {
	enumerable: true,
	get: function() {
		return isGatewayNonLoopbackBindMode;
	}
});
Object.defineProperty(exports, "resolveGatewayPortWithDefault", {
	enumerable: true,
	get: function() {
		return resolveGatewayPortWithDefault;
	}
});
