...
require("./runtime-state-DbA1_jkE.cjs");
...
const PLUGIN_HOST_RUNTIME_STATE_KEY = Symbol.for("operator.pluginHostRuntimeState");
const CLOSED_RUN_IDS_MAX = 512;
const PLUGIN_TERMINAL_EVENT_CLEANUP_WAIT_MS = 5e3;
const log$1 = require_subsystem.createSubsystemLogger("plugins/host-hooks");
function getPluginHostRuntimeState() {
	return require_global_singleton.resolveGlobalSingleton(PLUGIN_HOST_RUNTIME_STATE_KEY, () => ({
...
function setPluginRunContext(params) {
	const runId = (0, _gabrielvfonseca_normalization_core_string_coerce.normalizeOptionalString)(params.patch.runId);
	...
	if (!require_host_hook_json.isPluginJsonValue(params.patch.value)) return false;
...
function getPluginRunContext(params) {
	const runId = (0, _gabrielvfonseca_normalization_core_string_coerce.normalizeOptionalString)(params.get.runId);
...
function registerPluginSessionSchedulerJob(params) {
	const id = (0, _gabrielvfonseca_normalization_core_string_coerce.normalizeOptionalString)(params.job.id);
	const sessionKey = (0, _gabrielvfonseca_normalization_core_string_coerce.normalizeOptionalString)(params.job.sessionKey);
	const kind = (0, _gabrielvfonseca_normalization_core_string_coerce.normalizeOptionalString)(params.job.kind);
...
async function cleanupPluginSessionSchedulerJobs(params) {
	...
	if (params.records) for (const record of params.records) {
		...
		const jobId = (0, _gabrielvfonseca_normalization_core_string_coerce.normalizeOptionalString)(record.job.id);
		const sessionKey = (0, _gabrielvfonseca_normalization_core_string_coerce.normalizeOptionalString)(record.job.sessionKey);
...
var runtime_exports = /* @__PURE__ */ require_rolldown_runtime.__exportAll({
	collectLivePluginRegistries: () => collectLivePluginRegistries,
	getActivePluginChannelRegistry: () => getActivePluginChannelRegistry,
	getActivePluginChannelRegistryVersion: () => getActivePluginChannelRegistryVersion,
	getActivePluginGatewayCommandRegistry: () => getActivePluginGatewayCommandRegistry,
	getActivePluginGatewayNodePolicyRegistry: () => getActivePluginGatewayNodePolicyRegistry,
	getActivePluginHttpRouteRegistry: () => getActivePluginHttpRouteRegistry,
	getActivePluginHttpRouteRegistryVersion: () => getActivePluginHttpRouteRegistryVersion,
	getActivePluginRegistry: () => getActivePluginRegistry,
	getActivePluginRegistryKey: () => getActivePluginRegistryKey,
	getActivePluginRegistryVersion: () => getActivePluginRegistryVersion,
	getActivePluginRegistryWorkspaceDir: () => getActivePluginRegistryWorkspaceDir,
	getActivePluginRuntimeSubagentMode: () => getActivePluginRuntimeSubagentMode,
	getActivePluginSessionExtensionRegistry: () => getActivePluginSessionExtensionRegistry,
	listImportedRuntimePluginIds: () => listImportedRuntimePluginIds,
	pinActivePluginChannelRegistry: () => pinActivePluginChannelRegistry,
	pinActivePluginHttpRouteRegistry: () => pinActivePluginHttpRouteRegistry,
	pinActivePluginSessionExtensionRegistry: () => pinActivePluginSessionExtensionRegistry,
	recordImportedPluginId: () => recordImportedPluginId,
	releasePinnedPluginChannelRegistry: () => releasePinnedPluginChannelRegistry,
	releasePinnedPluginHttpRouteRegistry: () => releasePinnedPluginHttpRouteRegistry,
	releasePinnedPluginSessionExtensionRegistry: () => releasePinnedPluginSessionExtensionRegistry,
	requireActivePluginChannelRegistry: () => requireActivePluginChannelRegistry,
	requireActivePluginHttpRouteRegistry: () => requireActivePluginHttpRouteRegistry,
	requireActivePluginRegistry: () => requireActivePluginRegistry,
	resetPluginRuntimeStateForTest: () => resetPluginRuntimeStateForTest,
	resolveActivePluginHttpRouteRegistry: () => resolveActivePluginHttpRouteRegistry,
	setActivePluginRegistry: () => setActivePluginRegistry
});
const log = require_subsystem.createSubsystemLogger("plugins/runtime");
function asPluginRegistry(registry) {
	return registry;
}
const state = (() => {
	const globalState = globalThis;
	let registryState = globalState[require_runtime_state_key.PLUGIN_REGISTRY_STATE];
	if (!registryState) {
		registryState = {
			activeRegistry: null,
			activeVersion: 0,
		...
		globalState[require_runtime_state_key.PLUGIN_REGISTRY_STATE] = registryState;
	}
...
async function cleanupPreviousPluginHostRegistry(params) {
	const [{ getRuntimeConfig }, { cleanupReplacedPluginHostRegistry }] = await Promise.all([Promise.resolve().then(() => require("./config-DT0qiglW.cjs")).then((n) => n.config_exports), Promise.resolve().then(() => require("./host-hook-cleanup-CCfZfwzs.cjs")).then((n) => n.host_hook_cleanup_exports)]);
...
function syncPluginAgentEventBridge() {
	...
	state.agentEventBridgeUnsubscribe = require_agent_events.onAgentEvent((event) => {
...
function getActivePluginChannelRegistry() {
	return require_runtime_channel_state.getActivePluginChannelRegistrySnapshotFromState().registry;
}
function getActivePluginChannelRegistryVersion() {
	return require_runtime_channel_state.getActivePluginChannelRegistrySnapshotFromState().version;
}
...
//#endregion
Object.defineProperty(exports, "cleanupPluginSessionSchedulerJobs", {
	enumerable: true,
	get: function() {
		return cleanupPluginSessionSchedulerJobs;
	}
});
Object.defineProperty(exports, "clearPluginRunContext", {
	enumerable: true,
	get: function() {
		return clearPluginRunContext;
	}
});
Object.defineProperty(exports, "collectLivePluginRegistries", {
	enumerable: true,
	get: function() {
		return collectLivePluginRegistries;
	}
});
Object.defineProperty(exports, "createEmptyPluginRegistry", {
	enumerable: true,
	get: function() {
		return createEmptyPluginRegistry;
	}
});
Object.defineProperty(exports, "deletePluginSessionSchedulerJob", {
	enumerable: true,
	get: function() {
		return deletePluginSessionSchedulerJob;
	}
});
Object.defineProperty(exports, "getActivePluginChannelRegistry", {
	enumerable: true,
	get: function() {
		return getActivePluginChannelRegistry;
	}
});
Object.defineProperty(exports, "getActivePluginChannelRegistryVersion", {
	enumerable: true,
	get: function() {
		return getActivePluginChannelRegistryVersion;
	}
});
Object.defineProperty(exports, "getActivePluginGatewayCommandRegistry", {
	enumerable: true,
	get: function() {
		return getActivePluginGatewayCommandRegistry;
	}
});
Object.defineProperty(exports, "getActivePluginGatewayNodePolicyRegistry", {
	enumerable: true,
	get: function() {
		return getActivePluginGatewayNodePolicyRegistry;
	}
});
Object.defineProperty(exports, "getActivePluginHttpRouteRegistry", {
	enumerable: true,
	get: function() {
		return getActivePluginHttpRouteRegistry;
	}
});
Object.defineProperty(exports, "getActivePluginHttpRouteRegistryVersion", {
	enumerable: true,
	get: function() {
		return getActivePluginHttpRouteRegistryVersion;
	}
});
Object.defineProperty(exports, "getActivePluginRegistry", {
	enumerable: true,
	get: function() {
		return getActivePluginRegistry;
	}
});
Object.defineProperty(exports, "getActivePluginRegistryKey", {
	enumerable: true,
	get: function() {
		return getActivePluginRegistryKey;
	}
});
Object.defineProperty(exports, "getActivePluginRegistryVersion", {
	enumerable: true,
	get: function() {
		return getActivePluginRegistryVersion;
	}
});
Object.defineProperty(exports, "getActivePluginRegistryWorkspaceDir", {
	enumerable: true,
	get: function() {
		return getActivePluginRegistryWorkspaceDir;
	}
});
Object.defineProperty(exports, "getActivePluginRuntimeSubagentMode", {
	enumerable: true,
	get: function() {
		return getActivePluginRuntimeSubagentMode;
	}
});
Object.defineProperty(exports, "getActivePluginSessionExtensionRegistry", {
	enumerable: true,
	get: function() {
		return getActivePluginSessionExtensionRegistry;
	}
});
Object.defineProperty(exports, "getPluginRunContext", {
	enumerable: true,
	get: function() {
		return getPluginRunContext;
	}
});
Object.defineProperty(exports, "getPluginSessionSchedulerJobGeneration", {
	enumerable: true,
	get: function() {
		return getPluginSessionSchedulerJobGeneration;
	}
});
Object.defineProperty(exports, "isPluginRegistryActivated", {
	enumerable: true,
	get: function() {
		return isPluginRegistryActivated;
	}
});
Object.defineProperty(exports, "isPluginRegistryRetired", {
	enumerable: true,
	get: function() {
		return isPluginRegistryRetired;
	}
});
Object.defineProperty(exports, "listImportedRuntimePluginIds", {
	enumerable: true,
	get: function() {
		return listImportedRuntimePluginIds;
	}
});
Object.defineProperty(exports, "makePluginSessionSchedulerJobKey", {
	enumerable: true,
	get: function() {
		return makePluginSessionSchedulerJobKey;
	}
});
Object.defineProperty(exports, "pinActivePluginChannelRegistry", {
	enumerable: true,
	get: function() {
		return pinActivePluginChannelRegistry;
	}
});
Object.defineProperty(exports, "pinActivePluginHttpRouteRegistry", {
	enumerable: true,
	get: function() {
		return pinActivePluginHttpRouteRegistry;
	}
});
Object.defineProperty(exports, "pinActivePluginSessionExtensionRegistry", {
	enumerable: true,
	get: function() {
		return pinActivePluginSessionExtensionRegistry;
	}
});
Object.defineProperty(exports, "recordImportedPluginId", {
	enumerable: true,
	get: function() {
		return recordImportedPluginId;
	}
});
Object.defineProperty(exports, "registerPluginSessionSchedulerJob", {
	enumerable: true,
	get: function() {
		return registerPluginSessionSchedulerJob;
	}
});
Object.defineProperty(exports, "releasePinnedPluginChannelRegistry", {
	enumerable: true,
	get: function() {
		return releasePinnedPluginChannelRegistry;
	}
});
Object.defineProperty(exports, "releasePinnedPluginHttpRouteRegistry", {
	enumerable: true,
	get: function() {
		return releasePinnedPluginHttpRouteRegistry;
	}
});
Object.defineProperty(exports, "releasePinnedPluginSessionExtensionRegistry", {
	enumerable: true,
	get: function() {
		return releasePinnedPluginSessionExtensionRegistry;
	}
});
Object.defineProperty(exports, "requireActivePluginChannelRegistry", {
	enumerable: true,
	get: function() {
		return requireActivePluginChannelRegistry;
	}
});
Object.defineProperty(exports, "requireActivePluginRegistry", {
	enumerable: true,
	get: function() {
...
Object.defineProperty(exports, "setActivePluginRegistry", {
	enumerable: true,
	get: function() {
		return setActivePluginRegistry;
	}
});
Object.defineProperty(exports, "setPluginRunContext", {
	enumerable: true,
	get: function() {
		return setPluginRunContext;
	}
});
Object.defineProperty(exports, "withPluginHostCleanupTimeout", {
	enumerable: true,
	get: function() {
		return withPluginHostCleanupTimeout;
	}
});
