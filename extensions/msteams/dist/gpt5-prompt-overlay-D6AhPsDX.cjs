...
function isGpt5ModelId(modelId) {
	const normalized = (0, _gabrielvfonseca_normalization_core_string_coerce.normalizeOptionalLowercaseString)(modelId);
...
//#endregion
Object.defineProperty(exports, "isGpt5ModelId", {
	enumerable: true,
	get: function() {
		return isGpt5ModelId;
	}
});
Object.defineProperty(exports, "resolveGpt5SystemPromptContribution", {
	enumerable: true,
	get: function() {
