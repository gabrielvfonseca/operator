...
function randomChoice(values, fallback) {
	return values[require_retry.generateSecureInt(values.length)] ?? fallback;
}
const SLUG_FALLBACK_ALPHABET = "abcdefghijklmnopqrstuvwxyz0123456789";
function createFallbackSuffix(length) {
	let suffix = "";
	for (let i = 0; i < length; i += 1) suffix += SLUG_FALLBACK_ALPHABET[require_retry.generateSecureInt(36)] ?? "x";
	return suffix;
}
...
let jobTtlMs = clampTtl(require_bash_tools_shared.readEnvInt("OPERATOR_BASH_JOB_TTL_MS", "PI_BASH_JOB_TTL_MS"));
...
function tail(text, max = 2e3) {
	...
	return (0, _gabrielvfonseca_normalization_core_utf16_slice.sliceUtf16Safe)(text, text.length - max);
}
...
function capPendingBuffer(buffer, pendingCharsInput, cap) {
	...
	if (buffer.length && pendingChars > cap) {
		...
		if (firstChunk !== void 0) {
			const trimmedChunk = (0, _gabrielvfonseca_normalization_core_utf16_slice.sliceUtf16Safe)(firstChunk, overflow);
...
if (process.env.VITEST || false) globalThis[Symbol.for("operator.bashProcessRegistryTestApi")] = { resetProcessRegistryForTests };
...
//#endregion
Object.defineProperty(exports, "addSession", {
	enumerable: true,
	get: function() {
		return addSession;
	}
});
Object.defineProperty(exports, "appendOutput", {
	enumerable: true,
	get: function() {
		return appendOutput;
	}
});
Object.defineProperty(exports, "createSessionSlug", {
	enumerable: true,
	get: function() {
		return createSessionSlug;
	}
});
Object.defineProperty(exports, "deleteSession", {
	enumerable: true,
	get: function() {
		return deleteSession;
	}
});
Object.defineProperty(exports, "drainSession", {
	enumerable: true,
	get: function() {
		return drainSession;
	}
});
Object.defineProperty(exports, "getActiveBackgroundExecSessionCount", {
	enumerable: true,
	get: function() {
		return getActiveBackgroundExecSessionCount;
	}
});
Object.defineProperty(exports, "getFinishedSession", {
	enumerable: true,
	get: function() {
		return getFinishedSession;
	}
});
...
Object.defineProperty(exports, "listFinishedSessions", {
	enumerable: true,
	get: function() {
		return listFinishedSessions;
	}
});
Object.defineProperty(exports, "listRunningSessions", {
	enumerable: true,
	get: function() {
		return listRunningSessions;
	}
});
Object.defineProperty(exports, "markBackgrounded", {
	enumerable: true,
	get: function() {
		return markBackgrounded;
	}
});
Object.defineProperty(exports, "markExited", {
	enumerable: true,
	get: function() {
		return markExited;
	}
});
Object.defineProperty(exports, "setJobTtlMs", {
	enumerable: true,
	get: function() {
		return setJobTtlMs;
	}
