...
function resolveAgentIdentity(cfg, agentId) {
	return require_agent_scope_config.resolveAgentConfig(cfg, agentId)?.identity;
}
...
function resolveHumanDelayConfig(cfg, agentId) {
	...
	const overrides = require_agent_scope_config.resolveAgentConfig(cfg, agentId)?.humanDelay;
...
//#endregion
Object.defineProperty(exports, "resolveAgentIdentity", {
	enumerable: true,
	get: function() {
		return resolveAgentIdentity;
	}
});
Object.defineProperty(exports, "resolveEffectiveMessagesConfig", {
	enumerable: true,
	get: function() {
		return resolveEffectiveMessagesConfig;
	}
});
Object.defineProperty(exports, "resolveHumanDelayConfig", {
	enumerable: true,
	get: function() {
		return resolveHumanDelayConfig;
	}
});
Object.defineProperty(exports, "resolveResponsePrefix", {
	enumerable: true,
	get: function() {
		return resolveResponsePrefix;
	}
});
