...
function normalizeAllowedDomains(value) {
	const deduped = (0, _gabrielvfonseca_normalization_core_string_normalization.normalizeUniqueTrimmedStringList)(value);
...
/** Resolve Codex native web-search config from Operator tool settings. */
...
//#endregion
Object.defineProperty(exports, "describeCodexNativeWebSearch", {
	enumerable: true,
	get: function() {
		return describeCodexNativeWebSearch;
	}
});
Object.defineProperty(exports, "resolveCodexNativeWebSearchConfig", {
	enumerable: true,
	get: function() {
		return resolveCodexNativeWebSearchConfig;
	}
});
