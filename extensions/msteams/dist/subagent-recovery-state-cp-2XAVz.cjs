...
function evaluateSubagentRecoveryGate(entry, now) {
	...
	if (previousAttempts >= SUBAGENT_RECOVERY_MAX_AUTOMATIC_ATTEMPTS) return {
		allowed: false,
		reason: `subagent orphan recovery blocked after ${previousAttempts} rapid accepted resume attempts; run "operator tasks maintenance --apply" or "operator doctor --fix" to reconcile it`,
...
//#endregion
Object.defineProperty(exports, "clearWedgedSubagentRecoveryAbort", {
	enumerable: true,
	get: function() {
		return clearWedgedSubagentRecoveryAbort;
	}
});
Object.defineProperty(exports, "evaluateSubagentRecoveryGate", {
	enumerable: true,
	get: function() {
		return evaluateSubagentRecoveryGate;
	}
});
Object.defineProperty(exports, "formatSubagentRecoveryWedgedReason", {
	enumerable: true,
	get: function() {
		return formatSubagentRecoveryWedgedReason;
	}
});
Object.defineProperty(exports, "isSubagentRecoveryWedgedEntry", {
	enumerable: true,
	get: function() {
		return isSubagentRecoveryWedgedEntry;
	}
});
Object.defineProperty(exports, "markSubagentRecoveryAttempt", {
	enumerable: true,
	get: function() {
		return markSubagentRecoveryAttempt;
	}
});
Object.defineProperty(exports, "markSubagentRecoveryWedged", {
	enumerable: true,
	get: function() {
		return markSubagentRecoveryWedged;
	}
});
