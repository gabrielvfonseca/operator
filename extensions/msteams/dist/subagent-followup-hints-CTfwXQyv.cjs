...
function normalizeHintText(value) {
	return (0, _gabrielvfonseca_normalization_core_string_coerce.normalizeLowercaseStringOrEmpty)(value).replace(/\s+/g, " ");
}
...
//#endregion
Object.defineProperty(exports, "expectsSubagentFollowup", {
	enumerable: true,
	get: function() {
		return expectsSubagentFollowup;
	}
});
Object.defineProperty(exports, "isLikelyInterimCronMessage", {
	enumerable: true,
	get: function() {
		return isLikelyInterimCronMessage;
	}
});
