...
var plugin_metadata_lifecycle_exports = /* @__PURE__ */ require_rolldown_runtime.__exportAll({
	clearPluginMetadataLifecycleCaches: () => clearPluginMetadataLifecycleCaches,
	registerPluginMetadataProcessMemoLifecycleClear: () => registerPluginMetadataProcessMemoLifecycleClear
});
...
//#endregion
Object.defineProperty(exports, "clearCurrentPluginMetadataSnapshotState", {
	enumerable: true,
	get: function() {
		return clearCurrentPluginMetadataSnapshotState;
	}
});
Object.defineProperty(exports, "clearPluginMetadataLifecycleCaches", {
	enumerable: true,
	get: function() {
		return clearPluginMetadataLifecycleCaches;
	}
});
Object.defineProperty(exports, "getCurrentPluginMetadataSnapshotState", {
	enumerable: true,
	get: function() {
		return getCurrentPluginMetadataSnapshotState;
	}
});
Object.defineProperty(exports, "plugin_metadata_lifecycle_exports", {
	enumerable: true,
	get: function() {
		return plugin_metadata_lifecycle_exports;
	}
});
Object.defineProperty(exports, "registerPluginMetadataProcessMemoLifecycleClear", {
	enumerable: true,
	get: function() {
		return registerPluginMetadataProcessMemoLifecycleClear;
	}
});
Object.defineProperty(exports, "setCurrentPluginMetadataSnapshotState", {
	enumerable: true,
	get: function() {
