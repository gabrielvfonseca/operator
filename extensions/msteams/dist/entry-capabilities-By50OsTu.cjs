...
function resolveEffectiveMediaEntryCapabilities(params) {
	...
	const providerId = require_provider_id.normalizeMediaProviderId(params.entry.provider ?? "");
...
//#endregion
Object.defineProperty(exports, "matchesMediaEntryCapability", {
	enumerable: true,
	get: function() {
		return matchesMediaEntryCapability;
	}
});
Object.defineProperty(exports, "resolveConfiguredMediaEntryCapabilities", {
	enumerable: true,
	get: function() {
		return resolveConfiguredMediaEntryCapabilities;
	}
});
Object.defineProperty(exports, "resolveEffectiveMediaEntryCapabilities", {
	enumerable: true,
	get: function() {
		return resolveEffectiveMediaEntryCapabilities;
	}
});
