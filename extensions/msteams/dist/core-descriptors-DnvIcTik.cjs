...
const CORE_GATEWAY_METHOD_SPECS = [
	...
	{
		name: "operator.approval.list",
		scope: "operator.approvals"
	},
	{
		name: "operator.setup.detect",
		scope: "operator.admin"
	},
	{
		name: "operator.setup.activate",
		scope: "operator.admin"
	},
	{
		name: "operator.setup.auth.start",
		scope: "operator.admin"
	},
	{
		name: "wizard.start",
...
//#endregion
Object.defineProperty(exports, "DYNAMIC_GATEWAY_METHOD_SCOPE", {
	enumerable: true,
	get: function() {
		return DYNAMIC_GATEWAY_METHOD_SCOPE;
	}
});
Object.defineProperty(exports, "NODE_GATEWAY_METHOD_SCOPE", {
	enumerable: true,
	get: function() {
		return NODE_GATEWAY_METHOD_SCOPE;
	}
});
Object.defineProperty(exports, "STARTUP_UNAVAILABLE_GATEWAY_METHODS", {
	enumerable: true,
	get: function() {
		return STARTUP_UNAVAILABLE_GATEWAY_METHODS;
	}
});
Object.defineProperty(exports, "createCoreGatewayMethodDescriptors", {
	enumerable: true,
	get: function() {
		return createCoreGatewayMethodDescriptors;
	}
});
Object.defineProperty(exports, "isCoreGatewayMethodClassified", {
	enumerable: true,
	get: function() {
		return isCoreGatewayMethodClassified;
	}
});
Object.defineProperty(exports, "isCoreNodeGatewayMethod", {
	enumerable: true,
	get: function() {
		return isCoreNodeGatewayMethod;
	}
});
Object.defineProperty(exports, "isDynamicOperatorGatewayMethod", {
	enumerable: true,
	get: function() {
		return isDynamicOperatorGatewayMethod;
	}
});
Object.defineProperty(exports, "listCoreAdvertisedGatewayMethodNames", {
	enumerable: true,
	get: function() {
		return listCoreAdvertisedGatewayMethodNames;
	}
});
Object.defineProperty(exports, "listCoreGatewayMethodNames", {
	enumerable: true,
	get: function() {
		return listCoreGatewayMethodNames;
	}
});
Object.defineProperty(exports, "resolveCoreOperatorGatewayMethodScope", {
	enumerable: true,
	get: function() {
		return resolveCoreOperatorGatewayMethodScope;
	}
});
