...
function resolveSharedGatewaySessionGeneration(auth, trustedProxies) {
	...
	if (shared) return require_crypto_digest.sha256Base64Url(`${shared.mode}\u0000${shared.secret}`);
	if (auth.mode === "trusted-proxy") return require_crypto_digest.sha256Base64Url(JSON.stringify({
		mode: auth.mode,
...
//#endregion
Object.defineProperty(exports, "resolveSharedGatewaySessionGeneration", {
	enumerable: true,
	get: function() {
