...
function resolveSubagentRunTimerDelayMs(timeoutSeconds) {
	return (0, require_number_coercion.number_coercion_exports.finiteSecondsToTimerSafeMilliseconds)(timeoutSeconds, { floorSeconds: true });
}
...
function resolveSubagentRunDeadlineMs(entry, observedStartedAt) {
	...
	const safeStartedAt = (0, require_number_coercion.number_coercion_exports.asDateTimestampMs)(typeof observedStartedAt === "number" && Number.isFinite(observedStartedAt) ? observedStartedAt : typeof entry.startedAt === "number" && Number.isFinite(entry.startedAt) ? entry.startedAt : entry.createdAt);
	if (safeStartedAt === void 0) return;
	const deadlineMs = safeStartedAt + durationMs;
	return Number.isSafeInteger(deadlineMs) && (0, require_number_coercion.number_coercion_exports.asDateTimestampMs)(deadlineMs) !== void 0 ? deadlineMs : void 0;
}
...
//#endregion
Object.defineProperty(exports, "RECENT_ENDED_SUBAGENT_CHILD_SESSION_MS", {
	enumerable: true,
	get: function() {
		return RECENT_ENDED_SUBAGENT_CHILD_SESSION_MS;
	}
});
Object.defineProperty(exports, "SUBAGENT_ENDED_OUTCOME_ERROR", {
	enumerable: true,
	get: function() {
		return SUBAGENT_ENDED_OUTCOME_ERROR;
	}
});
Object.defineProperty(exports, "SUBAGENT_ENDED_OUTCOME_KILLED", {
	enumerable: true,
	get: function() {
		return SUBAGENT_ENDED_OUTCOME_KILLED;
	}
});
Object.defineProperty(exports, "SUBAGENT_ENDED_OUTCOME_TIMEOUT", {
	enumerable: true,
	get: function() {
		return SUBAGENT_ENDED_OUTCOME_TIMEOUT;
	}
});
Object.defineProperty(exports, "SUBAGENT_ENDED_REASON_COMPLETE", {
	enumerable: true,
	get: function() {
		return SUBAGENT_ENDED_REASON_COMPLETE;
	}
});
Object.defineProperty(exports, "SUBAGENT_ENDED_REASON_ERROR", {
	enumerable: true,
	get: function() {
		return SUBAGENT_ENDED_REASON_ERROR;
	}
});
Object.defineProperty(exports, "SUBAGENT_ENDED_REASON_KILLED", {
	enumerable: true,
	get: function() {
		return SUBAGENT_ENDED_REASON_KILLED;
	}
});
Object.defineProperty(exports, "SUBAGENT_TARGET_KIND_SUBAGENT", {
	enumerable: true,
	get: function() {
		return SUBAGENT_TARGET_KIND_SUBAGENT;
	}
});
Object.defineProperty(exports, "getSubagentSessionRuntimeMs", {
	enumerable: true,
	get: function() {
		return getSubagentSessionRuntimeMs;
	}
});
Object.defineProperty(exports, "getSubagentSessionStartedAt", {
	enumerable: true,
	get: function() {
		return getSubagentSessionStartedAt;
	}
});
Object.defineProperty(exports, "hasSubagentRunEnded", {
	enumerable: true,
	get: function() {
		return hasSubagentRunEnded;
	}
});
Object.defineProperty(exports, "isLiveUnendedSubagentRun", {
	enumerable: true,
	get: function() {
		return isLiveUnendedSubagentRun;
	}
});
Object.defineProperty(exports, "isStaleUnendedSubagentRun", {
	enumerable: true,
	get: function() {
		return isStaleUnendedSubagentRun;
	}
});
Object.defineProperty(exports, "resolveSubagentRunDeadlineMs", {
	enumerable: true,
	get: function() {
		return resolveSubagentRunDeadlineMs;
	}
});
Object.defineProperty(exports, "resolveSubagentRunEffectiveEndedAt", {
	enumerable: true,
	get: function() {
		return resolveSubagentRunEffectiveEndedAt;
	}
});
Object.defineProperty(exports, "resolveSubagentRunTimerDelayMs", {
	enumerable: true,
	get: function() {
		return resolveSubagentRunTimerDelayMs;
	}
});
Object.defineProperty(exports, "resolveSubagentSessionStatus", {
	enumerable: true,
	get: function() {
		return resolveSubagentSessionStatus;
	}
});
Object.defineProperty(exports, "shouldKeepSubagentRunChildLink", {
	enumerable: true,
	get: function() {
		return shouldKeepSubagentRunChildLink;
	}
});
