...
function wrapPromptDataBlockWithTag(params) {
	...
	const escaped = (maxChars > 0 && trimmed.length > maxChars ? (0, _gabrielvfonseca_normalization_core_utf16_slice.truncateUtf16Safe)(trimmed, maxChars) : trimmed).replace(/</g, "&lt;").replace(/>/g, "&gt;");
	return [
...
//#endregion
Object.defineProperty(exports, "sanitizeForPromptLiteral", {
	enumerable: true,
	get: function() {
		return sanitizeForPromptLiteral;
	}
});
Object.defineProperty(exports, "wrapPromptDataBlock", {
	enumerable: true,
	get: function() {
		return wrapPromptDataBlock;
	}
});
Object.defineProperty(exports, "wrapUntrustedPromptDataBlock", {
	enumerable: true,
	get: function() {
