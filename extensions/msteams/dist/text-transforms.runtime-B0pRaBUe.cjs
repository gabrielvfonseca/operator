...
function transformContentText(content, replacements) {
	...
	if (!(0, _gabrielvfonseca_normalization_core_record_coerce.isRecord)(content)) return content;
	const next = { ...content };
...
function transformMessageText(message, replacements) {
	if (!(0, _gabrielvfonseca_normalization_core_record_coerce.isRecord)(message)) return message;
	const next = { ...message };
	if (Object.hasOwn(next, "content")) next.content = transformContentText(next.content, replacements);
...
function transformAssistantEventText(event, replacements) {
	if (!(0, _gabrielvfonseca_normalization_core_record_coerce.isRecord)(event) || !replacements || replacements.length === 0) return event;
	const next = { ...event };
	...
	if (next.type === "toolcall_end" && (0, _gabrielvfonseca_normalization_core_record_coerce.isRecord)(next.toolCall) && Object.hasOwn(next.toolCall, "arguments")) next.toolCall = {
		...next.toolCall,
...
//#endregion
Object.defineProperty(exports, "applyPluginTextReplacements", {
	enumerable: true,
	get: function() {
		return applyPluginTextReplacements;
	}
});
Object.defineProperty(exports, "createStreamIteratorWrapper", {
	enumerable: true,
	get: function() {
		return createStreamIteratorWrapper;
	}
});
Object.defineProperty(exports, "mergePluginTextTransforms", {
	enumerable: true,
	get: function() {
		return mergePluginTextTransforms;
	}
});
Object.defineProperty(exports, "resolveRuntimeTextTransforms", {
	enumerable: true,
	get: function() {
		return resolveRuntimeTextTransforms;
	}
});
Object.defineProperty(exports, "wrapStreamFnTextTransforms", {
	enumerable: true,
	get: function() {
		return wrapStreamFnTextTransforms;
	}
});
