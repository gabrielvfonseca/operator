...
* channel split (`OPERATOR_UPDATE_POST_CORE_CHANNEL` vs `…_REQUESTED_CHANNEL`).
*/
const UPDATE_EFFECTIVE_CHANNEL_ENV = "OPERATOR_UPDATE_EFFECTIVE_CHANNEL";
...
/** Maps an Operator update channel to the npm dist-tag used for package lookups. */
...
function isPrereleaseTag(tag) {
	const parsed = (0, semver.parse)(require_semver.normalizeLegacyDotBetaVersion(tag));
...
//#endregion
Object.defineProperty(exports, "DEFAULT_PACKAGE_CHANNEL", {
	enumerable: true,
	get: function() {
		return DEFAULT_PACKAGE_CHANNEL;
	}
});
Object.defineProperty(exports, "DEV_BRANCH", {
	enumerable: true,
	get: function() {
		return DEV_BRANCH;
	}
});
Object.defineProperty(exports, "EXTENDED_STABLE_TAG_UNSUPPORTED_REASON", {
	enumerable: true,
	get: function() {
		return EXTENDED_STABLE_TAG_UNSUPPORTED_REASON;
	}
});
Object.defineProperty(exports, "UPDATE_EFFECTIVE_CHANNEL_ENV", {
	enumerable: true,
	get: function() {
		return UPDATE_EFFECTIVE_CHANNEL_ENV;
	}
});
Object.defineProperty(exports, "channelToNpmTag", {
	enumerable: true,
	get: function() {
		return channelToNpmTag;
	}
});
Object.defineProperty(exports, "isBetaTag", {
	enumerable: true,
	get: function() {
		return isBetaTag;
	}
});
Object.defineProperty(exports, "isStableTag", {
	enumerable: true,
	get: function() {
		return isStableTag;
	}
});
Object.defineProperty(exports, "normalizeUpdateChannel", {
	enumerable: true,
	get: function() {
		return normalizeUpdateChannel;
	}
});
Object.defineProperty(exports, "resolveRegistryUpdateChannel", {
	enumerable: true,
	get: function() {
		return resolveRegistryUpdateChannel;
	}
});
Object.defineProperty(exports, "resolveUpdateChannelDisplay", {
	enumerable: true,
	get: function() {
