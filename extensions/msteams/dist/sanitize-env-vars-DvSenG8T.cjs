...
const BLOCKED_ENV_VAR_PATTERNS = [
	...
	/^OPERATOR_GATEWAY_(TOKEN|PASSWORD)$/i,
...
function sanitizeEnvVars(envVars, options = {}) {
	...
	const activeMetadataSnapshot = metadataSnapshot ? {
		...metadataSnapshot,
		plugins: metadataSnapshot.plugins.filter((plugin) => require_installed_plugin_index.isInstalledPluginEnabled(metadataSnapshot.index, plugin.id))
	} : void 0;
	const knownSecretNames = new Set(require_provider_env_vars.listKnownSecretEnvVarNames({
		env: envVars,
...
//#endregion
Object.defineProperty(exports, "sanitizeEnvVars", {
	enumerable: true,
	get: function() {
		return sanitizeEnvVars;
	}
});
Object.defineProperty(exports, "sanitizeExplicitSandboxEnvVars", {
	enumerable: true,
	get: function() {
		return sanitizeExplicitSandboxEnvVars;
	}
});
Object.defineProperty(exports, "validateEnvVarValue", {
	enumerable: true,
	get: function() {
		return validateEnvVarValue;
	}
});
