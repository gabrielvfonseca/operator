...
function collectTrackedActiveSessionRuns(context) {
	...
	for (const [runId, active] of context.chatAbortControllers) if (active.projectSessionActive !== false && active.controlUiVisible !== false) {
		...
		runs.push({
			...
			...sessionId ? { sessionId } : {},
			agentId: typeof active.agentId === "string" ? (0, _gabrielvfonseca_normalization_core_agent_id.normalizeAgentId)(active.agentId) : void 0
		});
	}
	return runs;
}
function isTrackedActiveSessionRunForKey(active, key, agentId, defaultAgentId) {
	...
	return activeAgentId ? (0, _gabrielvfonseca_normalization_core_agent_id.normalizeAgentId)(activeAgentId) === (0, _gabrielvfonseca_normalization_core_agent_id.normalizeAgentId)(requestedAgentId) : false;
}
...
function resolveVisibleActiveSessionRunState(params) {
	...
	const hasProjectedRun = require_agent_events.hasProjectedAgentRunForSession({
		sessionKeys: [params.requestedKey, params.canonicalKey],
		...sessionId ? { sessionId } : {}
	});
	return {
		active: runIds.length > 0 || hasProjectedRun || sessionId !== void 0 && require_runs.isEmbeddedAgentRunActive(sessionId),
		runIds
	};
}
...
//#endregion
Object.defineProperty(exports, "hasTrackedActiveSessionRun", {
	enumerable: true,
	get: function() {
		return hasTrackedActiveSessionRun;
	}
});
Object.defineProperty(exports, "hasVisibleActiveSessionRun", {
	enumerable: true,
	get: function() {
		return hasVisibleActiveSessionRun;
	}
});
Object.defineProperty(exports, "resolveVisibleActiveSessionRunState", {
	enumerable: true,
	get: function() {
