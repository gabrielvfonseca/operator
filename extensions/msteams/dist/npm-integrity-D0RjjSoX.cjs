...
/**
* Resolves integrity drift with Operator's default warning and abort messages.
...
//#endregion
Object.defineProperty(exports, "resolveNpmIntegrityDriftWithDefaultMessage", {
	enumerable: true,
	get: function() {
		return resolveNpmIntegrityDriftWithDefaultMessage;
	}
});
