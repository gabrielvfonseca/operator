...
function sanitizeHostEnvOverridesWithDiagnostics(params) {
	...
	return {
		acceptedOverrides,
		rejectedOverrideBlockedKeys: (0, _gabrielvfonseca_normalization_core_string_normalization.sortUniqueStrings)(rejectedBlocked),
		rejectedOverrideInvalidKeys: (0, _gabrielvfonseca_normalization_core_string_normalization.sortUniqueStrings)(rejectedInvalid)
	};
}
function sanitizeHostExecEnvWithDiagnostics(params) {
	...
	return {
		env: require_openclaw_exec_env.markOperatorExecEnv(merged),
...
//#endregion
Object.defineProperty(exports, "isDangerousHostEnvOverrideVarName", {
	enumerable: true,
	get: function() {
		return isDangerousHostEnvOverrideVarName;
	}
});
Object.defineProperty(exports, "isDangerousHostEnvVarName", {
	enumerable: true,
	get: function() {
		return isDangerousHostEnvVarName;
	}
});
Object.defineProperty(exports, "isDangerousHostInheritedEnvVarName", {
	enumerable: true,
	get: function() {
		return isDangerousHostInheritedEnvVarName;
	}
});
Object.defineProperty(exports, "normalizeEnvVarKey", {
	enumerable: true,
	get: function() {
		return normalizeEnvVarKey;
	}
});
Object.defineProperty(exports, "normalizeHostOverrideEnvVarKey", {
	enumerable: true,
	get: function() {
		return normalizeHostOverrideEnvVarKey;
	}
});
Object.defineProperty(exports, "sanitizeHostExecEnv", {
	enumerable: true,
	get: function() {
		return sanitizeHostExecEnv;
	}
});
Object.defineProperty(exports, "sanitizeHostExecEnvWithDiagnostics", {
	enumerable: true,
	get: function() {
		return sanitizeHostExecEnvWithDiagnostics;
	}
});
