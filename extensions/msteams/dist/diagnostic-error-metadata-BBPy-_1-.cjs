...
function hashDiagnosticIdentifier(value) {
	return `sha256:${require_crypto_digest.sha256HexPrefix(value, REQUEST_ID_HASH_PREFIX_LEN)}`;
}
...
//#endregion
Object.defineProperty(exports, "diagnosticErrorCategory", {
	enumerable: true,
	get: function() {
		return diagnosticErrorCategory;
	}
});
Object.defineProperty(exports, "diagnosticErrorFailureKind", {
	enumerable: true,
	get: function() {
		return diagnosticErrorFailureKind;
	}
});
Object.defineProperty(exports, "diagnosticErrorMessage", {
	enumerable: true,
	get: function() {
		return diagnosticErrorMessage;
	}
});
Object.defineProperty(exports, "diagnosticHttpStatusCode", {
	enumerable: true,
	get: function() {
		return diagnosticHttpStatusCode;
	}
});
Object.defineProperty(exports, "diagnosticProviderRequestIdHash", {
	enumerable: true,
	get: function() {
		return diagnosticProviderRequestIdHash;
	}
});
