...
function resolveStatusUpdateChannelInfo(params) {
	return require_update_channels.resolveUpdateChannelDisplay({
		configChannel: require_update_channels.normalizeUpdateChannel(params.updateConfigChannel),
...
function buildStatusUpdateSurface(params) {
	...
	return {
		...
		gitLabel: require_update_check.formatGitInstallLabel(params.update),
		updateLine: require_status_update.formatUpdateOneLiner(params.update).replace(/^Update:\s*/i, ""),
		updateAvailable: require_status_update.resolveUpdateAvailability(params.update).available
	};
}
...
function formatStatusServiceValue(params) {
	...
	const installedPrefix = params.managedByOperator ? "installed · " : "";
...
function resolveStatusDashboardUrl(params) {
	...
	return require_control_ui_links.resolveControlUiLinks({
		port: require_paths.resolveGatewayPort(params.cfg),
...
function buildGatewayStatusSummaryParts(params) {
	...
	return {
		...
		reachText: params.remoteUrlMissing ? "misconfigured (remote.url missing)" : params.gatewayReachable ? `reachable ${require_format_duration.formatDurationPrecise(params.gatewayProbe?.connectLatencyMs ?? 0)}` : params.gatewayProbe?.error ? `unreachable (${params.gatewayProbe.error})` : "unreachable",
...
function buildStatusGatewaySurfaceValues(params) {
	...
	return {
		...
		gatewayServiceValue: formatStatusServiceValue({
			...
			managedByOperator: params.gatewayService.managedByOperator,
		...
		nodeServiceValue: formatStatusServiceValue({
			...
			managedByOperator: params.nodeService.managedByOperator,
...
//#endregion
Object.defineProperty(exports, "buildGatewayStatusJsonPayload", {
	enumerable: true,
	get: function() {
		return buildGatewayStatusJsonPayload;
	}
});
Object.defineProperty(exports, "buildGatewayStatusSummaryParts", {
	enumerable: true,
	get: function() {
		return buildGatewayStatusSummaryParts;
	}
});
Object.defineProperty(exports, "buildStatusGatewaySurfaceValues", {
	enumerable: true,
	get: function() {
		return buildStatusGatewaySurfaceValues;
	}
});
Object.defineProperty(exports, "buildStatusOverviewRows", {
	enumerable: true,
	get: function() {
		return buildStatusOverviewRows;
	}
});
Object.defineProperty(exports, "buildStatusOverviewSurfaceRows", {
	enumerable: true,
	get: function() {
		return buildStatusOverviewSurfaceRows;
	}
});
Object.defineProperty(exports, "buildStatusUpdateSurface", {
	enumerable: true,
	get: function() {
		return buildStatusUpdateSurface;
	}
});
Object.defineProperty(exports, "formatGatewayAuthUsed", {
	enumerable: true,
	get: function() {
		return formatGatewayAuthUsed;
	}
});
Object.defineProperty(exports, "formatGatewaySelfSummary", {
	enumerable: true,
	get: function() {
		return formatGatewaySelfSummary;
	}
});
Object.defineProperty(exports, "formatStatusDashboardValue", {
	enumerable: true,
	get: function() {
		return formatStatusDashboardValue;
	}
});
Object.defineProperty(exports, "formatStatusServiceValue", {
	enumerable: true,
	get: function() {
		return formatStatusServiceValue;
	}
});
Object.defineProperty(exports, "formatStatusTailscaleValue", {
	enumerable: true,
	get: function() {
		return formatStatusTailscaleValue;
	}
});
...
Object.defineProperty(exports, "resolveStatusDashboardUrl", {
	enumerable: true,
	get: function() {
		return resolveStatusDashboardUrl;
	}
});
Object.defineProperty(exports, "resolveStatusUpdateChannelInfo", {
	enumerable: true,
	get: function() {
		return resolveStatusUpdateChannelInfo;
	}
});
