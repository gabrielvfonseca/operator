...
function formatWindowShort(window, now) {
	const remaining = require_provider_usage_load.clampPercent(100 - window.usedPercent);
...
//#endregion
//#region src/infra/provider-usage.ts
var provider_usage_exports = /* @__PURE__ */ require_rolldown_runtime.__exportAll({
	...
	loadProviderUsageSummary: () => require_provider_usage_load.loadProviderUsageSummary,
	resolveUsageProviderId: () => require_provider_usage_load.resolveUsageProviderId
});
//#endregion
Object.defineProperty(exports, "formatUsageWindowSummary", {
	enumerable: true,
	get: function() {
		return formatUsageWindowSummary;
	}
});
Object.defineProperty(exports, "provider_usage_exports", {
	enumerable: true,
	get: function() {
		return provider_usage_exports;
	}
});
