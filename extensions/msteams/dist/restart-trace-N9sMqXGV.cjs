...
const restartTraceLog = require_subsystem.createSubsystemLogger("gateway");
const RESTART_TRACE_HANDOFF_STARTED_AT_ENV = "OPERATOR_GATEWAY_RESTART_TRACE_STARTED_AT_MS";
const RESTART_TRACE_HANDOFF_LAST_AT_ENV = "OPERATOR_GATEWAY_RESTART_TRACE_LAST_AT_MS";
const RESTART_TRACE_HANDOFF_MAX_AGE_MS = 10 * 6e4;
let startedAt = 0;
let lastAt = 0;
let active = false;
function nowMs() {
	return node_perf_hooks.performance.timeOrigin + node_perf_hooks.performance.now();
}
function isRestartTraceEnabled() {
	return require_env.isTruthyEnvValue(process.env.OPERATOR_GATEWAY_RESTART_TRACE);
}
...
//#endregion
Object.defineProperty(exports, "collectGatewayProcessMemoryUsageMb", {
	enumerable: true,
	get: function() {
		return collectGatewayProcessMemoryUsageMb;
	}
});
Object.defineProperty(exports, "finishGatewayRestartTrace", {
	enumerable: true,
	get: function() {
		return finishGatewayRestartTrace;
	}
});
Object.defineProperty(exports, "measureGatewayRestartTrace", {
	enumerable: true,
	get: function() {
		return measureGatewayRestartTrace;
	}
});
Object.defineProperty(exports, "recordGatewayRestartTrace", {
	enumerable: true,
	get: function() {
		return recordGatewayRestartTrace;
	}
});
Object.defineProperty(exports, "recordGatewayRestartTraceDetail", {
	enumerable: true,
	get: function() {
		return recordGatewayRestartTraceDetail;
	}
});
Object.defineProperty(exports, "recordGatewayRestartTraceSpan", {
	enumerable: true,
	get: function() {
		return recordGatewayRestartTraceSpan;
	}
});
Object.defineProperty(exports, "resumeGatewayRestartTraceFromEnv", {
	enumerable: true,
	get: function() {
		return resumeGatewayRestartTraceFromEnv;
	}
});
Object.defineProperty(exports, "resumeGatewayRestartTraceFromHandoff", {
	enumerable: true,
	get: function() {
		return resumeGatewayRestartTraceFromHandoff;
	}
