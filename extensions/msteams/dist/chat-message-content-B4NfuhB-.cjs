...
function extractFirstTextBlock(message) {
	...
	const inline = (0, _gabrielvfonseca_normalization_core_string_coerce.readStringValue)(content);
	if (inline !== void 0) return inline;
	if (!Array.isArray(content) || content.length === 0) return;
	const first = content[0];
	if (!first || typeof first !== "object") return;
	return (0, _gabrielvfonseca_normalization_core_string_coerce.readStringValue)(first.text);
}
...
//#endregion
Object.defineProperty(exports, "extractAssistantTextForPhase", {
	enumerable: true,
	get: function() {
		return extractAssistantTextForPhase;
	}
});
...
Object.defineProperty(exports, "extractFirstTextBlock", {
	enumerable: true,
	get: function() {
		return extractFirstTextBlock;
	}
});
Object.defineProperty(exports, "normalizeAssistantPhase", {
	enumerable: true,
	get: function() {
		return normalizeAssistantPhase;
	}
});
Object.defineProperty(exports, "parseAssistantTextSignature", {
	enumerable: true,
	get: function() {
		return parseAssistantTextSignature;
	}
});
Object.defineProperty(exports, "resolveAssistantEventPhase", {
	enumerable: true,
	get: function() {
		return resolveAssistantEventPhase;
	}
});
Object.defineProperty(exports, "resolveAssistantMessagePhase", {
	enumerable: true,
	get: function() {
		return resolveAssistantMessagePhase;
	}
});
