...
//#endregion
Object.defineProperty(exports, "compareSubagentRunGeneration", {
	enumerable: true,
	get: function() {
		return compareSubagentRunGeneration;
	}
});
Object.defineProperty(exports, "nextSubagentRunGeneration", {
	enumerable: true,
	get: function() {
		return nextSubagentRunGeneration;
	}
});
