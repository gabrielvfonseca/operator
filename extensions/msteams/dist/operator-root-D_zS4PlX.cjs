...
//#region src/infra/operator-root.ts
const CORE_PACKAGE_NAMES = /* @__PURE__ */ new Set(["operator"]);
...
Object.defineProperty(exports, "resolveOperatorPackageRootsSync", {
	enumerable: true,
	get: function() {
		return resolveOperatorPackageRootsSync;
	}
});
