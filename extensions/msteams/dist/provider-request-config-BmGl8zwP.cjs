...
function sanitizeConfiguredRequestString(value, path) {
	if (typeof value !== "string") {
		require_types_secrets.assertSecretInputResolved({
			value,
			path
		});
		return;
...
function resolveProviderDefaultRequestHeaders(provider) {
	if ((0, _gabrielvfonseca_normalization_core_string_coerce.normalizeLowercaseStringOrEmpty)(provider) !== "github-copilot") return;
	return {
		...buildCopilotIdeHeaders(),
		"Copilot-Integration-Id": COPILOT_INTEGRATION_ID,
		"Openai-Organization": "github-copilot"
...
function applyResolvedAuthHeader(headers, auth) {
	...
	const keysToDelete = /* @__PURE__ */ new Set([(0, _gabrielvfonseca_normalization_core_string_coerce.normalizeLowercaseStringOrEmpty)(auth.headerName)]);
	if (auth.mode === "header") keysToDelete.add("authorization");
	for (const key of Object.keys(next)) if (keysToDelete.has((0, _gabrielvfonseca_normalization_core_string_coerce.normalizeLowercaseStringOrEmpty)(key))) delete next[key];
...
function resolveProviderRequestPolicyConfig(params) {
	...
	const policy = require_provider_attribution.resolveProviderRequestPolicy(policyInput);
	...
	const protectedAttributionKeys = new Set(Object.keys(policy.attributionHeaders ?? {}).map((key) => (0, _gabrielvfonseca_normalization_core_string_coerce.normalizeLowercaseStringOrEmpty)(key)));
	const unprotectedCallerHeaders = params.callerHeaders ? Object.fromEntries(Object.entries(params.callerHeaders).filter(([key]) => !protectedAttributionKeys.has((0, _gabrielvfonseca_normalization_core_string_coerce.normalizeLowercaseStringOrEmpty)(key)))) : void 0;
...
const MODEL_PROVIDER_REQUEST_TRANSPORT_SYMBOL = Symbol.for("operator.modelProviderRequestTransport");
...
//#endregion
Object.defineProperty(exports, "COPILOT_INTEGRATION_ID", {
	enumerable: true,
	get: function() {
		return COPILOT_INTEGRATION_ID;
	}
});
Object.defineProperty(exports, "applyPreparedRuntimeAuthToModel", {
	enumerable: true,
	get: function() {
		return applyPreparedRuntimeAuthToModel;
	}
});
Object.defineProperty(exports, "attachModelProviderRequestTransport", {
	enumerable: true,
	get: function() {
		return attachModelProviderRequestTransport;
	}
});
Object.defineProperty(exports, "buildCopilotDynamicHeaders", {
	enumerable: true,
	get: function() {
		return buildCopilotDynamicHeaders;
	}
});
Object.defineProperty(exports, "buildCopilotIdeHeaders", {
	enumerable: true,
	get: function() {
		return buildCopilotIdeHeaders;
	}
});
Object.defineProperty(exports, "buildProviderRequestDispatcherPolicy", {
	enumerable: true,
	get: function() {
		return buildProviderRequestDispatcherPolicy;
	}
});
Object.defineProperty(exports, "getModelProviderRequestTransport", {
	enumerable: true,
	get: function() {
		return getModelProviderRequestTransport;
	}
});
Object.defineProperty(exports, "hasCopilotVisionInput", {
	enumerable: true,
	get: function() {
		return hasCopilotVisionInput;
	}
});
Object.defineProperty(exports, "mergeModelProviderRequestOverrides", {
	enumerable: true,
	get: function() {
		return mergeModelProviderRequestOverrides;
	}
});
Object.defineProperty(exports, "resolveProviderRequestConfig", {
	enumerable: true,
	get: function() {
		return resolveProviderRequestConfig;
	}
});
Object.defineProperty(exports, "resolveProviderRequestHeaders", {
	enumerable: true,
	get: function() {
		return resolveProviderRequestHeaders;
	}
});
Object.defineProperty(exports, "resolveProviderRequestPolicyConfig", {
	enumerable: true,
	get: function() {
		return resolveProviderRequestPolicyConfig;
	}
});
Object.defineProperty(exports, "sanitizeConfiguredModelProviderRequest", {
	enumerable: true,
	get: function() {
		return sanitizeConfiguredModelProviderRequest;
	}
});
Object.defineProperty(exports, "sanitizeConfiguredProviderRequest", {
	enumerable: true,
	get: function() {
		return sanitizeConfiguredProviderRequest;
	}
});
