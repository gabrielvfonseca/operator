...
const MCP_AUTH_HEADERS = { Authorization: "Bearer ${OPERATOR_MCP_TOKEN}" };
const MCP_CAPTURE_HEADERS = { "x-operator-cli-capture-key": "${OPERATOR_MCP_CLI_CAPTURE_KEY}" };
...
//#endregion
Object.defineProperty(exports, "beginMcpLoopbackToolCallCapture", {
	enumerable: true,
	get: function() {
		return beginMcpLoopbackToolCallCapture;
	}
});
Object.defineProperty(exports, "clearActiveMcpLoopbackRuntimeByOwnerToken", {
	enumerable: true,
	get: function() {
		return clearActiveMcpLoopbackRuntimeByOwnerToken;
	}
});
Object.defineProperty(exports, "clearMcpLoopbackToolCallCapture", {
	enumerable: true,
	get: function() {
		return clearMcpLoopbackToolCallCapture;
	}
});
Object.defineProperty(exports, "createMcpAttachGrantServerConfig", {
	enumerable: true,
	get: function() {
		return createMcpAttachGrantServerConfig;
	}
});
Object.defineProperty(exports, "createMcpLoopbackServerConfig", {
	enumerable: true,
	get: function() {
		return createMcpLoopbackServerConfig;
	}
});
Object.defineProperty(exports, "getActiveMcpLoopbackRuntime", {
	enumerable: true,
	get: function() {
		return getActiveMcpLoopbackRuntime;
	}
});
Object.defineProperty(exports, "markMcpLoopbackRequestClassified", {
	enumerable: true,
	get: function() {
		return markMcpLoopbackRequestClassified;
	}
});
Object.defineProperty(exports, "markMcpLoopbackRequestFinished", {
	enumerable: true,
	get: function() {
		return markMcpLoopbackRequestFinished;
	}
});
Object.defineProperty(exports, "markMcpLoopbackRequestStarted", {
	enumerable: true,
	get: function() {
		return markMcpLoopbackRequestStarted;
	}
});
Object.defineProperty(exports, "markMcpLoopbackToolCallFinished", {
	enumerable: true,
	get: function() {
		return markMcpLoopbackToolCallFinished;
	}
});
Object.defineProperty(exports, "markMcpLoopbackToolCallStarted", {
	enumerable: true,
	get: function() {
		return markMcpLoopbackToolCallStarted;
	}
});
Object.defineProperty(exports, "recordMcpLoopbackToolCallResult", {
	enumerable: true,
	get: function() {
		return recordMcpLoopbackToolCallResult;
	}
});
Object.defineProperty(exports, "resolveMcpLoopbackYieldContext", {
	enumerable: true,
	get: function() {
		return resolveMcpLoopbackYieldContext;
	}
});
Object.defineProperty(exports, "setActiveMcpLoopbackRuntime", {
	enumerable: true,
	get: function() {
		return setActiveMcpLoopbackRuntime;
	}
});
Object.defineProperty(exports, "updateMcpLoopbackToolCallCapture", {
	enumerable: true,
	get: function() {
		return updateMcpLoopbackToolCallCapture;
	}
});
Object.defineProperty(exports, "waitForMcpLoopbackToolCallCaptureIdle", {
	enumerable: true,
	get: function() {
		return waitForMcpLoopbackToolCallCaptureIdle;
	}
});
