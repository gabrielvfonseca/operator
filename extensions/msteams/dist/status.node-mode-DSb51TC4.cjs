...
async function resolveNodeOnlyGatewayInfo(params) {
	...
	const gatewayTarget = resolveNodeGatewayTarget((await require_config.loadNodeHostConfig())?.gateway);
	return {
		gatewayTarget,
...
//#endregion
exports.resolveNodeOnlyGatewayInfo = resolveNodeOnlyGatewayInfo;
