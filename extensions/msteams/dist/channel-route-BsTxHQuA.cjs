...
function normalizeRouteThreadId(value) {
	return require_string_coerce.normalizeOptionalThreadValue(value);
}
...
function normalizeChannelRouteRef(input) {
	if (!input) return;
	const channel = require_string_coerce.normalizeLowercaseStringOrEmpty(input.channel);
	const accountId = typeof input.accountId === "string" ? require_account_id.normalizeOptionalAccountId(input.accountId) : void 0;
	const to = require_string_coerce.normalizeOptionalString(input.to);
	const rawTo = require_string_coerce.normalizeOptionalString(input.rawTo);
...
//#endregion
Object.defineProperty(exports, "channelRouteCompactKey", {
	enumerable: true,
	get: function() {
		return channelRouteCompactKey;
	}
});
Object.defineProperty(exports, "channelRouteDedupeKey", {
	enumerable: true,
	get: function() {
		return channelRouteDedupeKey;
	}
});
Object.defineProperty(exports, "channelRouteTarget", {
	enumerable: true,
	get: function() {
		return channelRouteTarget;
	}
});
Object.defineProperty(exports, "channelRouteTargetsMatchExact", {
	enumerable: true,
	get: function() {
		return channelRouteTargetsMatchExact;
	}
});
Object.defineProperty(exports, "channelRouteTargetsShareConversation", {
	enumerable: true,
	get: function() {
		return channelRouteTargetsShareConversation;
	}
});
Object.defineProperty(exports, "channelRouteThreadId", {
	enumerable: true,
	get: function() {
		return channelRouteThreadId;
	}
});
Object.defineProperty(exports, "normalizeChannelRouteRef", {
	enumerable: true,
	get: function() {
		return normalizeChannelRouteRef;
	}
});
Object.defineProperty(exports, "normalizeChannelRouteTarget", {
	enumerable: true,
	get: function() {
		return normalizeChannelRouteTarget;
	}
});
Object.defineProperty(exports, "stringifyRouteThreadId", {
	enumerable: true,
	get: function() {
