...
function collectTypeOAuthSecretRefViolations(params) {
	...
	for (const field of [
		...
		if (require_types_secrets.coerceSecretRef(record[field], params.defaults) === null) continue;
...
//#endregion
Object.defineProperty(exports, "assertNoOAuthSecretRefPolicyViolations", {
	enumerable: true,
	get: function() {
		return assertNoOAuthSecretRefPolicyViolations;
	}
});
