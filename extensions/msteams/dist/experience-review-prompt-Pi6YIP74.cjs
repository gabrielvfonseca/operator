...
function formatSkillExperienceReviewTranscript(messages) {
	...
	const first = rendered[0]?.slice(0, 6e3) ?? "";
...
//#endregion
Object.defineProperty(exports, "buildSkillExperienceReviewPrompt", {
	enumerable: true,
	get: function() {
		return buildSkillExperienceReviewPrompt;
	}
});
Object.defineProperty(exports, "formatSkillExperienceReviewTranscript", {
	enumerable: true,
	get: function() {
		return formatSkillExperienceReviewTranscript;
	}
});
