...
function detectSystemTimeFormat() {
	if (process.platform === "darwin") try {
		const result = (0, node_child_process.execFileSync)("defaults", [
			"read",
			"-g",
	...
	if (process.platform === "win32") try {
		const result = (0, node_child_process.execFileSync)("powershell", ["-Command", "(Get-Culture).DateTimeFormat.ShortTimePattern"], {
			encoding: "utf8",
			timeout: 1e3
		}).trim();
...
//#endregion
Object.defineProperty(exports, "formatDateStamp", {
	enumerable: true,
	get: function() {
		return formatDateStamp;
	}
});
Object.defineProperty(exports, "formatUserTime", {
	enumerable: true,
	get: function() {
		return formatUserTime;
	}
});
Object.defineProperty(exports, "resolveUserTimeFormat", {
	enumerable: true,
	get: function() {
		return resolveUserTimeFormat;
	}
});
Object.defineProperty(exports, "resolveUserTimezone", {
	enumerable: true,
	get: function() {
