...
function resolveEmbeddedSandboxInfoExecPolicy(params) {
	const defaults = require_exec_defaults.resolveExecDefaults({
		cfg: params.config,
...
Object.defineProperty(exports, "resolveEmbeddedFullAccessState", {
	enumerable: true,
	get: function() {
		return resolveEmbeddedFullAccessState;
	}
});
Object.defineProperty(exports, "resolveEmbeddedSandboxInfoExecPolicy", {
	enumerable: true,
	get: function() {
		return resolveEmbeddedSandboxInfoExecPolicy;
	}
});
