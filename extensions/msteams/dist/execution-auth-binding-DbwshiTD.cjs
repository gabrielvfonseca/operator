...
const authBindingFingerprintKey = node_crypto.default.randomBytes(32);
function hashAuthBinding(value) {
	return node_crypto.default.createHmac("sha256", authBindingFingerprintKey).update(JSON.stringify(value)).digest("hex");
}
...
//#endregion
Object.defineProperty(exports, "fingerprintAuthProfileCredential", {
	enumerable: true,
	get: function() {
		return fingerprintAuthProfileCredential;
	}
});
Object.defineProperty(exports, "fingerprintAuthProfileOwnerShape", {
	enumerable: true,
	get: function() {
		return fingerprintAuthProfileOwnerShape;
	}
});
Object.defineProperty(exports, "fingerprintAwsSdkRuntimeOwner", {
	enumerable: true,
	get: function() {
		return fingerprintAwsSdkRuntimeOwner;
	}
});
Object.defineProperty(exports, "fingerprintOpaqueRuntimeOwner", {
	enumerable: true,
	get: function() {
		return fingerprintOpaqueRuntimeOwner;
	}
});
Object.defineProperty(exports, "fingerprintResolvedAuthProfileCredential", {
	enumerable: true,
	get: function() {
		return fingerprintResolvedAuthProfileCredential;
	}
});
Object.defineProperty(exports, "fingerprintResolvedProviderAuth", {
	enumerable: true,
	get: function() {
