...
function readToolResultStatus(result) {
	...
	return (0, _gabrielvfonseca_normalization_core_string_coerce.normalizeOptionalLowercaseString)(details ? readToolErrorField(details, "status") : void 0);
}
function isToolResultError(result) {
	...
	if (timedOut === true || error) return true;
...
function formatToolExecutionErrorMessage(error, fallback) {
	try {
		return require_errors.formatErrorMessage(error) || fallback;
	} catch {
		return fallback;
	}
}
...
//#endregion
Object.defineProperty(exports, "formatToolExecutionErrorMessage", {
	enumerable: true,
	get: function() {
		return formatToolExecutionErrorMessage;
	}
});
Object.defineProperty(exports, "isToolResultError", {
	enumerable: true,
	get: function() {
		return isToolResultError;
	}
});
Object.defineProperty(exports, "readToolResultDetails", {
	enumerable: true,
	get: function() {
		return readToolResultDetails;
	}
});
Object.defineProperty(exports, "readToolResultStatus", {
	enumerable: true,
	get: function() {
		return readToolResultStatus;
	}
});
Object.defineProperty(exports, "resolveToolExecutionErrorKind", {
	enumerable: true,
	get: function() {
		return resolveToolExecutionErrorKind;
	}
});
Object.defineProperty(exports, "resolveToolResultFailureKind", {
	enumerable: true,
	get: function() {
		return resolveToolResultFailureKind;
	}
});
