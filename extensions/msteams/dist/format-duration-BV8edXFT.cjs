...
pretty_ms = require_rolldown_runtime.__toESM(pretty_ms, 1);
...
function formatSingleUnitDuration(ms, verbose = false) {
	return (0, pretty_ms.default)(normalizeSingleUnitDurationMs(ms), {
		hideYear: true,
		unitCount: 1,
		verbose
	});
...
function formatDurationPrecise(ms, options = {}) {
	...
	if (roundedMs < 1e3) return (0, pretty_ms.default)(roundedMs);
...
function formatDurationCompact(ms, options) {
	...
	const roundedMs = Math.round(ms);
	if (roundedMs < 1e3) return (0, pretty_ms.default)(roundedMs);
	const formatted = (0, pretty_ms.default)(Math.round(ms / 1e3) * 1e3, {
		hideYear: true,
		unitCount: 2
	});
...
//#endregion
Object.defineProperty(exports, "formatDurationCompact", {
	enumerable: true,
	get: function() {
		return formatDurationCompact;
	}
});
Object.defineProperty(exports, "formatDurationHuman", {
	enumerable: true,
	get: function() {
		return formatDurationHuman;
	}
});
Object.defineProperty(exports, "formatDurationPrecise", {
	enumerable: true,
	get: function() {
		return formatDurationPrecise;
	}
});
Object.defineProperty(exports, "formatDurationSeconds", {
	enumerable: true,
	get: function() {
		return formatDurationSeconds;
	}
});
Object.defineProperty(exports, "formatSingleUnitDuration", {
	enumerable: true,
	get: function() {
		return formatSingleUnitDuration;
	}
});
