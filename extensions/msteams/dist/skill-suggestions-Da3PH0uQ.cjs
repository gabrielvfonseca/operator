...
async function recordSessionSkillCaptureSignals(options) {
	...
	const result = await require_session_accessor.patchSessionEntry(options, (entry) => ({ skillCaptureSignalHashes: appendSignalHashes(entry, signalHashes) }), { preserveActivity: true });
...
async function claimSessionSkillCaptureSignals(options) {
	...
	return await require_session_accessor.patchSessionEntry(options, (entry) => {
...
async function releaseSessionSkillCaptureSignals(options) {
	...
	await require_session_accessor.patchSessionEntry(options, (entry) => ({ skillCaptureSignalHashes: entry.skillCaptureSignalHashes?.filter((hash) => !released.has(hash)) }), { preserveActivity: true });
}
...
async function consumeSessionSkillSuggestion(options) {
	let currentEntry;
	let suggestion;
	const entry = await require_session_accessor.patchSessionEntry(options, (entry) => {
		currentEntry = entry;
...
//#endregion
Object.defineProperty(exports, "claimSessionSkillCaptureSignals", {
	enumerable: true,
	get: function() {
		return claimSessionSkillCaptureSignals;
	}
});
Object.defineProperty(exports, "consumeSessionSkillSuggestion", {
	enumerable: true,
	get: function() {
		return consumeSessionSkillSuggestion;
	}
});
Object.defineProperty(exports, "readSessionSkillCaptureSignalHashes", {
	enumerable: true,
	get: function() {
		return readSessionSkillCaptureSignalHashes;
	}
});
Object.defineProperty(exports, "recordSessionSkillCaptureSignals", {
	enumerable: true,
	get: function() {
		return recordSessionSkillCaptureSignals;
	}
});
Object.defineProperty(exports, "recordSessionSkillSuggestion", {
	enumerable: true,
	get: function() {
		return recordSessionSkillSuggestion;
	}
});
Object.defineProperty(exports, "releaseSessionSkillCaptureSignals", {
	enumerable: true,
	get: function() {
		return releaseSessionSkillCaptureSignals;
	}
});
