...
*/
const SESSION_WRITE_LOCK_TIMEOUT_CODE = "OPERATOR_SESSION_WRITE_LOCK_TIMEOUT";
const SESSION_WRITE_LOCK_STALE_CODE = "OPERATOR_SESSION_WRITE_LOCK_STALE";
...
//#endregion
Object.defineProperty(exports, "SessionWriteLockStaleError", {
	enumerable: true,
	get: function() {
		return SessionWriteLockStaleError;
	}
});
Object.defineProperty(exports, "SessionWriteLockTimeoutError", {
	enumerable: true,
	get: function() {
		return SessionWriteLockTimeoutError;
	}
});
Object.defineProperty(exports, "isSessionWriteLockAcquireError", {
	enumerable: true,
	get: function() {
		return isSessionWriteLockAcquireError;
	}
});
