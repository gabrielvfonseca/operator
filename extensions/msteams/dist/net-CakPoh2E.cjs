...
function pickPrimaryLanIPv4() {
	return require_network_interfaces.pickMatchingExternalInterfaceAddress(require_network_interfaces.readNetworkInterfaces(), {
		family: "IPv4",
...
function normalizeHostHeader(hostHeader) {
	return (0, _gabrielvfonseca_normalization_core_string_coerce.normalizeLowercaseStringOrEmpty)(hostHeader);
}
...
function resolveHostName(hostHeader) {
	...
	if (node_net.default.isIP(host) === 6) return host;
	const [name] = host.split(":");
	return name ?? "";
}
function isLoopbackAddress(ip) {
	return (0, _gabrielvfonseca_net_policy_ip.isLoopbackIpAddress)(ip);
}
function resolveLocalInterfaceAddressMatch(ip, snapshot) {
	const normalized = normalizeIp(ip);
	if (!normalized) return false;
	const effectiveSnapshot = arguments.length >= 2 ? snapshot : require_network_interfaces.safeNetworkInterfaces();
...
function isPrivateOrLoopbackAddress(ip) {
	return (0, _gabrielvfonseca_net_policy_ip.isPrivateOrLoopbackIpAddress)(ip);
}
function normalizeIp(ip) {
	return (0, _gabrielvfonseca_net_policy_ip.normalizeIpAddress)(ip);
}
function stripOptionalPort(ip) {
	...
	if (node_net.default.isIP(ip)) return ip;
	const lastColon = ip.lastIndexOf(":");
	if (lastColon > -1 && ip.includes(".") && ip.indexOf(":") === lastColon) {
		const candidate = ip.slice(0, lastColon);
		if (node_net.default.isIP(candidate) === 4) return candidate;
	}
	return ip;
}
function parseIpLiteral(raw) {
	...
	if (!normalized || node_net.default.isIP(normalized) === 0) return;
	return normalized;
}
...
function isTrustedProxyAddress(ip, trustedProxies) {
	...
	return trustedProxies.some((proxy) => {
		...
		return (0, _gabrielvfonseca_net_policy_ip.isIpInCidr)(normalized, candidate);
	});
}
...
async function resolveGatewayBindHost(bind, customHost) {
	...
	if (mode === "tailnet") {
		const tailnetIP = require_tailnet.pickPrimaryTailnetIPv4();
	...
	if (mode === "auto") {
		if (require_container_environment.isContainerEnvironment()) return "0.0.0.0";
		if (await canBindToHost("127.0.0.1")) return "127.0.0.1";
		return "0.0.0.0";
	}
	return "0.0.0.0";
...
function defaultGatewayBindMode(tailscaleMode) {
	...
	return require_container_environment.isContainerEnvironment() ? "auto" : "loopback";
}
/**
...
async function canBindToHost(host) {
	return new Promise((resolve) => {
		const testServer = node_net.default.createServer();
...
function isValidIPv4(host) {
	return (0, _gabrielvfonseca_net_policy_ip.isCanonicalDottedDecimalIPv4)(host);
}
/**
...
function isPrivateOrLoopbackHost(host) {
	...
	if (node_net.default.isIP(normalized) === 6) {
...
function parseHostForAddressChecks(host) {
	if (!host) return null;
	const normalizedHost = (0, _gabrielvfonseca_normalization_core_string_coerce.normalizeLowercaseStringOrEmpty)(host);
...
function isSecureWebSocketUrl(url, opts) {
	...
	if (opts?.allowPrivateWs) {
		...
		return node_net.default.isIP(hostForIpCheck) === 0;
	}
	return false;
}
...
//#endregion
Object.defineProperty(exports, "defaultGatewayBindMode", {
	enumerable: true,
	get: function() {
		return defaultGatewayBindMode;
	}
});
Object.defineProperty(exports, "isLocalishHost", {
	enumerable: true,
	get: function() {
		return isLocalishHost;
	}
});
Object.defineProperty(exports, "isLoopbackAddress", {
	enumerable: true,
	get: function() {
		return isLoopbackAddress;
	}
});
Object.defineProperty(exports, "isLoopbackHost", {
	enumerable: true,
	get: function() {
		return isLoopbackHost;
	}
});
Object.defineProperty(exports, "isPrivateOrLoopbackAddress", {
	enumerable: true,
	get: function() {
		return isPrivateOrLoopbackAddress;
	}
});
Object.defineProperty(exports, "isPrivateOrLoopbackHost", {
	enumerable: true,
	get: function() {
		return isPrivateOrLoopbackHost;
	}
});
Object.defineProperty(exports, "isSecureWebSocketUrl", {
	enumerable: true,
	get: function() {
		return isSecureWebSocketUrl;
	}
});
Object.defineProperty(exports, "isTrustedProxyAddress", {
	enumerable: true,
	get: function() {
...
Object.defineProperty(exports, "normalizeHostHeader", {
	enumerable: true,
	get: function() {
		return normalizeHostHeader;
	}
});
Object.defineProperty(exports, "pickPrimaryLanIPv4", {
	enumerable: true,
	get: function() {
		return pickPrimaryLanIPv4;
	}
});
Object.defineProperty(exports, "resolveClientIp", {
	enumerable: true,
	get: function() {
		return resolveClientIp;
	}
});
Object.defineProperty(exports, "resolveGatewayBindHost", {
	enumerable: true,
	get: function() {
		return resolveGatewayBindHost;
	}
});
Object.defineProperty(exports, "resolveGatewayListenHosts", {
	enumerable: true,
	get: function() {
		return resolveGatewayListenHosts;
	}
});
Object.defineProperty(exports, "resolveHostName", {
	enumerable: true,
	get: function() {
		return resolveHostName;
	}
});
Object.defineProperty(exports, "resolveLocalInterfaceAddressMatch", {
	enumerable: true,
	get: function() {
		return resolveLocalInterfaceAddressMatch;
	}
});
Object.defineProperty(exports, "resolveRequestClientIp", {
	enumerable: true,
	get: function() {
