...
function createSessionMessageSubscriberRegistry() {
	...
	const registry = {
		subscribe: (connId, sessionKey, opts) => {
			...
			const hadMessages = sessionToConnIds.get(normalizedSessionKey)?.has(normalizedConnId) ?? false;
			...
			if (opts?.includeApprovals) {
				const approvalConnIds = approvalSessionToConnIds.get(normalizedSessionKey) ?? /* @__PURE__ */ new Set();
				approvalConnIds.add(normalizedConnId);
				approvalSessionToConnIds.set(normalizedSessionKey, approvalConnIds);
				const approvalSessionKeys = connToApprovalSessionKeys.get(normalizedConnId) ?? /* @__PURE__ */ new Set();
			...
			return () => {
				...
				registry.subscribe(normalizedConnId, normalizedSessionKey, hadApprovals ? { includeApprovals: true } : void 0);
			};
		},
...
//#endregion
Object.defineProperty(exports, "chatAbortMarkerTimestampMs", {
	enumerable: true,
	get: function() {
		return chatAbortMarkerTimestampMs;
	}
});
Object.defineProperty(exports, "createChatAbortMarker", {
	enumerable: true,
	get: function() {
		return createChatAbortMarker;
	}
});
Object.defineProperty(exports, "createChatRunRegistry", {
	enumerable: true,
	get: function() {
		return createChatRunRegistry;
	}
});
Object.defineProperty(exports, "createChatRunState", {
	enumerable: true,
	get: function() {
		return createChatRunState;
	}
});
Object.defineProperty(exports, "createSessionEventSubscriberRegistry", {
	enumerable: true,
	get: function() {
		return createSessionEventSubscriberRegistry;
	}
});
Object.defineProperty(exports, "createSessionMessageSubscriberRegistry", {
	enumerable: true,
	get: function() {
		return createSessionMessageSubscriberRegistry;
	}
});
Object.defineProperty(exports, "createToolEventRecipientRegistry", {
	enumerable: true,
	get: function() {
		return createToolEventRecipientRegistry;
	}
});
Object.defineProperty(exports, "isChatAbortMarkerCurrent", {
	enumerable: true,
	get: function() {
		return isChatAbortMarkerCurrent;
	}
});
