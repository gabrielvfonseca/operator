...
//#endregion
Object.defineProperty(exports, "normalizePluginGatewayMethodScope", {
	enumerable: true,
	get: function() {
		return normalizePluginGatewayMethodScope;
	}
});
Object.defineProperty(exports, "resolveReservedGatewayMethodScope", {
	enumerable: true,
	get: function() {
		return resolveReservedGatewayMethodScope;
	}
});
