...
function hasRecursiveSecretValue(params) {
	if (require_types_secrets.coerceSecretRef(params.value, params.defaults)) return true;
...
//#endregion
Object.defineProperty(exports, "hasCredentialBearingObjectValue", {
	enumerable: true,
	get: function() {
		return hasCredentialBearingObjectValue;
	}
});
Object.defineProperty(exports, "hasSecretRefCandidate", {
	enumerable: true,
	get: function() {
		return hasSecretRefCandidate;
	}
});
