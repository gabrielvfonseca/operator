...
*/
var bootstrap_budget_exports = /* @__PURE__ */ require_rolldown_runtime.__exportAll({
	analyzeBootstrapBudget: () => analyzeBootstrapBudget,
	appendBootstrapPromptWarning: () => appendBootstrapPromptWarning,
	buildBootstrapInjectionStats: () => buildBootstrapInjectionStats,
	buildBootstrapPromptWarning: () => buildBootstrapPromptWarning,
	buildBootstrapPromptWarningNotice: () => buildBootstrapPromptWarningNotice,
	buildBootstrapTruncationReportMeta: () => buildBootstrapTruncationReportMeta,
	resolveBootstrapWarningSignaturesSeen: () => resolveBootstrapWarningSignaturesSeen
});
...
function normalizeSeenSignatures(signatures) {
	...
	for (const signature of signatures) {
		const value = (0, _gabrielvfonseca_normalization_core_string_coerce.normalizeOptionalString)(signature) ?? "";
...
function resolveBootstrapWarningSignaturesSeen(report) {
	...
	const single = typeof truncation?.promptWarningSignature === "string" ? (0, _gabrielvfonseca_normalization_core_string_coerce.normalizeOptionalString)(truncation.promptWarningSignature) ?? "" : "";
...
function buildBootstrapInjectionStats(params) {
	...
	for (const file of params.injectedFiles) {
		...
		const baseName = node_path.default.posix.basename(normalizedPath);
...
//#endregion
Object.defineProperty(exports, "analyzeBootstrapBudget", {
	enumerable: true,
	get: function() {
		return analyzeBootstrapBudget;
	}
});
Object.defineProperty(exports, "appendBootstrapPromptWarning", {
	enumerable: true,
	get: function() {
		return appendBootstrapPromptWarning;
	}
});
Object.defineProperty(exports, "bootstrap_budget_exports", {
	enumerable: true,
	get: function() {
		return bootstrap_budget_exports;
	}
});
Object.defineProperty(exports, "buildBootstrapInjectionStats", {
	enumerable: true,
	get: function() {
		return buildBootstrapInjectionStats;
	}
});
Object.defineProperty(exports, "buildBootstrapPromptWarning", {
	enumerable: true,
	get: function() {
		return buildBootstrapPromptWarning;
	}
});
Object.defineProperty(exports, "buildBootstrapPromptWarningNotice", {
	enumerable: true,
	get: function() {
		return buildBootstrapPromptWarningNotice;
	}
});
Object.defineProperty(exports, "buildBootstrapTruncationReportMeta", {
	enumerable: true,
	get: function() {
		return buildBootstrapTruncationReportMeta;
	}
});
Object.defineProperty(exports, "resolveBootstrapWarningSignaturesSeen", {
	enumerable: true,
	get: function() {
		return resolveBootstrapWarningSignaturesSeen;
	}
});
