...
function isChatStopCommandText(text) {
	return require_abort_primitives.isAbortRequestText(text);
}
function createChatAbortSignalReason(stopReason) {
	if (stopReason === "restart") return require_run_termination.createAgentRunRestartAbortError();
...
function resolveChatRunExpiresAtMs(params) {
	...
	const safeNow = (0, _gabrielvfonseca_normalization_core_number_coercion.asDateTimestampMs)(now);
	if (safeNow === void 0) return 0;
	const target = (0, _gabrielvfonseca_normalization_core_number_coercion.resolveExpiresAtMsFromDurationMs)(Math.max(0, timeoutMs) + graceMs, { nowMs: safeNow });
	const min = (0, _gabrielvfonseca_normalization_core_number_coercion.resolveExpiresAtMsFromDurationMs)(minMs, { nowMs: safeNow });
	const max = (0, _gabrielvfonseca_normalization_core_number_coercion.resolveExpiresAtMsFromDurationMs)(maxMs, { nowMs: safeNow });
...
function registerChatAbortController(params) {
	...
	const now = (0, _gabrielvfonseca_normalization_core_number_coercion.resolveDateTimestampMs)(rawNow, 0);
	const explicitExpiresAtMs = params.expiresAtMs === void 0 ? void 0 : (0, _gabrielvfonseca_normalization_core_number_coercion.asDateTimestampMs)(params.expiresAtMs) ?? 0;
	const entry = {
		controller,
		sessionId: params.sessionId,
		sessionKey: params.sessionKey,
		lifecycleGeneration: params.lifecycleGeneration ?? require_agent_events.getAgentEventLifecycleGeneration(),
...
function resolveInFlightRunSnapshot(params) {
	...
	const projected = require_live_chat_projector.projectLiveAssistantBufferedText(params.chatRunBuffers?.get(best.runId) ?? "", { suppressLeadFragments: true });
	return {
		runId: best.runId,
...
function boundInFlightRunSnapshotForChatHistory(params) {
	...
	if (require_json_utf8_bytes.jsonUtf8Bytes(params.messages) + require_json_utf8_bytes.jsonUtf8Bytes(params.snapshot) <= params.maxBytes) return params.snapshot;
	return {
...
function resolveChatAbortDeliverySessionKeys(ops, sessionKey, agentId) {
	...
	const defaultAgentId = cfg ? require_agent_scope_config.resolveDefaultAgentId(cfg) : void 0;
...
function broadcastChatAborted(ops, params) {
	...
	const errorMessage = require_tool_error_summary.readToolValidationErrorSummary(params.errorMessage);
...
function resolveDefaultGlobalAgentId(ops) {
	const cfg = ops.getRuntimeConfig?.();
	return cfg ? require_agent_scope_config.resolveDefaultAgentId(cfg) : void 0;
}
...
function abortChatRunById(ops, params) {
	...
	const partialText = bufferedText?.trim() ? bufferedText : void 0;
	ops.chatAbortedRuns.set(runId, require_server_chat_state.createChatAbortMarker());
...
//#endregion
Object.defineProperty(exports, "abortChatRunById", {
	enumerable: true,
	get: function() {
		return abortChatRunById;
	}
});
Object.defineProperty(exports, "abortChatRunsForProvider", {
	enumerable: true,
	get: function() {
		return abortChatRunsForProvider;
	}
});
Object.defineProperty(exports, "abortTrackedChatRunById", {
	enumerable: true,
	get: function() {
		return abortTrackedChatRunById;
	}
});
Object.defineProperty(exports, "boundInFlightRunSnapshotForChatHistory", {
	enumerable: true,
	get: function() {
		return boundInFlightRunSnapshotForChatHistory;
	}
});
Object.defineProperty(exports, "isChatAbortControllerEntryAbortable", {
	enumerable: true,
	get: function() {
		return isChatAbortControllerEntryAbortable;
	}
});
Object.defineProperty(exports, "isChatStopCommandText", {
	enumerable: true,
	get: function() {
		return isChatStopCommandText;
	}
});
Object.defineProperty(exports, "registerChatAbortController", {
	enumerable: true,
	get: function() {
		return registerChatAbortController;
	}
});
Object.defineProperty(exports, "removeChatAbortControllerEntry", {
	enumerable: true,
	get: function() {
		return removeChatAbortControllerEntry;
	}
});
Object.defineProperty(exports, "resolveAgentRunExpiresAtMs", {
	enumerable: true,
	get: function() {
		return resolveAgentRunExpiresAtMs;
	}
});
Object.defineProperty(exports, "resolveChatRunExpiresAtMs", {
	enumerable: true,
	get: function() {
		return resolveChatRunExpiresAtMs;
	}
});
Object.defineProperty(exports, "resolveInFlightRunSnapshot", {
	enumerable: true,
	get: function() {
		return resolveInFlightRunSnapshot;
	}
});
Object.defineProperty(exports, "updateChatRunProvider", {
	enumerable: true,
	get: function() {
		return updateChatRunProvider;
	}
});
