...
async function loadSessionSubagentReactivationRuntime() {
	return Promise.resolve().then(() => require("./session-subagent-reactivation.runtime-3qptnNYt.cjs"));
}
/**
...
async function reactivateCompletedSubagentSession(params) {
	...
	const existing = require_subagent_registry_read.getLatestSubagentRunByChildSessionKey(params.sessionKey);
...
//#endregion
Object.defineProperty(exports, "reactivateCompletedSubagentSession", {
	enumerable: true,
	get: function() {
		return reactivateCompletedSubagentSession;
	}
});
