...
function shouldLoadChannelPluginInSetupRuntime(params) {
	...
	return !params.manifestChannels.some((channelId) => require_channel_configured.isChannelConfigured(params.cfg, channelId, params.env));
}
function shouldDeferConfiguredChannelFullRuntimeMerge(params) {
	return params.preferSetupRuntimeForChannelPlugins === true && params.startupDeferConfiguredChannelFullLoadUntilAfterListen === true && params.manifestChannels.some((channelId) => require_channel_configured.isChannelConfigured(params.cfg, channelId, params.env));
}
...
//#endregion
Object.defineProperty(exports, "channelPluginIdBelongsToManifest", {
	enumerable: true,
	get: function() {
		return channelPluginIdBelongsToManifest;
	}
});
Object.defineProperty(exports, "loadBundledRuntimeChannelPlugin", {
	enumerable: true,
	get: function() {
		return loadBundledRuntimeChannelPlugin;
	}
});
Object.defineProperty(exports, "mergeSetupRuntimeChannelPlugin", {
	enumerable: true,
	get: function() {
		return mergeSetupRuntimeChannelPlugin;
	}
});
Object.defineProperty(exports, "resolveBundledRuntimeChannelRegistration", {
	enumerable: true,
	get: function() {
		return resolveBundledRuntimeChannelRegistration;
	}
});
Object.defineProperty(exports, "resolveSetupChannelRegistration", {
	enumerable: true,
	get: function() {
		return resolveSetupChannelRegistration;
	}
});
Object.defineProperty(exports, "shouldDeferConfiguredChannelFullRuntimeMerge", {
	enumerable: true,
	get: function() {
		return shouldDeferConfiguredChannelFullRuntimeMerge;
	}
});
Object.defineProperty(exports, "shouldLoadChannelPluginInSetupRuntime", {
	enumerable: true,
	get: function() {
		return shouldLoadChannelPluginInSetupRuntime;
	}
});
