...
async function searchInstallablePluginPackages(params) {
	...
	return mergePackageSearchResults(await Promise.all(INSTALLABLE_PLUGIN_FAMILIES.map((family) => require_clawhub.searchClawHubPackages({
		query: params.query,
		family,
		limit
	}))), limit);
...
//#endregion
Object.defineProperty(exports, "searchInstallablePluginPackages", {
	enumerable: true,
	get: function() {
		return searchInstallablePluginPackages;
	}
});
