...
function createGatewayRequestContext(params) {
	...
	return {
		...
		disconnectClientsUsingSharedGatewayAuth: () => {
			require_server_shared_auth_generation.disconnectAllSharedGatewayAuthClients(params.clients);
		},
...
//#endregion
exports.createGatewayRequestContext = createGatewayRequestContext;
