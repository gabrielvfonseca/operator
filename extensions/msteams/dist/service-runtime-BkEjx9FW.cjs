...
function getSystemdCgroupHygieneSummary(runtime) {
	if (!runtime?.killMode) return null;
...
function isSystemdStartLimitHit(runtime) {
	if (!runtime || (0, _gabrielvfonseca_normalization_core_string_coerce.normalizeLowercaseStringOrEmpty)(runtime.state) !== "failed") return false;
	const systemd = runtime.systemd;
	if (!systemd) return false;
	if ((0, _gabrielvfonseca_normalization_core_string_coerce.normalizeLowercaseStringOrEmpty)(systemd.result) === "start-limit-hit") return true;
...
//#endregion
Object.defineProperty(exports, "getSystemdCgroupHygieneSummary", {
	enumerable: true,
	get: function() {
		return getSystemdCgroupHygieneSummary;
	}
});
Object.defineProperty(exports, "isSystemdCgroupHygieneRisk", {
	enumerable: true,
	get: function() {
		return isSystemdCgroupHygieneRisk;
	}
});
Object.defineProperty(exports, "isSystemdStartLimitHit", {
	enumerable: true,
	get: function() {
		return isSystemdStartLimitHit;
	}
});
