...
function hasApprovalTurnSourceRoute(params) {
	...
	return require_exec_approval_surface.resolveApprovalInitiatingSurfaceState({
...
const APPROVAL_NOT_FOUND_DETAILS = {
	reason: require_error_codes.ErrorCodes.APPROVAL_NOT_FOUND,
...
function respondUnknownOrExpiredApproval(respond) {
	respond(false, void 0, require_error_codes.errorShape(require_error_codes.ErrorCodes.INVALID_REQUEST, "unknown or expired approval id", { details: APPROVAL_NOT_FOUND_DETAILS }));
}
...
function isApprovalRecordVisibleToClient(params) {
	...
	const hasApprovalsScope = scopes.includes(require_operator_scopes.APPROVALS_SCOPE);
...
function resolveApprovalDecisionParams(params) {
	...
	if (!params.validate(rawParams)) {
		params.respond(false, void 0, require_error_codes.errorShape(require_error_codes.ErrorCodes.INVALID_REQUEST, `invalid ${params.methodName} params: ${require_validation_errors.formatValidationErrors(params.validate.errors)}`));
		return null;
	}
	if (!isApprovalDecision(rawParams.decision)) {
		params.respond(false, void 0, require_error_codes.errorShape(require_error_codes.ErrorCodes.INVALID_REQUEST, "invalid decision"));
		return null;
	}
	return {
...
function respondPendingApprovalLookupError(params) {
	...
	params.respond(false, void 0, require_error_codes.errorShape(params.response.code, params.response.message));
}
/** Waits for an already-registered approval decision visible to the caller. */
async function handleApprovalWaitDecision(params) {
	const id = (0, _gabrielvfonseca_normalization_core_string_coerce.normalizeOptionalString)(params.inputId) ?? "";
	if (!id) {
		params.respond(false, void 0, require_error_codes.errorShape(require_error_codes.ErrorCodes.INVALID_REQUEST, "id is required"));
		return;
	}
	...
	if (!snapshot || !isApprovalRecordVisibleToClient({
		...
		params.respond(false, void 0, require_error_codes.errorShape(require_error_codes.ErrorCodes.INVALID_REQUEST, "approval expired or not found"));
		return;
	}
...
async function handleApprovalResolve(params) {
	...
	if (!resolved.ok) {
		...
		if (resolvedRepeat.ok) {
			...
			params.respond(false, void 0, require_error_codes.errorShape(require_error_codes.ErrorCodes.INVALID_REQUEST, "approval already resolved", { details: APPROVAL_ALREADY_RESOLVED_DETAILS }));
			return;
		}
	...
	if (validationError) {
		params.respond(false, void 0, require_error_codes.errorShape(require_error_codes.ErrorCodes.INVALID_REQUEST, validationError.message, validationError.details ? { details: validationError.details } : void 0));
		return;
	}
...
//#endregion
Object.defineProperty(exports, "bindApprovalRequesterMetadata", {
	enumerable: true,
	get: function() {
		return bindApprovalRequesterMetadata;
	}
});
Object.defineProperty(exports, "bindApprovalReviewerDeviceIds", {
	enumerable: true,
	get: function() {
		return bindApprovalReviewerDeviceIds;
	}
});
Object.defineProperty(exports, "buildRequestedApprovalEvent", {
	enumerable: true,
	get: function() {
		return buildRequestedApprovalEvent;
	}
});
Object.defineProperty(exports, "handleApprovalResolve", {
	enumerable: true,
	get: function() {
		return handleApprovalResolve;
	}
});
Object.defineProperty(exports, "handleApprovalWaitDecision", {
	enumerable: true,
	get: function() {
		return handleApprovalWaitDecision;
	}
});
Object.defineProperty(exports, "handlePendingApprovalRequest", {
	enumerable: true,
	get: function() {
		return handlePendingApprovalRequest;
	}
});
Object.defineProperty(exports, "isApprovalRecordVisibleToClient", {
	enumerable: true,
	get: function() {
		return isApprovalRecordVisibleToClient;
	}
});
Object.defineProperty(exports, "listVisiblePendingApprovalRequests", {
	enumerable: true,
	get: function() {
		return listVisiblePendingApprovalRequests;
	}
});
Object.defineProperty(exports, "registerPendingApprovalRecord", {
	enumerable: true,
	get: function() {
		return registerPendingApprovalRecord;
	}
});
Object.defineProperty(exports, "resolveApprovalDecisionParams", {
	enumerable: true,
	get: function() {
		return resolveApprovalDecisionParams;
	}
});
Object.defineProperty(exports, "resolveApprovalRequestRecipientConnIds", {
	enumerable: true,
	get: function() {
		return resolveApprovalRequestRecipientConnIds;
	}
});
Object.defineProperty(exports, "resolvePendingApprovalRecord", {
	enumerable: true,
	get: function() {
		return resolvePendingApprovalRecord;
	}
});
Object.defineProperty(exports, "respondPendingApprovalLookupError", {
	enumerable: true,
	get: function() {
		return respondPendingApprovalLookupError;
	}
});
