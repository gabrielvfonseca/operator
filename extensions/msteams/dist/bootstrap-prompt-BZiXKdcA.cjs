...
//#endregion
Object.defineProperty(exports, "buildFullBootstrapPromptLines", {
	enumerable: true,
	get: function() {
		return buildFullBootstrapPromptLines;
	}
});
Object.defineProperty(exports, "buildLimitedBootstrapPromptLines", {
	enumerable: true,
	get: function() {
		return buildLimitedBootstrapPromptLines;
	}
});
