...
//#endregion
Object.defineProperty(exports, "APPROVAL_ID_WELL_FORMED_UNICODE_PATTERN", {
	enumerable: true,
	get: function() {
		return APPROVAL_ID_WELL_FORMED_UNICODE_PATTERN;
	}
});
Object.defineProperty(exports, "isWellFormedApprovalId", {
	enumerable: true,
	get: function() {
		return isWellFormedApprovalId;
	}
});
