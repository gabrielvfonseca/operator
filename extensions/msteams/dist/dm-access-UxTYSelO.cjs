...
function allowFromListsMatch(left, right) {
	...
	const normalizedLeft = (0, _gabrielvfonseca_normalization_core_string_normalization.normalizeStringEntries)(left);
	const normalizedRight = (0, _gabrielvfonseca_normalization_core_string_normalization.normalizeStringEntries)(right);
...
//#endregion
Object.defineProperty(exports, "ensureOpenDmPolicyAllowFromWildcard", {
	enumerable: true,
	get: function() {
		return ensureOpenDmPolicyAllowFromWildcard;
	}
});
Object.defineProperty(exports, "normalizeLegacyDmAliases", {
	enumerable: true,
	get: function() {
		return normalizeLegacyDmAliases;
	}
});
Object.defineProperty(exports, "resolveChannelDmAllowFrom", {
	enumerable: true,
	get: function() {
		return resolveChannelDmAllowFrom;
	}
});
Object.defineProperty(exports, "resolveChannelDmPolicy", {
	enumerable: true,
	get: function() {
		return resolveChannelDmPolicy;
	}
});
Object.defineProperty(exports, "setCanonicalDmAllowFrom", {
	enumerable: true,
	get: function() {
		return setCanonicalDmAllowFrom;
	}
});
