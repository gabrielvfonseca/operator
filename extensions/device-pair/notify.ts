...
function openNotifySubscriberStore(api: OperatorPluginApi): NotifySubscriberStore {
...
async function notifyPendingPairingRequests(params: { api: OperatorPluginApi }): Promise<void> {
...
async function runNotifyPoll(api: OperatorPluginApi): Promise<void> {
...
export function createPairingNotifierService(api: OperatorPluginApi): OperatorPluginService {
