...
const BROWSER_PROFILE_ARCHIVE_ENV = "OPERATOR_MANTIS_BROWSER_PROFILE_TGZ_B64";
const BROWSER_PROFILE_DIR_ENV = "OPERATOR_MANTIS_BROWSER_PROFILE_DIR";
...
export async function runMantisDesktopBrowserSmoke(
  ...
  const browserProfileArchiveEnv =
    ...
    trimToValue(env.OPERATOR_MANTIS_BROWSER_PROFILE_ARCHIVE_ENV) ??
