...
function buildWhatsAppQuoteReplyRun(target: "dm" | "group"): WhatsAppQaMessageScenarioRun {
  ...
  const input =
    target === "group"
      ? `operatorqa reply with only this exact marker: ${token}`
  ...
  },
  {
    ...
    buildRun: () => {
      ...
      return {
        configMode: "allowlist",
        expectReply: true,
        input: `operatorqa reply with only this exact marker: ${replyToken}`,
  ...
  },
  {
    ...
    buildRun: () => {
      ...
      return {
        ...
        input:
          `operatorqa pending history context check ${triggerMarker}. ` +
  ...
  },
  {
    ...
    buildRun: () => {
      ...
      return {
        ...
        configMode: "open",
        expectReply: true,
        input: `operatorqa broadcast fanout check ${token}`,
  ...
  },
  {
    ...
    buildRun: () => {
      ...
      return {
        ...
        configMode: "allowlist",
        expectReply: true,
        input: `operatorqa Mentioned group seed marker ${seedMarker}`,
