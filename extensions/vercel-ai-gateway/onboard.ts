...
function applyVercelAiGatewayProviderConfig(cfg: OperatorConfig): OperatorConfig {
...
export function applyVercelAiGatewayConfig(cfg: OperatorConfig): OperatorConfig {
