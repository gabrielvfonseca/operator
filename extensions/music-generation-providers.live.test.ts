...
const providerFilter = parseCsvFilter(process.env.OPERATOR_LIVE_MUSIC_GENERATION_PROVIDERS);
const envModelMap = parseProviderModelMap(process.env.OPERATOR_LIVE_MUSIC_GENERATION_MODELS);
