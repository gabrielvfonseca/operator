...
EXPECTED_COMMIT="$(operator_trim_build_metadata_value "${EXPECTED_COMMIT}")"
if ! operator_is_full_git_commit "${EXPECTED_COMMIT}"; then
...
if ! operator_is_full_git_commit "${CHECKOUT_COMMIT}"; then
