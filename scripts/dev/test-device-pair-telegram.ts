// Test Device Pair Telegram script supports Operator repository automation.
...
type DevicePairTelegramDeps = {
  ...
  loadOperatorPlugins: typeof loadOperatorPlugins;
...
async function runDevicePairTelegram(
  ...
  deps.loadOperatorPlugins({ config: cfg });
