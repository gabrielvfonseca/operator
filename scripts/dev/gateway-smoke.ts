// Gateway Smoke script supports Operator repository automation.
...
function parseGatewaySmokeCli(
  ...
  return {
    help: has("--help") || has("-h"),
    token: getArg("--token") ?? env.OPERATOR_GATEWAY_TOKEN,
    urlRaw: getArg("--url") ?? env.OPERATOR_GATEWAY_URL,
  };
}
