...
// Summarizes Operator performance source fixtures for reports.
...
function printHelp() {
  console.log(`Usage: node scripts/operator-performance-source-summary.mjs --source-dir <dir> [--baseline-source-dir <dir>] [--output <summary.md>]

Summarizes Operator-native performance probe artifacts for CI reports.`);
}
