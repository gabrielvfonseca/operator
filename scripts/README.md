...
| Commits         | `scripts/committer "<message>" <files...>`                                     | Preferred scoped commit helper for Operator changes.                                                               |
...
- `release-*`, `operator-npm-*`, and `plugin-*-release-*`: release preparation,
...
See also [Scripts](https://docs.operator.ai/help/scripts) for public-facing script guidance.
