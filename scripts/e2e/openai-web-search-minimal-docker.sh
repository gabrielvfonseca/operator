...
IMAGE_NAME="$(docker_e2e_resolve_image "operator-openai-web-search-minimal-e2e" OPENCLAW_OPENAI_WEB_SEARCH_MINIMAL_E2E_IMAGE)"
...
docker_e2e_run_logged_with_harness openai-web-search-minimal \
  ...
  -e "OPENAI_API_KEY=sk-operator-web-search-minimal-e2e" \
