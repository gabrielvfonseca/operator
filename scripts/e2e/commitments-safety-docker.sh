...
IMAGE_NAME="$(docker_e2e_resolve_image "operator-commitments-safety-e2e" OPENCLAW_COMMITMENTS_SAFETY_E2E_IMAGE)"
CONTAINER_NAME="operator-commitments-safety-e2e-$$"
RUN_LOG="$(mktemp -t operator-commitments-safety-log.XXXXXX)"
