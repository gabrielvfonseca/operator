...
const allowDegradedReady =
  ...
  process.env.OPERATOR_UPGRADE_SURVIVOR_READYZ_ALLOW_DEGRADED === "1";
const timeoutOption = optionValue(
  "--timeout-ms",
  "OPERATOR_UPGRADE_SURVIVOR_PROBE_TIMEOUT_MS",
  "60000",
);
const attemptTimeoutOption = optionValue(
  "--attempt-timeout-ms",
  "OPERATOR_UPGRADE_SURVIVOR_PROBE_ATTEMPT_TIMEOUT_MS",
  "5000",
);
const maxBodyOption = optionValue(
  "--max-body-bytes",
  "OPERATOR_UPGRADE_SURVIVOR_PROBE_MAX_BODY_BYTES",
  "1048576",
);
