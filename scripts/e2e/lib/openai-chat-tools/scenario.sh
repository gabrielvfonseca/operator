...
GATEWAY_LOG="/tmp/operator-openai-chat-tools-gateway.log"
CLIENT_LOG="/tmp/operator-openai-chat-tools-client.log"
gateway_pid=""
...
dump_debug_logs() {
  ...
  operator_e2e_dump_logs "$GATEWAY_LOG" "$CLIENT_LOG"
