// Macos Discord script supports Operator repository automation.
...
export class MacosDiscordSmoke {
  constructor(
    private input: {
      ...
      guest: MacosGuest;
      guestNode: string;
      guestOperator: string;
      guestOperatorEntry: string;
      runDir: string;
      vmName: string;
    },
  ) {}
...
${this.input.guestNode} ${this.input.guestOperatorEntry} config set channels.discord.token ${shellQuote(this.input.config.token)}
${this.input.guestNode} ${this.input.guestOperatorEntry} config set channels.discord.enabled true
${this.input.guestNode} ${this.input.guestOperatorEntry} config set channels.discord.groupPolicy allowlist
${this.input.guestNode} ${this.input.guestOperatorEntry} config set channels.discord.guilds ${shellQuote(guilds)} --strict-json
${this.input.guestNode} ${this.input.guestOperatorEntry} doctor --fix --yes --non-interactive
...
JS
${this.input.guestNode} ${this.input.guestOperatorEntry} plugins enable discord
${this.input.guestNode} ${this.input.guestOperatorEntry} gateway restart
${this.input.guestNode} ${this.input.guestOperatorEntry} channels status --probe --json`);
  }
