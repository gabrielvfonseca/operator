...
IMAGE_NAME="$(docker_e2e_resolve_image "operator-onboard-e2e" OPENCLAW_ONBOARD_E2E_IMAGE)"
...
CONTAINER_NAME="operator-onboard-e2e-$$"
RUN_LOG="$(mktemp "${TMPDIR:-/tmp}/operator-onboard.XXXXXX")"
STATS_LOG="$(mktemp "${TMPDIR:-/tmp}/operator-onboard-stats.XXXXXX")"
