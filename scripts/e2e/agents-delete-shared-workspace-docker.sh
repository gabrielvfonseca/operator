...
IMAGE_NAME="$(docker_e2e_resolve_image "operator-agents-delete-shared-workspace-e2e:local" OPENCLAW_AGENTS_DELETE_SHARED_WORKSPACE_E2E_IMAGE)"
...
run_operator agents delete ops --force --json > "$output_file"
