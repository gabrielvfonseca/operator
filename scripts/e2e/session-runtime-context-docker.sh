...
IMAGE_NAME="$(docker_e2e_resolve_image "operator-session-runtime-context-e2e" OPENCLAW_SESSION_RUNTIME_CONTEXT_E2E_IMAGE)"
CONTAINER_NAME="operator-session-runtime-context-e2e-$$"
RUN_LOG="$(mktemp -t operator-session-runtime-context-log.XXXXXX)"
