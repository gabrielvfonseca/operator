...
function ensureOperatorExtensionAlias(params) {
...
function shouldCopyRuntimeFile(relativePath) {
  return (
    ...
    isPathOrNestedPath(relativePath, "operator.plugin.json") ||
...
export function stageBundledPluginRuntime(params = {}) {
  ...
  ensureOperatorExtensionAlias({ repoRoot, distExtensionsRoot });
