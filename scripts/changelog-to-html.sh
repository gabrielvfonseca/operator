...
if [[ -z "$version_content" ]]; then
  echo "<h2>Operator $VERSION</h2>"
  echo "<p>Latest Operator update.</p>"
  echo "<p><a href=\"https://github.com/operator/operator/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
