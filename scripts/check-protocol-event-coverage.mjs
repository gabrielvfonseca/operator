...
// macOS, so the iOS coverage owner lives in OperatorChatUI.
const IOS_SCAN_ROOTS = ["apps/ios/Sources", "apps/shared/OperatorKit/Sources"];
const IOS_SENTINEL_FILE =
  "apps/shared/OperatorKit/Sources/OperatorChatUI/ChatGatewayPayloadCodec.swift";
const ANDROID_SCAN_ROOT = "apps/android/app/src/main/java/ai/operator/app";
const ANDROID_SENTINEL_FILES = [
  "apps/android/app/src/main/java/ai/operator/app/gateway/GatewaySession.kt",
  "apps/android/app/src/main/java/ai/operator/app/chat/ChatController.kt",
];
