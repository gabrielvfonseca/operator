...
const TIMINGS_FILE_ENV_KEY = "OPERATOR_TEST_PROJECTS_TIMINGS_PATH";
const TIMINGS_DISABLE_ENV_KEY = "OPERATOR_TEST_PROJECTS_TIMINGS";
const SHARD_NAME_ENV_KEY = "OPERATOR_VITEST_SHARD_NAME";
