...
const thirdPartyExtensionMessage =
  "Please publish this as a third-party plugin on [ClawHub](https://clawhub.ai) instead of adding it to the core repo. Docs: https://docs.operator.ai/plugin and https://docs.operator.ai/clawhub";
...
const rules = [
  ...
  },
  {
    ...
    close: true,
    message:
      "Please use [our support server](https://discord.gg/clawd) and ask in #help or #users-helping-users to resolve this, or follow the stuck FAQ at https://docs.operator.ai/help/faq#im-stuck-whats-the-fastest-way-to-get-unstuck.",
  },
  {
    label: "r: false-positive",
    close: true,
    message:
      "Closing this because it looks like a false positive or reclassification-only report rather than an actionable Operator bug. If this is still a real issue, please open a fresh report with concrete reproduction steps and current-version details.",
  },
  {
    label: "r: no-ci-pr",
    close: true,
  ...
  },
  {
    ...
    message:
      "BlueBubbles is deprecated and no longer ships as a bundled Operator channel. Use iMessage via `imsg` instead: https://docs.operator.ai/channels/imessage. If this needs to stay BlueBubbles-backed, publish it as a third-party plugin on ClawHub instead of adding it back to core.",
  },
  {
    label: "r: moltbook",
    close: true,
    ...
    message:
      "Operator is not affiliated with Moltbook, and issues related to Moltbook should not be submitted here.",
  },
];
...
export const managedLabelSpecs = {
  ...
  "r: moltbook": {
    color: "B60205",
    description: "Auto-close and lock: Moltbook is off-topic for Operator.",
  },
  "r: spam": {
    color: "B60205",
...
const candidateActionRules = [
  ...
  },
  {
    ...
    close: true,
    message:
      "Closing this PR because the docs-only change is too low-signal for the core repo. Please reopen or resubmit with a concrete Operator docs gap and linked context.",
  },
  {
  ...
  },
  {
    ...
    close: true,
    message:
      "Closing this PR because the template is mostly blank and does not describe a concrete Operator problem, fix, or test plan. Please reopen or resubmit with the missing context filled in.",
  },
];
