...
/** Provider API families with first-class request/stream adapters in Operator. */
...
/** Image-generation API families with first-class adapters in Operator. */
...
/** Image provider ids with first-class adapters in Operator. */
...
export interface UserMessage {
   ...
   * (e.g. an Operator runtime-context carrier appended after the active user
...
export interface Model<TApi extends Api = Api> {
  ...
  reasoning: boolean;
  /**
   * Maps Operator thinking levels to provider/model-specific values.
