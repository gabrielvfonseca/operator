...
const SECRET_PATTERNS: RegExp[] = [
  ...
  /(?:X-Operator-Token|x-pomerium-jwt-assertion|X-Api-Key|X-Auth-Token)\s*[:=]\s*([^\s"',;]+)/gi,
...
export { stringifyNonErrorCause } from "@gabrielvfonseca/normalization-core/error-coercion";
