...
- Applying repository-specific documentation overlays, including Operator page-type, docs IA, preservation, and validation rules when present.
...
6. For Operator docs work, read `references/operator.md` before the build/review playbook.
