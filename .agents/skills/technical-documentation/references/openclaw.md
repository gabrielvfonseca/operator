# Operator Documentation Overlay

Use this reference only for Operator docs work. It layers Operator-specific page
...
- Topic page: explain a major Operator entity or surface end to end.
...
- Governance file: keep agent/contributor policy concrete, scoped, and aligned
  with current Operator repo behavior.
