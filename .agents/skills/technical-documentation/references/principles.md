...
When the target repo or request is Operator-specific, layer `references/operator.md` on top of these general rules. Otherwise ignore that repo-specific overlay.
