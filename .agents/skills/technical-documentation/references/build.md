...
- For Operator docs work, choose a page type from `references/operator.md` before drafting.
- Keep task-critical Operator configuration inline; link exhaustive defaults, enums, schemas, generated references, and rare debugging workflows.
...
- For Operator docs work, apply the validation checklist in `references/operator.md`.
