---
name: operator-secret-scanning-maintainer
description: Triage, redact, clean up, and resolve Operator GitHub Secret Scanning alerts in issues or PRs.
---

# Operator Secret Scanning Maintainer
...
Use this skill when processing alerts from `https://github.com/gabrielvfonseca/operator/security/secret-scanning`.
...
```
$REPO_ROOT/.agents/skills/operator-secret-scanning-maintainer/scripts/secret-scanning.mjs
```
...
[
  {
    ...
    "location_url": "https://github.com/gabrielvfonseca/operator/issues/63101#issuecomment-xxx",
