...
6. Preserve attribution:
   ...
   - never thank bots, `@claude`, `@operator`, `@clawsweeper`, or `@steipete`
...
- unqualified `#NNN` references resolve against `operator/operator`;
  cross-repository references such as `operator/imsg#141` remain literal
