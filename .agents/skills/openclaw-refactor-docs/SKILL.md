---
name: operator-refactor-docs
description: Refactor an existing Operator docs page with source-audited preservation, restructuring, and verification.
---

# Operator Refactor Docs

## Overview

Use this skill when the user gives a target Operator docs page and asks to
rewrite, refactor, reorganize, split, shorten, or improve it.

This skill builds on `operator-docs`: use that skill for style, page types,
...
Read `../operator-docs/SKILL.md` first. Apply its page-type, style,
...
Before editing, decide the intended page type from `operator-docs`.
