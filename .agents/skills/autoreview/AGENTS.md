...
- Canonical source: `operator/agent-skills`, under `skills/autoreview`.
- Before editing any copy, fast-forward a checkout of `operator/agent-skills` from `origin/main`.
