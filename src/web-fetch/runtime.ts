...
let webFetchProviderCache = new WeakMap<OperatorConfig, WebFetchProviderCacheEntry>();
...
function resolveFetchConfig(config: OperatorConfig | undefined): WebFetchConfig | undefined {
...
function createWebFetchProviderConfigFingerprint(config: OperatorConfig): string {
