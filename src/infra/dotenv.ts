...
const BLOCKED_WORKSPACE_DOTENV_KEYS = new Set([
  ...
  "OPERATOR_OAUTH_DIR",
  "OPERATOR_PINNED_PYTHON",
  "OPERATOR_PINNED_WRITE_PYTHON",
  "OPERATOR_PLUGIN_INSTALL_OVERRIDES",
  ...
  "OPERATOR_STATE_DIR",
  "OPERATOR_TEST_TAILSCALE_BINARY",
  "PATH",
  "PI_CODING_AGENT_DIR",
...
export function loadDotEnv(opts?: { quiet?: boolean }) {
  ...
  // Then load global fallback: ~/.operator/.env (or OPERATOR_STATE_DIR/.env),
