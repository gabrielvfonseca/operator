...
export const INSTALLED_PLUGIN_INDEX_WARNING =
  "DO NOT EDIT. This file is generated by OpenClaw from plugin manifests, install records, and config policy. Use `operator plugins registry --refresh`, `operator plugins install/update/uninstall`, or `operator plugins enable/disable` instead.";
