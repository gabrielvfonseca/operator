...
import type { OperatorPluginConfigSchema } from "./types.js";
...
type BuildPluginConfigSchemaOptions = {
  ...
  safeParse?: OperatorPluginConfigSchema["safeParse"];
};
...
export function emptyPluginConfigSchema(): OperatorPluginConfigSchema {
  return {
