...
vi.mock("../discovery.js", () => ({
  discoverOperatorPlugins: (
    ...args: Parameters<typeof registryJitiMocks.discoverOperatorPlugins>
  ) => registryJitiMocks.discoverOperatorPlugins(...args),
}));
...
export function resetRegistryJitiMocks(): void {
  ...
  registryJitiMocks.discoverOperatorPlugins.mockReset();
  registryJitiMocks.loadPluginManifestRegistry.mockReset();
  registryJitiMocks.loadPluginRegistrySnapshot.mockReset();
  registryJitiMocks.discoverOperatorPlugins.mockReturnValue({
    candidates: [],
    diagnostics: [],
  });
