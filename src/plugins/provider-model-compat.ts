...
import { resolveUnsupportedToolSchemaKeywords } from "@operator/ai/internal/openai";
...
// Tool-schema compat predicates moved into @operator/ai (agent-tools-parameter-schema);
