...
import { resolveUnsupportedToolSchemaKeywords } from "@gabrielvfonseca/ai/internal/openai";
...
// Tool-schema compat predicates moved into @gabrielvfonseca/ai (agent-tools-parameter-schema);
