...
const DEPRECATED_PLUGIN_SDK_SUBPATH_SEEDS = [
  ...
  },
  {
    ...
    replacement:
      "`operator/plugin-sdk/plugin-config-runtime`, `operator/plugin-sdk/config-mutation`, `operator/plugin-sdk/runtime-config-snapshot`, and `operator/plugin-sdk/config-contracts`",
  },
  {
  ...
  },
  {
    ...
    removeAfter: "2026-07-30",
    replacement:
      "plugin-local schemas with `operator/plugin-sdk/json-schema-runtime` for JSON Schema validation",
  },
  {
  ...
  },
  {
    ...
    removeAfter: "2026-09-01",
    replacement:
      "focused subpaths including `operator/plugin-sdk/delivery-queue-runtime`, `operator/plugin-sdk/diagnostic-runtime`, `operator/plugin-sdk/error-runtime`, `operator/plugin-sdk/exec-approvals-runtime`, `operator/plugin-sdk/fetch-runtime`, and `operator/plugin-sdk/ssrf-runtime`",
  },
  {
    ...
    removeAfter: "2026-08-15",
    replacement:
      "`operator/plugin-sdk/logging-core`, `operator/plugin-sdk/text-chunking`, `operator/plugin-sdk/text-utility-runtime`, and `operator/plugin-sdk/string-coerce-runtime`",
  },
  {
    ...
    removeAfter: "2026-08-15",
    replacement:
      "`operator/plugin-sdk/channel-secret-basic-runtime` and `operator/plugin-sdk/channel-secret-tts-runtime`",
  },
  {
  ...
  },
  {
    ...
    removeAfter: "2026-07-30",
    replacement:
      "`operator/plugin-sdk/command-auth`, `operator/plugin-sdk/channel-plugin-common`, and `operator/plugin-sdk/reply-history`",
  },
  {
  ...
  },
  {
    ...
    removeAfter: "2026-07-30",
    replacement:
      "`operator/plugin-sdk/music-generation` for public types and assets; plugin-owned provider runtime helpers for provider registration",
  },
  {
  ...
  },
  {
    ...
    removeAfter: "2026-07-30",
    replacement:
      "`operator/plugin-sdk/memory-host-search` for active search-manager lifecycle operations",
  },
  {
  ...
  },
  {
    ...
    removeAfter: "2026-07-30",
    replacement:
      "plugin-owned endpoint detection using `operator/plugin-sdk/provider-http` for generic transport helpers",
  },
  {
  ...
  },
  {
    ...
    removeAfter: "2026-07-30",
    replacement:
      "`resolveAgentDir` or `resolveDefaultAgentDir` from `operator/plugin-sdk/agent-harness-runtime`",
  },
...
const PLUGIN_COMPAT_RECORDS = [
  ...
  },
  {
    ...
    surfaces: [
      "@operator/whatsapp WebInboundMessage flat fields",
  ...
  },
  {
    ...
    docsPath: "/plugins/compatibility",
    surfaces: [
      "@operator/whatsapp WebInboundMessage top-level admission fields",
      "WhatsApp monitorWebInbox onMessage callback",
      "WhatsApp monitorWebChannel listenerFactory injected messages",
    ],
  ...
  },
  {
    ...
    surfaces: [
      "operator/plugin-sdk/discord component message helpers",
      "operator/plugin-sdk/telegram-account resolveTelegramAccount",
    ],
  ...
  },
  {
    ...
    replacement:
      "`operator/plugin-sdk/bundled-channel-config-schema` for maintained bundled plugins; plugin-local schemas for third-party plugins",
    docsPath: "/plugins/sdk-migration",
  ...
  },
  {
    ...
    removeAfter: "2026-07-28",
    replacement:
      "focused `operator/plugin-sdk/*` test subpaths such as `plugin-test-runtime`, `channel-test-helpers`, `test-env`, and `test-fixtures`",
  ...
  },
  {
    ...
    docsPath: "/plugins/sdk-migration",
    surfaces: [
      "operator/plugin-sdk/channel-route channelRouteIdentityKey",
      "operator/plugin-sdk/channel-route channelRouteKey",
    ],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: [
  ...
  },
  {
    ...
    removeAfter: "2026-07-26",
    replacement:
      "focused channel SDK subpaths, especially `operator/plugin-sdk/channel-runtime-context`",
    docsPath: "/plugins/sdk-migration",
  ...
  },
  {
    ...
    warningStarts: "2026-04-26",
    removeAfter: "2026-07-26",
    replacement: "`OpenClawConfig` from `operator/plugin-sdk/config-schema`",
    docsPath: "/plugins/sdk-migration",
    surfaces: ["operator/plugin-sdk `OpenClawSchemaType` type export"],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: ["src/plugins/contracts/plugin-sdk-index.test.ts"],
  },
  {
    ...
    removeAfter: "2026-07-26",
    replacement:
      "injected `api.runtime.*` helpers or focused `operator/plugin-sdk/<subpath>` imports",
    docsPath: "/plugins/sdk-migration",
  ...
  },
  {
    ...
    docsPath: "/plugins/sdk-migration",
    surfaces: [
      "operator/plugin-sdk/channel-actions createMessageToolButtonsSchema",
      "operator/plugin-sdk/channel-actions createMessageToolCardSchema",
    ],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: ["src/plugins/contracts/plugin-sdk-subpaths.test.ts"],
  },
