 ...
 *
 * Runs after Operator resolves an explicit/discovered/dynamic model and before
 ...
 *
 * The helper methods cover the common Operator auth resolution paths:
 *
 ...
 *
 * Called when OAuth refresh fails and Operator wants a provider-specific repair
...
/**
 * Provider-owned extra-param normalization before Operator builds its generic
 ...
 */
/** Provider-facing effort after Operator lowers orchestration-only modes. */
