...
export function applyProviderDefaultModel(cfg: OperatorConfig, modelRef: string): OperatorConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  contextWindow?: number;
  maxTokens?: number;
}): { config: OperatorConfig; modelId: string; modelRef: string; profileId: string } {
