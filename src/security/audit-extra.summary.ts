...
function summarizeGroupPolicy(cfg: OperatorConfig): {
  open: number;
  allowlist: number;
  other: number;
} {
...
function hasWebSearchKey(cfg: OperatorConfig, env: NodeJS.ProcessEnv): boolean {
...
function isWebSearchEnabled(cfg: OperatorConfig, env: NodeJS.ProcessEnv): boolean {
...
function isWebFetchEnabled(cfg: OperatorConfig): boolean {
...
function isBrowserEnabled(cfg: OperatorConfig): boolean {
...
export function collectAttackSurfaceSummaryFindings(cfg: OperatorConfig): SecurityAuditFinding[] {
