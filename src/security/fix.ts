...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof OperatorConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: OperatorConfig; env: NodeJS.ProcessEnv }): {
  cfg: OperatorConfig;
  changes: string[];
} {
