/**
 * Standalone MCP server that exposes Operator plugin-registered tools
...
function resolvePluginToolPolicy(config: OperatorConfig): {
...
function resolveTools(config: OperatorConfig): AnyAgentTool[] {
