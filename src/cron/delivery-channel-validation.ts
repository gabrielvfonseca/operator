...
function hasExplicitChannelConfigEntry(cfg: OperatorConfig): boolean {
...
export async function assertValidCronCreateDelivery(cfg: OperatorConfig, job: CronJobCreate) {
