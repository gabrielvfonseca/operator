...
type CapabilityProviderCandidate = {
  ...
  isConfigured?: (ctx: { cfg?: OperatorConfig; agentDir?: string }) => boolean;
};
...
function resolveCurrentDefaultProviderId(cfg?: OperatorConfig): string {
...
function resolveAutoCapabilityFallbackRefs(params: {
  cfg: OperatorConfig;
  agentDir?: string;
  listProviders: (cfg?: OperatorConfig) => CapabilityProviderCandidate[];
}): string[] {
