...
function isDirectSessionKey(sessionKey?: string): boolean {
  ...
  return normalizeOptionalString(parts[1]) && DIRECT_SESSION_MARKERS.has(parts[2] ?? "")
...
export function resolveLastChannelRaw(params: {
  ...
  // channel. See: https://github.com/operator/operator/issues/47745
  ...
  // See: https://github.com/operator/operator/issues/54441
