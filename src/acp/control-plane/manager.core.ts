...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: OperatorConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: OperatorConfig): AcpManagerObservabilitySnapshot {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: OperatorConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(cfg: OperatorConfig): Promise<void> {
