...
import { normalizeText } from "@gabrielvfonseca/acp-core/normalize-text";
...
export { normalizeText } from "@gabrielvfonseca/acp-core/normalize-text";
...
export type ConfiguredAcpBindingSpec = {
  ...
  /** Owning Operator agent id (used for session identity/storage). */
  agentId: string;
