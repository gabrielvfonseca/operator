...
export type AgentDefaultsConfig = {
  ...
  /** Embedded Operator runner hardening and compatibility controls. */
  embeddedAgent?: {
    /**
     * How embedded Operator should trust workspace-local `.operator/settings.json`.
    ...
    /**
     * Embedded Operator execution contract:
...
export type AgentCompactionConfig = {
  ...
  /** Embedded Operator reserve target before floor and context-window caps. */
  reserveTokens?: number;
  /** Embedded Operator keepRecentTokens budget used for cut-point selection. */
  keepRecentTokens?: number;
  /** Minimum reserve tokens enforced for embedded Operator compaction (0 disables the floor). */
