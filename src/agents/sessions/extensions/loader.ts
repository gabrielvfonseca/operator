...
import * as bundledLlm from "@gabrielvfonseca/operator/plugin-sdk/llm";
...
import { installOperatorInternalCorePackageNativeResolver } from "../../../plugins/plugin-sdk-native-resolver.js";
import {
...
const VIRTUAL_MODULES: Record<string, unknown> = {
  ...
  "@gabrielvfonseca/plugin-sdk/llm": bundledLlm,
  "openclaw/plugin-sdk/agent-sessions": bundledAgentSessions,
  "@gabrielvfonseca/plugin-sdk/agent-sessions": bundledAgentSessions,
};
...
async function loadExtensionSourceTransformModule(
  ...
  if (!extensionSourceTransformLoader) {
    installOperatorInternalCorePackageNativeResolver({ moduleUrl: import.meta.url });
