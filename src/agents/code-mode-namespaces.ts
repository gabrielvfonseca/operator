...
function normalizeRegistration(
  ...
  if (RESERVED_NAMESPACE_GLOBALS.has(globalName) || globalName.startsWith("__operator")) {
...
if (process.env.VITEST || process.env.NODE_ENV === "test") {
  (globalThis as Record<PropertyKey, unknown>)[Symbol.for("operator.codeModeNamespacesTestApi")] = {
