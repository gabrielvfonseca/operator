...
type SandboxRegistryTable = OperatorStateKyselyDatabase["sandbox_registry_entries"];
type SandboxRegistryDatabase = Pick<OperatorStateKyselyDatabase, "sandbox_registry_entries">;
