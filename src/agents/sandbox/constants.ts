...
export const DEFAULT_SANDBOX_IMAGE = "operator-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "operator-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "operator-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "operator-sandbox-common:bookworm-slim";
...
export const DEFAULT_SANDBOX_BROWSER_PREFIX = "operator-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "operator-sandbox-browser";
