...
function resolveCompactionReserveTokensFloor(cfg?: OperatorConfig): number {
...
export function resolveEffectiveCompactionMode(cfg?: OperatorConfig): AgentCompactionMode {
