...
function findMutableAgentEntry(cfg: OperatorConfig, agentId: string): AgentConfig | undefined {
...
export function resolveAgentModelPrimary(cfg: OperatorConfig, agentId: string): string | undefined {
