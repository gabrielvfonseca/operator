 ...
 * pairs directly into the provider payload, so Operator must normalize here.
 */
 ...
 *
 * Operator persists provider-specific reasoning metadata in `thinkingSignature`; if that metadata
