...
// are selectable here; built-in Operator/default runtime ids are excluded.
...
function pushConfiguredModelRuntimeIds(config: OperatorConfig, runtimes: Set<string>): void {
