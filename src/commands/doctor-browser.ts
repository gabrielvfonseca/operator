...
type BrowserDoctorSurface = {
  noteChromeMcpBrowserReadiness: (cfg: OperatorConfig, deps?: BrowserDoctorDeps) => Promise<void>;
...
export async function noteChromeMcpBrowserReadiness(cfg: OperatorConfig, deps?: BrowserDoctorDeps) {
  try {
