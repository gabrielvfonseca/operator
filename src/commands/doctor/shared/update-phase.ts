...
export const UPDATE_IN_PROGRESS_ENV = "OPERATOR_UPDATE_IN_PROGRESS";
export const UPDATE_POST_CORE_CONVERGENCE_ENV = "OPERATOR_UPDATE_POST_CORE_CONVERGENCE";
...
export const UPDATE_PARENT_SUPPORTS_DOCTOR_CONFIG_WRITE_ENV =
  "OPERATOR_UPDATE_PARENT_SUPPORTS_DOCTOR_CONFIG_WRITE";
