...
export function scanLegacyToolsBySenderKeys(cfg: OperatorConfig): LegacyToolsBySenderKeyHit[] {
...
export function maybeRepairLegacyToolsBySenderKeys(cfg: OperatorConfig): {
