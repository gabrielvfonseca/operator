...
function collectExecSafeBinScopes(cfg: OperatorConfig): ExecSafeBinScopeRef[] {
...
export function scanExecSafeBinCoverage(cfg: OperatorConfig): ExecSafeBinCoverageHit[] {
...
export function maybeRepairExecSafeBinProfiles(cfg: OperatorConfig): {
