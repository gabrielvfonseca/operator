...
function resolveEffectiveTrustConfig(cfg: OperatorConfig, env?: NodeJS.ProcessEnv): OperatorConfig {
...
function resolveTrustedCatalogExtraPaths(cfg: OperatorConfig): string[] | undefined {
