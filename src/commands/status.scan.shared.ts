...
function hasExplicitMemorySearchConfig(cfg: OperatorConfig, agentId: string): boolean {
...
export function resolveMemoryPluginStatus(cfg: OperatorConfig): MemoryPluginStatus {
