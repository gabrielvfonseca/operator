...
describe("registerPreActionHooks", () => {
  ...
  it("only allows invalid config for explicit official recovery reinstall requests", async () => {
    await runPreAction({
      parseArgv: ["plugins", "install", "@operator/discord"],
      processArgv: ["node", "openclaw", "plugins", "install", "@operator/discord"],
    });
    ...
    vi.clearAllMocks();
    await runPreAction({
      parseArgv: ["plugins", "install", "@operator/discord@2026.5.22"],
      processArgv: ["node", "openclaw", "plugins", "install", "@operator/discord@2026.5.22"],
    });
    ...
    vi.clearAllMocks();
    await runPreAction({
      parseArgv: ["plugins", "install", "@operator/brave-plugin"],
      processArgv: ["node", "openclaw", "plugins", "install", "@operator/brave-plugin"],
    });
    ...
    vi.clearAllMocks();
    await runPreAction({
      parseArgv: ["plugins", "install", "@operator/slack"],
      processArgv: ["node", "openclaw", "plugins", "install", "@operator/slack"],
    });
    ...
    vi.clearAllMocks();
    await runPreAction({
      parseArgv: ["plugins", "install", "@operator/discord", "--marketplace", "local/repo"],
      processArgv: [
        "node",
        "openclaw",
        "plugins",
