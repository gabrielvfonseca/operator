...
${formatHelpExamples([
  ['operator message send --target +15555550123 --message "Hi"', "Send a text message."],
  [
    'operator message send --target +15555550123 --message "Hi" --media photo.jpg',
    "Send a message with media.",
  ],
  [
    'operator message poll --channel discord --target channel:123 --poll-question "Snack?" --poll-option Pizza --poll-option Sushi',
    "Create a Discord poll.",
  ],
  [
    'operator message react --channel discord --target 123 --message-id 456 --emoji "✅"',
    "React to a message.",
  ],
])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/message", "docs.operator.ai/cli/message")}`,
    )
    .action(() => {
