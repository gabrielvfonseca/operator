...
import { getToolPluginMetadata } from "@gabrielvfonseca/operator/plugin-sdk/tool-plugin";
...
function writeProviderPluginScaffold(params: { rootDir: string; id: string; name: string }): void {
  ...
  const indexSource = `import { definePluginEntry } from "@gabrielvfonseca/operator/plugin-sdk/plugin-entry";
