...
export function registerPluginsCli(program: Command) {
  const plugins = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/plugins", "docs.operator.ai/cli/plugins")}\n`,
    );
  ...
  marketplace
    .command("entries")
    .description("List entries from the configured Operator marketplace feed")
  ...
  marketplace
    .command("refresh")
    .description("Refresh the configured Operator marketplace feed snapshot")
