...
function resolveFetchConfig(config: OperatorConfig): Record<string, unknown> | undefined {
...
function resolveSearchConfig(config: OperatorConfig): Record<string, unknown> | undefined {
...
function getCapabilityWebSearchAutoDetectTargets(config: OperatorConfig): CommandSecretTargetScope {
...
function getCapabilityWebFetchAutoDetectTargets(config: OperatorConfig): CommandSecretTargetScope {
  return getCapabilityWebProviderAutoDetectTargets({
    config,
...
type CapabilityWebCommandSecretTargetParams = {
  ...
  autoDetectTargets: (config: OperatorConfig) => CommandSecretTargetScope;
  selectedProviderTargetIds: (
    config: OperatorConfig,
    providerId?: string | null,
  ) => SelectedProviderTargetIds;
