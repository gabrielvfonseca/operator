...
import { normalizeOptionalString as resolveOptionalStringParam } from "@gabrielvfonseca/normalization-core/string-coerce";
import {
  ErrorCodes,
  errorShape,
...
function resolveAgentIdOrError(agentIdRaw: string, cfg: OperatorConfig) {
