 ...
 *
 * @see https://github.com/operator/operator/issues/3658
 */
...
/**
 * Build TimestampInjectionOptions from an OperatorConfig.
 */
export function timestampOptsFromConfig(cfg: OperatorConfig): TimestampInjectionOptions {
  return {
