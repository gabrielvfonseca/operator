...
export function hasAmbiguousGatewayAuthModeConfig(cfg: OperatorConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: OperatorConfig): void {
