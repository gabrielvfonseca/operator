...
type GatewayInstallAuthMode = NonNullable<NonNullable<OperatorConfig["gateway"]>["auth"]>["mode"];
...
function hasConfiguredGatewayPasswordForInstall(cfg: OperatorConfig): boolean {
