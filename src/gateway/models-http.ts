// OpenAI-compatible `/v1/models` HTTP route backed by configured Operator agents.
...
export async function handleOpenAiModelsHttpRequest(
  ...
  if (decodedId !== OPERATOR_MODEL_ID && !resolveAgentIdFromModel(decodedId)) {
