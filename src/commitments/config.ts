...
export function resolveCommitmentsConfig(cfg?: OperatorConfig): ResolvedCommitmentsConfig {
...
export function resolveCommitmentTimezone(cfg?: OperatorConfig): string {
