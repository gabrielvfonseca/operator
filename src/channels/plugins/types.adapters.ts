...
export type ChannelConfigAdapter<ResolvedAccount> = {
  listAccountIds: (cfg: OperatorConfig) => string[];
  resolveAccount: (cfg: OperatorConfig, accountId?: string | null) => ResolvedAccount;
  inspectAccount?: (cfg: OperatorConfig, accountId?: string | null) => unknown;
  defaultAccountId?: (cfg: OperatorConfig) => string;
  setAccountEnabled?: (params: {
    cfg: OperatorConfig;
    accountId: string;
    enabled: boolean;
  }) => OperatorConfig;
  deleteAccount?: (params: { cfg: OperatorConfig; accountId: string }) => OperatorConfig;
  isEnabled?: ChannelAdapterCallback<(account: ResolvedAccount, cfg: OperatorConfig) => boolean>;
  disabledReason?: ChannelAdapterCallback<
    (account: ResolvedAccount, cfg: OperatorConfig) => string
  >;
  isConfigured?: ChannelAdapterCallback<
    (account: ResolvedAccount, cfg: OperatorConfig) => boolean | Promise<boolean>
  >;
  unconfiguredReason?: ChannelAdapterCallback<
    (account: ResolvedAccount, cfg: OperatorConfig) => string
  >;
  describeAccount?: ChannelAdapterCallback<
    (account: ResolvedAccount, cfg: OperatorConfig) => ChannelAccountSnapshot
  >;
  ...
  hasConfiguredState?: (params: { cfg: OperatorConfig; env?: NodeJS.ProcessEnv }) => boolean;
  hasPersistedAuthState?: (params: { cfg: OperatorConfig; env?: NodeJS.ProcessEnv }) => boolean;
...
export type ChannelStatusAdapter<ResolvedAccount, Probe = unknown, Audit = unknown> = {
  ...
  probeAccount?: ChannelAdapterCallback<
    (params: { account: ResolvedAccount; timeoutMs: number; cfg: OperatorConfig }) => Promise<Probe>
  >;
...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
   ...
   * @see {@link https://docs.operator.ai/plugins/building-plugins | Plugin SDK documentation}
   */
...
export type ChannelGatewayAdapter<ResolvedAccount = unknown> = {
  ...
  resolveGatewayAuthBypassPaths?: (params: { cfg: OperatorConfig }) => string[];
...
export type ChannelLifecycleAdapter = {
  onAccountConfigChanged?: (params: {
    prevCfg: OperatorConfig;
    nextCfg: OperatorConfig;
    accountId: string;
    runtime: RuntimeEnv;
  }) => Promise<void> | void;
...
export type ChannelApprovalDeliveryAdapter = {
  hasConfiguredDmRoute?: (params: { cfg: OperatorConfig }) => boolean;
...
export type ChannelAllowlistAdapter = {
  applyConfigEdit?: (params: {
    ...
    | Promise<
      ...
      >
    | null;
  readConfig?: (params: { cfg: OperatorConfig; accountId?: string | null }) =>
    | {
...
export type ChannelConversationBindingSupport = {
  ...
  createManager?: (params: { cfg: OperatorConfig; accountId?: string | null }) =>
    | {
