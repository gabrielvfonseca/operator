    ...
    it.each([
          ...
          return {
            ...
            expected: {
              ...
              installSource: {
                defaultChoice: "npm",
                npm: {
                  spec: "@wecom/wecom-operator-plugin@1.2.3",
      ...
      },
      {
        ...
        setup: () => {
              ...
              entries: [
                {
                  ...
                  operator: {
                    ...
                    install: {
                      npmSpec: "operator-plugin-yuanbao@1.0.0",
                      defaultChoice: "npm",
                      minHostVersion: ">=2026.4.10",
          ...
          return {
            channelId: "operator-plugin-yuanbao",
            catalogPaths: [catalogPath],
            expected: {
              id: "operator-plugin-yuanbao",
              meta: {
    ...
    it.each([
      {
        ...
        setup: () => {
          ...
          return {
            env: {
              ...process.env,
              OPERATOR_PLUGIN_CATALOG_PATHS: "~/catalog.json",
              OPERATOR_HOME: home,
              HOME: home,
            },
