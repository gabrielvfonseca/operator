...
export type ChannelAgentToolFactory = (params: { cfg?: OperatorConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: OperatorConfig; accountId?: string | null }) => string[];
  messageToolCapabilities?: (params: {
    cfg: OperatorConfig;
    accountId?: string | null;
  }) => string[] | undefined;
  inboundFormattingHints?: (params: { cfg: OperatorConfig; accountId?: string | null }) =>
    | {
        text_markup: string;
        rules: string[];
      }
