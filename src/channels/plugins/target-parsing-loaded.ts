...
/** @deprecated Use `channelRouteTargetsMatchExact` from `operator/plugin-sdk/channel-route`. */
...
/** @deprecated Use `channelRouteTargetsShareConversation` from `operator/plugin-sdk/channel-route`. */
