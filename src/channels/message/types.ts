...
export type ChannelMessageSendTextContext<TConfig = OperatorConfig> = {
  cfg: TConfig;
  to: string;
  text: string;
...
export type ChannelMessageSendMediaContext<TConfig = OperatorConfig> =
...
export type ChannelMessageSendPayloadContext<TConfig = OperatorConfig> =
  ChannelMessageSendTextContext<TConfig> & {
...
export type ChannelMessageSendPollContext<TConfig = OperatorConfig> = Omit<
  ChannelMessageSendTextContext<TConfig>,
  "text" | "threadId"
> & {
  poll: PollInput;
...
export type ChannelMessageSendAttemptContext<TConfig = OperatorConfig> =
...
type ChannelMessageSendFailureContext<TConfig = OperatorConfig> =
  ChannelMessageSendAttemptContext<TConfig> & {
    error: unknown;
    attemptToken?: unknown;
  };
...
export type ChannelMessageUnknownSendContext<TConfig = OperatorConfig> = {
  cfg: TConfig;
  queueId: string;
  channel: string;
  to: string;
...
export type ChannelMessageDeferredDeliveryAdmissionContext<TConfig = OperatorConfig> = {
  cfg: TConfig;
  channel: string;
  to: string;
  accountId?: string | null;
