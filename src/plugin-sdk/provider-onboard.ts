...
export type { OperatorConfig, ModelApi, ModelDefinitionConfig, ModelProviderConfig };
export {
...
export type ProviderOnboardPresetAppliers<TArgs extends unknown[]> = {
  applyProviderConfig: (cfg: OperatorConfig, ...args: TArgs) => OperatorConfig;
  applyConfig: (cfg: OperatorConfig, ...args: TArgs) => OperatorConfig;
};
...
function hasAgentDefaultModelPrimary(cfg: OperatorConfig): boolean {
...
>(params: {
  ...
  applyPreset: (cfg: OperatorConfig, preset: TParams) => OperatorConfig;
  primaryModelRef: string;
...
export function applyOpencodeZenModelDefault(cfg: OperatorConfig): {
  next: OperatorConfig;
  changed: boolean;
} {
