...
/**
 * @deprecated Compatibility facade for the `operator/plugin-sdk/discord` subpath.
...
export type { OperatorConfig } from "./config-types.js";
export type { OperatorPluginApi, PluginRuntime } from "./channel-plugin-common.js";
...
/** Discord channel config shape for one account in Operator config. */
export type DiscordAccountConfig = NonNullable<NonNullable<OperatorConfig["channels"]>["discord"]>;
...
type DiscordApiFacadeModule = {
  ...
  inspectDiscordAccount: (params: { cfg: OperatorConfig; accountId?: string | null }) => unknown;
  listDiscordAccountIds: (cfg: OperatorConfig) => string[];
  ...
  resolveDefaultDiscordAccountId: (cfg: OperatorConfig) => string;
...
function resolveCompatRuntimeConfig(params: { cfg?: OperatorConfig }): OperatorConfig {
...
/** List configured Discord account ids from Operator config. */
export function listDiscordAccountIds(cfg: OperatorConfig): string[] {
...
export function resolveDefaultDiscordAccountId(cfg: OperatorConfig): string {
