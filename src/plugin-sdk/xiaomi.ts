...
type FacadeModule = {
  applyXiaomiConfig: (cfg: OperatorConfig) => OperatorConfig;
  applyXiaomiProviderConfig: (cfg: OperatorConfig) => OperatorConfig;
...
/** Apply Xiaomi provider defaults to the full Operator config. */
