...
type ChannelApprovalForwardingEvaluatorParams = {
  channel: string;
  isTransportEnabled: (params: { cfg: OperatorConfig; accountId?: string | null }) => boolean;
...
type NativeApprovalChannelRouteGateParams<TTarget extends NativeApprovalTarget> = {
  ...
  isTransportEnabled: (params: { cfg: OperatorConfig; accountId?: string | null }) => boolean;
  listAccountIds: (cfg: OperatorConfig) => readonly string[];
  resolveDefaultAccountId: (cfg: OperatorConfig) => string;
  normalizeForwardTarget: (target: NativeApprovalForwardTarget) => TTarget | null;
...
export function shouldSuppressLocalNativeExecApprovalPrompt(params: {
  ...
  isNativeDeliveryEnabled?: (params: { cfg: OperatorConfig; accountId?: string | null }) => boolean;
