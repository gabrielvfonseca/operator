...
import {
  ...
  type OperatorPluginApiWithoutFacades,
} from "../plugins/api-facades.js";
import type { OperatorPluginApi } from "./plugin-runtime.js";

/** Partial plugin API overrides accepted by the SDK test helper. */
export type TestPluginApiInput = Partial<OperatorPluginApi>;

/** Create a minimal plugin API object for plugin-sdk contract and unit tests. */
export function createTestPluginApi(api: TestPluginApiInput = {}): OperatorPluginApi {
  ...
  const mergedApi = {
    ...
    on() {},
    ...flatApi,
  } satisfies OperatorPluginApiWithoutFacades;
