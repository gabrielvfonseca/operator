...
/** Normalized model metadata used by Operator provider catalogs. */
...
export const LMSTUDIO_DEFAULT_MODEL_ID: FacadeModule["LMSTUDIO_DEFAULT_MODEL_ID"] =
  "qwen/qwen3.5-9b";
/** Stable provider id used in Operator config and provider catalogs. */
...
/** Map one raw LM Studio model entry into Operator model metadata. */
...
/** Discover Operator model definitions from an LM Studio server. */
