...
/** @deprecated Use route descriptors with `resolveChannelMessageIngress` from `operator/plugin-sdk/channel-ingress-runtime`. */
...
/** @deprecated Use `resolveOpenProviderRuntimeGroupPolicy` plus `resolveChannelMessageIngress` from `operator/plugin-sdk/channel-ingress-runtime`. */
