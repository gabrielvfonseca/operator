...
type FacadeModule = {
  applyOpenrouterConfig: (cfg: OperatorConfig) => OperatorConfig;
  applyOpenrouterProviderConfig: (cfg: OperatorConfig) => OperatorConfig;
...
/** Apply OpenRouter defaults to the full Operator config. */
