...
export function resolveSessionToolsVisibility(cfg: OperatorConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: OperatorConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: OperatorConfig): AgentToAgentPolicy {
