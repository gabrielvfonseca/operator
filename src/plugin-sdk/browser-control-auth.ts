// Browser control auth helpers resolve plugin browser credentials from Operator config.
...
type BrowserControlAuthSurface = {
  resolveBrowserControlAuth: (cfg?: OperatorConfig, env?: NodeJS.ProcessEnv) => BrowserControlAuth;
