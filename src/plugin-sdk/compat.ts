...
const shouldWarnCompatImport =
  ...
  process.env.OPERATOR_SUPPRESS_PLUGIN_SDK_COMPAT_WARNING !== "1";
...
if (shouldWarnCompatImport) {
  process.emitWarning(
    "operator/plugin-sdk/compat is deprecated for new plugins. Migrate to focused operator/plugin-sdk/<subpath> imports. See https://docs.operator.ai/plugins/sdk-migration",
    {
      ...
      detail:
        "Bundled plugins must use scoped plugin-sdk subpaths. External plugins may keep compat temporarily while migrating. Migration guide: https://docs.operator.ai/plugins/sdk-migration",
    },
  );
}
